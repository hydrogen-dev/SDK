...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_fee'))
        obj.isFee = ApiClient.convertToType(data['is_fee'], 'Boolean');
      ...
      if (data.hasOwnProperty('is_transfer'))
        obj.isTransfer = ApiClient.convertToType(data['is_transfer'], 'Boolean');
   ...
   */
  exports.prototype.isFee = undefined;
  ...
  /**
   * @member {Boolean} isTransfer
   */
  exports.prototype.isTransfer = undefined;
