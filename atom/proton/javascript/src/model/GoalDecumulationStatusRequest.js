...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DecumulationGoalDepositConfig', 'model/GoalWithdrawalConfig', 'model/RecommendationConfig'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DecumulationGoalDepositConfig'), require('./GoalWithdrawalConfig'), require('./RecommendationConfig'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenProtonApi) {
      root.HydrogenProtonApi = {};
    }
    root.HydrogenProtonApi.GoalDecumulationStatusRequest = factory(root.HydrogenProtonApi.ApiClient, root.HydrogenProtonApi.DecumulationGoalDepositConfig, root.HydrogenProtonApi.GoalWithdrawalConfig, root.HydrogenProtonApi.RecommendationConfig);
  }
}(this, function(ApiClient, DecumulationGoalDepositConfig, GoalWithdrawalConfig, RecommendationConfig) {
  'use strict';

  /**
   * The GoalDecumulationStatusRequest model module.
   * @module model/GoalDecumulationStatusRequest
   * @version 1.9.0
   */

  /**
   * Constructs a new <code>GoalDecumulationStatusRequest</code>.
   * @alias module:model/GoalDecumulationStatusRequest
   * @class
  ...
  /**
   * Constructs a <code>GoalDecumulationStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GoalDecumulationStatusRequest} obj Optional instance to populate.
   * @return {module:model/GoalDecumulationStatusRequest} The populated <code>GoalDecumulationStatusRequest</code> instance.
   */
  ...
  /**
   * @member {module:model/GoalDecumulationStatusRequest.RecommendTypeEnum} recommendType
   * @default 'horizon'
   */
  ...
  /**
   * @member {module:model/GoalDecumulationStatusRequest.ThreshTypeEnum} threshType
   * @default 'perc'
   */
  exports.prototype.threshType = 'perc';

  /**
   * @member {module:model/GoalDecumulationStatusRequest.HorizonFrequencyEnum} horizonFrequency
   * @default 'year'
   */
