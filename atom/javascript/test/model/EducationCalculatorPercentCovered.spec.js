...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.EducationCalculatorPercentCovered();
  });
  ...
  describe('EducationCalculatorPercentCovered', function() {
    it('should create an instance of EducationCalculatorPercentCovered', function() {
      // uncomment below and update the code to test EducationCalculatorPercentCovered
      //var instance = new atom_api.EducationCalculatorPercentCovered();
      //expect(instance).to.be.a(atom_api.EducationCalculatorPercentCovered);
    });
