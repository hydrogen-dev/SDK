...
public class SpecificAllocationCompositionResponse {
  ...
  public SpecificAllocationCompositionResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public SpecificAllocationCompositionResponse createDate(String createDate) {
  ...
  **/
  ...
  public SpecificAllocationCompositionResponse allocationId(UUID allocationId) {
  ...
  **/
  ...
  public SpecificAllocationCompositionResponse modelId(UUID modelId) {
  ...
  **/
  ...
  public SpecificAllocationCompositionResponse currentWeight(Double currentWeight) {
  ...
  **/
  ...
  public SpecificAllocationCompositionResponse strategicWeight(Double strategicWeight) {
  ...
  **/
  ...
  public SpecificAllocationCompositionResponse date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  **/
  ...
  public SpecificAllocationCompositionResponse core(Boolean core) {
    this.core = core;
    return this;
  }
  ...
  **/
   ...
   * @return updateDate
  **/
  @ApiModelProperty(value = "Latest datetime the allocation composition was updated")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SpecificAllocationCompositionResponse specificAllocationCompositionResponse = (SpecificAllocationCompositionResponse) o;
    return Objects.equals(this.id, specificAllocationCompositionResponse.id) &&
        Objects.equals(this.createDate, specificAllocationCompositionResponse.createDate) &&
        Objects.equals(this.allocationId, specificAllocationCompositionResponse.allocationId) &&
        Objects.equals(this.modelId, specificAllocationCompositionResponse.modelId) &&
        Objects.equals(this.currentWeight, specificAllocationCompositionResponse.currentWeight) &&
  ...
  public String toString() {
    ...
    sb.append("class SpecificAllocationCompositionResponse {\n");
