...
# Unit tests for NucleusApi::PageFaq
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PageFaq' do
  before do
    # run before each test
    @instance = NucleusApi::PageFaq.new
  end
  ...
  describe 'test an instance of PageFaq' do
    it 'should create an instance of PageFaq' do
      expect(@instance).to be_instance_of(NucleusApi::PageFaq)
    end
  end
