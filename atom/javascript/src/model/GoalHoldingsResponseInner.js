...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.GoalHoldingsResponseInner = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The GoalHoldingsResponseInner model module.
   * @module model/GoalHoldingsResponseInner
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GoalHoldingsResponseInner</code>.
   * @alias module:model/GoalHoldingsResponseInner
   * @class
   */
  ...
  /**
   * Constructs a <code>GoalHoldingsResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GoalHoldingsResponseInner} obj Optional instance to populate.
   * @return {module:model/GoalHoldingsResponseInner} The populated <code>GoalHoldingsResponseInner</code> instance.
   */
