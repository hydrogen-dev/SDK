...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BusinessStatusResponseVO :  IEquatable<BusinessStatusResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessStatusResponseVO" /> class.
        /// </summary>
        ...
        public BusinessStatusResponseVO(string message = default(string), Guid? nucleusBusinessId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as BusinessStatusResponseVO);
        }

        /// <summary>
        /// Returns true if BusinessStatusResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of BusinessStatusResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BusinessStatusResponseVO input)
        {
            if (input == null)
                return false;
