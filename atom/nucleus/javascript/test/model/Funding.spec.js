...
(function(root, factory) {
  ...
  describe('Funding', function() {
    ...
    it('should have the property receivingAccountId (base name: "receiving_account_id")', function() {
      // uncomment below and update the code to test the property receivingAccountId
      //var instane = new HydrogenNucleusApi.Funding();
      //expect(instance).to.be();
    });

    it('should have the property receivingBankLinkId (base name: "receiving_bank_link_id")', function() {
      // uncomment below and update the code to test the property receivingBankLinkId
      //var instane = new HydrogenNucleusApi.Funding();
      //expect(instance).to.be();
    });

    it('should have the property receivingPortfolioId (base name: "receiving_portfolio_id")', function() {
      // uncomment below and update the code to test the property receivingPortfolioId
      //var instane = new HydrogenNucleusApi.Funding();
      //expect(instance).to.be();
    });
    ...
    it('should have the property transferSpeed (base name: "transfer_speed")', function() {
      // uncomment below and update the code to test the property transferSpeed
      //var instane = new HydrogenNucleusApi.Funding();
      //expect(instance).to.be();
    });
