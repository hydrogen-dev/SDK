...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.PortfolioRebalanceSellOnlyOrderPayload();
  });
  ...
  describe('PortfolioRebalanceSellOnlyOrderPayload', function() {
    it('should create an instance of PortfolioRebalanceSellOnlyOrderPayload', function() {
      // uncomment below and update the code to test PortfolioRebalanceSellOnlyOrderPayload
      //var instance = new atom_api.PortfolioRebalanceSellOnlyOrderPayload();
      //expect(instance).to.be.a(atom_api.PortfolioRebalanceSellOnlyOrderPayload);
    });
