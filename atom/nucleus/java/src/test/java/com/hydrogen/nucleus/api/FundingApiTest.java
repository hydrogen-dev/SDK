...
public class FundingApiTest {
    ...
    public void getDepositAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageDailyDeposit response = api.getDepositAllUsingGet(ascending, currencyConversion, filter, orderBy, page, size);
    ...
    public void getDepositUsingGetTest() throws ApiException {
        UUID depositId = null;
        String currencyConversion = null;
        DailyDeposit response = api.getDepositUsingGet(depositId, currencyConversion);
    ...
    public void getWithdrawalAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageDailyWithdrawal response = api.getWithdrawalAllUsingGet(ascending, currencyConversion, filter, orderBy, page, size);
    ...
    public void getWithdrawalUsingGetTest() throws ApiException {
        UUID withdrawalId = null;
        String currencyConversion = null;
        DailyWithdrawal response = api.getWithdrawalUsingGet(withdrawalId, currencyConversion);
