...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageAccountStatus();
  });
  ...
  describe('PageAccountStatus', function() {
    it('should create an instance of PageAccountStatus', function() {
      ...
      //var instane = new HydrogenAtomApi.PageAccountStatus();
      //expect(instance).to.be.a(HydrogenAtomApi.PageAccountStatus);
    });
