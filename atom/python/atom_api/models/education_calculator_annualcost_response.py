...
class EducationCalculatorAnnualcostResponse(object):
    ...
    def __init__(self, total_annual_cost=None, total_annual_cost_adjusted=None, projected_accumulation_savings=None, total_earnings=None, total_contributions=None, total_cost=None, total_taxes=None, return_details=None):  # noqa: E501
        """EducationCalculatorAnnualcostResponse - a model defined in Swagger"""  # noqa: E501

        self._total_annual_cost = None
        self._total_annual_cost_adjusted = None
        ...
        self.total_annual_cost_adjusted = total_annual_cost_adjusted
    ...
    @property
    def total_annual_cost_adjusted(self):
        """Gets the total_annual_cost_adjusted of this EducationCalculatorAnnualcostResponse.  # noqa: E501

        The total education cost per year that can be afforded, represented in today's dollars.  # noqa: E501

        :return: The total_annual_cost_adjusted of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :rtype: float
        """
        return self._total_annual_cost_adjusted

    @total_annual_cost_adjusted.setter
    def total_annual_cost_adjusted(self, total_annual_cost_adjusted):
        """Sets the total_annual_cost_adjusted of this EducationCalculatorAnnualcostResponse.

        The total education cost per year that can be afforded, represented in today's dollars.  # noqa: E501

        :param total_annual_cost_adjusted: The total_annual_cost_adjusted of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :type: float
        """
        if total_annual_cost_adjusted is None:
            raise ValueError("Invalid value for `total_annual_cost_adjusted`, must not be `None`")  # noqa: E501

        self._total_annual_cost_adjusted = total_annual_cost_adjusted

    @property
    def projected_accumulation_savings(self):
        """Gets the projected_accumulation_savings of this EducationCalculatorAnnualcostResponse.  # noqa: E501

        The projected balance at the end of accumulation_horizon.  # noqa: E501

        :return: The projected_accumulation_savings of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def projected_accumulation_savings(self, projected_accumulation_savings):
        """Sets the projected_accumulation_savings of this EducationCalculatorAnnualcostResponse.

        The projected balance at the end of accumulation_horizon.  # noqa: E501

        :param projected_accumulation_savings: The projected_accumulation_savings of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :type: float
        """
    ...
    def total_earnings(self):
        """Gets the total_earnings of this EducationCalculatorAnnualcostResponse.  # noqa: E501

        The total earnings generated over the horizon.  # noqa: E501

        :return: The total_earnings of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def total_earnings(self, total_earnings):
        """Sets the total_earnings of this EducationCalculatorAnnualcostResponse.

        The total earnings generated over the horizon.  # noqa: E501

        :param total_earnings: The total_earnings of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :type: float
        """
    ...
    def total_contributions(self):
        """Gets the total_contributions of this EducationCalculatorAnnualcostResponse.  # noqa: E501

        The total contributions added over the horizon.  # noqa: E501

        :return: The total_contributions of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def total_contributions(self, total_contributions):
        """Sets the total_contributions of this EducationCalculatorAnnualcostResponse.

        The total contributions added over the horizon.  # noqa: E501

        :param total_contributions: The total_contributions of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :type: float
        """
    ...
    def total_taxes(self):
        """Gets the total_taxes of this EducationCalculatorAnnualcostResponse.  # noqa: E501

        The total taxes paid on withdrawals over decumulation_horizon.  # noqa: E501

        :return: The total_taxes of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def total_taxes(self, total_taxes):
        """Sets the total_taxes of this EducationCalculatorAnnualcostResponse.

        The total taxes paid on withdrawals over decumulation_horizon.  # noqa: E501

        :param total_taxes: The total_taxes of this EducationCalculatorAnnualcostResponse.  # noqa: E501
        :type: float
        """
