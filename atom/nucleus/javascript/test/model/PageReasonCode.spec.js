...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageReasonCode();
  });
  ...
  describe('PageReasonCode', function() {
    it('should create an instance of PageReasonCode', function() {
      // uncomment below and update the code to test PageReasonCode
      //var instane = new HydrogenNucleusApi.PageReasonCode();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageReasonCode);
    });
