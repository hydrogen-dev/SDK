...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageInsuranceCoverage();
  });
  ...
  describe('PageInsuranceCoverage', function() {
    it('should create an instance of PageInsuranceCoverage', function() {
      // uncomment below and update the code to test PageInsuranceCoverage
      //var instane = new HydrogenNucleusApi.PageInsuranceCoverage();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageInsuranceCoverage);
    });
