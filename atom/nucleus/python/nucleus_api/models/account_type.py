...
class AccountType(object):
    ...
    def __init__(self, category=None, code=None, create_date=None, id=None, is_active=None, is_taxable=None, metadata=None, name=None, secondary_id=None, short_name=None, subcategory=None, update_date=None):  # noqa: E501
