...
module NucleusApi
  ...
  class InsuranceQuote
    ...
    def hash
      [coverages, create_date, currency_code, discounts, end_date, financial_offer_id, id, is_active, metadata, node_map, premium, premium_duration, premium_frequency, premium_frequency_unit, secondary_id, start_date, update_date].hash
    end
