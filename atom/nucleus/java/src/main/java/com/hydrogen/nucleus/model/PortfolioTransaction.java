...
public class PortfolioTransaction {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, balance, category, check, createDate, currencyCode, date, dateAvailable, description, id, isCleansed, isDisputed, isRead, isRecurring, location, memo, merchant, merchantCategoryCode, metadata, modelId, portfolioId, price, quantity, secondaryId, securityId, status, subcategory, transactionCodeId, updateDate);
  }
