...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.GoalAccumulationRecommendation();
  });
  ...
  describe('GoalAccumulationRecommendation', function() {
    it('should create an instance of GoalAccumulationRecommendation', function() {
      // uncomment below and update the code to test GoalAccumulationRecommendation
      //var instance = new atom_api.GoalAccumulationRecommendation();
      //expect(instance).to.be.a(atom_api.GoalAccumulationRecommendation);
    });
