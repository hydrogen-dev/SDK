...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BudgetPayload', 'model/BudgetPayloadAggregationAccounts', 'model/BudgetPayloadBudget', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BudgetPayload'), require('./BudgetPayloadAggregationAccounts'), require('./BudgetPayloadBudget'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.CreateBudgetResponse = factory(root.atom_api.ApiClient, root.atom_api.BudgetPayload, root.atom_api.BudgetPayloadAggregationAccounts, root.atom_api.BudgetPayloadBudget, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, BudgetPayload, BudgetPayloadAggregationAccounts, BudgetPayloadBudget, SecondaryId) {
  'use strict';
