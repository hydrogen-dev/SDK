...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExchangePublicTokenVO :  IEquatable<ExchangePublicTokenVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangePublicTokenVO" /> class.
        /// </summary>
        ...
        public ExchangePublicTokenVO(string integrationType = default(string), Guid? nucleusBusinessId = default(Guid?), Guid? nucleusClientId = default(Guid?), string product = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as ExchangePublicTokenVO);
        }

        /// <summary>
        /// Returns true if ExchangePublicTokenVO instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangePublicTokenVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangePublicTokenVO input)
        {
            if (input == null)
                return false;
