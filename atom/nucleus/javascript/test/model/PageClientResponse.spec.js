...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageClientResponse();
  });
  ...
  describe('PageClientResponse', function() {
    it('should create an instance of PageClientResponse', function() {
      ...
      //var instane = new HydrogenAtomApi.PageClientResponse();
      //expect(instance).to.be.a(HydrogenAtomApi.PageClientResponse);
    });
