...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class WireTransferResponseVO :  IEquatable<WireTransferResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WireTransferResponseVO" /> class.
        /// </summary>
        ...
        public WireTransferResponseVO(string message = default(string), Guid? nucleusFundingId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorRequest = default(Object), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as WireTransferResponseVO);
        }

        /// <summary>
        /// Returns true if WireTransferResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of WireTransferResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WireTransferResponseVO input)
        {
            if (input == null)
                return false;
