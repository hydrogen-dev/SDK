...
import com.hydrogen.model.Allocation;
import com.hydrogen.model.AllocationAggregatedVO;
...
import com.hydrogen.model.AllocationComposition;
import org.threeten.bp.LocalDate;
import com.hydrogen.model.ModelHoldingAgg;
import org.threeten.bp.OffsetDateTime;
import com.hydrogen.model.PageAllocation;
import com.hydrogen.model.PageAllocationComposition;
...
public class AllocationApi {
    ...
    public com.squareup.okhttp.Call createAllocationCompositionUsingPostCall(AllocationComposition allocRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/allocation_composition";
    ...
    public com.squareup.okhttp.Call createAllocationUsingPostCall(Allocation allocationRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/allocation";
    ...
    public com.squareup.okhttp.Call deleteAllocationCompositionUsingDeleteCall(UUID allocationCompositionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/allocation_composition/{allocation_composition_id}"
    ...
    public com.squareup.okhttp.Call deleteAllocationUsingDeleteCall(UUID allocationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/allocation/{allocation_id}"
    ...
    /**
     * Build call for getAllHoldingsUsingGET
     * @param allocationId UUID allocation_id (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAllHoldingsUsingGETCall(UUID allocationId, OffsetDateTime endDate, OffsetDateTime startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/allocation/{allocation_id}/holding"
            .replaceAll("\\{" + "allocation_id" + "\\}", apiClient.escapeString(allocationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAllHoldingsUsingGETValidateBeforeCall(UUID allocationId, OffsetDateTime endDate, OffsetDateTime startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'allocationId' is set
        if (allocationId == null) {
            throw new ApiException("Missing the required parameter 'allocationId' when calling getAllHoldingsUsingGET(Async)");
        }
        

        com.squareup.okhttp.Call call = getAllHoldingsUsingGETCall(allocationId, endDate, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @param endDate end_date (optional, default to null)
     * @param startDate start_date (optional, default to null)
     * @return List&lt;ModelHoldingAgg&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<ModelHoldingAgg> getAllHoldingsUsingGET(UUID allocationId, OffsetDateTime endDate, OffsetDateTime startDate) throws ApiException {
        ApiResponse<List<ModelHoldingAgg>> resp = getAllHoldingsUsingGETWithHttpInfo(allocationId, endDate, startDate);
        return resp.getData();
    }
     ...
     * @param endDate end_date (optional, default to null)
     * @param startDate start_date (optional, default to null)
     * @return ApiResponse&lt;List&lt;ModelHoldingAgg&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ModelHoldingAgg>> getAllHoldingsUsingGETWithHttpInfo(UUID allocationId, OffsetDateTime endDate, OffsetDateTime startDate) throws ApiException {
        com.squareup.okhttp.Call call = getAllHoldingsUsingGETValidateBeforeCall(allocationId, endDate, startDate, null, null);
        Type localVarReturnType = new TypeToken<List<ModelHoldingAgg>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAllHoldingsUsingGETAsync(UUID allocationId, OffsetDateTime endDate, OffsetDateTime startDate, final ApiCallback<List<ModelHoldingAgg>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAllHoldingsUsingGETValidateBeforeCall(allocationId, endDate, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ModelHoldingAgg>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAllTransactionsUsingGETCall(UUID allocationId, Boolean ascending, OffsetDateTime endDate, String orderBy, Integer page, Integer size, OffsetDateTime startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/allocation/{allocation_id}/transaction"
            .replaceAll("\\{" + "allocation_id" + "\\}", apiClient.escapeString(allocationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAllTransactionsUsingGETValidateBeforeCall(UUID allocationId, Boolean ascending, OffsetDateTime endDate, String orderBy, Integer page, Integer size, OffsetDateTime startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'allocationId' is set
        if (allocationId == null) {
            throw new ApiException("Missing the required parameter 'allocationId' when calling getAllTransactionsUsingGET(Async)");
        }
        

        com.squareup.okhttp.Call call = getAllTransactionsUsingGETCall(allocationId, ascending, endDate, orderBy, page, size, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageModelTransaction getAllTransactionsUsingGET(UUID allocationId, Boolean ascending, OffsetDateTime endDate, String orderBy, Integer page, Integer size, OffsetDateTime startDate) throws ApiException {
        ApiResponse<PageModelTransaction> resp = getAllTransactionsUsingGETWithHttpInfo(allocationId, ascending, endDate, orderBy, page, size, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageModelTransaction> getAllTransactionsUsingGETWithHttpInfo(UUID allocationId, Boolean ascending, OffsetDateTime endDate, String orderBy, Integer page, Integer size, OffsetDateTime startDate) throws ApiException {
        com.squareup.okhttp.Call call = getAllTransactionsUsingGETValidateBeforeCall(allocationId, ascending, endDate, orderBy, page, size, startDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAllTransactionsUsingGETAsync(UUID allocationId, Boolean ascending, OffsetDateTime endDate, String orderBy, Integer page, Integer size, OffsetDateTime startDate, final ApiCallback<PageModelTransaction> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAllTransactionsUsingGETValidateBeforeCall(allocationId, ascending, endDate, orderBy, page, size, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageModelTransaction>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for getAllocationAggregatedDataUsingGET
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAllocationAggregatedDataUsingGETCall(UUID allocationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/allocation/{allocation_id}/aggregate_data"
            .replaceAll("\\{" + "allocation_id" + "\\}", apiClient.escapeString(allocationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAllocationAggregatedDataUsingGETValidateBeforeCall(UUID allocationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'allocationId' is set
        if (allocationId == null) {
            throw new ApiException("Missing the required parameter 'allocationId' when calling getAllocationAggregatedDataUsingGET(Async)");
        }
        

        com.squareup.okhttp.Call call = getAllocationAggregatedDataUsingGETCall(allocationId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AllocationAggregatedVO getAllocationAggregatedDataUsingGET(UUID allocationId) throws ApiException {
        ApiResponse<AllocationAggregatedVO> resp = getAllocationAggregatedDataUsingGETWithHttpInfo(allocationId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AllocationAggregatedVO> getAllocationAggregatedDataUsingGETWithHttpInfo(UUID allocationId) throws ApiException {
        com.squareup.okhttp.Call call = getAllocationAggregatedDataUsingGETValidateBeforeCall(allocationId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAllocationAggregatedDataUsingGETAsync(UUID allocationId, final ApiCallback<AllocationAggregatedVO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAllocationAggregatedDataUsingGETValidateBeforeCall(allocationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AllocationAggregatedVO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for getAssetsizeUsingGET
     * @param allocationId UUID allocation_id (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAssetsizeUsingGETCall(UUID allocationId, LocalDate endDate, Boolean getLatest, Boolean isCurrentWeight, String sortType, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/allocation/{allocation_id}/asset_size"
            .replaceAll("\\{" + "allocation_id" + "\\}", apiClient.escapeString(allocationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAssetsizeUsingGETValidateBeforeCall(UUID allocationId, LocalDate endDate, Boolean getLatest, Boolean isCurrentWeight, String sortType, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'allocationId' is set
        if (allocationId == null) {
            throw new ApiException("Missing the required parameter 'allocationId' when calling getAssetsizeUsingGET(Async)");
        }
        

        com.squareup.okhttp.Call call = getAssetsizeUsingGETCall(allocationId, endDate, getLatest, isCurrentWeight, sortType, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<DateDoubleVO> getAssetsizeUsingGET(UUID allocationId, LocalDate endDate, Boolean getLatest, Boolean isCurrentWeight, String sortType, LocalDate startDate) throws ApiException {
        ApiResponse<List<DateDoubleVO>> resp = getAssetsizeUsingGETWithHttpInfo(allocationId, endDate, getLatest, isCurrentWeight, sortType, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<DateDoubleVO>> getAssetsizeUsingGETWithHttpInfo(UUID allocationId, LocalDate endDate, Boolean getLatest, Boolean isCurrentWeight, String sortType, LocalDate startDate) throws ApiException {
        com.squareup.okhttp.Call call = getAssetsizeUsingGETValidateBeforeCall(allocationId, endDate, getLatest, isCurrentWeight, sortType, startDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAssetsizeUsingGETAsync(UUID allocationId, LocalDate endDate, Boolean getLatest, Boolean isCurrentWeight, String sortType, LocalDate startDate, final ApiCallback<List<DateDoubleVO>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAssetsizeUsingGETValidateBeforeCall(allocationId, endDate, getLatest, isCurrentWeight, sortType, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<DateDoubleVO>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param allocationComposition aggregation_composition (required)
     * @param allocationCompositionId UUID allocation_composition_id (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
