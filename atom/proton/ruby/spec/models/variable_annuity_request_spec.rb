...
# Unit tests for ProtonApi::VariableAnnuityRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VariableAnnuityRequest' do
  before do
    # run before each test
    @instance = ProtonApi::VariableAnnuityRequest.new
  end
  ...
  describe 'test an instance of VariableAnnuityRequest' do
    it 'should create an instance of VariableAnnuityRequest' do
      expect(@instance).to be_instance_of(ProtonApi::VariableAnnuityRequest)
    end
  end
