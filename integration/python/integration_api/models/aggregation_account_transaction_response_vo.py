...
class AggregationAccountTransactionResponseVO(object):
    ...
    def __init__(self, message=None, nucleus_aggregation_account_id=None, nucleus_transactions_canceled=None, nucleus_transactions_posted=None, vendor_name=None, _configuration=None):  # noqa: E501
