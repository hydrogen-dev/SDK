...
class Webhook(object):
    ...
    def __init__(self, create_date=None, id=None, integration_service=None, is_active=None, secondary_id=None, secret=None, update_date=None, url=None, _configuration=None):  # noqa: E501
    ...
    def integration_service(self, integration_service):
        ...
        :type: list[str]
        """
        allowed_values = ["kyc", "kyc_status", "async_accounting_customer", "async_accounting_supplier", "async_accounting_customer_revenue", "async_accounting_invoice", "async_accounting_bill", "async_accounting_invoice_payment", "async_aggregation_account", "async_aggregation_account_transaction", "async_aggregation_account_holding"]  # noqa: E501
        if (self._configuration.client_side_validation and
                not set(integration_service).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
