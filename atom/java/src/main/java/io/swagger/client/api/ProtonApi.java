...
public class ProtonApi {
     ...
     */
    public com.squareup.okhttp.Call budgetCalculatorCall(BudgetCalculatorPayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = payload;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call budgetCalculatorValidateBeforeCall(BudgetCalculatorPayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Budget-Calculator">Budget Calculator Documentation</a>
     */
    public BudgetCalculatorResponse budgetCalculator(BudgetCalculatorPayload payload) throws ApiException {
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Budget-Calculator">Budget Calculator Documentation</a>
     */
    public ApiResponse<BudgetCalculatorResponse> budgetCalculatorWithHttpInfo(BudgetCalculatorPayload payload) throws ApiException {
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Budget-Calculator">Budget Calculator Documentation</a>
     */
    public com.squareup.okhttp.Call budgetCalculatorAsync(BudgetCalculatorPayload payload, final ApiCallback<BudgetCalculatorResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     * 
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Cash-Flow-Analysis">Cash Flow Analysis Documentation</a>
     */
    public com.squareup.okhttp.Call cashFlowAnalysisCall(CashFlowAnalysisPayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = payload;

        // create path and map variables
        String localVarPath = "/proton/v1/cash_flow_analysis";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call cashFlowAnalysisValidateBeforeCall(CashFlowAnalysisPayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'payload' is set
        if (payload == null) {
            throw new ApiException("Missing the required parameter 'payload' when calling cashFlowAnalysis(Async)");
        }
        

        com.squareup.okhttp.Call call = cashFlowAnalysisCall(payload, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Cash-Flow-Analysis">Cash Flow Analysis Documentation</a>
     */
    public CashFlowAnalysisResponse cashFlowAnalysis(CashFlowAnalysisPayload payload) throws ApiException {
        ApiResponse<CashFlowAnalysisResponse> resp = cashFlowAnalysisWithHttpInfo(payload);
        return resp.getData();
    }
     ...
     * 
     * @param payload  (required)
     * @return ApiResponse&lt;CashFlowAnalysisResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * 
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Cash-Flow-Analysis">Cash Flow Analysis Documentation</a>
     */
    public ApiResponse<CashFlowAnalysisResponse> cashFlowAnalysisWithHttpInfo(CashFlowAnalysisPayload payload) throws ApiException {
        com.squareup.okhttp.Call call = cashFlowAnalysisValidateBeforeCall(payload, null, null);
        Type localVarReturnType = new TypeToken<CashFlowAnalysisResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Cash-Flow-Analysis">Cash Flow Analysis Documentation</a>
     */
    public com.squareup.okhttp.Call cashFlowAnalysisAsync(CashFlowAnalysisPayload payload, final ApiCallback<CashFlowAnalysisResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = cashFlowAnalysisValidateBeforeCall(payload, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CashFlowAnalysisResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     */
    public com.squareup.okhttp.Call financialPictureCall(FinancialPicturePayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = payload;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call financialPictureValidateBeforeCall(FinancialPicturePayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Financial-Picture">Financial Picture Documentation</a>
     */
    public FinancialPictureResponse financialPicture(FinancialPicturePayload payload) throws ApiException {
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Financial-Picture">Financial Picture Documentation</a>
     */
    public ApiResponse<FinancialPictureResponse> financialPictureWithHttpInfo(FinancialPicturePayload payload) throws ApiException {
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/proton/v1/#Financial-Picture">Financial Picture Documentation</a>
     */
    public com.squareup.okhttp.Call financialPictureAsync(FinancialPicturePayload payload, final ApiCallback<FinancialPictureResponse> callback) throws ApiException {
