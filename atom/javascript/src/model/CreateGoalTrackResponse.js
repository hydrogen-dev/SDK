...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GoalTrackPayload', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GoalTrackPayload'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.CreateGoalTrackResponse = factory(root.atom_api.ApiClient, root.atom_api.GoalTrackPayload, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, GoalTrackPayload, SecondaryId) {
  'use strict';
  ...
  /**
   * The CreateGoalTrackResponse model module.
   * @module model/CreateGoalTrackResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateGoalTrackResponse</code>.
   * @alias module:model/CreateGoalTrackResponse
   * @class
   * @implements module:model/GoalTrackPayload
   * @param goalId {String} The ID of a goal to which the goal track record pertains
   */
  var exports = function(goalId) {
    var _this = this;

    GoalTrackPayload.call(_this, goalId);


  };

  /**
   * Constructs a <code>CreateGoalTrackResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateGoalTrackResponse} obj Optional instance to populate.
   * @return {module:model/CreateGoalTrackResponse} The populated <code>CreateGoalTrackResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      GoalTrackPayload.constructFromObject(data, obj);
  ...
  // Implement GoalTrackPayload interface:
  /**
