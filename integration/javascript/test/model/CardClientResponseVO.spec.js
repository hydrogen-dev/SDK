...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CardClientResponseVO', function() {
      beforeEach(function() {
        instance = new HydrogenIntegrationApi.CardClientResponseVO();
      });

      it('should create an instance of CardClientResponseVO', function() {
        // TODO: update the code to test CardClientResponseVO
        expect(instance).to.be.a(HydrogenIntegrationApi.CardClientResponseVO);
      });
