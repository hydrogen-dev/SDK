...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageApplication();
  });
  ...
  describe('PageApplication', function() {
    it('should create an instance of PageApplication', function() {
      // uncomment below and update the code to test PageApplication
      //var instane = new HydrogenNucleusApi.PageApplication();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageApplication);
    });
