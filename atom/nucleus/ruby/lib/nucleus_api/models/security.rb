...
module NucleusApi
  class Security
    ...
    def hash
      [asset_class, category, create_date, currency_code, cusip, exchange, id, industry, is_active, isin, metadata, name, proxy_id, secondary_id, sector, security_class, security_composition, security_country, ticker, total_expense_ratio, type, update_date].hash
    end
