...
module AtomApi
  ...
  class Overflow
    ...
    # overflowSettingId
    attr_accessor :overflow_setting_id

    # totalOverflowAmount
    attr_accessor :total_overflow_amount

    # updateBalances
    attr_accessor :update_balances
    ...
    def hash
      [account_id, client_id, create_date, funding_requests, funding_start_date, id, overflow_setting_id, total_overflow_amount, update_balances, update_date].hash
    end
