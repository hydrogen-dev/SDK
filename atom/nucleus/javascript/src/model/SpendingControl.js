...
(function(root, factory) {
   ...
   */
  var exports = function(controlScope, controlType, currencyCode) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('client_group')) {
        obj['client_group'] = ApiClient.convertToType(data['client_group'], 'String');
      }
  ...
  /**
   * client_group
   * @member {String} client_group
   */
  exports.prototype['client_group'] = undefined;
  /**
   * client_id
