...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Sale', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Sale'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageSale = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Sale, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, Sale, Sort) {
  'use strict';
  ...
  /**
   * The PageSale model module.
   * @module model/PageSale
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageSale</code>.
   * Page Object
   * @alias module:model/PageSale
   * @class
   */
  ...
  /**
   * Constructs a <code>PageSale</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageSale} obj Optional instance to populate.
   * @return {module:model/PageSale} The populated <code>PageSale</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Sale]);
      }
  ...
  /**
   * @member {Array.<module:model/Sale>} content
   */
