...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchBankLinkRequestCO :  IEquatable<AchBankLinkRequestCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchBankLinkRequestCO" /> class.
        /// </summary>
        /// <param name="isReserve">isReserve.</param>
        /// <param name="nucleusBankLinkId">nucleusBankLinkId.</param>
        /// <param name="vendorRequest">vendorRequest.</param>
        public AchBankLinkRequestCO(bool? isReserve = default(bool?), Guid? nucleusBankLinkId = default(Guid?), Object vendorRequest = default(Object))
        {
        ...
        /// <summary>
        /// Gets or Sets IsReserve
        /// </summary>
        [DataMember(Name="is_reserve", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AchBankLinkRequestCO {\n");
            sb.Append("  IsReserve: ").Append(IsReserve).Append("\n");
        ...
        {
            return this.Equals(input as AchBankLinkRequestCO);
        }

        /// <summary>
        /// Returns true if AchBankLinkRequestCO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchBankLinkRequestCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchBankLinkRequestCO input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.IsReserve == input.IsReserve ||
                    (this.IsReserve != null &&
                    this.IsReserve.Equals(input.IsReserve))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsReserve != null)
                    hashCode = hashCode * 59 + this.IsReserve.GetHashCode();
