...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.CashFlowAnalysisResponseSpendingDetailsByMerchant();
  });
  ...
  describe('CashFlowAnalysisResponseSpendingDetailsByMerchant', function() {
    it('should create an instance of CashFlowAnalysisResponseSpendingDetailsByMerchant', function() {
      // uncomment below and update the code to test CashFlowAnalysisResponseSpendingDetailsByMerchant
      //var instance = new atom_api.CashFlowAnalysisResponseSpendingDetailsByMerchant();
      //expect(instance).to.be.a(atom_api.CashFlowAnalysisResponseSpendingDetailsByMerchant);
    });
