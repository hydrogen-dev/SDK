...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PagePortfolioAssetSizeLog();
  });
  ...
  describe('PagePortfolioAssetSizeLog', function() {
    it('should create an instance of PagePortfolioAssetSizeLog', function() {
      // uncomment below and update the code to test PagePortfolioAssetSizeLog
      //var instane = new HydrogenNucleusApi.PagePortfolioAssetSizeLog();
      //expect(instance).to.be.a(HydrogenNucleusApi.PagePortfolioAssetSizeLog);
    });
