...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MoleculeApiDocumentation.TokenParams = factory(root.MoleculeApiDocumentation.ApiClient, root.MoleculeApiDocumentation.TokenParamsOfferingSettings);
  }
}(this, function(ApiClient, TokenParamsOfferingSettings) {
  'use strict';

  /**
   * The TokenParams model module.
   * @module model/TokenParams
   * @version 1.3.0
   */

  /**
   * Constructs a new <code>TokenParams</code>.
  ...
  /**
   * Constructs a <code>TokenParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TokenParams} obj Optional instance to populate.
   * @return {module:model/TokenParams} The populated <code>TokenParams</code> instance.
   */
