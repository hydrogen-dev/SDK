...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.AccountRebalanceOrderPayload = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The AccountRebalanceOrderPayload model module.
   * @module model/AccountRebalanceOrderPayload
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AccountRebalanceOrderPayload</code>.
   * @alias module:model/AccountRebalanceOrderPayload
   * @class
  ...
  /**
   * Constructs a <code>AccountRebalanceOrderPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountRebalanceOrderPayload} obj Optional instance to populate.
   * @return {module:model/AccountRebalanceOrderPayload} The populated <code>AccountRebalanceOrderPayload</code> instance.
   */
