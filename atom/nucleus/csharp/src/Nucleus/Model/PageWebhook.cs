...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageWebhook :  IEquatable<PageWebhook>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageWebhook" /> class.
        /// </summary>
        ...
        public PageWebhook(List<Webhook> content = default(List<Webhook>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        {
            return this.Equals(input as PageWebhook);
        }

        /// <summary>
        /// Returns true if PageWebhook instances are equal
        /// </summary>
        /// <param name="input">Instance of PageWebhook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageWebhook input)
        {
            if (input == null)
                return false;
