...
module ProtonApi
  class GoalAccumulationAllocationRequest
    ...
    def hash
      [allocations, client_id, adjust_for_compounding, compounding_rate, horizon_frequency, conf_tgt, risk_score, market_data_source, trading_days_per_year, withdrawal_tax, thresh_type, recommend_type, goal_id, deposit_config, opt_config, goal_config, n, recommendation_config, use_proxy_data, thresh, curr_inv, remove_outliers, allocation_priority, allocation_method, horizon].hash
    end
