...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.BusinessAddress();
  });
  ...
  describe('BusinessAddress', function() {
    it('should create an instance of BusinessAddress', function() {
      ...
      //var instane = new HydrogenIntegrationApi.BusinessAddress();
      //expect(instance).to.be.a(HydrogenIntegrationApi.BusinessAddress);
    });
