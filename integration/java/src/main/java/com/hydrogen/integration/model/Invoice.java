...
public class Invoice {
  ...
  **/
   ...
   * @return customerId
  **/
  @ApiModelProperty(example = "14566616-6846-4090-beae-5b1568b82370", required = true, value = "customer_id")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, createDate, currencyCode, customerId, department, description, documentId, dueDate, id, invoiceDate, invoiceName, invoiceNumber, isActive, lineItems, metadata, paymentInstructions, paymentTerms, secondaryId, status, totalAmount, totalDiscount, totalDue, totalSubtotal, totalTax, updateDate);
  }
