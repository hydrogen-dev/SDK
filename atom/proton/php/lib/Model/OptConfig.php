 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OptConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OptConfig';
    ...
    public function setMinAssets($min_assets)
    {
        ...
        if (($min_assets < 1)) {
            throw new \InvalidArgumentException('invalid value for $min_assets when calling OptConfig., must be bigger than or equal to 1.');
        }
