...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageNotificationSetting();
  });
  ...
  describe('PageNotificationSetting', function() {
    it('should create an instance of PageNotificationSetting', function() {
      // uncomment below and update the code to test PageNotificationSetting
      //var instane = new HydrogenNucleusApi.PageNotificationSetting();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageNotificationSetting);
    });
