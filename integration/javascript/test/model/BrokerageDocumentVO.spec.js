...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.BrokerageDocumentVO();
  });
  ...
  describe('BrokerageDocumentVO', function() {
    it('should create an instance of BrokerageDocumentVO', function() {
      // uncomment below and update the code to test BrokerageDocumentVO
      //var instane = new HydrogenIntegrationApi.BrokerageDocumentVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.BrokerageDocumentVO);
    });
