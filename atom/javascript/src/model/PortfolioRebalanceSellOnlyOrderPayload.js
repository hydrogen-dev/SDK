...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.PortfolioRebalanceSellOnlyOrderPayload = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The PortfolioRebalanceSellOnlyOrderPayload model module.
   * @module model/PortfolioRebalanceSellOnlyOrderPayload
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PortfolioRebalanceSellOnlyOrderPayload</code>.
   * @alias module:model/PortfolioRebalanceSellOnlyOrderPayload
   * @class
  ...
  /**
   * Constructs a <code>PortfolioRebalanceSellOnlyOrderPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioRebalanceSellOnlyOrderPayload} obj Optional instance to populate.
   * @return {module:model/PortfolioRebalanceSellOnlyOrderPayload} The populated <code>PortfolioRebalanceSellOnlyOrderPayload</code> instance.
   */
