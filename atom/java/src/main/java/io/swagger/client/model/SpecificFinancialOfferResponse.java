...
public class SpecificFinancialOfferResponse {
  @SerializedName("id")
  ...
  public SpecificFinancialOfferResponse id(UUID id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @ApiModelProperty(value = "ID of the financial offer")
  public UUID getId() {
    return id;
  }
  ...
  public SpecificFinancialOfferResponse createDate(String createDate) {
   ...
   * @return createDate
  **/
  @ApiModelProperty(value = "Datetime the financial offer was created")
  ...
  public SpecificFinancialOfferResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public SpecificFinancialOfferResponse institutionName(String institutionName) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse offerLink(String offerLink) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse category(CategoryEnum category) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse subcategory(String subcategory) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse description(String description) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse image(String image) {
    this.image = image;
    return this;
  }
  ...
  **/
  ...
  public SpecificFinancialOfferResponse currencyCode(String currencyCode) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse financialRate(Double financialRate) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse financialRateType(String financialRateType) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse financialRateTerm(Double financialRateTerm) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse financialRateTermUnit(FinancialRateTermUnitEnum financialRateTermUnit) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse feeAmount(Double feeAmount) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse feeType(String feeType) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse offerTerm(Double offerTerm) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse offerTermUnit(OfferTermUnitEnum offerTermUnit) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse minimumContribution(Double minimumContribution) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse minimumContributionTerm(Double minimumContributionTerm) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse minimumContributionTermUnit(MinimumContributionTermUnitEnum minimumContributionTermUnit) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse prerequisite(String prerequisite) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse prerequisiteType(String prerequisiteType) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse affiliateRate(Double affiliateRate) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse clientReview(String clientReview) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse rating(String rating) {
    this.rating = rating;
    return this;
  }
  ...
  **/
  ...
  public SpecificFinancialOfferResponse documentId(String documentId) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse campaignId(UUID campaignId) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse metadata(Object metadata) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse secondaryId(String secondaryId) {
  ...
  **/
  ...
  public SpecificFinancialOfferResponse updateDate(String updateDate) {
   ...
   * @return updateDate
  **/
  @ApiModelProperty(value = "Datetime the financial offer was last updated")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SpecificFinancialOfferResponse specificFinancialOfferResponse = (SpecificFinancialOfferResponse) o;
    return Objects.equals(this.id, specificFinancialOfferResponse.id) &&
        Objects.equals(this.createDate, specificFinancialOfferResponse.createDate) &&
        Objects.equals(this.name, specificFinancialOfferResponse.name) &&
        Objects.equals(this.institutionName, specificFinancialOfferResponse.institutionName) &&
        Objects.equals(this.offerLink, specificFinancialOfferResponse.offerLink) &&
        Objects.equals(this.category, specificFinancialOfferResponse.category) &&
        Objects.equals(this.subcategory, specificFinancialOfferResponse.subcategory) &&
        Objects.equals(this.description, specificFinancialOfferResponse.description) &&
        Objects.equals(this.image, specificFinancialOfferResponse.image) &&
        Objects.equals(this.currencyCode, specificFinancialOfferResponse.currencyCode) &&
        Objects.equals(this.financialRate, specificFinancialOfferResponse.financialRate) &&
        Objects.equals(this.financialRateType, specificFinancialOfferResponse.financialRateType) &&
        Objects.equals(this.financialRateTerm, specificFinancialOfferResponse.financialRateTerm) &&
        Objects.equals(this.financialRateTermUnit, specificFinancialOfferResponse.financialRateTermUnit) &&
        Objects.equals(this.feeAmount, specificFinancialOfferResponse.feeAmount) &&
        Objects.equals(this.feeType, specificFinancialOfferResponse.feeType) &&
        Objects.equals(this.offerTerm, specificFinancialOfferResponse.offerTerm) &&
        Objects.equals(this.offerTermUnit, specificFinancialOfferResponse.offerTermUnit) &&
        Objects.equals(this.minimumContribution, specificFinancialOfferResponse.minimumContribution) &&
        Objects.equals(this.minimumContributionTerm, specificFinancialOfferResponse.minimumContributionTerm) &&
        Objects.equals(this.minimumContributionTermUnit, specificFinancialOfferResponse.minimumContributionTermUnit) &&
        Objects.equals(this.prerequisite, specificFinancialOfferResponse.prerequisite) &&
        Objects.equals(this.prerequisiteType, specificFinancialOfferResponse.prerequisiteType) &&
        Objects.equals(this.affiliateRate, specificFinancialOfferResponse.affiliateRate) &&
        Objects.equals(this.clientReview, specificFinancialOfferResponse.clientReview) &&
        Objects.equals(this.rating, specificFinancialOfferResponse.rating) &&
        Objects.equals(this.documentId, specificFinancialOfferResponse.documentId) &&
        Objects.equals(this.campaignId, specificFinancialOfferResponse.campaignId) &&
        Objects.equals(this.metadata, specificFinancialOfferResponse.metadata) &&
        Objects.equals(this.secondaryId, specificFinancialOfferResponse.secondaryId) &&
        Objects.equals(this.updateDate, specificFinancialOfferResponse.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createDate, name, institutionName, offerLink, category, subcategory, description, image, currencyCode, financialRate, financialRateType, financialRateTerm, financialRateTermUnit, feeAmount, feeType, offerTerm, offerTermUnit, minimumContribution, minimumContributionTerm, minimumContributionTermUnit, prerequisite, prerequisiteType, affiliateRate, clientReview, rating, documentId, campaignId, metadata, secondaryId, updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class SpecificFinancialOfferResponse {\n");
