...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.CreateAccountStatusResponse = factory(root.atom_api.ApiClient, root.atom_api.SecondaryId);
  }
  ...
  /**
   * The CreateAccountStatusResponse model module.
   * @module model/CreateAccountStatusResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateAccountStatusResponse</code>.
   * @alias module:model/CreateAccountStatusResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateAccountStatusResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateAccountStatusResponse} obj Optional instance to populate.
   * @return {module:model/CreateAccountStatusResponse} The populated <code>CreateAccountStatusResponse</code> instance.
   */
