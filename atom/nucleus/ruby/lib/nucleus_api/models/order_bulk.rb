...
module NucleusApi
  class OrderBulk
    ...
    def list_invalid_properties
      ...
      if @order_bulk_id.nil?
        invalid_properties.push('invalid value for "order_bulk_id", order_bulk_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @order_bulk_id.nil?
    ...
    def hash
      [account_id, create_date, date, id, metadata, model_id, order_bulk_id, order_id, portfolio_id, secondary_id, update_date].hash
    end
