...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenProtonApi.AnnuityCalculatorAnnuityAmountRequest = factory(root.HydrogenProtonApi.ApiClient, root.HydrogenProtonApi.AnnuityDepositSchedule);
  }
}(this, function(ApiClient, AnnuityDepositSchedule) {
  'use strict';

  /**
   * The AnnuityCalculatorAnnuityAmountRequest model module.
   * @module model/AnnuityCalculatorAnnuityAmountRequest
   * @version 1.8.0
   */

  /**
   * Constructs a new <code>AnnuityCalculatorAnnuityAmountRequest</code>.
   * @alias module:model/AnnuityCalculatorAnnuityAmountRequest
   * @class
   * @param portfolioReturn {Number} 
   * @param decumulationHorizon {Number} 
   * @param accumulationHorizon {Number} 
   */
  var exports = function(portfolioReturn, decumulationHorizon, accumulationHorizon) {
  ...
  /**
   * Constructs a <code>AnnuityCalculatorAnnuityAmountRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AnnuityCalculatorAnnuityAmountRequest} obj Optional instance to populate.
   * @return {module:model/AnnuityCalculatorAnnuityAmountRequest} The populated <code>AnnuityCalculatorAnnuityAmountRequest</code> instance.
   */
  ...
  /**
   * @member {module:model/AnnuityCalculatorAnnuityAmountRequest.AnnuityFrequencyIntervalEnum} annuityFrequencyInterval
   * @default 'year'
   */
   ...
   * @default 1.0
   */
  exports.prototype.annuityAmount = 1.0;
