...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageNotification();
  });
  ...
  describe('PageNotification', function() {
    it('should create an instance of PageNotification', function() {
      // uncomment below and update the code to test PageNotification
      //var instane = new HydrogenNucleusApi.PageNotification();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageNotification);
    });
