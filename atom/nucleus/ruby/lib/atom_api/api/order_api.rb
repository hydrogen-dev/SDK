...
module AtomApi
  class OrderApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Order]
    def get_order_all_using_get(order_info_request, opts = {})
      data, _status_code, _headers = get_order_all_using_get_with_http_info(order_info_request, opts)
      data
    end
    ...
    def get_order_all_using_get_with_http_info(order_info_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && order_info_request.nil?
        fail ArgumentError, "Missing the required parameter 'order_info_request' when calling OrderApi.get_order_all_using_get"
      end
      # resource path
    ...
    # @return [PageOrder]
    def get_order_all_using_get1(opts = {})
      data, _status_code, _headers = get_order_all_using_get1_with_http_info(opts)
      data
    end
    ...
    def get_order_all_using_get1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrderApi.get_order_all_using_get1 ...'
      end
      # resource path
      local_var_path = '/order'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrderApi#get_order_all_using_get1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
