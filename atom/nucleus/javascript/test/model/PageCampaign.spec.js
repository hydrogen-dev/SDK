...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageCampaign();
  });
  ...
  describe('PageCampaign', function() {
    it('should create an instance of PageCampaign', function() {
      // uncomment below and update the code to test PageCampaign
      //var instane = new HydrogenNucleusApi.PageCampaign();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageCampaign);
    });
