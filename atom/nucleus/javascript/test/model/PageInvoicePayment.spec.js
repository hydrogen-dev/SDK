...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageInvoicePayment();
  });
  ...
  describe('PageInvoicePayment', function() {
    it('should create an instance of PageInvoicePayment', function() {
      // uncomment below and update the code to test PageInvoicePayment
      //var instane = new HydrogenNucleusApi.PageInvoicePayment();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageInvoicePayment);
    });
