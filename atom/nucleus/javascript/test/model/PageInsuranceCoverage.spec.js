...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageInsuranceCoverage();
  });
  ...
  describe('PageInsuranceCoverage', function() {
    it('should create an instance of PageInsuranceCoverage', function() {
      ...
      //var instane = new HydrogenAtomApi.PageInsuranceCoverage();
      //expect(instance).to.be.a(HydrogenAtomApi.PageInsuranceCoverage);
    });
