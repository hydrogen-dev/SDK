...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PropertyValueResponseVO :  IEquatable<PropertyValueResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyValueResponseVO" /> class.
        /// </summary>
        ...
        public PropertyValueResponseVO(string integrationType = default(string), Guid? nucleusBusinessId = default(Guid?), Guid? nucleusClientId = default(Guid?), string product = default(string), string vendorName = default(string), ZillowPropertyVendorResponseVO vendorResponse = default(ZillowPropertyVendorResponseVO))
        {
        ...
        public ZillowPropertyVendorResponseVO VendorResponse { get; set; }
        ...
        {
            return this.Equals(input as PropertyValueResponseVO);
        }

        /// <summary>
        /// Returns true if PropertyValueResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyValueResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyValueResponseVO input)
        {
            if (input == null)
                return false;
