...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrokerageDepositCO :  IEquatable<BrokerageDepositCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerageDepositCO" /> class.
        /// </summary>
        /// <param name="nucleusFundingId">nucleusFundingId.</param>
        public BrokerageDepositCO(Guid? nucleusFundingId = default(Guid?))
        {
        ...
        {
            return this.Equals(input as BrokerageDepositCO);
        }

        /// <summary>
        /// Returns true if BrokerageDepositCO instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerageDepositCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerageDepositCO input)
        {
            if (input == null)
                return false;
