...
# Unit tests for ProtonApi::AccumulationGoalDepositConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccumulationGoalDepositConfig' do
  before do
    # run before each test
    @instance = ProtonApi::AccumulationGoalDepositConfig.new
  end
  ...
  describe 'test an instance of AccumulationGoalDepositConfig' do
    it 'should create an instance of AccumulationGoalDepositConfig' do
      expect(@instance).to be_instance_of(ProtonApi::AccumulationGoalDepositConfig)
    end
  end
