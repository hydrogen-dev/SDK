...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.BaasBusinessVO();
  });
  ...
  describe('BaasBusinessVO', function() {
    it('should create an instance of BaasBusinessVO', function() {
      // uncomment below and update the code to test BaasBusinessVO
      //var instane = new HydrogenIntegrationApi.BaasBusinessVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.BaasBusinessVO);
    });
