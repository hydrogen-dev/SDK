...
# Unit tests for ProtonApi::AnnuityCalculatorDepositAmountRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnnuityCalculatorDepositAmountRequest' do
  before do
    # run before each test
    @instance = ProtonApi::AnnuityCalculatorDepositAmountRequest.new
  end
  ...
  describe 'test an instance of AnnuityCalculatorDepositAmountRequest' do
    it 'should create an instance of AnnuityCalculatorDepositAmountRequest' do
      expect(@instance).to be_instance_of(ProtonApi::AnnuityCalculatorDepositAmountRequest)
    end
  end
