...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.SpendingAnalysisResponseOutlierTransactions();
  });
  ...
  describe('SpendingAnalysisResponseOutlierTransactions', function() {
    it('should create an instance of SpendingAnalysisResponseOutlierTransactions', function() {
      // uncomment below and update the code to test SpendingAnalysisResponseOutlierTransactions
      //var instance = new atom_api.SpendingAnalysisResponseOutlierTransactions();
      //expect(instance).to.be.a(atom_api.SpendingAnalysisResponseOutlierTransactions);
    });
