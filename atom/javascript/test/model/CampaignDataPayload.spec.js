...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.CampaignDataPayload();
  });
  ...
  describe('CampaignDataPayload', function() {
    it('should create an instance of CampaignDataPayload', function() {
      // uncomment below and update the code to test CampaignDataPayload
      //var instance = new atom_api.CampaignDataPayload();
      //expect(instance).to.be.a(atom_api.CampaignDataPayload);
    });
