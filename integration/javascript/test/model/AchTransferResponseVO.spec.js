...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.AchTransferResponseVO();
  });
  ...
  describe('AchTransferResponseVO', function() {
    it('should create an instance of AchTransferResponseVO', function() {
      // uncomment below and update the code to test AchTransferResponseVO
      //var instane = new HydrogenIntegrationApi.AchTransferResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.AchTransferResponseVO);
    });

    it('should have the property cardLoadResponse (base name: "card_load_response")', function() {
      // uncomment below and update the code to test the property cardLoadResponse
      //var instane = new HydrogenIntegrationApi.AchTransferResponseVO();
