...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.AllocationComposition();
  });
  ...
  describe('AllocationComposition', function() {
    it('should create an instance of AllocationComposition', function() {
      ...
      //var instane = new HydrogenAtomApi.AllocationComposition();
      //expect(instance).to.be.a(HydrogenAtomApi.AllocationComposition);
    });
