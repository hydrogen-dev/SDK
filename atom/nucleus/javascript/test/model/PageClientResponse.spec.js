...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageClientResponse();
  });
  ...
  describe('PageClientResponse', function() {
    it('should create an instance of PageClientResponse', function() {
      // uncomment below and update the code to test PageClientResponse
      //var instane = new HydrogenNucleusApi.PageClientResponse();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageClientResponse);
    });
