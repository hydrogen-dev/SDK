...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageBenchmark :  IEquatable<PageBenchmark>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageBenchmark" /> class.
        /// </summary>
        ...
        public PageBenchmark(List<Benchmark> content = default(List<Benchmark>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Benchmark> Content { get; set; }
        ...
        {
            return this.Equals(input as PageBenchmark);
        }

        /// <summary>
        /// Returns true if PageBenchmark instances are equal
        /// </summary>
        /// <param name="input">Instance of PageBenchmark to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageBenchmark input)
        {
            if (input == null)
                return false;
