...
module AtomApi
  class AnnuityCalculatorDepositAmount
    ...
    def list_invalid_properties
      ...
      if @annuity_amount <= 0
        invalid_properties.push('invalid value for "annuity_amount", must be greater than 0.')
      end
    ...
    def valid?
      ...
      annuity_frequency_interval_validator = EnumAttributeValidator.new('String', ['year', 'quarter', 'month', 'week'])
    ...
    def annuity_amount=(annuity_amount)
      ...
      if annuity_amount <= 0
        fail ArgumentError, 'invalid value for "annuity_amount", must be greater than 0.'
      end
    ...
    def hash
      [portfolio_return, initial_balance, accumulation_horizon, decumulation_horizon, annuity_amount, annuity_frequency_interval, inflation_rate, tax_rate, deposit_schedule].hash
    end
