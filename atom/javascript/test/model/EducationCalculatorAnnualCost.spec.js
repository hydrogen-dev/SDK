...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.EducationCalculatorAnnualCost();
  });
  ...
  describe('EducationCalculatorAnnualCost', function() {
    it('should create an instance of EducationCalculatorAnnualCost', function() {
      // uncomment below and update the code to test EducationCalculatorAnnualCost
      //var instance = new atom_api.EducationCalculatorAnnualCost();
      //expect(instance).to.be.a(atom_api.EducationCalculatorAnnualCost);
    });
