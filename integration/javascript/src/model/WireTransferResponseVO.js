...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.WireTransferResponseVO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
  ...
  /**
   * The WireTransferResponseVO model module.
   * @module model/WireTransferResponseVO
   * @version 1.3.0
   */

  /**
   * Constructs a new <code>WireTransferResponseVO</code>.
   * @alias module:model/WireTransferResponseVO
   * @class
   */
  ...
  /**
   * Constructs a <code>WireTransferResponseVO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WireTransferResponseVO} obj Optional instance to populate.
   * @return {module:model/WireTransferResponseVO} The populated <code>WireTransferResponseVO</code> instance.
   */
