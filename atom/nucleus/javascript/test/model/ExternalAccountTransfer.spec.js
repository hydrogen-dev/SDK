...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.ExternalAccountTransfer();
  });
  ...
  describe('ExternalAccountTransfer', function() {
    it('should create an instance of ExternalAccountTransfer', function() {
      ...
      //var instane = new HydrogenAtomApi.ExternalAccountTransfer();
      //expect(instance).to.be.a(HydrogenAtomApi.ExternalAccountTransfer);
    });
