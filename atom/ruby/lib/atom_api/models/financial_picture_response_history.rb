...
module AtomApi
  ...
  class FinancialPictureResponseHistory
    ...
    def self.swagger_types
      {
        ...
        :'net_worth' => :'Float',
        :'by_category' => :'Array<FinancialPictureResponseHistoryByCategory>'
      }
    end
    ...
    def hash
      [date, total_assets, total_liabilities, net_worth, by_category].hash
    end
