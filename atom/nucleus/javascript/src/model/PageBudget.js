...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Budget', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Budget'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageBudget = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Budget, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, Budget, Sort) {
  'use strict';
  ...
  /**
   * The PageBudget model module.
   * @module model/PageBudget
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageBudget</code>.
   * Page Object
   * @alias module:model/PageBudget
   * @class
   */
  ...
  /**
   * Constructs a <code>PageBudget</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageBudget} obj Optional instance to populate.
   * @return {module:model/PageBudget} The populated <code>PageBudget</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Budget]);
      }
  ...
  /**
   * @member {Array.<module:model/Budget>} content
   */
