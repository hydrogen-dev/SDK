...
public class Funding {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, bankLinkId, cardId, createDate, currencyCode, description, endDate, frequency, frequencyUnit, fundingStatus, fundingType, id, isActive, isDeposit, lastRequestDate, metadata, nextRequestDate, portfolioId, secondaryId, startDate, supportTicketId, transferId, updateDate);
  }
