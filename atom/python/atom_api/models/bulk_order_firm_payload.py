...
class BulkOrderFirmPayload(object):
    ...
    def __init__(self, _date=None, buy_transaction_code_id=None, sell_transaction_code_id=None):  # noqa: E501
        """BulkOrderFirmPayload - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def _date(self):
        """Gets the _date of this BulkOrderFirmPayload.  # noqa: E501

        Date for all the orders that should be aggregated together in the bulk order record  # noqa: E501

        :return: The _date of this BulkOrderFirmPayload.  # noqa: E501
        :rtype: date
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this BulkOrderFirmPayload.

        Date for all the orders that should be aggregated together in the bulk order record  # noqa: E501

        :param _date: The _date of this BulkOrderFirmPayload.  # noqa: E501
        :type: date
        """
        if _date is None:
    ...
    def buy_transaction_code_id(self):
        """Gets the buy_transaction_code_id of this BulkOrderFirmPayload.  # noqa: E501

        The ID of the transaction code that will ultimately be used to denote the buy transactions  # noqa: E501

        :return: The buy_transaction_code_id of this BulkOrderFirmPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def buy_transaction_code_id(self, buy_transaction_code_id):
        """Sets the buy_transaction_code_id of this BulkOrderFirmPayload.

        The ID of the transaction code that will ultimately be used to denote the buy transactions  # noqa: E501

        :param buy_transaction_code_id: The buy_transaction_code_id of this BulkOrderFirmPayload.  # noqa: E501
        :type: str
        """
    ...
    def sell_transaction_code_id(self):
        """Gets the sell_transaction_code_id of this BulkOrderFirmPayload.  # noqa: E501

        The ID of the transaction code that will ultimately be used to denote the sell transactions  # noqa: E501

        :return: The sell_transaction_code_id of this BulkOrderFirmPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def sell_transaction_code_id(self, sell_transaction_code_id):
        """Sets the sell_transaction_code_id of this BulkOrderFirmPayload.

        The ID of the transaction code that will ultimately be used to denote the sell transactions  # noqa: E501

        :param sell_transaction_code_id: The sell_transaction_code_id of this BulkOrderFirmPayload.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkOrderFirmPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkOrderFirmPayload):
            return False
