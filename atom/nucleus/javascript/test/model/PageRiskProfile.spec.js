...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageRiskProfile();
  });
  ...
  describe('PageRiskProfile', function() {
    it('should create an instance of PageRiskProfile', function() {
      // uncomment below and update the code to test PageRiskProfile
      //var instane = new HydrogenNucleusApi.PageRiskProfile();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageRiskProfile);
    });
