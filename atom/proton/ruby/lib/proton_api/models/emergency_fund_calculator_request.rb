...
module ProtonApi
  class EmergencyFundCalculatorRequest
    ...
    def hash
      [telecom_payments, savings_horizon, insurance_payments, client_id, aggregation_account_ids, interest_rate, other_expenses, emergency_fund_duration, debt_payments, housing_cost, food_costs, utility_payments, account_ids, transportation_costs, lookback_periods, current_emergency_fund_balance, frequency_unit].hash
    end
