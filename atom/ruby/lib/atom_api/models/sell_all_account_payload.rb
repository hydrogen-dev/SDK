...
module AtomApi
  class SellAllAccountPayload
    ...
    def hash
      [sell_transaction_code_id, buy_transaction_code_id, buy_threshold, cash_portfolio_id, commit_orders, non_fractional, port_threshold, restrictions_on, sell_threshold].hash
    end
