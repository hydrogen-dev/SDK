...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenProtonApi.AnnuityCalculatorAccumulationHorizonRequest = factory(root.HydrogenProtonApi.ApiClient, root.HydrogenProtonApi.AnnuityDepositSchedule);
  }
}(this, function(ApiClient, AnnuityDepositSchedule) {
  'use strict';

  /**
   * The AnnuityCalculatorAccumulationHorizonRequest model module.
   * @module model/AnnuityCalculatorAccumulationHorizonRequest
   * @version 1.8.0
   */

  /**
   * Constructs a new <code>AnnuityCalculatorAccumulationHorizonRequest</code>.
   * @alias module:model/AnnuityCalculatorAccumulationHorizonRequest
   * @class
   * @param annuityAmount {Number} 
   * @param decumulationHorizon {Number} 
   * @param portfolioReturn {Number} 
   */
  var exports = function(annuityAmount, decumulationHorizon, portfolioReturn) {
  ...
  /**
   * Constructs a <code>AnnuityCalculatorAccumulationHorizonRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AnnuityCalculatorAccumulationHorizonRequest} obj Optional instance to populate.
   * @return {module:model/AnnuityCalculatorAccumulationHorizonRequest} The populated <code>AnnuityCalculatorAccumulationHorizonRequest</code> instance.
   */
  ...
  /**
   * @member {module:model/AnnuityCalculatorAccumulationHorizonRequest.AnnuityFrequencyIntervalEnum} annuityFrequencyInterval
   * @default 'year'
   */
