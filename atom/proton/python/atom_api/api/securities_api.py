...
class SecuritiesApi(object):
    ...
    def get_security_exclusion_all_using_get(self, security_exclusion_id, **kwargs):  # noqa: E501
        """List all security exclusions  # noqa: E501

        Get details for all security exclusions defined for your firm.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_exclusion_all_using_get(security_exclusion_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_security_exclusion_all_using_get_with_http_info(security_exclusion_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_exclusion_all_using_get_with_http_info(security_exclusion_id, **kwargs)  # noqa: E501
            return data

    def get_security_exclusion_all_using_get_with_http_info(self, security_exclusion_id, **kwargs):  # noqa: E501
        """List all security exclusions  # noqa: E501

        Get details for all security exclusions defined for your firm.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_security_exclusion_all_using_get_with_http_info(security_exclusion_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['security_exclusion_id', 'ascending', 'filter', 'order_by', 'page', 'size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('security_exclusion_id' not in params or
                params['security_exclusion_id'] is None):
            raise ValueError("Missing the required parameter `security_exclusion_id` when calling `get_security_exclusion_all_using_get`")  # noqa: E501
    ...
    def get_security_exclusion_using_get(self, security_exclusion_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str security_exclusion_id: security exclusion id (required)
        :return: SecurityExclusion
                 If the method is called asynchronously,
                 returns the request thread.
        """
