...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PagePortfolioComment();
  });
  ...
  describe('PagePortfolioComment', function() {
    it('should create an instance of PagePortfolioComment', function() {
      ...
      //var instane = new HydrogenAtomApi.PagePortfolioComment();
      //expect(instance).to.be.a(HydrogenAtomApi.PagePortfolioComment);
    });
