...
module IntegrationApi
  class BrokeragePerformanceVO
    attr_accessor :holdings_performance
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'holdings_performance')
        self.holdings_performance = attributes[:'holdings_performance']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          holdings_performance == o.holdings_performance &&
          message == o.message &&
    ...
    def hash
      [holdings_performance, message, nucleus_portfolio_id, status, vendor_name, vendor_response].hash
    end
