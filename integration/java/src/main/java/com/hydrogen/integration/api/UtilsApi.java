...
public class UtilsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAuditLogAllUsingGetCall(Boolean ascending, LocalDate endDate, String event, String integrationType, Boolean isRequest, UUID nucleusAggregationAccountId, UUID nucleusClientId, String orderBy, Integer page, String requestType, Integer size, LocalDate startDate, String vendorName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAuditLogAllUsingGetValidateBeforeCall(Boolean ascending, LocalDate endDate, String event, String integrationType, Boolean isRequest, UUID nucleusAggregationAccountId, UUID nucleusClientId, String orderBy, Integer page, String requestType, Integer size, LocalDate startDate, String vendorName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Pageobject getAuditLogAllUsingGet(Boolean ascending, LocalDate endDate, String event, String integrationType, Boolean isRequest, UUID nucleusAggregationAccountId, UUID nucleusClientId, String orderBy, Integer page, String requestType, Integer size, LocalDate startDate, String vendorName) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Pageobject> getAuditLogAllUsingGetWithHttpInfo(Boolean ascending, LocalDate endDate, String event, String integrationType, Boolean isRequest, UUID nucleusAggregationAccountId, UUID nucleusClientId, String orderBy, Integer page, String requestType, Integer size, LocalDate startDate, String vendorName) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAuditLogAllUsingGetAsync(Boolean ascending, LocalDate endDate, String event, String integrationType, Boolean isRequest, UUID nucleusAggregationAccountId, UUID nucleusClientId, String orderBy, Integer page, String requestType, Integer size, LocalDate startDate, String vendorName, final ApiCallback<Pageobject> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call getWidgetLinkUsingGetCall(UUID nucleusId, Boolean isBusiness, Boolean isMobileWebview, String memberId, BigDecimal messageVersion, String mode, UUID nucleusAggregationAccountId, UUID nucleusBankLinkId, String vendorName, Boolean waitForFullAggregation, String webviewUrlScheme, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("nucleus_bank_link_id", nucleusBankLinkId));
        if (vendorName != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("vendor_name", vendorName));
    ...
    private com.squareup.okhttp.Call getWidgetLinkUsingGetValidateBeforeCall(UUID nucleusId, Boolean isBusiness, Boolean isMobileWebview, String memberId, BigDecimal messageVersion, String mode, UUID nucleusAggregationAccountId, UUID nucleusBankLinkId, String vendorName, Boolean waitForFullAggregation, String webviewUrlScheme, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWidgetLinkUsingGetCall(nucleusId, isBusiness, isMobileWebview, memberId, messageVersion, mode, nucleusAggregationAccountId, nucleusBankLinkId, vendorName, waitForFullAggregation, webviewUrlScheme, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public WidgetUrlVO getWidgetLinkUsingGet(UUID nucleusId, Boolean isBusiness, Boolean isMobileWebview, String memberId, BigDecimal messageVersion, String mode, UUID nucleusAggregationAccountId, UUID nucleusBankLinkId, String vendorName, Boolean waitForFullAggregation, String webviewUrlScheme) throws ApiException {
        ApiResponse<WidgetUrlVO> resp = getWidgetLinkUsingGetWithHttpInfo(nucleusId, isBusiness, isMobileWebview, memberId, messageVersion, mode, nucleusAggregationAccountId, nucleusBankLinkId, vendorName, waitForFullAggregation, webviewUrlScheme);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<WidgetUrlVO> getWidgetLinkUsingGetWithHttpInfo(UUID nucleusId, Boolean isBusiness, Boolean isMobileWebview, String memberId, BigDecimal messageVersion, String mode, UUID nucleusAggregationAccountId, UUID nucleusBankLinkId, String vendorName, Boolean waitForFullAggregation, String webviewUrlScheme) throws ApiException {
        com.squareup.okhttp.Call call = getWidgetLinkUsingGetValidateBeforeCall(nucleusId, isBusiness, isMobileWebview, memberId, messageVersion, mode, nucleusAggregationAccountId, nucleusBankLinkId, vendorName, waitForFullAggregation, webviewUrlScheme, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getWidgetLinkUsingGetAsync(UUID nucleusId, Boolean isBusiness, Boolean isMobileWebview, String memberId, BigDecimal messageVersion, String mode, UUID nucleusAggregationAccountId, UUID nucleusBankLinkId, String vendorName, Boolean waitForFullAggregation, String webviewUrlScheme, final ApiCallback<WidgetUrlVO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWidgetLinkUsingGetValidateBeforeCall(nucleusId, isBusiness, isMobileWebview, memberId, messageVersion, mode, nucleusAggregationAccountId, nucleusBankLinkId, vendorName, waitForFullAggregation, webviewUrlScheme, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<WidgetUrlVO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
