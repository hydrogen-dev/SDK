...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.BrokerageUpdateClientVO();
  });
  ...
  describe('BrokerageUpdateClientVO', function() {
    it('should create an instance of BrokerageUpdateClientVO', function() {
      // uncomment below and update the code to test BrokerageUpdateClientVO
      //var instane = new HydrogenIntegrationApi.BrokerageUpdateClientVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.BrokerageUpdateClientVO);
    });
