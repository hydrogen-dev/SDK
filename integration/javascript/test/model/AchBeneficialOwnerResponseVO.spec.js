...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.AchBeneficialOwnerResponseVO();
  });
  ...
  describe('AchBeneficialOwnerResponseVO', function() {
    it('should create an instance of AchBeneficialOwnerResponseVO', function() {
      // uncomment below and update the code to test AchBeneficialOwnerResponseVO
      //var instane = new HydrogenIntegrationApi.AchBeneficialOwnerResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.AchBeneficialOwnerResponseVO);
    });
