...
public class AccountApiTest {
    ...
    public void getPortfolioHoldingAggAllUsingGetTest() throws ApiException {
        ...
        Integer size = null;
        LocalDate startDate = null;
        List<PortfolioHoldingAgg> response = api.getPortfolioHoldingAggAllUsingGet(accountId, ascending, currencyConversion, endDate, filter, getLatest, orderBy, page, size, startDate);
