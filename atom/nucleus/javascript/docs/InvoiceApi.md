...
var apiInstance = new HydrogenAtomApi.InvoiceApi();

var invoicePayment = new HydrogenAtomApi.InvoicePayment(); // InvoicePayment | invoicePayment
...
var invoice = new HydrogenAtomApi.Invoice(); // Invoice | invoice
...
var invoicePayment = new HydrogenAtomApi.InvoicePayment(); // InvoicePayment | invoice_payment
