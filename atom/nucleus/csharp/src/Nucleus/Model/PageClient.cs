...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageClient :  IEquatable<PageClient>, IValidatableObject
    {
        /// <summary>
        ...
        public PageClient(List<ModelClient> content = default(List<ModelClient>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<ModelClient> Content { get; set; }
        ...
        {
            return this.Equals(input as PageClient);
        }

        /// <summary>
        /// Returns true if PageClient instances are equal
        /// </summary>
        /// <param name="input">Instance of PageClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageClient input)
        {
            if (input == null)
                return false;
