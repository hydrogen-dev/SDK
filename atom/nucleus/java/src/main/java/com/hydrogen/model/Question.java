...
public class Question {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(answers, category, description, document, id, image, isAccount, metadata, orderIndex, questionType, questionnaire, questionnaireId, subcategory, title, tooltip, weight);
  }
