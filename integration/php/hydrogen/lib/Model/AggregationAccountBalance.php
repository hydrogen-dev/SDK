...
class AggregationAccountBalance implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['balance_time_stamp'] === null) {
            $invalidProperties[] = "'balance_time_stamp' can't be null";
        }
     ...
     *
     * @param string $available_balance availableBalance
     *
     * @return $this
     */
     ...
     *
     * @param string $available_credit availableCredit
     *
     * @return $this
     */
