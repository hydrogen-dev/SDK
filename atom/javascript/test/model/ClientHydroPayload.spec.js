...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.ClientHydroPayload();
  });
  ...
  describe('ClientHydroPayload', function() {
    it('should create an instance of ClientHydroPayload', function() {
      // uncomment below and update the code to test ClientHydroPayload
      //var instance = new atom_api.ClientHydroPayload();
      //expect(instance).to.be.a(atom_api.ClientHydroPayload);
    });
