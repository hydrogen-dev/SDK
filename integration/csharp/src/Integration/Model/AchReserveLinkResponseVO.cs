...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchReserveLinkResponseVO :  IEquatable<AchReserveLinkResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchReserveLinkResponseVO" /> class.
        /// </summary>
        ...
        public AchReserveLinkResponseVO(List<string> fundingSourceId = default(List<string>), string message = default(string), Guid? nucleusBusinessId = default(Guid?), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        /// <summary>
        /// Gets or Sets FundingSourceId
        /// </summary>
        [DataMember(Name="funding_source_id", EmitDefaultValue=false)]
        public List<string> FundingSourceId { get; set; }
        ...
        {
            return this.Equals(input as AchReserveLinkResponseVO);
        }

        /// <summary>
        /// Returns true if AchReserveLinkResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchReserveLinkResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchReserveLinkResponseVO input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.FundingSourceId == input.FundingSourceId ||
                    this.FundingSourceId != null &&
                    this.FundingSourceId.SequenceEqual(input.FundingSourceId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FundingSourceId != null)
                    hashCode = hashCode * 59 + this.FundingSourceId.GetHashCode();
