...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class MortgageCalculatorHomePriceRequest :  IEquatable<MortgageCalculatorHomePriceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MortgageCalculatorHomePriceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MortgageCalculatorHomePriceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MortgageCalculatorHomePriceRequest" /> class.
        /// </summary>
        ...
        public MortgageCalculatorHomePriceRequest(float? periodicPayment = default(float?), float? downPayment = default(float?), float? interestRate = 0.04F, int? mortgageTerm = 360)
        {
            // to ensure "periodicPayment" is required (not null)
            if (periodicPayment == null)
            {
                throw new InvalidDataException("periodicPayment is a required property for MortgageCalculatorHomePriceRequest and cannot be null");
            }
            else
            {
            ...
            if (downPayment == null)
            {
                throw new InvalidDataException("downPayment is a required property for MortgageCalculatorHomePriceRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as MortgageCalculatorHomePriceRequest);
        }

        /// <summary>
        /// Returns true if MortgageCalculatorHomePriceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MortgageCalculatorHomePriceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MortgageCalculatorHomePriceRequest input)
        {
            if (input == null)
                return false;
