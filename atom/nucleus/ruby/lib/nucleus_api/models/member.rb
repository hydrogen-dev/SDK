...
module NucleusApi
  class Member
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'client_relationships')
        if (value = attributes[:'client_relationships']).is_a?(Array)
          self.client_relationships = value
        end
      end

      if attributes.has_key?(:'household')
        self.household = attributes[:'household']
      end
    ...
    def hash
      [client_id, client_relationships, household, is_primary].hash
    end
