...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageSecurityPrice();
  });
  ...
  describe('PageSecurityPrice', function() {
    it('should create an instance of PageSecurityPrice', function() {
      ...
      //var instane = new HydrogenAtomApi.PageSecurityPrice();
      //expect(instance).to.be.a(HydrogenAtomApi.PageSecurityPrice);
    });
