...
class KycVendorRequestDataVO(object):
    ...
    def __init__(self, address=None, business_addresses=None, country_of_residence=None, date_of_birth=None, dba_name=None, email=None, first_name=None, gender=None, identification_number=None, identification_number_type=None, incorporation_date=None, incorporation_state=None, is_public=None, last_name=None, legal_name=None, legal_structure=None, metadata=None, middle_name=None, nucleus_document_id=None, owners=None, phone_number=None, ticker=None, website=None, _configuration=None):  # noqa: E501
