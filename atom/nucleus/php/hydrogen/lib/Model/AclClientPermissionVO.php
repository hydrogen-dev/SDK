...
/**
 * AclClientPermissionVO Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\nucleus
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AclClientPermissionVO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AclClientPermissionVO';
    ...
    public function setPermissionType($permission_type)
    {
        ...
        if (!is_null($permission_type)
            && !in_array(strtoupper($permission_type), $allowedValues, true)) {
