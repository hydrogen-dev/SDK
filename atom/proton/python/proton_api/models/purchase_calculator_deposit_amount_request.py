...
class PurchaseCalculatorDepositAmountRequest(object):
    ...
    def __init__(self, deposit_schedule=None, portfolio_return=None, inflation_rate=0.0, investment_tax=0.0, purchase_horizon=None, purchase_amount=None, aggregation_account_ids=None, account_ids=None, current_savings=0.0, horizon_frequency_interval='year'):  # noqa: E501
