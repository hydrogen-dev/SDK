...
# Unit tests for NucleusApi::PageMXMerchantRes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PageMXMerchantRes' do
  before do
    # run before each test
    @instance = NucleusApi::PageMXMerchantRes.new
  end
  ...
  describe 'test an instance of PageMXMerchantRes' do
    it 'should create an instance of PageMXMerchantRes' do
      expect(@instance).to be_instance_of(NucleusApi::PageMXMerchantRes)
    end
  end
