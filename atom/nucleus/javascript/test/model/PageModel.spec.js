...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageModel();
  });
  ...
  describe('PageModel', function() {
    it('should create an instance of PageModel', function() {
      // uncomment below and update the code to test PageModel
      //var instane = new HydrogenNucleusApi.PageModel();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageModel);
    });
