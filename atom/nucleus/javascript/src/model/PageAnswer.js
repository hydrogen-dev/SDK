...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Answer', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Answer'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageAnswer = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Answer, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, Answer, Sort) {
  'use strict';
  ...
  /**
   * The PageAnswer model module.
   * @module model/PageAnswer
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageAnswer</code>.
   * Page Object
   * @alias module:model/PageAnswer
   * @class
   */
  ...
  /**
   * Constructs a <code>PageAnswer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageAnswer} obj Optional instance to populate.
   * @return {module:model/PageAnswer} The populated <code>PageAnswer</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Answer]);
      }
  ...
  /**
   * @member {Array.<module:model/Answer>} content
   */
