...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageTransactionCode();
  });
  ...
  describe('PageTransactionCode', function() {
    it('should create an instance of PageTransactionCode', function() {
      ...
      //var instane = new HydrogenAtomApi.PageTransactionCode();
      //expect(instance).to.be.a(HydrogenAtomApi.PageTransactionCode);
    });
