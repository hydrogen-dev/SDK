...
(function(root, factory) {
  ...
  describe('CardApi', function() {
    ...
    describe('updateCardPinUsingPut', function() {
      it('should call updateCardPinUsingPut successfully', function(done) {
        //uncomment below and update the code to test updateCardPinUsingPut
        //instance.updateCardPinUsingPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
