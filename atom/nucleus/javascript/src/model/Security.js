...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Brokers', 'model/SecuritiesComposition', 'model/SecuritiesCountry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Brokers'), require('./SecuritiesComposition'), require('./SecuritiesCountry'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.Security = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Brokers, root.HydrogenNucleusApi.SecuritiesComposition, root.HydrogenNucleusApi.SecuritiesCountry);
  }
}(this, function(ApiClient, Brokers, SecuritiesComposition, SecuritiesCountry) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('brokers')) {
        obj['brokers'] = ApiClient.convertToType(data['brokers'], [Brokers]);
      }
  ...
  /**
   * brokers
   * @member {Array.<module:model/Brokers>} brokers
   */
