...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.ClientAddress();
  });
  ...
  describe('ClientAddress', function() {
    it('should create an instance of ClientAddress', function() {
      ...
      //var instane = new HydrogenIntegrationApi.ClientAddress();
      //expect(instance).to.be.a(HydrogenIntegrationApi.ClientAddress);
    });
