...
# Unit tests for MoleculeApi::WalletClients
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WalletClients' do
  before do
    # run before each test
    @instance = MoleculeApi::WalletClients.new
  end
  ...
  describe 'test an instance of WalletClients' do
    it 'should create an instance of WalletClients' do
      expect(@instance).to be_instance_of(MoleculeApi::WalletClients)
    end
  end
