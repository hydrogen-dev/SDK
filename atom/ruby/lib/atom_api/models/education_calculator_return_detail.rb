...
module AtomApi
  class EducationCalculatorReturnDetail
    ...
    def list_invalid_properties
      ...
      if @period_withdrawal > 0
        invalid_properties.push('invalid value for "period_withdrawal", must be smaller than or equal to 0.')
      end
      ...
      if @period_taxes > 0
        invalid_properties.push('invalid value for "period_taxes", must be smaller than or equal to 0.')
      end
      ...
      if @cumulative_withdrawals > 0
        invalid_properties.push('invalid value for "cumulative_withdrawals", must be smaller than or equal to 0.')
      end
      ...
      if @cumulative_taxes > 0
        invalid_properties.push('invalid value for "cumulative_taxes", must be smaller than or equal to 0.')
      end
    ...
    def period_withdrawal=(period_withdrawal)
      ...
      if period_withdrawal > 0
        fail ArgumentError, 'invalid value for "period_withdrawal", must be smaller than or equal to 0.'
      end
    ...
    def period_taxes=(period_taxes)
      ...
      if period_taxes > 0
        fail ArgumentError, 'invalid value for "period_taxes", must be smaller than or equal to 0.'
      end
    ...
    def cumulative_withdrawals=(cumulative_withdrawals)
      ...
      if cumulative_withdrawals > 0
        fail ArgumentError, 'invalid value for "cumulative_withdrawals", must be smaller than or equal to 0.'
      end
    ...
    def cumulative_taxes=(cumulative_taxes)
      ...
      if cumulative_taxes > 0
        fail ArgumentError, 'invalid value for "cumulative_taxes", must be smaller than or equal to 0.'
      end
