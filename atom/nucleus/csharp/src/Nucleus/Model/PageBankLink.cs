...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageBankLink :  IEquatable<PageBankLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageBankLink" /> class.
        /// </summary>
        ...
        public PageBankLink(List<BankLink> content = default(List<BankLink>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<BankLink> Content { get; set; }
        ...
        {
            return this.Equals(input as PageBankLink);
        }

        /// <summary>
        /// Returns true if PageBankLink instances are equal
        /// </summary>
        /// <param name="input">Instance of PageBankLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageBankLink input)
        {
            if (input == null)
                return false;
