...
class IAVApi
{
     ...
     * @return void
     */
    public function deleteBankLinkUsingDelete2($nucleus_bank_link_id, $delete_type = 'delink', $nucleus_data = null)
    {
        $this->deleteBankLinkUsingDelete2WithHttpInfo($nucleus_bank_link_id, $delete_type, $nucleus_data);
    }
     ...
     */
    public function deleteBankLinkUsingDelete2WithHttpInfo($nucleus_bank_link_id, $delete_type = 'delink', $nucleus_data = null)
    {
        $returnType = '';
        $request = $this->deleteBankLinkUsingDelete2Request($nucleus_bank_link_id, $delete_type, $nucleus_data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteBankLinkUsingDelete2Async($nucleus_bank_link_id, $delete_type = 'delink', $nucleus_data = null)
    {
        return $this->deleteBankLinkUsingDelete2AsyncWithHttpInfo($nucleus_bank_link_id, $delete_type, $nucleus_data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteBankLinkUsingDelete2AsyncWithHttpInfo($nucleus_bank_link_id, $delete_type = 'delink', $nucleus_data = null)
    {
        $returnType = '';
        $request = $this->deleteBankLinkUsingDelete2Request($nucleus_bank_link_id, $delete_type, $nucleus_data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteBankLinkUsingDelete2Request($nucleus_bank_link_id, $delete_type = 'delink', $nucleus_data = null)
    {
