...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.ChildrenEducationConfig();
  });
  ...
  describe('ChildrenEducationConfig', function() {
    it('should create an instance of ChildrenEducationConfig', function() {
      // uncomment below and update the code to test ChildrenEducationConfig
      //var instance = new atom_api.ChildrenEducationConfig();
      //expect(instance).to.be.a(atom_api.ChildrenEducationConfig);
    });
    ...
    it('should have the property educationConfig (base name: "education_config")', function() {
      // uncomment below and update the code to test the property educationConfig
      //var instance = new atom_api.ChildrenEducationConfig();
      //expect(instance).to.be();
    });
