...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class DiversificationScoreRequest :  IEquatable<DiversificationScoreRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DiversificationScoreRequest" /> class.
        /// </summary>
        ...
        public DiversificationScoreRequest(Guid? allocationId = default(Guid?), DateTime? endDate = default(DateTime?), MarketDataSourceEnum? marketDataSource = MarketDataSourceEnum.Nucleus, Guid? modelId = default(Guid?), Guid? accountId = default(Guid?), DateTime? startDate = default(DateTime?), bool? useProxyData = false, List<float?> portfolioWeights = default(List<float?>), List<string> portfolioTickers = default(List<string>), bool? createLog = false, Guid? aggregationAccountId = default(Guid?), Guid? portfolioId = default(Guid?))
        {
        ...
        {
            return this.Equals(input as DiversificationScoreRequest);
        }

        /// <summary>
        /// Returns true if DiversificationScoreRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DiversificationScoreRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DiversificationScoreRequest input)
        {
            if (input == null)
                return false;
