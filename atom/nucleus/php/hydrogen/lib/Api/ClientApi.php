...
class ClientApi
{
     ...
     */
    public function getClientHoldingUsingGet($client_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        list($response) = $this->getClientHoldingUsingGetWithHttpInfo($client_id, $currency_conversion, $end_date, $get_latest, $start_date);
        return $response;
    }
     ...
     */
    public function getClientHoldingUsingGetWithHttpInfo($client_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PortfolioHoldingAgg[]';
        $request = $this->getClientHoldingUsingGetRequest($client_id, $currency_conversion, $end_date, $get_latest, $start_date);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClientHoldingUsingGetAsync($client_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        return $this->getClientHoldingUsingGetAsyncWithHttpInfo($client_id, $currency_conversion, $end_date, $get_latest, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClientHoldingUsingGetAsyncWithHttpInfo($client_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PortfolioHoldingAgg[]';
        $request = $this->getClientHoldingUsingGetRequest($client_id, $currency_conversion, $end_date, $get_latest, $start_date);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getClientHoldingUsingGetRequest($client_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getClientTransactionAllUsingGet($client_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        list($response) = $this->getClientTransactionAllUsingGetWithHttpInfo($client_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date);
        return $response;
    }
     ...
     */
    public function getClientTransactionAllUsingGetWithHttpInfo($client_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PagePortfolioTransaction_';
        $request = $this->getClientTransactionAllUsingGetRequest($client_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClientTransactionAllUsingGetAsync($client_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        return $this->getClientTransactionAllUsingGetAsyncWithHttpInfo($client_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClientTransactionAllUsingGetAsyncWithHttpInfo($client_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PagePortfolioTransaction_';
        $request = $this->getClientTransactionAllUsingGetRequest($client_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getClientTransactionAllUsingGetRequest($client_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
