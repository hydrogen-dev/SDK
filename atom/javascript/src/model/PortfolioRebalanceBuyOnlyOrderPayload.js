...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.PortfolioRebalanceBuyOnlyOrderPayload = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The PortfolioRebalanceBuyOnlyOrderPayload model module.
   * @module model/PortfolioRebalanceBuyOnlyOrderPayload
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PortfolioRebalanceBuyOnlyOrderPayload</code>.
   * @alias module:model/PortfolioRebalanceBuyOnlyOrderPayload
   * @class
  ...
  /**
   * Constructs a <code>PortfolioRebalanceBuyOnlyOrderPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioRebalanceBuyOnlyOrderPayload} obj Optional instance to populate.
   * @return {module:model/PortfolioRebalanceBuyOnlyOrderPayload} The populated <code>PortfolioRebalanceBuyOnlyOrderPayload</code> instance.
   */
