...
// APIClient manages communication with the Hydrogen Integration API API v1.3.1
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.WireApi = (*WireApiService)(&c.common)
