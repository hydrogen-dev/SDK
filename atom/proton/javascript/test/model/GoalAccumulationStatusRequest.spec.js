...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GoalAccumulationStatusRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.GoalAccumulationStatusRequest();
      });

      it('should create an instance of GoalAccumulationStatusRequest', function() {
        // TODO: update the code to test GoalAccumulationStatusRequest
        expect(instance).to.be.a(HydrogenProtonApi.GoalAccumulationStatusRequest);
      });
