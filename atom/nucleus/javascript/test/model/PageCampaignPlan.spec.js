...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageCampaignPlan();
  });
  ...
  describe('PageCampaignPlan', function() {
    it('should create an instance of PageCampaignPlan', function() {
      // uncomment below and update the code to test PageCampaignPlan
      //var instane = new HydrogenNucleusApi.PageCampaignPlan();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageCampaignPlan);
    });
