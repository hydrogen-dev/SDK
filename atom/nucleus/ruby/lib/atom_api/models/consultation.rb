...
module AtomApi
  ...
  class Consultation
    ...
    def hash
      [account_type_id, additional_questions, assets, assigned, calendar, category, client_id, close_time, closed_by, comments, completed, create_date, email, firmname, id, investment_allocation, investment_location, investment_objectives, is_active, metadata, name, phone, reminded, secondary_id, source, time, update_date].hash
    end
