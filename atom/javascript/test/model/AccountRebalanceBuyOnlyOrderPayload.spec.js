...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AccountRebalanceBuyOnlyOrderPayload();
  });
  ...
  describe('AccountRebalanceBuyOnlyOrderPayload', function() {
    it('should create an instance of AccountRebalanceBuyOnlyOrderPayload', function() {
      // uncomment below and update the code to test AccountRebalanceBuyOnlyOrderPayload
      //var instance = new atom_api.AccountRebalanceBuyOnlyOrderPayload();
      //expect(instance).to.be.a(atom_api.AccountRebalanceBuyOnlyOrderPayload);
    });
