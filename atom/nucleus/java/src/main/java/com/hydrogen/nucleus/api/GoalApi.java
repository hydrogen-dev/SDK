...
public class GoalApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<PortfolioHoldingAgg> getGoalHoldingAllUsingGet(UUID clientId, UUID goalId, Boolean ascending, String currencyConversion, LocalDate endDate, String filter, String orderBy, Integer page, Boolean portfolioGoal, Integer size, LocalDate startDate) throws ApiException {
        ApiResponse<List<PortfolioHoldingAgg>> resp = getGoalHoldingAllUsingGetWithHttpInfo(clientId, goalId, ascending, currencyConversion, endDate, filter, orderBy, page, portfolioGoal, size, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<PortfolioHoldingAgg>> getGoalHoldingAllUsingGetWithHttpInfo(UUID clientId, UUID goalId, Boolean ascending, String currencyConversion, LocalDate endDate, String filter, String orderBy, Integer page, Boolean portfolioGoal, Integer size, LocalDate startDate) throws ApiException {
