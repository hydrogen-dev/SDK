...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchBalanceResponseVO :  IEquatable<AchBalanceResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchBalanceResponseVO" /> class.
        /// </summary>
        ...
        public AchBalanceResponseVO(string message = default(string), List<Object> nucleusAssetSizesPosted = default(List<Object>), List<Object> nucleusAssetSizesUpdated = default(List<Object>), Guid? nucleusPortfolioId = default(Guid?), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as AchBalanceResponseVO);
        }

        /// <summary>
        /// Returns true if AchBalanceResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchBalanceResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchBalanceResponseVO input)
        {
            if (input == null)
                return false;
