...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchCardResponseVO :  IEquatable<AchCardResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchCardResponseVO" /> class.
        /// </summary>
        ...
        public AchCardResponseVO(string message = default(string), Guid? nucleusFundingId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as AchCardResponseVO);
        }

        /// <summary>
        /// Returns true if AchCardResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchCardResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchCardResponseVO input)
        {
            if (input == null)
                return false;
