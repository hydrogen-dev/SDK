...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class SamsungPayload :  IEquatable<SamsungPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SamsungPayload" /> class.
        /// </summary>
        /// <param name="issuerPayload">issuerPayload.</param>
        public SamsungPayload(string issuerPayload = default(string))
        {
        ...
        {
            return this.Equals(input as SamsungPayload);
        }

        /// <summary>
        /// Returns true if SamsungPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of SamsungPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SamsungPayload input)
        {
            if (input == null)
                return false;
