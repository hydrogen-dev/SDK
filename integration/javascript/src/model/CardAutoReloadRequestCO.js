...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('reload_amount'))
        obj.reloadAmount = ApiClient.convertToType(data['reload_amount'], 'Number');
      if (data.hasOwnProperty('threshold_amount'))
        obj.thresholdAmount = ApiClient.convertToType(data['threshold_amount'], 'Number');
    }
    return obj;
  }
  ...
  /**
   * @member {Number} reloadAmount
   */
  exports.prototype.reloadAmount = undefined;

  /**
   * @member {Number} thresholdAmount
   */
  exports.prototype.thresholdAmount = undefined;
