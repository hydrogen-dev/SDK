...
public class GetAccountResponse {
  ...
  private List<SpecificAccountResponse> content = null;

  public GetAccountResponse last(Boolean last) {
    this.last = last;
    return this;
  }
  ...
  **/
  ...
  public GetAccountResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public GetAccountResponse totalElements(Integer totalElements) {
  ...
  **/
  ...
  public GetAccountResponse sort(List<PaginationSort> sort) {
    this.sort = sort;
    return this;
  }

  public GetAccountResponse addSortItem(PaginationSort sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public GetAccountResponse first(Boolean first) {
    this.first = first;
    return this;
  }
  ...
  **/
  ...
  public GetAccountResponse numberOfElements(Integer numberOfElements) {
  ...
  **/
  ...
  public GetAccountResponse size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public GetAccountResponse number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  **/
  ...
  public GetAccountResponse content(List<SpecificAccountResponse> content) {
    this.content = content;
    return this;
  }

  public GetAccountResponse addContentItem(SpecificAccountResponse contentItem) {
    if (this.content == null) {
      this.content = new ArrayList<SpecificAccountResponse>();
    }
  ...
  **/
  ...
  public List<SpecificAccountResponse> getContent() {
    return content;
  }

  public void setContent(List<SpecificAccountResponse> content) {
    this.content = content;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.last, getAccountResponse.last) &&
        Objects.equals(this.totalPages, getAccountResponse.totalPages) &&
        Objects.equals(this.totalElements, getAccountResponse.totalElements) &&
        Objects.equals(this.sort, getAccountResponse.sort) &&
        Objects.equals(this.first, getAccountResponse.first) &&
        Objects.equals(this.numberOfElements, getAccountResponse.numberOfElements) &&
        Objects.equals(this.size, getAccountResponse.size) &&
        Objects.equals(this.number, getAccountResponse.number) &&
        Objects.equals(this.content, getAccountResponse.content);
  }
