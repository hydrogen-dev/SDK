...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class EducationCalculatorPercentCoveredRequest :  IEquatable<EducationCalculatorPercentCoveredRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EducationCalculatorPercentCoveredRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EducationCalculatorPercentCoveredRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EducationCalculatorPercentCoveredRequest" /> class.
        /// </summary>
        ...
        public EducationCalculatorPercentCoveredRequest(float? educationInflationRate = 0.05F, int? decumulationHorizon = default(int?), int? accumulationHorizon = default(int?), List<Guid?> accountIds = default(List<Guid?>), float? taxRate = 0.0F, float? generalInflationRate = 0.0F, float? totalAnnualCost = default(float?), float? portfolioReturn = default(float?), CalculatorDepositSchedule1 depositSchedule = default(CalculatorDepositSchedule1), float? initialBalance = 0.0F, List<Guid?> aggregationAccountIds = default(List<Guid?>))
        {
            // to ensure "decumulationHorizon" is required (not null)
            if (decumulationHorizon == null)
            {
                throw new InvalidDataException("decumulationHorizon is a required property for EducationCalculatorPercentCoveredRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accumulationHorizon is a required property for EducationCalculatorPercentCoveredRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("totalAnnualCost is a required property for EducationCalculatorPercentCoveredRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioReturn is a required property for EducationCalculatorPercentCoveredRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EducationCalculatorPercentCoveredRequest);
        }

        /// <summary>
        /// Returns true if EducationCalculatorPercentCoveredRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EducationCalculatorPercentCoveredRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EducationCalculatorPercentCoveredRequest input)
        {
            if (input == null)
                return false;
