...
module ProtonApi
  class RetirementCalculatorDepositAmountRequest
    ...
    def hash
      [inflation_rate, current_age, deposit_schedule, portfolio_return, retirement_income, aggregation_account_ids, retirement_expenses, percent_of_expenses_covered, retirement_tax, account_ids, retirement_age, death_age, retirement_savings].hash
    end
