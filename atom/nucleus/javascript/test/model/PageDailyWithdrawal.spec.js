...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageDailyWithdrawal();
  });
  ...
  describe('PageDailyWithdrawal', function() {
    it('should create an instance of PageDailyWithdrawal', function() {
      ...
      //var instane = new HydrogenAtomApi.PageDailyWithdrawal();
      //expect(instance).to.be.a(HydrogenAtomApi.PageDailyWithdrawal);
    });
