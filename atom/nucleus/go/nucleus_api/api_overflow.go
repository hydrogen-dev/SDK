...
/*
OverflowApiService Create a Overflow Settings request
...
func (a *OverflowApiService) CreateOverflowSettingsUsingPost(ctx context.Context, overflowSettings OverflowSettings) (OverflowSettings, *http.Response, error) {
	var (
		...
		localVarReturnValue OverflowSettings
	)
	...
	// body params
	localVarPostBody = &overflowSettings
...
/*
OverflowApiService Create a Overflow request
...
/*
OverflowApiService Delete a overflow settings
...
/*
OverflowApiService List all overflow objects
Get details for all overflow.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *OverflowApiGetOverflowAllUsingGetOpts - Optional Parameters:
...
func (a *OverflowApiService) GetOverflowAllUsingGet(ctx context.Context, localVarOptionals *OverflowApiGetOverflowAllUsingGetOpts) (PageOverflow, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PageOverflow
	)
...
/*
OverflowApiService List all overflow settings
Get details for all overflow setting.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *OverflowApiGetOverflowSettingsAllUsingGetOpts - Optional Parameters:
     * @param "Ascending" (optional.Bool) -  ascending
     * @param "Filter" (optional.String) -  filter
     * @param "OrderBy" (optional.String) -  order_by
     * @param "Page" (optional.Int32) -  page
...
func (a *OverflowApiService) GetOverflowSettingsAllUsingGet(ctx context.Context, localVarOptionals *OverflowApiGetOverflowSettingsAllUsingGetOpts) (PageOverflowSettings, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PageOverflowSettings
	)
...
/*
OverflowApiService Retrieve a Overflow Setting
...
/*
OverflowApiService Retrieve a Overflow object
...
/*
OverflowApiService Update a overflow settings
