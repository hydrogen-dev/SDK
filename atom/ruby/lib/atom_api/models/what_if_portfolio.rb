...
module AtomApi
  class WhatIfPortfolio
    ...
    def list_invalid_properties
      ...
      if @current_portfolio_tickers.nil?
        invalid_properties.push('invalid value for "current_portfolio_tickers", current_portfolio_tickers cannot be nil.')
      end

      if @current_portfolio_weights.nil?
        invalid_properties.push('invalid value for "current_portfolio_weights", current_portfolio_weights cannot be nil.')
      end
    ...
    def valid?
      return false if @current_portfolio_tickers.nil?
      return false if @current_portfolio_weights.nil?
    ...
    def hash
      [current_portfolio_tickers, current_portfolio_weights, altered_portfolio_tickers, altered_portfolio_weights, start_date, end_date, use_proxy_data].hash
    end
