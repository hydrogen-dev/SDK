...
/**
 * EscrowDepositParams Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\molecule
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EscrowDepositParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EscrowDepositParams';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payee_wallet_id'] === null) {
            $invalidProperties[] = "'payee_wallet_id' can't be null";
        }
        if ($this->container['payer_wallet_id'] === null) {
            $invalidProperties[] = "'payer_wallet_id' can't be null";
        }
