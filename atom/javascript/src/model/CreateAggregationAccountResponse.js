...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AggregationAccountPayload', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AggregationAccountPayload'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.CreateAggregationAccountResponse = factory(root.atom_api.ApiClient, root.atom_api.AggregationAccountPayload, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, AggregationAccountPayload, SecondaryId) {
  'use strict';
  ...
  /**
   * The CreateAggregationAccountResponse model module.
   * @module model/CreateAggregationAccountResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateAggregationAccountResponse</code>.
   * @alias module:model/CreateAggregationAccountResponse
   * @class
   * @implements module:model/AggregationAccountPayload
  ...
  var exports = function(clientId, accountName, institutionName) {
    ...
    AggregationAccountPayload.call(_this, clientId, accountName, institutionName);


  };

  /**
   * Constructs a <code>CreateAggregationAccountResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateAggregationAccountResponse} obj Optional instance to populate.
   * @return {module:model/CreateAggregationAccountResponse} The populated <code>CreateAggregationAccountResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      AggregationAccountPayload.constructFromObject(data, obj);
  ...
  // Implement AggregationAccountPayload interface:
  /**
