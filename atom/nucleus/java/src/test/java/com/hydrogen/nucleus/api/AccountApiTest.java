...
public class AccountApiTest {
    ...
    public void getPortfolioHoldingAggAllUsingGetTest() throws ApiException {
        ...
        Boolean getLatest = null;
        LocalDate startDate = null;
        List<PortfolioHoldingAgg> response = api.getPortfolioHoldingAggAllUsingGet(accountId, currencyConversion, endDate, getLatest, startDate);
    ...
    public void getPortfolioTransactionAggAllUsingGetTest() throws ApiException {
        ...
        Integer size = null;
        LocalDate startDate = null;
        PagePortfolioTransaction response = api.getPortfolioTransactionAggAllUsingGet(accountId, ascending, currencyConversion, endDate, orderBy, page, size, startDate);
