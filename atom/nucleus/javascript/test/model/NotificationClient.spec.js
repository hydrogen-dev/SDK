...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.NotificationClient();
  });
  ...
  describe('NotificationClient', function() {
    it('should create an instance of NotificationClient', function() {
      ...
      //var instane = new HydrogenAtomApi.NotificationClient();
      //expect(instance).to.be.a(HydrogenAtomApi.NotificationClient);
    });
