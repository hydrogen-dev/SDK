...
module AtomApi
  class AccountPermissionClientsPayload
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'acl_exist')
        self.acl_exist = attributes[:'acl_exist']
      end
    end
    ...
    def valid?
      ...
      permission_type_validator = EnumAttributeValidator.new('String', ['INQUIRY_ACCESS', 'LIMTIED_AUTHORITY', 'FULL_AUTHORITY', 'POWER_OF_ATTORNEY'])
    ...
    def permission_type=(permission_type)
      validator = EnumAttributeValidator.new('String', ['INQUIRY_ACCESS', 'LIMTIED_AUTHORITY', 'FULL_AUTHORITY', 'POWER_OF_ATTORNEY'])
    ...
    def hash
      [client_id, permission_type, acl_exist].hash
    end
