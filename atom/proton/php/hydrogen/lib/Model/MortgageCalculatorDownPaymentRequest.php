...
class MortgageCalculatorDownPaymentRequest implements ModelInterface, ArrayAccess
{
    ...
    public function setInterestRate($interest_rate)
    {
        ...
        if (!is_null($interest_rate) && ($interest_rate < -1)) {
            throw new \InvalidArgumentException('invalid value for $interest_rate when calling MortgageCalculatorDownPaymentRequest., must be bigger than or equal to -1.');
        }
