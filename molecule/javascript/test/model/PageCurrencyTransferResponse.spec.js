...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageCurrencyTransferResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageCurrencyTransferResponse();
      });

      it('should create an instance of PageCurrencyTransferResponse', function() {
        // TODO: update the code to test PageCurrencyTransferResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageCurrencyTransferResponse);
      });
