...
module NucleusApi
  class BenchmarkApi
    ...
    def delete_benchmark_using_delete_with_http_info(benchmark_id, opts = {})
      ...
      # resource path
      local_var_path = '/benchmark/{benchmark_id}'.sub('{' + 'benchmark_id' + '}', benchmark_id.to_s)
    ...
    def get_benchmark_asset_size_all_using_get_with_http_info(benchmark_id, opts = {})
      ...
      # resource path
      local_var_path = '/benchmark/{benchmark_id}/asset_size'.sub('{' + 'benchmark_id' + '}', benchmark_id.to_s)
