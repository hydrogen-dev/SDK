...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageAllocation :  IEquatable<PageAllocation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAllocation" /> class.
        /// </summary>
        ...
        public PageAllocation(List<Allocation> content = default(List<Allocation>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Allocation> Content { get; set; }
        ...
        {
            return this.Equals(input as PageAllocation);
        }

        /// <summary>
        /// Returns true if PageAllocation instances are equal
        /// </summary>
        /// <param name="input">Instance of PageAllocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageAllocation input)
        {
            if (input == null)
                return false;
