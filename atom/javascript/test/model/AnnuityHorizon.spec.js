...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AnnuityHorizon();
  });
  ...
  describe('AnnuityHorizon', function() {
    it('should create an instance of AnnuityHorizon', function() {
      // uncomment below and update the code to test AnnuityHorizon
      //var instance = new atom_api.AnnuityHorizon();
      //expect(instance).to.be.a(atom_api.AnnuityHorizon);
    });
