...
from integration_api.models.create_order_response import CreateOrderResponse  # noqa: E501
...
class TestCreateOrderResponse(unittest.TestCase):
    ...
    def testCreateOrderResponse(self):
        ...
        # model = integration_api.models.create_order_response.CreateOrderResponse()  # noqa: E501
        pass
