...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaasClientVO :  IEquatable<BaasClientVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaasClientVO" /> class.
        /// </summary>
        ...
        public BaasClientVO(string message = default(string), Guid? nucleusClientId = default(Guid?), List<Guid?> nucleusDocumentId = default(List<Guid?>), string status = default(string), string vendorName = default(string), ClientVendorRequestDataVO vendorRequestData = default(ClientVendorRequestDataVO), Object vendorResponse = default(Object))
        {
        ...
        public ClientVendorRequestDataVO VendorRequestData { get; set; }
        ...
        {
            return this.Equals(input as BaasClientVO);
        }

        /// <summary>
        /// Returns true if BaasClientVO instances are equal
        /// </summary>
        /// <param name="input">Instance of BaasClientVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaasClientVO input)
        {
            if (input == null)
                return false;
