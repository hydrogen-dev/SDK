...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAuditLog();
  });
  ...
  describe('PageAuditLog', function() {
    it('should create an instance of PageAuditLog', function() {
      // uncomment below and update the code to test PageAuditLog
      //var instane = new HydrogenNucleusApi.PageAuditLog();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAuditLog);
    });
