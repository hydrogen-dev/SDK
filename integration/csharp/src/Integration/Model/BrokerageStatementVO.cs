...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrokerageStatementVO :  IEquatable<BrokerageStatementVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerageStatementVO" /> class.
        /// </summary>
        /// <param name="nucleusAccountId">nucleusAccountId.</param>
        /// <param name="statements">statements.</param>
        /// <param name="vendorName">vendorName.</param>
        public BrokerageStatementVO(Guid? nucleusAccountId = default(Guid?), Object statements = default(Object), string vendorName = default(string))
        {
        ...
        {
            return this.Equals(input as BrokerageStatementVO);
        }

        /// <summary>
        /// Returns true if BrokerageStatementVO instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerageStatementVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerageStatementVO input)
        {
            if (input == null)
                return false;
