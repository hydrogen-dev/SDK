...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DiversificationScoreRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.DiversificationScoreRequest();
      });

      it('should create an instance of DiversificationScoreRequest', function() {
        // TODO: update the code to test DiversificationScoreRequest
        expect(instance).to.be.a(HydrogenProtonApi.DiversificationScoreRequest);
      });
