...
public class ClientApiTest {
    ...
    public void getClientHoldingUsingGetTest() throws ApiException {
        ...
        List<PortfolioHoldingAgg> response = api.getClientHoldingUsingGet(clientId, ascending, currencyConversion, endDate, filter, getLatest, orderBy, page, size, startDate);
