...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.ExchangeTokenCO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ExchangeTokenCO model module.
   * @module model/ExchangeTokenCO
   * @version 1.2.1
   */

  /**
   * Constructs a new <code>ExchangeTokenCO</code>.
   * @alias module:model/ExchangeTokenCO
   * @class
   */
  ...
  /**
   * Constructs a <code>ExchangeTokenCO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExchangeTokenCO} obj Optional instance to populate.
   * @return {module:model/ExchangeTokenCO} The populated <code>ExchangeTokenCO</code> instance.
   */
