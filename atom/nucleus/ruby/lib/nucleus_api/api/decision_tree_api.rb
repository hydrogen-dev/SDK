...
module NucleusApi
  class DecisionTreeApi
    ...
    def delete_node_relationship_using_delete(node_relationship_id, opts = {})
      data, _status_code, _headers = delete_node_relationship_using_delete_with_http_info(node_relationship_id, opts)
      data
    end
    ...
    def delete_node_using_delete(node_id, opts = {})
      data, _status_code, _headers = delete_node_using_delete_with_http_info(node_id, opts)
      data
    end
