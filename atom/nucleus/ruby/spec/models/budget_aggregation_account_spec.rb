...
# Unit tests for AtomApi::BudgetAggregationAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BudgetAggregationAccount' do
  before do
    # run before each test
    @instance = AtomApi::BudgetAggregationAccount.new
  end
  ...
  describe 'test an instance of BudgetAggregationAccount' do
    it 'should create an instance of BudgetAggregationAccount' do
      expect(@instance).to be_instance_of(AtomApi::BudgetAggregationAccount)
    end
  end
