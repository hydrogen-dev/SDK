...
module AtomApi
  class SpecificBudgetResponse
    ...
    def hash
      [id, create_date, name, client_id, currency_code, budget, frequency_unit, frequency, account_id, goal_id, start_date, end_date, metadata, secondary_id, update_date].hash
    end
