...
module NucleusApi
  class PortfolioApi
    ...
    # @return [Array<(PortfolioAggregatedVO, Fixnum, Hash)>] PortfolioAggregatedVO data, response status code and response headers
    def get_portfolio_aggregated_data_using_get_with_http_info(portfolio_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PortfolioAggregatedVO')
      if @api_client.config.debugging
    ...
    # @param portfolio_asset_size_id portfolio_asset_size_id
    # @param [Hash] opts the optional parameters
    # @return [Array<(PortfolioAssetSize, Fixnum, Hash)>] PortfolioAssetSize data, response status code and response headers
    def get_portfolio_asset_size_using_get_with_http_info(portfolio_asset_size_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PortfolioAssetSize')
      if @api_client.config.debugging
    ...
    # @option opts [Integer] :page page
    # @option opts [Integer] :size size
    # @return [Array<(PortfolioHolding, Fixnum, Hash)>] PortfolioHolding data, response status code and response headers
