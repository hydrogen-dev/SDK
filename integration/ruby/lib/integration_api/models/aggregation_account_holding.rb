...
module IntegrationApi
  ...
  class AggregationAccountHolding
    ...
    def hash
      [aggregation_account_id, amount, asset_class, cost_basis, create_date, currency_code, cusip, exchange, holding_date, holding_type, id, is_active, isin, metadata, price, secondary_id, shares, ticker, ticker_name, update_date].hash
    end
