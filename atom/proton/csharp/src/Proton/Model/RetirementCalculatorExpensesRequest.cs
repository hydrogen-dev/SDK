...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class RetirementCalculatorExpensesRequest :  IEquatable<RetirementCalculatorExpensesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetirementCalculatorExpensesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RetirementCalculatorExpensesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RetirementCalculatorExpensesRequest" /> class.
        /// </summary>
        ...
        public RetirementCalculatorExpensesRequest(float? retirementSavings = 0.0F, int? currentAge = default(int?), List<Guid?> accountIds = default(List<Guid?>), float? retirementIncome = 0.0F, float? retirementTax = 0.0F, int? deathAge = default(int?), int? retirementAge = 65, float? percentOfExpensesCovered = 1.0F, float? portfolioReturn = default(float?), CalculatorDepositSchedule1 depositSchedule = default(CalculatorDepositSchedule1), float? inflationRate = 0.0F, List<Guid?> aggregationAccountIds = default(List<Guid?>))
        {
            ...
            if (deathAge == null)
            {
                throw new InvalidDataException("deathAge is a required property for RetirementCalculatorExpensesRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioReturn is a required property for RetirementCalculatorExpensesRequest and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets PercentOfExpensesCovered
        /// </summary>
        [DataMember(Name="percent_of_expenses_covered", EmitDefaultValue=false)]
        public float? PercentOfExpensesCovered { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PercentOfExpensesCovered: ").Append(PercentOfExpensesCovered).Append("\n");
        ...
        {
            return this.Equals(input as RetirementCalculatorExpensesRequest);
        }

        /// <summary>
        /// Returns true if RetirementCalculatorExpensesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RetirementCalculatorExpensesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetirementCalculatorExpensesRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PercentOfExpensesCovered == input.PercentOfExpensesCovered ||
                    (this.PercentOfExpensesCovered != null &&
                    this.PercentOfExpensesCovered.Equals(input.PercentOfExpensesCovered))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PercentOfExpensesCovered != null)
                    hashCode = hashCode * 59 + this.PercentOfExpensesCovered.GetHashCode();
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // PercentOfExpensesCovered (float?) maximum
            if(this.PercentOfExpensesCovered > (float?)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PercentOfExpensesCovered, must be a value less than or equal to 1.", new [] { "PercentOfExpensesCovered" });
            }

            // PercentOfExpensesCovered (float?) minimum
            if(this.PercentOfExpensesCovered < (float?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PercentOfExpensesCovered, must be a value greater than or equal to 0.", new [] { "PercentOfExpensesCovered" });
            }
