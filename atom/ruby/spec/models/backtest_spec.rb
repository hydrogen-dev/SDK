...
# Unit tests for AtomApi::Backtest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Backtest' do
  before do
    # run before each test
    @instance = AtomApi::Backtest.new
  end
  ...
  describe 'test an instance of Backtest' do
    it 'should create an instance of Backtest' do
      expect(@instance).to be_instance_of(AtomApi::Backtest)
    end
  end
