...
module NucleusApi
  class SecurityPrice
    ...
    def list_invalid_properties
      ...
      if @adjusted_price.nil?
        invalid_properties.push('invalid value for "adjusted_price", adjusted_price cannot be nil.')
      end
    ...
    def valid?
      return false if @adjusted_price.nil?
    ...
    def hash
      [adjusted_price, create_date, currency_code, date, id, price, secondary_id, security_id, update_date].hash
    end
