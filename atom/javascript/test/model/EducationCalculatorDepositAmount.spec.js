...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.EducationCalculatorDepositAmount();
  });
  ...
  describe('EducationCalculatorDepositAmount', function() {
    it('should create an instance of EducationCalculatorDepositAmount', function() {
      // uncomment below and update the code to test EducationCalculatorDepositAmount
      //var instance = new atom_api.EducationCalculatorDepositAmount();
      //expect(instance).to.be.a(atom_api.EducationCalculatorDepositAmount);
    });
