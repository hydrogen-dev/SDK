...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.RetirementCalculatorPercentCovered();
  });
  ...
  describe('RetirementCalculatorPercentCovered', function() {
    it('should create an instance of RetirementCalculatorPercentCovered', function() {
      // uncomment below and update the code to test RetirementCalculatorPercentCovered
      //var instance = new atom_api.RetirementCalculatorPercentCovered();
      //expect(instance).to.be.a(atom_api.RetirementCalculatorPercentCovered);
    });
