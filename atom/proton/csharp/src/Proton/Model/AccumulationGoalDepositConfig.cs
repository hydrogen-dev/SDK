...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccumulationGoalDepositConfig :  IEquatable<AccumulationGoalDepositConfig>, IValidatableObject
    {
        /// <summary>
        ...
        public enum DepEndReferenceEnum
        {
            ...
            /// <summary>
            /// Enum Start for value: a_start
            /// </summary>
            [EnumMember(Value = "a_start")]
            Start = 1,
            
            /// <summary>
            /// Enum End for value: a_end
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccumulationGoalDepositConfig" /> class.
        /// </summary>
        /// <param name="depEndPeriod">depEndPeriod (default to 0).</param>
        /// <param name="depAmount">depAmount.</param>
        /// <param name="depEndReference">depEndReference (default to DepEndReferenceEnum.End).</param>
        ...
        /// <param name="depStartReference">depStartReference (default to DepStartReferenceEnum.Start).</param>
        public AccumulationGoalDepositConfig(int? depEndPeriod = 0, decimal? depAmount = default(decimal?), DepEndReferenceEnum? depEndReference = DepEndReferenceEnum.End, int? depStartPeriod = 0, DepFrequencyEnum? depFrequency = DepFrequencyEnum.Year, float? depInflation = 0.0F, DepStartReferenceEnum? depStartReference = DepStartReferenceEnum.Start)
        {
            ...
            {
                this.DepEndReference = DepEndReferenceEnum.End;
            }
            else
            {
            ...
            {
                this.DepStartReference = DepStartReferenceEnum.Start;
            }
            else
            {
        ...
        {
            return this.Equals(input as AccumulationGoalDepositConfig);
        }

        /// <summary>
        /// Returns true if AccumulationGoalDepositConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of AccumulationGoalDepositConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccumulationGoalDepositConfig input)
        {
            if (input == null)
                return false;
