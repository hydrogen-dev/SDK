...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageCard :  IEquatable<PageCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageCard" /> class.
        /// </summary>
        ...
        public PageCard(List<Card> content = default(List<Card>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        {
            return this.Equals(input as PageCard);
        }

        /// <summary>
        /// Returns true if PageCard instances are equal
        /// </summary>
        /// <param name="input">Instance of PageCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageCard input)
        {
            if (input == null)
                return false;
