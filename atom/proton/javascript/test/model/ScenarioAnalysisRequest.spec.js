...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScenarioAnalysisRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.ScenarioAnalysisRequest();
      });

      it('should create an instance of ScenarioAnalysisRequest', function() {
        // TODO: update the code to test ScenarioAnalysisRequest
        expect(instance).to.be.a(HydrogenProtonApi.ScenarioAnalysisRequest);
      });
