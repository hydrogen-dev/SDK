...
public class PortfolioOptimizationScoreRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(optConfig, tgtType, portfolioTickers, createLog, aggregationAccountId, allocationId, modelId, portfolioWeights, endDate, startDate, useProxyData, accountId, marketDataSource, portfolioId);
  }
