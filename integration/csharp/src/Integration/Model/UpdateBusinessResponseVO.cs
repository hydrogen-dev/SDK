...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateBusinessResponseVO :  IEquatable<UpdateBusinessResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateBusinessResponseVO" /> class.
        /// </summary>
        ...
        public UpdateBusinessResponseVO(string message = default(string), Guid? nucleusBusinessId = default(Guid?), string vendorName = default(string), BusinessVendorRequestDataVO vendorRequestData = default(BusinessVendorRequestDataVO), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as UpdateBusinessResponseVO);
        }

        /// <summary>
        /// Returns true if UpdateBusinessResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateBusinessResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateBusinessResponseVO input)
        {
            if (input == null)
                return false;
