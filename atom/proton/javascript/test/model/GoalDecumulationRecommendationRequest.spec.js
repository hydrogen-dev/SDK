...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GoalDecumulationRecommendationRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.GoalDecumulationRecommendationRequest();
      });

      it('should create an instance of GoalDecumulationRecommendationRequest', function() {
        // TODO: update the code to test GoalDecumulationRecommendationRequest
        expect(instance).to.be.a(HydrogenProtonApi.GoalDecumulationRecommendationRequest);
      });
