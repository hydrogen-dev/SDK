...
public class IavApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteBankLinkUsingDelete2Call(UUID nucleusBankLinkId, String deleteType, String nucleusData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteBankLinkUsingDelete2ValidateBeforeCall(UUID nucleusBankLinkId, String deleteType, String nucleusData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteBankLinkUsingDelete2Call(nucleusBankLinkId, deleteType, nucleusData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void deleteBankLinkUsingDelete2(UUID nucleusBankLinkId, String deleteType, String nucleusData) throws ApiException {
        deleteBankLinkUsingDelete2WithHttpInfo(nucleusBankLinkId, deleteType, nucleusData);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> deleteBankLinkUsingDelete2WithHttpInfo(UUID nucleusBankLinkId, String deleteType, String nucleusData) throws ApiException {
        com.squareup.okhttp.Call call = deleteBankLinkUsingDelete2ValidateBeforeCall(nucleusBankLinkId, deleteType, nucleusData, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteBankLinkUsingDelete2Async(UUID nucleusBankLinkId, String deleteType, String nucleusData, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteBankLinkUsingDelete2ValidateBeforeCall(nucleusBankLinkId, deleteType, nucleusData, progressListener, progressRequestListener);
