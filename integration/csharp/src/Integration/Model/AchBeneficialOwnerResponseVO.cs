...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchBeneficialOwnerResponseVO :  IEquatable<AchBeneficialOwnerResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchBeneficialOwnerResponseVO" /> class.
        /// </summary>
        ...
        public AchBeneficialOwnerResponseVO(string message = default(string), Guid? nucleusBusinessId = default(Guid?), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as AchBeneficialOwnerResponseVO);
        }

        /// <summary>
        /// Returns true if AchBeneficialOwnerResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchBeneficialOwnerResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchBeneficialOwnerResponseVO input)
        {
            if (input == null)
                return false;
