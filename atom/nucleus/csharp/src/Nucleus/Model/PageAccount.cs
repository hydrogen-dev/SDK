...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageAccount :  IEquatable<PageAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAccount" /> class.
        /// </summary>
        ...
        public PageAccount(List<Account> content = default(List<Account>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Account> Content { get; set; }
        ...
        {
            return this.Equals(input as PageAccount);
        }

        /// <summary>
        /// Returns true if PageAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of PageAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageAccount input)
        {
            if (input == null)
                return false;
