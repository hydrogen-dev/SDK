...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAnswer();
  });
  ...
  describe('PageAnswer', function() {
    it('should create an instance of PageAnswer', function() {
      // uncomment below and update the code to test PageAnswer
      //var instane = new HydrogenNucleusApi.PageAnswer();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAnswer);
    });
