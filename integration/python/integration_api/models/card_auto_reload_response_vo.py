...
class CardAutoReloadResponseVO(object):
    ...
    def __init__(self, message=None, nucleus_client_id=None, reload_amount=None, threshold_amount=None, vendor_name=None, vendor_response=None, _configuration=None):  # noqa: E501
