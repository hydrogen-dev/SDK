...
class Contact implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'address' => '\com\hydrogen\integration\Model\ContactAddress[]',
        'balances' => '\com\hydrogen\integration\Model\Balances',
        'business_id' => 'string',
        'client_id' => 'string',
        'company_name' => 'string',
    ...
    const IS_CUSTOMER_TRUE = 'true';
    const IS_CUSTOMER_FALSE = 'false';
    const IS_CUSTOMER_NULL = 'null';
    const IS_SUPPLIER_TRUE = 'true';
    const IS_SUPPLIER_FALSE = 'false';
    const IS_SUPPLIER_NULL = 'null';
     ...
     * @return string[]
     */
    public function getIsCustomerAllowableValues()
    {
        return [
            self::IS_CUSTOMER_TRUE,
            self::IS_CUSTOMER_FALSE,
            self::IS_CUSTOMER_NULL,
        ];
    }
     ...
     * @return string[]
     */
    public function getIsSupplierAllowableValues()
    {
        return [
            self::IS_SUPPLIER_TRUE,
            self::IS_SUPPLIER_FALSE,
            self::IS_SUPPLIER_NULL,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getIsCustomerAllowableValues();
        if (!is_null($this->container['is_customer']) && !in_array($this->container['is_customer'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'is_customer', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getIsSupplierAllowableValues();
        if (!is_null($this->container['is_supplier']) && !in_array($this->container['is_supplier'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'is_supplier', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Gets address
     *
     * @return \com\hydrogen\integration\Model\ContactAddress[]
     */
     ...
     * Sets address
     *
     * @param \com\hydrogen\integration\Model\ContactAddress[] $address address
     *
     * @return $this
     */
     ...
     * Gets balances
     *
     * @return \com\hydrogen\integration\Model\Balances
     */
     ...
     * Sets balances
     *
     * @param \com\hydrogen\integration\Model\Balances $balances balances
     *
     * @return $this
     */
     ...
     * Sets is_customer
     *
     * @param string $is_customer isCustomer
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getIsCustomerAllowableValues();
        if (!is_null($is_customer) && !in_array($is_customer, $allowedValues, true)) {
     ...
     * Sets is_supplier
     *
     * @param string $is_supplier isSupplier
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getIsSupplierAllowableValues();
        if (!is_null($is_supplier) && !in_array($is_supplier, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'is_supplier', must be one of '%s'",
                    implode("', '", $allowedValues)
