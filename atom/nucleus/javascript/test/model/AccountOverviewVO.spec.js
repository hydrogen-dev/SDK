...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.AccountOverviewVO();
  });
  ...
  describe('AccountOverviewVO', function() {
    it('should create an instance of AccountOverviewVO', function() {
      ...
      //var instane = new HydrogenAtomApi.AccountOverviewVO();
      //expect(instance).to.be.a(HydrogenAtomApi.AccountOverviewVO);
    });
