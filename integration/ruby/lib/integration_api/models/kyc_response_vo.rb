...
module IntegrationApi
  class KycResponseVo
    ...
    def hash
      [create_date, electron_document_id, kyc_status, kyc_type, nucleus_client_id, product, update_date, vendor_name, vendor_request_data, vendor_response].hash
    end
