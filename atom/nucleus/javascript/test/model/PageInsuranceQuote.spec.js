...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageInsuranceQuote();
  });
  ...
  describe('PageInsuranceQuote', function() {
    it('should create an instance of PageInsuranceQuote', function() {
      // uncomment below and update the code to test PageInsuranceQuote
      //var instane = new HydrogenNucleusApi.PageInsuranceQuote();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageInsuranceQuote);
    });
