...
module NucleusApi
  ...
  class OrderReconcileRequest
    attr_accessor :account_id

    attr_accessor :non_fractional

    attr_accessor :order_track_ids
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'order_track_ids')
        if (value = attributes[:'order_track_ids']).is_a?(Array)
          self.order_track_ids = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          order_track_ids == o.order_track_ids &&
    ...
    def hash
      [account_id, non_fractional, order_track_ids, portfolio_id, tenant_id].hash
    end
