...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.GoalTransactionsResponseContent();
  });
  ...
  describe('GoalTransactionsResponseContent', function() {
    it('should create an instance of GoalTransactionsResponseContent', function() {
      // uncomment below and update the code to test GoalTransactionsResponseContent
      //var instance = new atom_api.GoalTransactionsResponseContent();
      //expect(instance).to.be.a(atom_api.GoalTransactionsResponseContent);
    });
