...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageSupportTicketComment();
  });
  ...
  describe('PageSupportTicketComment', function() {
    it('should create an instance of PageSupportTicketComment', function() {
      ...
      //var instane = new HydrogenAtomApi.PageSupportTicketComment();
      //expect(instance).to.be.a(HydrogenAtomApi.PageSupportTicketComment);
    });
