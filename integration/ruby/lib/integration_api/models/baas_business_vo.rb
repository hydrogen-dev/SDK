  ...
  class BaasBusinessVO
    ...
    def self.swagger_types
      {
        ...
        :'nucleus_document_id' => :'Array<String>',
        :'status' => :'String',
        :'vendor_name' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nucleus_document_id')
        if (value = attributes[:'nucleus_document_id']).is_a?(Array)
          self.nucleus_document_id = value
        end
      end
    ...
    def hash
      [message, nucleus_business_id, nucleus_document_id, status, vendor_name, vendor_request_data, vendor_response].hash
    end
