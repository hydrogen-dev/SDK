...
module AtomApi
  class FinancialPictureResponseSnapshot
    ...
    def self.swagger_types
      {
        ...
        :'by_category' => :'Array<FinancialPictureResponseSnapshotByCategory>'
      }
    end
    ...
    def hash
      [total_assets, total_liabilities, net_worth, by_category].hash
    end
