...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AccountRebalanceSellOnlyOrderPayload();
  });
  ...
  describe('AccountRebalanceSellOnlyOrderPayload', function() {
    it('should create an instance of AccountRebalanceSellOnlyOrderPayload', function() {
      // uncomment below and update the code to test AccountRebalanceSellOnlyOrderPayload
      //var instance = new atom_api.AccountRebalanceSellOnlyOrderPayload();
      //expect(instance).to.be.a(atom_api.AccountRebalanceSellOnlyOrderPayload);
    });
