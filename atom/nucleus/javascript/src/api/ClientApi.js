...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AvailableDateDoubleVO', 'model/Client', 'model/ClientHydro', 'model/ClientStatus', 'model/PageClient', 'model/PageClientHydro', 'model/PageClientStatus', 'model/PagePortfolioTransaction', 'model/PortfolioHoldingAgg', 'model/VClientGoalViewData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AvailableDateDoubleVO'), require('../model/Client'), require('../model/ClientHydro'), require('../model/ClientStatus'), require('../model/PageClient'), require('../model/PageClientHydro'), require('../model/PageClientStatus'), require('../model/PagePortfolioTransaction'), require('../model/PortfolioHoldingAgg'), require('../model/VClientGoalViewData'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.ClientApi = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.AvailableDateDoubleVO, root.HydrogenNucleusApi.Client, root.HydrogenNucleusApi.ClientHydro, root.HydrogenNucleusApi.ClientStatus, root.HydrogenNucleusApi.PageClient, root.HydrogenNucleusApi.PageClientHydro, root.HydrogenNucleusApi.PageClientStatus, root.HydrogenNucleusApi.PagePortfolioTransaction, root.HydrogenNucleusApi.PortfolioHoldingAgg, root.HydrogenNucleusApi.VClientGoalViewData);
  }
}(this, function(ApiClient, AvailableDateDoubleVO, Client, ClientHydro, ClientStatus, PageClient, PageClientHydro, PageClientStatus, PagePortfolioTransaction, PortfolioHoldingAgg, VClientGoalViewData) {
  'use strict';
