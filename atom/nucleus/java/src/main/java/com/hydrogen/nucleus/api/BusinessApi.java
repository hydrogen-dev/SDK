...
public class BusinessApi {
    ...
    public com.squareup.okhttp.Call deleteBusinessUsingDeleteCall(UUID businessId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/business/{business_id}"
    ...
    public com.squareup.okhttp.Call getBusinessAssetSizeUsingGetCall(UUID businessId, String currencyConversion, LocalDate endDate, Boolean excludeSubledger, Boolean getLatest, String sortType, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/business/{business_id}/asset_size"
            .replaceAll("\\{" + "business_id" + "\\}", apiClient.escapeString(businessId.toString()));
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getBusinessClientTransactionAllUsingGetCall(UUID businessId, Boolean ascending, String currencyConversion, String endDate, String orderBy, Integer page, Integer size, String startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/business/{business_id}/transaction"
            .replaceAll("\\{" + "business_id" + "\\}", apiClient.escapeString(businessId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getBusinessClientTransactionAllUsingGetValidateBeforeCall(UUID businessId, Boolean ascending, String currencyConversion, String endDate, String orderBy, Integer page, Integer size, String startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBusinessClientTransactionAllUsingGetCall(businessId, ascending, currencyConversion, endDate, orderBy, page, size, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PagePortfolioTransaction getBusinessClientTransactionAllUsingGet(UUID businessId, Boolean ascending, String currencyConversion, String endDate, String orderBy, Integer page, Integer size, String startDate) throws ApiException {
        ApiResponse<PagePortfolioTransaction> resp = getBusinessClientTransactionAllUsingGetWithHttpInfo(businessId, ascending, currencyConversion, endDate, orderBy, page, size, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PagePortfolioTransaction> getBusinessClientTransactionAllUsingGetWithHttpInfo(UUID businessId, Boolean ascending, String currencyConversion, String endDate, String orderBy, Integer page, Integer size, String startDate) throws ApiException {
        com.squareup.okhttp.Call call = getBusinessClientTransactionAllUsingGetValidateBeforeCall(businessId, ascending, currencyConversion, endDate, orderBy, page, size, startDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getBusinessClientTransactionAllUsingGetAsync(UUID businessId, Boolean ascending, String currencyConversion, String endDate, String orderBy, Integer page, Integer size, String startDate, final ApiCallback<PagePortfolioTransaction> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBusinessClientTransactionAllUsingGetValidateBeforeCall(businessId, ascending, currencyConversion, endDate, orderBy, page, size, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PagePortfolioTransaction>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getBusinessHoldingUsingGetCall(UUID businessId, String currencyConversion, String endDate, Boolean getLatest, String startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/business/{business_id}/holding"
            .replaceAll("\\{" + "business_id" + "\\}", apiClient.escapeString(businessId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getBusinessHoldingUsingGetValidateBeforeCall(UUID businessId, String currencyConversion, String endDate, Boolean getLatest, String startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBusinessHoldingUsingGetCall(businessId, currencyConversion, endDate, getLatest, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<PortfolioHoldingAgg> getBusinessHoldingUsingGet(UUID businessId, String currencyConversion, String endDate, Boolean getLatest, String startDate) throws ApiException {
        ApiResponse<List<PortfolioHoldingAgg>> resp = getBusinessHoldingUsingGetWithHttpInfo(businessId, currencyConversion, endDate, getLatest, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<PortfolioHoldingAgg>> getBusinessHoldingUsingGetWithHttpInfo(UUID businessId, String currencyConversion, String endDate, Boolean getLatest, String startDate) throws ApiException {
        com.squareup.okhttp.Call call = getBusinessHoldingUsingGetValidateBeforeCall(businessId, currencyConversion, endDate, getLatest, startDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getBusinessHoldingUsingGetAsync(UUID businessId, String currencyConversion, String endDate, Boolean getLatest, String startDate, final ApiCallback<List<PortfolioHoldingAgg>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBusinessHoldingUsingGetValidateBeforeCall(businessId, currencyConversion, endDate, getLatest, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<PortfolioHoldingAgg>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
