...
module AtomApi
  class GoalAccumulationAllocation
    ...
    def hash
      [allocation_method, allocation_priority, opt_config, allocations, curr_inv, horizon, horizon_frequency, goal_config, deposit_config, recommendation_config, recommend_type, conf_tgt, n, remove_outliers, thresh_type, thresh, withdrawal_tax, trading_days_per_year, risk_score, adjust_for_compounding, compounding_rate, use_proxy_data].hash
    end
