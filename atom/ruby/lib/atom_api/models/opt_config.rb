...
module AtomApi
  class OptConfig
    ...
    def list_invalid_properties
      ...
      if !@min_assets.nil? && @min_assets <= 0
    ...
    def valid?
      return false if !@min_assets.nil? && @min_assets <= 0
      true
    end
    ...
    def hash
      [tickers, min_assets, w_asset_config, w_config, sec_types, start_date, end_date].hash
    end
