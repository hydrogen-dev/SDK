...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class RtpBankLinkResponseVO :  IEquatable<RtpBankLinkResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RtpBankLinkResponseVO" /> class.
        /// </summary>
        ...
        public RtpBankLinkResponseVO(string message = default(string), Guid? nucleusBankLinkId = default(Guid?), Guid? nucleusClientId = default(Guid?), string status = default(string), string vendorName = default(string), BankLinkVendorDataVO vendorRequestData = default(BankLinkVendorDataVO), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as RtpBankLinkResponseVO);
        }

        /// <summary>
        /// Returns true if RtpBankLinkResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of RtpBankLinkResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RtpBankLinkResponseVO input)
        {
            if (input == null)
                return false;
