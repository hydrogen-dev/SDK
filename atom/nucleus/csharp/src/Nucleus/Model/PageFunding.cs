...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageFunding :  IEquatable<PageFunding>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageFunding" /> class.
        /// </summary>
        ...
        public PageFunding(List<Funding> content = default(List<Funding>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Funding> Content { get; set; }
        ...
        {
            return this.Equals(input as PageFunding);
        }

        /// <summary>
        /// Returns true if PageFunding instances are equal
        /// </summary>
        /// <param name="input">Instance of PageFunding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageFunding input)
        {
            if (input == null)
                return false;
