...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.ScorePayload();
  });
  ...
  describe('ScorePayload', function() {
    it('should create an instance of ScorePayload', function() {
      // uncomment below and update the code to test ScorePayload
      //var instance = new atom_api.ScorePayload();
      //expect(instance).to.be.a(atom_api.ScorePayload);
    });
