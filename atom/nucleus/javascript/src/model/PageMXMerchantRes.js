...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MXMerchantRes', 'model/Pageable', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MXMerchantRes'), require('./Pageable'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageMXMerchantRes = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.MXMerchantRes, root.HydrogenNucleusApi.Pageable, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, MXMerchantRes, Pageable, Sort) {
  'use strict';
  ...
  /**
   * The PageMXMerchantRes model module.
   * @module model/PageMXMerchantRes
   * @version 1.9.1
   */

  /**
   * Constructs a new <code>PageMXMerchantRes</code>.
   * @alias module:model/PageMXMerchantRes
   * @class
   */
  ...
  /**
   * Constructs a <code>PageMXMerchantRes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageMXMerchantRes} obj Optional instance to populate.
   * @return {module:model/PageMXMerchantRes} The populated <code>PageMXMerchantRes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [MXMerchantRes]);
      }
  ...
  /**
   * @member {Array.<module:model/MXMerchantRes>} content
   */
   ...
   */
  exports.prototype['pageable'] = undefined;
  /**
   * @member {Number} size
   */
