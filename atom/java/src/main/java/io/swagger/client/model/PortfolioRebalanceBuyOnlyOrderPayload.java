...
public class PortfolioRebalanceBuyOnlyOrderPayload {
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload buyTransactionCodeId(UUID buyTransactionCodeId) {
  ...
  **/
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload sellTransactionCodeId(UUID sellTransactionCodeId) {
  ...
  **/
  @ApiModelProperty(value = "The ID of the transaction code to denote a sell transaction")
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload buyThreshold(Double buyThreshold) {
  ...
  **/
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload cashSecId(UUID cashSecId) {
  ...
  **/
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload commitOrders(Boolean commitOrders) {
  ...
  **/
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload nonFractional(Boolean nonFractional) {
  ...
  **/
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload portThreshold(Double portThreshold) {
  ...
  **/
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload restrictionsOn(Boolean restrictionsOn) {
  ...
  **/
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload sellThreshold(Double sellThreshold) {
  ...
  **/
  ...
  public PortfolioRebalanceBuyOnlyOrderPayload useStrategic(Boolean useStrategic) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PortfolioRebalanceBuyOnlyOrderPayload portfolioRebalanceBuyOnlyOrderPayload = (PortfolioRebalanceBuyOnlyOrderPayload) o;
    return Objects.equals(this.buyTransactionCodeId, portfolioRebalanceBuyOnlyOrderPayload.buyTransactionCodeId) &&
        Objects.equals(this.sellTransactionCodeId, portfolioRebalanceBuyOnlyOrderPayload.sellTransactionCodeId) &&
        Objects.equals(this.buyThreshold, portfolioRebalanceBuyOnlyOrderPayload.buyThreshold) &&
        Objects.equals(this.cashSecId, portfolioRebalanceBuyOnlyOrderPayload.cashSecId) &&
        Objects.equals(this.commitOrders, portfolioRebalanceBuyOnlyOrderPayload.commitOrders) &&
        Objects.equals(this.nonFractional, portfolioRebalanceBuyOnlyOrderPayload.nonFractional) &&
        Objects.equals(this.portThreshold, portfolioRebalanceBuyOnlyOrderPayload.portThreshold) &&
        Objects.equals(this.restrictionsOn, portfolioRebalanceBuyOnlyOrderPayload.restrictionsOn) &&
        Objects.equals(this.sellThreshold, portfolioRebalanceBuyOnlyOrderPayload.sellThreshold) &&
        Objects.equals(this.useStrategic, portfolioRebalanceBuyOnlyOrderPayload.useStrategic);
  }

  @Override
  public int hashCode() {
    return Objects.hash(buyTransactionCodeId, sellTransactionCodeId, buyThreshold, cashSecId, commitOrders, nonFractional, portThreshold, restrictionsOn, sellThreshold, useStrategic);
  }
  ...
  public String toString() {
    ...
    sb.append("class PortfolioRebalanceBuyOnlyOrderPayload {\n");
