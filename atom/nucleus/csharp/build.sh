...
${nuget_cmd} install src/Nucleus/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Nucleus.dll"
...
then
  ...
  echo "[INFO] bin/Nucleus.dll was created successfully"
fi
