...
class AuthApi(object):
    ...
    def create_using_post_password_credentials(self, client_id, client_secret, username, password, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_using_post_password_credentials_with_http_info(client_id, client_secret, username, password, **kwargs)
        else:
            (data) = self.create_using_post_password_credentials_with_http_info(client_id, client_secret, username, password, **kwargs)
            return data
    
    def create_using_post_password_credentials_with_http_info(self, client_id, client_secret, username, password, **kwargs):
