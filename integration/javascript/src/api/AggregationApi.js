...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.deleteAggregationAccountUsingDelete = function(nucleusAggregationAccountId, callback) {
      var postBody = null;
    ...
    this.getAggregationAccountAllUsingGet = function(aggregationAccountIdList, callback) {
      ...
      var collectionQueryParams = {
        'aggregation_account_id_list': {
          value: aggregationAccountIdList,
     ...
     * data is of type: {@link module:model/PropertyValueResponseVO}
     */
    this.getPropertyValue = function(nucleusAggregationAccountId, nucleusClientId, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      if (nucleusClientId === undefined || nucleusClientId === null) {
        throw new Error("Missing the required parameter 'nucleusClientId' when calling getPropertyValue");
      }
