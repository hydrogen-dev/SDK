...
module AtomApi
  class GoalAccumulationRecommendation
    ...
    def hash
      [p_ret, p_risk, curr_inv, horizon, horizon_frequency, goal_config, deposit_config, recommendation_config, recommend_type, conf_tgt, n, remove_outliers, thresh_type, thresh, withdrawal_tax, trading_days_per_year, adjust_for_compounding, compounding_rate].hash
    end
