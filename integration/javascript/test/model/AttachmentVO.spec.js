...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.AttachmentVO();
  });
  ...
  describe('AttachmentVO', function() {
    it('should create an instance of AttachmentVO', function() {
      // uncomment below and update the code to test AttachmentVO
      //var instane = new HydrogenIntegrationApi.AttachmentVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.AttachmentVO);
    });
