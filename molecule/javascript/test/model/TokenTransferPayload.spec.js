...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new molecule_api.TokenTransferPayload();
  });
  ...
  describe('TokenTransferPayload', function() {
    it('should create an instance of TokenTransferPayload', function() {
      // uncomment below and update the code to test TokenTransferPayload
      //var instance = new molecule_api.TokenTransferPayload();
      //expect(instance).to.be.a(molecule_api.TokenTransferPayload);
    });
