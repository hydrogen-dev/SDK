...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageBudget();
  });
  ...
  describe('PageBudget', function() {
    it('should create an instance of PageBudget', function() {
      // uncomment below and update the code to test PageBudget
      //var instane = new HydrogenNucleusApi.PageBudget();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageBudget);
    });
