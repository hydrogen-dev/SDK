...
require 'molecule_api/models/currency_balance_update_payload'
require 'molecule_api/models/currency_create_payload'
require 'molecule_api/models/currency_transfer_payload'
require 'molecule_api/models/currency_transfer_specific_response'
require 'molecule_api/models/currency_update_payload'
...
require 'molecule_api/models/wallet_permission_specific_response'
require 'molecule_api/models/wallet_permission_specific_response_clients'
require 'molecule_api/models/wallet_permission_update_payload'
...
require 'molecule_api/models/currency_create_response'
require 'molecule_api/models/currency_get_response'
...
require 'molecule_api/models/wallet_permission_get_response'
require 'molecule_api/models/webhook_create_response'
require 'molecule_api/models/webhook_get_response'
require 'molecule_api/models/currency_specific_response'
