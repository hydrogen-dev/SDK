...
module NucleusApi
  ...
  class MerchantCategoryCode
    ...
    def list_invalid_properties
      ...
      if @transaction_category_id.nil?
        invalid_properties.push('invalid value for "transaction_category_id", transaction_category_id cannot be nil.')
      end
    ...
    def valid?
      return false if @transaction_category_id.nil?
      true
    end
    ...
    def hash
      [category, description, mcc, subcategory, transaction_category_id].hash
    end
