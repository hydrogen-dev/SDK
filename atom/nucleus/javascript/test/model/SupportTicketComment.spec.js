...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.SupportTicketComment();
  });
  ...
  describe('SupportTicketComment', function() {
    it('should create an instance of SupportTicketComment', function() {
      ...
      //var instane = new HydrogenAtomApi.SupportTicketComment();
      //expect(instance).to.be.a(HydrogenAtomApi.SupportTicketComment);
    });
