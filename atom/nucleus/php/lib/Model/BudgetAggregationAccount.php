...
/**
 * BudgetAggregationAccount Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\nucleus
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BudgetAggregationAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BudgetAggregationAccount';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aggregation_account_id'] === null) {
            $invalidProperties[] = "'aggregation_account_id' can't be null";
        }
     ...
     *
     * @param string $aggregation_account_id node_id
     *
     * @return $this
     */
