...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('nucleus_holdings_posted'))
        obj.nucleusHoldingsPosted = ApiClient.convertToType(data['nucleus_holdings_posted'], [AggregationAccountHoldingResponseInternalObjectVO]);
  ...
  /**
   * @member {Array.<module:model/AggregationAccountHoldingResponseInternalObjectVO>} nucleusHoldingsPosted
   */
