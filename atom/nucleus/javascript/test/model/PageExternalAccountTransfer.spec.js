...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageExternalAccountTransfer();
  });
  ...
  describe('PageExternalAccountTransfer', function() {
    it('should create an instance of PageExternalAccountTransfer', function() {
      // uncomment below and update the code to test PageExternalAccountTransfer
      //var instane = new HydrogenNucleusApi.PageExternalAccountTransfer();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageExternalAccountTransfer);
    });
