...
public class CreateConsultationResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountTypeId, additionalQuestions, assets, assigned, calendar, category, comments, clientId, time, closeTime, closedBy, completed, name, email, firmname, phone, investmentAllocation, investmentLocation, investmentObjectives, isActive, reminded, source, secondaryId, id, createDate);
  }
