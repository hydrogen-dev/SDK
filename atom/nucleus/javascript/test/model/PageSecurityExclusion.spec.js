...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageSecurityExclusion();
  });
  ...
  describe('PageSecurityExclusion', function() {
    it('should create an instance of PageSecurityExclusion', function() {
      // uncomment below and update the code to test PageSecurityExclusion
      //var instane = new HydrogenNucleusApi.PageSecurityExclusion();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageSecurityExclusion);
    });
