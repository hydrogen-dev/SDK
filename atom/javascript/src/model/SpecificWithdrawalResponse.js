...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateWithdrawalResponse', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CreateWithdrawalResponse'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.SpecificWithdrawalResponse = factory(root.atom_api.ApiClient, root.atom_api.CreateWithdrawalResponse, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, CreateWithdrawalResponse, SecondaryId) {
  'use strict';
  ...
  /**
   * The SpecificWithdrawalResponse model module.
   * @module model/SpecificWithdrawalResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SpecificWithdrawalResponse</code>.
   * @alias module:model/SpecificWithdrawalResponse
   * @class
   * @implements module:model/CreateWithdrawalResponse
  ...
  var exports = function(accountId, amount, fundingId, withdrawalDate) {
    ...
    CreateWithdrawalResponse.call(_this, accountId, amount, fundingId, withdrawalDate);

  };

  /**
   * Constructs a <code>SpecificWithdrawalResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpecificWithdrawalResponse} obj Optional instance to populate.
   * @return {module:model/SpecificWithdrawalResponse} The populated <code>SpecificWithdrawalResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      CreateWithdrawalResponse.constructFromObject(data, obj);
  ...
  // Implement CreateWithdrawalResponse interface:
  /**
