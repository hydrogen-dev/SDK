...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.BrokerageAccountVO();
  });
  ...
  describe('BrokerageAccountVO', function() {
    it('should create an instance of BrokerageAccountVO', function() {
      // uncomment below and update the code to test BrokerageAccountVO
      //var instane = new HydrogenIntegrationApi.BrokerageAccountVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.BrokerageAccountVO);
    });
