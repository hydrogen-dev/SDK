...
public class GetTransferResponse {
  ...
  private List<SpecificTransferResponse> content = null;

  public GetTransferResponse last(Boolean last) {
    this.last = last;
    return this;
  }
  ...
  **/
  ...
  public GetTransferResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public GetTransferResponse totalElements(Integer totalElements) {
  ...
  **/
  ...
  public GetTransferResponse sort(List<PaginationSort> sort) {
    this.sort = sort;
    return this;
  }

  public GetTransferResponse addSortItem(PaginationSort sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public GetTransferResponse first(Boolean first) {
    this.first = first;
    return this;
  }
  ...
  **/
  ...
  public GetTransferResponse numberOfElements(Integer numberOfElements) {
  ...
  **/
  ...
  public GetTransferResponse size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public GetTransferResponse number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  **/
  ...
  public GetTransferResponse content(List<SpecificTransferResponse> content) {
    this.content = content;
    return this;
  }

  public GetTransferResponse addContentItem(SpecificTransferResponse contentItem) {
    if (this.content == null) {
      this.content = new ArrayList<SpecificTransferResponse>();
    }
  ...
  **/
  ...
  public List<SpecificTransferResponse> getContent() {
    return content;
  }

  public void setContent(List<SpecificTransferResponse> content) {
    this.content = content;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.last, getTransferResponse.last) &&
        Objects.equals(this.totalPages, getTransferResponse.totalPages) &&
        Objects.equals(this.totalElements, getTransferResponse.totalElements) &&
        Objects.equals(this.sort, getTransferResponse.sort) &&
        Objects.equals(this.first, getTransferResponse.first) &&
        Objects.equals(this.numberOfElements, getTransferResponse.numberOfElements) &&
        Objects.equals(this.size, getTransferResponse.size) &&
        Objects.equals(this.number, getTransferResponse.number) &&
        Objects.equals(this.content, getTransferResponse.content);
  }
