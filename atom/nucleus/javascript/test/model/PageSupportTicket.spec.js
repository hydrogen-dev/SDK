...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageSupportTicket();
  });
  ...
  describe('PageSupportTicket', function() {
    it('should create an instance of PageSupportTicket', function() {
      ...
      //var instane = new HydrogenAtomApi.PageSupportTicket();
      //expect(instance).to.be.a(HydrogenAtomApi.PageSupportTicket);
    });
