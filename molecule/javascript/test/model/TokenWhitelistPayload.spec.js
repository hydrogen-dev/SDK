...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new molecule_api.TokenWhitelistPayload();
  });
  ...
  describe('TokenWhitelistPayload', function() {
    it('should create an instance of TokenWhitelistPayload', function() {
      // uncomment below and update the code to test TokenWhitelistPayload
      //var instance = new molecule_api.TokenWhitelistPayload();
      //expect(instance).to.be.a(molecule_api.TokenWhitelistPayload);
    });
