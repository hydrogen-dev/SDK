...
module IntegrationApi
  class KycVendorRequestDataVO
    ...
    def hash
      [address, country_of_residence, date_of_birth, electron_document_id, email, first_name, gender, identification_number, identification_number_type, last_name, metadata, middle_name, phone_number].hash
    end
