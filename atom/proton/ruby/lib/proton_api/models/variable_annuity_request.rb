...
module ProtonApi
  class VariableAnnuityRequest
    ...
    def hash
      [guaranteed_accumulation_benefit, p, aggregation_account_id, allocation_id, portfolio_weights, end_date, n, account_id, portfolio_tickers, initial_balance, remove_outliers, model_id, guaranteed_rate_benefit, deposit_schedule, use_proxy_data, accumulation_horizon, inflation_rate, annuitization_rate, result_type, start_date, portfolio_id, market_data_source, trading_days_per_year, frequency_interval, create_log, decumulation_horizon, tax_rate].hash
    end
