...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.BrokerageDepositVO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The BrokerageDepositVO model module.
   * @module model/BrokerageDepositVO
   * @version 1.2.1
   */

  /**
   * Constructs a new <code>BrokerageDepositVO</code>.
   * @alias module:model/BrokerageDepositVO
   * @class
   */
  ...
  /**
   * Constructs a <code>BrokerageDepositVO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BrokerageDepositVO} obj Optional instance to populate.
   * @return {module:model/BrokerageDepositVO} The populated <code>BrokerageDepositVO</code> instance.
   */
