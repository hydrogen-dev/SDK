...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.RiskScoreOptConfigModel();
  });
  ...
  describe('RiskScoreOptConfigModel', function() {
    it('should create an instance of RiskScoreOptConfigModel', function() {
      // uncomment below and update the code to test RiskScoreOptConfigModel
      //var instance = new atom_api.RiskScoreOptConfigModel();
      //expect(instance).to.be.a(atom_api.RiskScoreOptConfigModel);
    });
