...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AchCardResponseVO', function() {
      beforeEach(function() {
        instance = new HydrogenElectronApi.AchCardResponseVO();
      });

      it('should create an instance of AchCardResponseVO', function() {
        // TODO: update the code to test AchCardResponseVO
        expect(instance).to.be.a(HydrogenElectronApi.AchCardResponseVO);
      });
