...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.LifeInsuranceReturnDetail();
  });
  ...
  describe('LifeInsuranceReturnDetail', function() {
    it('should create an instance of LifeInsuranceReturnDetail', function() {
      // uncomment below and update the code to test LifeInsuranceReturnDetail
      //var instance = new atom_api.LifeInsuranceReturnDetail();
      //expect(instance).to.be.a(atom_api.LifeInsuranceReturnDetail);
    });
