...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageEscrowResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageEscrowResponse();
      });

      it('should create an instance of PageEscrowResponse', function() {
        // TODO: update the code to test PageEscrowResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageEscrowResponse);
      });
