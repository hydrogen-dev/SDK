...
module IntegrationApi
  class CardTokenResponseVO
    ...
    def valid?
      wallet_validator = EnumAttributeValidator.new('String', ['google', 'apple', 'samsung', 'other'])
    ...
    def wallet=(wallet)
      validator = EnumAttributeValidator.new('String', ['google', 'apple', 'samsung', 'other'])
    ...
    def hash
      [apple_payload, google_payload, message, nucleus_card_id, samsung_payload, vendor_name, vendor_response, wallet].hash
    end
