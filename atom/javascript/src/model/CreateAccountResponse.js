...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountCreateClient', 'model/AccountCreateGoal', 'model/AccountCreatePayload', 'model/Pagination', 'model/PaginationSort', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountCreateClient'), require('./AccountCreateGoal'), require('./AccountCreatePayload'), require('./Pagination'), require('./PaginationSort'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.CreateAccountResponse = factory(root.atom_api.ApiClient, root.atom_api.AccountCreateClient, root.atom_api.AccountCreateGoal, root.atom_api.AccountCreatePayload, root.atom_api.Pagination, root.atom_api.PaginationSort, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, AccountCreateClient, AccountCreateGoal, AccountCreatePayload, Pagination, PaginationSort, SecondaryId) {
  'use strict';
   ...
   * @class
   * @implements module:model/AccountCreatePayload
  ...
  var exports = function(name, accountTypeId) {
    ...
    AccountCreatePayload.call(_this, name, accountTypeId);
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      AccountCreatePayload.constructFromObject(data, obj);
  ...
  // Implement AccountCreatePayload interface:
  /**
   * Name of the account
   * @member {String} name
   */
