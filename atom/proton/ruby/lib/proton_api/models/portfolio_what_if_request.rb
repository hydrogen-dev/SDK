...
module ProtonApi
  class PortfolioWhatIfRequest
    ...
    def hash
      [altered_portfolio_weights, create_log, aggregation_account_id, allocation_id, model_id, end_date, current_portfolio_tickers, use_proxy_data, altered_portfolio_tickers, start_date, current_portfolio_weights, account_id, market_data_source, portfolio_id].hash
    end
