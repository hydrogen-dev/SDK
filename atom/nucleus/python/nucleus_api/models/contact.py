...
class Contact(object):
    ...
    def is_customer(self, is_customer):
        ...
        if (self._configuration.client_side_validation and
                is_customer not in allowed_values):
            raise ValueError(
                "Invalid value for `is_customer` ({0}), must be one of {1}"  # noqa: E501
                .format(is_customer, allowed_values)
            )
    ...
    def is_supplier(self, is_supplier):
        ...
        allowed_values = ["true", "false", "null"]  # noqa: E501
        if (self._configuration.client_side_validation and
                is_supplier not in allowed_values):
            raise ValueError(
                "Invalid value for `is_supplier` ({0}), must be one of {1}"  # noqa: E501
                .format(is_supplier, allowed_values)
            )
