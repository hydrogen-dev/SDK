...
class Client(object):
    ...
    def __init__(self, address=None, citizenship_status=None, client_type=None, country_of_citizenship=None, country_of_residence=None, create_date=None, date_of_birth=None, email=None, employment=None, firm_name=None, first_name=None, gender=None, hydro_id=None, id=None, identification_number=None, identification_number_type=None, image=None, income=None, is_active=None, is_verified=None, last_name=None, liquid_net_worth=None, metadata=None, middle_name=None, phone_number=None, secondary_id=None, suffix=None, title=None, total_net_worth=None, update_date=None, username=None):  # noqa: E501
