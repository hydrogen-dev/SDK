...
(function(root, factory) {
  ...
  describe('AggregationAccountBalanceResponseVO', function() {
    it('should create an instance of AggregationAccountBalanceResponseVO', function() {
      // uncomment below and update the code to test AggregationAccountBalanceResponseVO
      //var instane = new HydrogenIntegrationApi.AggregationAccountBalanceResponseVO();
    ...
    it('should have the property nucleusBalancePosted (base name: "nucleus_balance_posted")', function() {
      // uncomment below and update the code to test the property nucleusBalancePosted
      //var instane = new HydrogenIntegrationApi.AggregationAccountBalanceResponseVO();
      //expect(instance).to.be();
    });
