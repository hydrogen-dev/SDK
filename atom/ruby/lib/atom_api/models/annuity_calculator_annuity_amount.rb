...
module AtomApi
  class AnnuityCalculatorAnnuityAmount
    ...
    def hash
      [portfolio_return, initial_balance, accumulation_horizon, decumulation_horizon, annuity_frequency_interval, inflation_rate, tax_rate, deposit_schedule].hash
    end
