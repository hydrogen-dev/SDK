  ...
  class TokenSpecificResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'conract_address')
        self.conract_address = attributes[:'conract_address']
      end

      if attributes.has_key?(:'crowdsale_address')
        self.crowdsale_address = attributes[:'crowdsale_address']
      end
      ...
      if attributes.has_key?(:'offering_settings')
        self.offering_settings = attributes[:'offering_settings']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          offering_settings == o.offering_settings &&
          metadata == o.metadata &&
    ...
    def hash
      [id, create_date, symbol, name, type, is_mintable, is_burnable, nucleus_model_id, owner_wallet_id, total_supply, circulating_supply, whitelist_address, conract_address, crowdsale_address, restrictions, offering_settings, metadata, secondary_id, update_date].hash
    end
