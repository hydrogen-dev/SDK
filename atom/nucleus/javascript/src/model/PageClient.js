...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Client', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Client'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageClient = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Client, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, Client, Sort) {
  'use strict';
  ...
  /**
   * The PageClient model module.
   * @module model/PageClient
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageClient</code>.
   * Page Object
   * @alias module:model/PageClient
   * @class
   */
  ...
  /**
   * Constructs a <code>PageClient</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageClient} obj Optional instance to populate.
   * @return {module:model/PageClient} The populated <code>PageClient</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Client]);
      }
  ...
  /**
   * @member {Array.<module:model/Client>} content
   */
