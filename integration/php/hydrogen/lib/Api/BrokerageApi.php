...
class BrokerageApi
{
     ...
     */
    public function createBankLinkUsingPost($brokerage_bank_link_co)
    {
        list($response) = $this->createBankLinkUsingPostWithHttpInfo($brokerage_bank_link_co);
        return $response;
    }
     ...
     */
    public function createBankLinkUsingPostWithHttpInfo($brokerage_bank_link_co)
    {
        $returnType = '\com\hydrogen\integration\Model\BrokerageBankLinkVO';
        $request = $this->createBankLinkUsingPostRequest($brokerage_bank_link_co);
     ...
     */
    public function createBankLinkUsingPostAsync($brokerage_bank_link_co)
    {
        return $this->createBankLinkUsingPostAsyncWithHttpInfo($brokerage_bank_link_co)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBankLinkUsingPostAsyncWithHttpInfo($brokerage_bank_link_co)
    {
        $returnType = '\com\hydrogen\integration\Model\BrokerageBankLinkVO';
        $request = $this->createBankLinkUsingPostRequest($brokerage_bank_link_co);
     ...
     */
    protected function createBankLinkUsingPostRequest($brokerage_bank_link_co)
    {
        ...
        if ($brokerage_bank_link_co === null || (is_array($brokerage_bank_link_co) && count($brokerage_bank_link_co) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brokerage_bank_link_co when calling createBankLinkUsingPost'
            );
        }
     ...
     * @throws \com\hydrogen\integration\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\hydrogen\integration\Model\CreateOrderResponse
     */
    public function createOrderUsingPost($nucleus_order_id)
    {
        list($response) = $this->createOrderUsingPostWithHttpInfo($nucleus_order_id);
        return $response;
    }
     ...
     * @throws \com\hydrogen\integration\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\hydrogen\integration\Model\CreateOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOrderUsingPostWithHttpInfo($nucleus_order_id)
    {
        $returnType = '\com\hydrogen\integration\Model\CreateOrderResponse';
        $request = $this->createOrderUsingPostRequest($nucleus_order_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\hydrogen\integration\Model\CreateOrderResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrderUsingPostAsync($nucleus_order_id)
    {
        return $this->createOrderUsingPostAsyncWithHttpInfo($nucleus_order_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrderUsingPostAsyncWithHttpInfo($nucleus_order_id)
    {
        $returnType = '\com\hydrogen\integration\Model\CreateOrderResponse';
        $request = $this->createOrderUsingPostRequest($nucleus_order_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createOrderUsingPostRequest($nucleus_order_id)
    {
        ...
        if ($nucleus_order_id === null || (is_array($nucleus_order_id) && count($nucleus_order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $nucleus_order_id when calling createOrderUsingPost'
            );
        }
        ...
        if ($nucleus_order_id !== null) {
            $queryParams['nucleus_order_id'] = ObjectSerializer::toQueryValue($nucleus_order_id);
        }
     ...
     * @throws \com\hydrogen\integration\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\hydrogen\integration\Model\ResponseEntity
     */
     ...
     * @throws \com\hydrogen\integration\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\hydrogen\integration\Model\ResponseEntity, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteBankLinkUsingDeleteWithHttpInfo($nucleus_bank_link_id)
    {
        $returnType = '\com\hydrogen\integration\Model\ResponseEntity';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\hydrogen\integration\Model\ResponseEntity',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return void
     */
    public function deleteOrderUsingDelete($nucleus_order_id)
    {
        $this->deleteOrderUsingDeleteWithHttpInfo($nucleus_order_id);
    }
     ...
     */
    public function deleteOrderUsingDeleteWithHttpInfo($nucleus_order_id)
    {
        $returnType = '';
        $request = $this->deleteOrderUsingDeleteRequest($nucleus_order_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteOrderUsingDeleteAsync($nucleus_order_id)
    {
        return $this->deleteOrderUsingDeleteAsyncWithHttpInfo($nucleus_order_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteOrderUsingDeleteAsyncWithHttpInfo($nucleus_order_id)
    {
        $returnType = '';
        $request = $this->deleteOrderUsingDeleteRequest($nucleus_order_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteOrderUsingDeleteRequest($nucleus_order_id)
    {
        // verify the required parameter 'nucleus_order_id' is set
        if ($nucleus_order_id === null || (is_array($nucleus_order_id) && count($nucleus_order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $nucleus_order_id when calling deleteOrderUsingDelete'
            );
        }
    ...
    protected function getBrokerageAccountStatementUsingGetRequest($end_date, $nucleus_account_id, $start_date, $statement_type)
    {
        ...
        $resourcePath = '/brokerage/{nucleus_account_id}/statement';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \com\hydrogen\integration\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\hydrogen\integration\Model\GetOrderResponse
     */
     ...
     * @throws \com\hydrogen\integration\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\hydrogen\integration\Model\GetOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderUsingGetWithHttpInfo($nucleus_order_id)
    {
        $returnType = '\com\hydrogen\integration\Model\GetOrderResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\hydrogen\integration\Model\GetOrderResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
