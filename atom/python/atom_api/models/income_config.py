...
class IncomeConfig(object):
    ...
    def __init__(self, annual_net_take_home_pay=None, percentage_of_income_covered=None, income_benefit_duration=None):  # noqa: E501
    ...
    def annual_net_take_home_pay(self):
        ...
        The annual net take-home pay  # noqa: E501
    ...
    def percentage_of_income_covered(self):
        ...
        The percentage of income covered  # noqa: E501
    ...
    def percentage_of_income_covered(self, percentage_of_income_covered):
        ...
        if percentage_of_income_covered is not None and percentage_of_income_covered <= 0:  # noqa: E501
            raise ValueError("Invalid value for `percentage_of_income_covered`, must be a value greater than `0`")  # noqa: E501
    ...
    def income_benefit_duration(self):
        ...
        The income benefit duration  # noqa: E501
    ...
    def income_benefit_duration(self, income_benefit_duration):
        ...
        :type: float
        """
        if income_benefit_duration is not None and income_benefit_duration <= 0:  # noqa: E501
            raise ValueError("Invalid value for `income_benefit_duration`, must be a value greater than `0`")  # noqa: E501
