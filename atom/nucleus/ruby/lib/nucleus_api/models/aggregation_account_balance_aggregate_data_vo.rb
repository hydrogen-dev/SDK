...
module NucleusApi
  class AggregationAccountBalanceAggregateDataVO
    ...
    def hash
      [aggregation_account_balance_id, available_balance, available_credit, balance, balance_time_stamp, create_date, currency_code, secondary_id, update_date].hash
    end
