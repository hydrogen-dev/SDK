...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PurchaseCalculatorAmountRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.PurchaseCalculatorAmountRequest();
      });

      it('should create an instance of PurchaseCalculatorAmountRequest', function() {
        // TODO: update the code to test PurchaseCalculatorAmountRequest
        expect(instance).to.be.a(HydrogenProtonApi.PurchaseCalculatorAmountRequest);
      });
