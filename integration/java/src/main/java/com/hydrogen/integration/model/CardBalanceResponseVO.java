...
import com.hydrogen.integration.model.PortfolioAssetSizeLog;
...
public class CardBalanceResponseVO {
  ...
  private List<PortfolioAssetSizeLog> nucleusAssetSizesUpdated = null;
  ...
  **/
  ...
  public CardBalanceResponseVO nucleusAssetSizesPosted(List<PortfolioAssetSizeLog> nucleusAssetSizesPosted) {
    this.nucleusAssetSizesPosted = nucleusAssetSizesPosted;
    return this;
  }

  public CardBalanceResponseVO addNucleusAssetSizesPostedItem(PortfolioAssetSizeLog nucleusAssetSizesPostedItem) {
  ...
  **/
  ...
  public CardBalanceResponseVO nucleusAssetSizesUpdated(List<PortfolioAssetSizeLog> nucleusAssetSizesUpdated) {
    this.nucleusAssetSizesUpdated = nucleusAssetSizesUpdated;
    return this;
  }

  public CardBalanceResponseVO addNucleusAssetSizesUpdatedItem(PortfolioAssetSizeLog nucleusAssetSizesUpdatedItem) {
    if (this.nucleusAssetSizesUpdated == null) {
      this.nucleusAssetSizesUpdated = new ArrayList<PortfolioAssetSizeLog>();
    }
  ...
  **/
  @ApiModelProperty(value = "")
  public List<PortfolioAssetSizeLog> getNucleusAssetSizesUpdated() {
    return nucleusAssetSizesUpdated;
  }

  public void setNucleusAssetSizesUpdated(List<PortfolioAssetSizeLog> nucleusAssetSizesUpdated) {
    this.nucleusAssetSizesUpdated = nucleusAssetSizesUpdated;
  }
