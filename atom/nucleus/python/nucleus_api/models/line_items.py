...
class LineItems(object):
    ...
    def __init__(self, amount=None, currency_code=None, description=None, line_item_id=None, quantity=None, rate=None, subtotal=None, tax=None, _configuration=None):  # noqa: E501
