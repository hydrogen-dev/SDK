...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateBusinessResponseVO :  IEquatable<CreateBusinessResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBusinessResponseVO" /> class.
        /// </summary>
        ...
        public CreateBusinessResponseVO(string message = default(string), Guid? nucleusBusinessId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as CreateBusinessResponseVO);
        }

        /// <summary>
        /// Returns true if CreateBusinessResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBusinessResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBusinessResponseVO input)
        {
            if (input == null)
                return false;
