...
# create an instance of the API class
api_instance = atom_api.RiskProfileApi(atom_api.ApiClient(configuration))
risk_profile = atom_api.RiskProfile() # RiskProfile | riskProfile
...
# create an instance of the API class
api_instance = atom_api.RiskProfileApi(atom_api.ApiClient(configuration))
risk_profile = atom_api.RiskProfile() # RiskProfile | risk_profile
risk_profile_id = 'risk_profile_id_example' # str | UUID risk_profile_id
