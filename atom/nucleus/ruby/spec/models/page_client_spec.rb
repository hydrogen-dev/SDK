...
# Unit tests for NucleusApi::PageClient
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PageClient' do
  before do
    # run before each test
    @instance = NucleusApi::PageClient.new
  end
  ...
  describe 'test an instance of PageClient' do
    it 'should create an instance of PageClient' do
      expect(@instance).to be_instance_of(NucleusApi::PageClient)
    end
  end
