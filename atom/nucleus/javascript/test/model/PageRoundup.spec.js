...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageRoundup();
  });
  ...
  describe('PageRoundup', function() {
    it('should create an instance of PageRoundup', function() {
      // uncomment below and update the code to test PageRoundup
      //var instane = new HydrogenNucleusApi.PageRoundup();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageRoundup);
    });
