...
class DiversificationScoreRequest(object):
    ...
    def __init__(self, use_proxy_data=False, start_date=None, portfolio_tickers=None, end_date=None, model_id=None, allocation_id=None, account_id=None, portfolio_id=None, portfolio_weights=None, aggregation_account_id=None, market_data_source='nucleus'):  # noqa: E501
