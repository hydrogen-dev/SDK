...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.GoalDecumulationStatus();
  });
  ...
  describe('GoalDecumulationStatus', function() {
    it('should create an instance of GoalDecumulationStatus', function() {
      // uncomment below and update the code to test GoalDecumulationStatus
      //var instance = new atom_api.GoalDecumulationStatus();
      //expect(instance).to.be.a(atom_api.GoalDecumulationStatus);
    });
