...
module AtomApi
  class EducationCalculatorPctcoveredResponse
    # The annual cost that can be covered, expressed in today's dollars.
    attr_accessor :achievable_cost
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'achievable_cost')
        self.achievable_cost = attributes[:'achievable_cost']
      end

      if attributes.has_key?(:'target_cost')
        self.target_cost = attributes[:'target_cost']
      end
    ...
    def list_invalid_properties
      ...
      if @achievable_cost.nil?
        invalid_properties.push('invalid value for "achievable_cost", achievable_cost cannot be nil.')
      end

      if @target_cost.nil?
        invalid_properties.push('invalid value for "target_cost", target_cost cannot be nil.')
      end

      if @percent_of_costs_covered.nil?
        invalid_properties.push('invalid value for "percent_of_costs_covered", percent_of_costs_covered cannot be nil.')
      end

      if @percent_of_costs_covered > 1
        invalid_properties.push('invalid value for "percent_of_costs_covered", must be smaller than or equal to 1.')
      end

      if @percent_of_costs_covered < 0
    ...
    def valid?
      return false if @achievable_cost.nil?
      return false if @target_cost.nil?
      return false if @percent_of_costs_covered.nil?
      return false if @percent_of_costs_covered > 1
      return false if @percent_of_costs_covered < 0
    ...
    def percent_of_costs_covered=(percent_of_costs_covered)
      if percent_of_costs_covered.nil?
        fail ArgumentError, 'percent_of_costs_covered cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          achievable_cost == o.achievable_cost &&
          target_cost == o.target_cost &&
    ...
    def hash
      [achievable_cost, target_cost, percent_of_costs_covered, projected_accumulation_savings, total_earnings, total_contributions, total_cost, total_taxes, return_details].hash
    end
