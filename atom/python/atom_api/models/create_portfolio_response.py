...
class CreatePortfolioResponse(object):
    ...
    def __init__(self, name=None, account_id=None, model_id=None, percentage=None, description=None, metadata=None, secondary_id=None, id=None, create_date=None):  # noqa: E501
