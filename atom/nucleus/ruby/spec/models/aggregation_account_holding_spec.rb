...
# Unit tests for AtomApi::AggregationAccountHolding
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AggregationAccountHolding' do
  before do
    # run before each test
    @instance = AtomApi::AggregationAccountHolding.new
  end
  ...
  describe 'test an instance of AggregationAccountHolding' do
    it 'should create an instance of AggregationAccountHolding' do
      expect(@instance).to be_instance_of(AtomApi::AggregationAccountHolding)
    end
  end
