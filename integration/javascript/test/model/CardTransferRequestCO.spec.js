...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CardTransferRequestCO', function() {
      beforeEach(function() {
        instance = new HydrogenIntegrationApi.CardTransferRequestCO();
      });

      it('should create an instance of CardTransferRequestCO', function() {
        // TODO: update the code to test CardTransferRequestCO
        expect(instance).to.be.a(HydrogenIntegrationApi.CardTransferRequestCO);
      });
