...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.OptConfig();
  });
  ...
  describe('OptConfig', function() {
    it('should create an instance of OptConfig', function() {
      // uncomment below and update the code to test OptConfig
      //var instance = new atom_api.OptConfig();
      //expect(instance).to.be.a(atom_api.OptConfig);
    });
