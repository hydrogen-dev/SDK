...
class MdHistoryItemVO(object):
    ...
    def __init__(self, adjusted_price=None, currency_code=None, _date=None, nucleus_security_id=None, price=None, security_price_id=None, ticker=None, _configuration=None):  # noqa: E501
