...
module AtomApi
  class CreateBudgetResponse
    ...
    def hash
      [name, client_id, currency_code, budget, frequency_unit, frequency, account_id, goal_id, aggregation_accounts, start_date, end_date, metadata, secondary_id, id, create_date].hash
    end
