...
module AtomApi
  class PurchaseCalculatorDepositamountResponse
    ...
    def hash
      [deposit_amount, deposit_frequency_interval, adjusted_goal_amount, projected_savings_at_purchase_horizon, total_earnings, total_contributions, return_details].hash
    end
