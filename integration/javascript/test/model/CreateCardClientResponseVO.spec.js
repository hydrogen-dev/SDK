...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.CreateCardClientResponseVO();
  });
  ...
  describe('CreateCardClientResponseVO', function() {
    it('should create an instance of CreateCardClientResponseVO', function() {
      // uncomment below and update the code to test CreateCardClientResponseVO
      //var instane = new HydrogenIntegrationApi.CreateCardClientResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.CreateCardClientResponseVO);
    });
