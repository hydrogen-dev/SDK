...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageBankLink();
  });
  ...
  describe('PageBankLink', function() {
    it('should create an instance of PageBankLink', function() {
      // uncomment below and update the code to test PageBankLink
      //var instane = new HydrogenNucleusApi.PageBankLink();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageBankLink);
    });
