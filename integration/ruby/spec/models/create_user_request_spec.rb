...
# Unit tests for IntegrationApi::CreateUserRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateUserRequest' do
  before do
    # run before each test
    @instance = IntegrationApi::CreateUserRequest.new
  end
  ...
  describe 'test an instance of CreateUserRequest' do
    it 'should create an instance of CreateUserRequest' do
      expect(@instance).to be_instance_of(IntegrationApi::CreateUserRequest)
    end
  end
