...
public class GetOrderResponse {
  ...
  private List<SpecificOrderResponse> content = null;

  public GetOrderResponse last(Boolean last) {
    this.last = last;
    return this;
  }
  ...
  **/
  ...
  public GetOrderResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public GetOrderResponse totalElements(Integer totalElements) {
  ...
  **/
  ...
  public GetOrderResponse sort(List<PaginationSort> sort) {
    this.sort = sort;
    return this;
  }

  public GetOrderResponse addSortItem(PaginationSort sortItem) {
    if (this.sort == null) {
  ...
  **/
  ...
  public GetOrderResponse first(Boolean first) {
    this.first = first;
    return this;
  }
  ...
  **/
  ...
  public GetOrderResponse numberOfElements(Integer numberOfElements) {
  ...
  **/
  ...
  public GetOrderResponse size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public GetOrderResponse number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  **/
  ...
  public GetOrderResponse content(List<SpecificOrderResponse> content) {
    this.content = content;
    return this;
  }

  public GetOrderResponse addContentItem(SpecificOrderResponse contentItem) {
    if (this.content == null) {
      this.content = new ArrayList<SpecificOrderResponse>();
    }
  ...
  **/
  ...
  public List<SpecificOrderResponse> getContent() {
    return content;
  }

  public void setContent(List<SpecificOrderResponse> content) {
    this.content = content;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.last, getOrderResponse.last) &&
        Objects.equals(this.totalPages, getOrderResponse.totalPages) &&
        Objects.equals(this.totalElements, getOrderResponse.totalElements) &&
        Objects.equals(this.sort, getOrderResponse.sort) &&
        Objects.equals(this.first, getOrderResponse.first) &&
        Objects.equals(this.numberOfElements, getOrderResponse.numberOfElements) &&
        Objects.equals(this.size, getOrderResponse.size) &&
        Objects.equals(this.number, getOrderResponse.number) &&
        Objects.equals(this.content, getOrderResponse.content);
  }
