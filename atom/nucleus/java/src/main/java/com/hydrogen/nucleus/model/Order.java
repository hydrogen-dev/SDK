...
public class Order {
  ...
  **/
   ...
   * @return quantity
  **/
  @ApiModelProperty(example = "100.0", required = true, value = "quantity")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, createDate, date, id, isRead, metadata, modelId, orderBulkId, orderTicketId, orderType, portfolioId, price, quantity, secondaryId, securityId, tmpTrackerId, transactionCodeId, updateDate);
  }
