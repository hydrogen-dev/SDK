...
module ProtonApi
  class VariableAnnuityRequest
    ...
    def self.swagger_types
      {
        ...
        :'guaranteed_rate_benefit' => :'Array<Object>',
        :'n' => :'Integer',
    ...
    def hash
      [start_date, initial_balance, tax_rate, allocation_id, account_id, result_type, accumulation_horizon, aggregation_account_id, market_data_source, guaranteed_accumulation_benefit, decumulation_horizon, deposit_schedule, portfolio_tickers, trading_days_per_year, portfolio_id, frequency_interval, guaranteed_rate_benefit, n, inflation_rate, model_id, portfolio_weights, use_proxy_data, end_date, annuitization_rate, remove_outliers, p].hash
    end
