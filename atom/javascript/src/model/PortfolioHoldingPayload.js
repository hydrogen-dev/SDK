...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.PortfolioHoldingPayload = factory(root.atom_api.ApiClient, root.atom_api.SecondaryId);
  }
  ...
  /**
   * The PortfolioHoldingPayload model module.
   * @module model/PortfolioHoldingPayload
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>PortfolioHoldingPayload</code>.
   * @alias module:model/PortfolioHoldingPayload
   * @class
  ...
  /**
   * Constructs a <code>PortfolioHoldingPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioHoldingPayload} obj Optional instance to populate.
   * @return {module:model/PortfolioHoldingPayload} The populated <code>PortfolioHoldingPayload</code> instance.
   */
