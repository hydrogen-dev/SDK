...
class DecisionTree(object):
    ...
    def __init__(self, category=None, create_date=None, description=None, id=None, is_active=None, metadata=None, name=None, secondary_id=None, subcategory=None, update_date=None):  # noqa: E501
