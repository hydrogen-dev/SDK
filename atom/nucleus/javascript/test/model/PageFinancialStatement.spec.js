...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageFinancialStatement();
  });
  ...
  describe('PageFinancialStatement', function() {
    it('should create an instance of PageFinancialStatement', function() {
      // uncomment below and update the code to test PageFinancialStatement
      //var instane = new HydrogenNucleusApi.PageFinancialStatement();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageFinancialStatement);
    });
