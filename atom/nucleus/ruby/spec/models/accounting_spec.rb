...
# Unit tests for NucleusApi::Accounting
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Accounting' do
  before do
    # run before each test
    @instance = NucleusApi::Accounting.new
  end
  ...
  describe 'test an instance of Accounting' do
    it 'should create an instance of Accounting' do
      expect(@instance).to be_instance_of(NucleusApi::Accounting)
    end
  end
  ...
  describe 'test attribute "stat_date"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
