...
class BusinessApi
{
    ...
    protected function deleteBusinessUsingDeleteRequest($business_id)
    {
        ...
        $resourcePath = '/business/{business_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBusinessAssetSizeUsingGetRequest($business_id, $currency_conversion = null, $end_date = 'null', $exclude_subledger = 'false', $get_latest = null, $sort_type = null, $start_date = 'null')
    {
        ...
        $resourcePath = '/business/{business_id}/asset_size';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getBusinessClientTransactionAllUsingGet($business_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        list($response) = $this->getBusinessClientTransactionAllUsingGetWithHttpInfo($business_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date);
        return $response;
    }
     ...
     */
    public function getBusinessClientTransactionAllUsingGetWithHttpInfo($business_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PagePortfolioTransaction_';
        $request = $this->getBusinessClientTransactionAllUsingGetRequest($business_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBusinessClientTransactionAllUsingGetAsync($business_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        return $this->getBusinessClientTransactionAllUsingGetAsyncWithHttpInfo($business_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBusinessClientTransactionAllUsingGetAsyncWithHttpInfo($business_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PagePortfolioTransaction_';
        $request = $this->getBusinessClientTransactionAllUsingGetRequest($business_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBusinessClientTransactionAllUsingGetRequest($business_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        // verify the required parameter 'business_id' is set
        if ($business_id === null || (is_array($business_id) && count($business_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/business/{business_id}/transaction';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getBusinessHoldingUsingGet($business_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        list($response) = $this->getBusinessHoldingUsingGetWithHttpInfo($business_id, $currency_conversion, $end_date, $get_latest, $start_date);
        return $response;
    }
     ...
     */
    public function getBusinessHoldingUsingGetWithHttpInfo($business_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PortfolioHoldingAgg[]';
        $request = $this->getBusinessHoldingUsingGetRequest($business_id, $currency_conversion, $end_date, $get_latest, $start_date);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBusinessHoldingUsingGetAsync($business_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        return $this->getBusinessHoldingUsingGetAsyncWithHttpInfo($business_id, $currency_conversion, $end_date, $get_latest, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBusinessHoldingUsingGetAsyncWithHttpInfo($business_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PortfolioHoldingAgg[]';
        $request = $this->getBusinessHoldingUsingGetRequest($business_id, $currency_conversion, $end_date, $get_latest, $start_date);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBusinessHoldingUsingGetRequest($business_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        // verify the required parameter 'business_id' is set
        if ($business_id === null || (is_array($business_id) && count($business_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/business/{business_id}/holding';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
