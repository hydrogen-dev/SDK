...
module AtomApi
  class SellAllPortfolioPayload
    ...
    def hash
      [sell_transaction_code_id, buy_transaction_code_id, buy_threshold, cash_sec_id, commit_orders, non_fractional, port_threshold, restrictions_on, sell_threshold].hash
    end
