...
class ACHApi(object):
    ...
    def get_business_balance_using_get(self, business_id, **kwargs):  # noqa: E501
        """Get business balance  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_business_balance_using_get(business_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_business_balance_using_get_with_http_info(business_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_business_balance_using_get_with_http_info(business_id, **kwargs)  # noqa: E501
            return data

    def get_business_balance_using_get_with_http_info(self, business_id, **kwargs):  # noqa: E501
        """Get business balance  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_business_balance_using_get_with_http_info(business_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_business_balance_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('business_id' not in params or
            ...
            raise ValueError("Missing the required parameter `business_id` when calling `get_business_balance_using_get`")  # noqa: E501
