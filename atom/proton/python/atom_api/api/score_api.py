...
class ScoreApi(object):
    ...
    def create_score_using_post1(self, score_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_score_using_post1(score_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_score_using_post1_with_http_info(score_id, **kwargs)  # noqa: E501
        else:
            (data) = self.create_score_using_post1_with_http_info(score_id, **kwargs)  # noqa: E501
            return data

    def create_score_using_post1_with_http_info(self, score_id, **kwargs):  # noqa: E501
        """Retrieve a score  # noqa: E501

        Retrieve the information for a specific score associated with a client, account, goal, portfolio, allocation, model, benchmark or security.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_score_using_post1_with_http_info(score_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_score_using_post1" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('score_id' not in params or
            ...
            raise ValueError("Missing the required parameter `score_id` when calling `create_score_using_post1`")  # noqa: E501
