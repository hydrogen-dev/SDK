...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class SensitivityAnalysisRequest :  IEquatable<SensitivityAnalysisRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SensitivityAnalysisRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SensitivityAnalysisRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SensitivityAnalysisRequest" /> class.
        /// </summary>
        ...
        /// <param name="sensitivityFactor">sensitivityFactor (required).</param>
        ...
        public SensitivityAnalysisRequest(Guid? allocationId = default(Guid?), DateTime? endDate = default(DateTime?), MarketDataSourceEnum? marketDataSource = MarketDataSourceEnum.Nucleus, Guid? modelId = default(Guid?), Guid? accountId = default(Guid?), DateTime? startDate = default(DateTime?), FrequencyIntervalEnum frequencyInterval = default(FrequencyIntervalEnum), int? tradingDaysPerYear = 252, SensitivityFactor sensitivityFactor = default(SensitivityFactor), bool? useProxyData = false, List<float?> portfolioWeights = default(List<float?>), List<string> portfolioTickers = default(List<string>), bool? createLog = false, Guid? aggregationAccountId = default(Guid?), Guid? portfolioId = default(Guid?))
        {
            // to ensure "frequencyInterval" is required (not null)
            if (frequencyInterval == null)
            {
                throw new InvalidDataException("frequencyInterval is a required property for SensitivityAnalysisRequest and cannot be null");
            }
            else
            {
                this.FrequencyInterval = frequencyInterval;
            }
            // to ensure "sensitivityFactor" is required (not null)
            if (sensitivityFactor == null)
            {
                throw new InvalidDataException("sensitivityFactor is a required property for SensitivityAnalysisRequest and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets SensitivityFactor
        /// </summary>
        [DataMember(Name="sensitivity_factor", EmitDefaultValue=false)]
        public SensitivityFactor SensitivityFactor { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SensitivityFactor: ").Append(SensitivityFactor).Append("\n");
        ...
        {
            return this.Equals(input as SensitivityAnalysisRequest);
        }

        /// <summary>
        /// Returns true if SensitivityAnalysisRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SensitivityAnalysisRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SensitivityAnalysisRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SensitivityFactor == input.SensitivityFactor ||
                    (this.SensitivityFactor != null &&
                    this.SensitivityFactor.Equals(input.SensitivityFactor))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SensitivityFactor != null)
                    hashCode = hashCode * 59 + this.SensitivityFactor.GetHashCode();
