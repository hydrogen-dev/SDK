...
class SensitivityFactor(object):
    ...
    def __init__(self, ticker=None, change_amount=None, change_duration=None, lag=None):  # noqa: E501
    ...
    def ticker(self):
        ...
        The symbol of the instrument being changed in the scenario  # noqa: E501
    ...
    def change_amount(self):
        ...
        A positive or negative percentage price change for the ticker  # noqa: E501
    ...
    def change_amount(self, change_amount):
        ...
        if change_amount is not None and change_amount <= -1:  # noqa: E501
            raise ValueError("Invalid value for `change_amount`, must be a value greater than `-1`")  # noqa: E501
    ...
    def change_duration(self):
        ...
        The number of time periods over which the scenario price change is to occur  # noqa: E501
    ...
    def change_duration(self, change_duration):
        ...
        if change_duration is not None and change_duration <= 0:  # noqa: E501
            raise ValueError("Invalid value for `change_duration`, must be a value greater than `0`")  # noqa: E501
    ...
    def lag(self):
        ...
        Number of periods to lag between factor return and resulting portfolio return  # noqa: E501
