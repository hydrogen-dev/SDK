...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageCustomerRevenue();
  });
  ...
  describe('PageCustomerRevenue', function() {
    it('should create an instance of PageCustomerRevenue', function() {
      ...
      //var instane = new HydrogenAtomApi.PageCustomerRevenue();
      //expect(instance).to.be.a(HydrogenAtomApi.PageCustomerRevenue);
    });
