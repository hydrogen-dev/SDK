...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.PortfolioTransactionPayload();
  });
  ...
  describe('PortfolioTransactionPayload', function() {
    it('should create an instance of PortfolioTransactionPayload', function() {
      // uncomment below and update the code to test PortfolioTransactionPayload
      //var instance = new atom_api.PortfolioTransactionPayload();
      //expect(instance).to.be.a(atom_api.PortfolioTransactionPayload);
    });
