...
class GoalConfig(object):
    ...
    def __init__(self, goal_amount=None, goal_inflation=None):  # noqa: E501
    ...
    def goal_amount(self, goal_amount):
        ...
        if goal_amount is None:
            raise ValueError("Invalid value for `goal_amount`, must not be `None`")  # noqa: E501
        if goal_amount is not None and goal_amount <= 0:  # noqa: E501
            raise ValueError("Invalid value for `goal_amount`, must be a value greater than `0`")  # noqa: E501
    ...
    def goal_inflation(self):
        ...
        The annualized inflation for goal_amount  # noqa: E501
    ...
    def goal_inflation(self, goal_inflation):
        ...
        :type: float
        """
        if goal_inflation is not None and goal_inflation >= 20:  # noqa: E501
            raise ValueError("Invalid value for `goal_inflation`, must be a value less than `20`")  # noqa: E501
        if goal_inflation is not None and goal_inflation <= -1:  # noqa: E501
            raise ValueError("Invalid value for `goal_inflation`, must be a value greater than `-1`")  # noqa: E501
