...
module ProtonApi
  class RetirementCalculatorPercentCoveredRequest
    ...
    def hash
      [retirement_income, deposit_schedule, retirement_age, portfolio_return, retirement_expenses, inflation_rate, aggregation_account_ids, current_age, account_ids, retirement_savings, retirement_tax, death_age].hash
    end
