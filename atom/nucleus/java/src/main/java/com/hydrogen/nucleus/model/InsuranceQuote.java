...
public class InsuranceQuote {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(coverages, createDate, currencyCode, discounts, endDate, id, isActive, metadata, nodeMap, premium, premiumDuration, premiumFrequency, premiumFrequencyUnit, secondaryId, startDate, updateDate);
  }
