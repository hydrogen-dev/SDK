...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('kyc_status'))
        obj.kycStatus = ApiClient.convertToType(data['kyc_status'], 'String');
      ...
      if (data.hasOwnProperty('vendor_request_data'))
        obj.vendorRequestData = KycVendorRequestDataVO.constructFromObject(data['vendor_request_data']);
  ...
  /**
   * @member {module:model/KycVendorRequestDataVO} vendorRequestData
   */
