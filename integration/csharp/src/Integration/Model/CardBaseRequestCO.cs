...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardBaseRequestCO :  IEquatable<CardBaseRequestCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardBaseRequestCO" /> class.
        /// </summary>
        /// <param name="nucleusCardId">nucleusCardId.</param>
        /// <param name="reason">reason.</param>
        /// <param name="vendorRequest">vendorRequest.</param>
        public CardBaseRequestCO(Guid? nucleusCardId = default(Guid?), string reason = default(string), Object vendorRequest = default(Object))
        {
        ...
        {
            return this.Equals(input as CardBaseRequestCO);
        }

        /// <summary>
        /// Returns true if CardBaseRequestCO instances are equal
        /// </summary>
        /// <param name="input">Instance of CardBaseRequestCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardBaseRequestCO input)
        {
            if (input == null)
                return false;
