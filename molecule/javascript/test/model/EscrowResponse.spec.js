...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EscrowResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.EscrowResponse();
      });

      it('should create an instance of EscrowResponse', function() {
        // TODO: update the code to test EscrowResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.EscrowResponse);
      });
