...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.FinancialPictureResponseHistory();
  });
  ...
  describe('FinancialPictureResponseHistory', function() {
    it('should create an instance of FinancialPictureResponseHistory', function() {
      // uncomment below and update the code to test FinancialPictureResponseHistory
      //var instance = new atom_api.FinancialPictureResponseHistory();
      //expect(instance).to.be.a(atom_api.FinancialPictureResponseHistory);
    });
