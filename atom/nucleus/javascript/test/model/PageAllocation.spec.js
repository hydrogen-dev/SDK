...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAllocation();
  });
  ...
  describe('PageAllocation', function() {
    it('should create an instance of PageAllocation', function() {
      // uncomment below and update the code to test PageAllocation
      //var instane = new HydrogenNucleusApi.PageAllocation();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAllocation);
    });
