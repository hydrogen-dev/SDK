...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class RtpTransferResponseVO :  IEquatable<RtpTransferResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RtpTransferResponseVO" /> class.
        /// </summary>
        ...
        public RtpTransferResponseVO(string message = default(string), Guid? nucleusFundingId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorRequest = default(Object), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as RtpTransferResponseVO);
        }

        /// <summary>
        /// Returns true if RtpTransferResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of RtpTransferResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RtpTransferResponseVO input)
        {
            if (input == null)
                return false;
