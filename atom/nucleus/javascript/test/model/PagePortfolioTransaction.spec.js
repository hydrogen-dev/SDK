...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PagePortfolioTransaction();
  });
  ...
  describe('PagePortfolioTransaction', function() {
    it('should create an instance of PagePortfolioTransaction', function() {
      ...
      //var instane = new HydrogenAtomApi.PagePortfolioTransaction();
      //expect(instance).to.be.a(HydrogenAtomApi.PagePortfolioTransaction);
    });
