...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.GoalAccumulationAllocation();
  });
  ...
  describe('GoalAccumulationAllocation', function() {
    it('should create an instance of GoalAccumulationAllocation', function() {
      // uncomment below and update the code to test GoalAccumulationAllocation
      //var instance = new atom_api.GoalAccumulationAllocation();
      //expect(instance).to.be.a(atom_api.GoalAccumulationAllocation);
    });
