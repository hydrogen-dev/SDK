...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.BusinessStatusResponseVO();
  });
  ...
  describe('BusinessStatusResponseVO', function() {
    it('should create an instance of BusinessStatusResponseVO', function() {
      // uncomment below and update the code to test BusinessStatusResponseVO
      //var instane = new HydrogenIntegrationApi.BusinessStatusResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.BusinessStatusResponseVO);
    });
