...
class GetCardStatementResponseVO(object):
    ...
    def __init__(self, currency_code=None, ending_balance=None, initial_balance=None, message=None, nucleus_card_id=None, transactions=None, vendor_name=None, vendor_response=None, _configuration=None):  # noqa: E501
