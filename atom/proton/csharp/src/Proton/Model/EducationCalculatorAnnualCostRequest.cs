...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class EducationCalculatorAnnualCostRequest :  IEquatable<EducationCalculatorAnnualCostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EducationCalculatorAnnualCostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EducationCalculatorAnnualCostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EducationCalculatorAnnualCostRequest" /> class.
        /// </summary>
        ...
        public EducationCalculatorAnnualCostRequest(float? educationInflationRate = 0.05F, int? decumulationHorizon = default(int?), int? accumulationHorizon = default(int?), List<Guid?> accountIds = default(List<Guid?>), float? taxRate = 0.0F, float? generalInflationRate = 0.0F, float? portfolioReturn = default(float?), CalculatorDepositSchedule1 depositSchedule = default(CalculatorDepositSchedule1), float? initialBalance = 0.0F, float? percentOfCostsCovered = 1.0F, List<Guid?> aggregationAccountIds = default(List<Guid?>))
        {
            // to ensure "decumulationHorizon" is required (not null)
            if (decumulationHorizon == null)
            {
                throw new InvalidDataException("decumulationHorizon is a required property for EducationCalculatorAnnualCostRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accumulationHorizon is a required property for EducationCalculatorAnnualCostRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioReturn is a required property for EducationCalculatorAnnualCostRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EducationCalculatorAnnualCostRequest);
        }

        /// <summary>
        /// Returns true if EducationCalculatorAnnualCostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EducationCalculatorAnnualCostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EducationCalculatorAnnualCostRequest input)
        {
            if (input == null)
                return false;
