...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchCardLinkResponseVO :  IEquatable<AchCardLinkResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchCardLinkResponseVO" /> class.
        /// </summary>
        ...
        public AchCardLinkResponseVO(string message = default(string), Guid? nucleusBankLinkId = default(Guid?), Guid? nucleusClientId = default(Guid?), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as AchCardLinkResponseVO);
        }

        /// <summary>
        /// Returns true if AchCardLinkResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchCardLinkResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchCardLinkResponseVO input)
        {
            if (input == null)
                return false;
