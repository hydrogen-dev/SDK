  ...
  class BacktestResponse
    ...
    def self.swagger_types
      {
        ...
        :'trades' => :'Array<RebalanceSignal>',
        :'holdings' => :'Array<HoldingsDetail>',
        :'stats' => :'StatsDetail'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'asset_sizes')
        if (value = attributes[:'asset_sizes']).is_a?(Hash)
          self.asset_sizes = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @asset_sizes.nil?
        invalid_properties.push('invalid value for "asset_sizes", asset_sizes cannot be nil.')
      end

      if @trades.nil?
        invalid_properties.push('invalid value for "trades", trades cannot be nil.')
      end
    ...
    def valid?
      return false if @asset_sizes.nil?
      return false if @trades.nil?
    ...
    def hash
      [asset_sizes, trades, holdings, stats].hash
    end
