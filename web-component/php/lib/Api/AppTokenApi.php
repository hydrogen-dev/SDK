...
class AppTokenApi
{
     ...
     */
    public function getAppTokenUsingGET($app_name)
    {
        list($response) = $this->getAppTokenUsingGETWithHttpInfo($app_name);
        return $response;
    }
     ...
     */
    public function getAppTokenUsingGETWithHttpInfo($app_name)
    {
     ...
     */
    protected function getAppTokenUsingGETRequest($app_name)
    {
