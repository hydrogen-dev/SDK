...
module ProtonApi
  class BusinessInvoiceAnalysisRequest
    ...
    def hash
      [overdue_periods, show_outstanding_invoices, show_history, client_id, future_due_periods, currency_conversion, history_frequency_interval, end_date, currency_code, start_date, response_limit, invoice_ids, customer_id].hash
    end
