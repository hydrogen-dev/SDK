...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createOrUpdateBillPayment operation.
     * @callback module:api/AccountingApi~createOrUpdateBillPaymentCallback
     ...
     * @param {module:api/AccountingApi~createOrUpdateBillPaymentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AccountingFinalResponseVO}
     */
    this.createOrUpdateBillPayment = function(nucleusInvoiceId, callback) {
      var postBody = null;

      // verify the required parameter 'nucleusInvoiceId' is set
      if (nucleusInvoiceId === undefined || nucleusInvoiceId === null) {
        throw new Error("Missing the required parameter 'nucleusInvoiceId' when calling createOrUpdateBillPayment");
      }
    ...
    /**
     * Callback function to receive the result of the createOrUpdateBills operation.
     * @callback module:api/AccountingApi~createOrUpdateBillsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AccountingFinalResponseVO} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AccountingApi~createOrUpdateBillsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AccountingFinalResponseVO}
     */
    this.createOrUpdateBills = function(nucleusContactId, startDate, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'nucleusContactId' is set
      if (nucleusContactId === undefined || nucleusContactId === null) {
        throw new Error("Missing the required parameter 'nucleusContactId' when calling createOrUpdateBills");
      }

      // verify the required parameter 'startDate' is set
      if (startDate === undefined || startDate === null) {
        throw new Error("Missing the required parameter 'startDate' when calling createOrUpdateBills");
      }
     ...
     * data is of type: {@link module:model/AccountingFinalResponseVO}
     */
    this.createOrUpdateCustomer = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     * data is of type: {@link module:model/AccountingFinalResponseVO}
     */
    this.createOrUpdateCustomerRevenue = function(nucleusContactId, startDate, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'nucleusContactId' is set
      if (nucleusContactId === undefined || nucleusContactId === null) {
        throw new Error("Missing the required parameter 'nucleusContactId' when calling createOrUpdateCustomerRevenue");
      }
     ...
     * data is of type: {@link module:model/AccountingFinalResponseVO}
     */
    this.createOrUpdateInvoices = function(nucleusContactId, startDate, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'nucleusContactId' is set
      if (nucleusContactId === undefined || nucleusContactId === null) {
        throw new Error("Missing the required parameter 'nucleusContactId' when calling createOrUpdateInvoices");
      }
    ...
    /**
     * Callback function to receive the result of the createOrUpdateSupplier operation.
     * @callback module:api/AccountingApi~createOrUpdateSupplierCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AccountingFinalResponseVO} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.nucleusBusinessId nucleus_business_id
     * @param {String} opts.nucleusClientId nucleus_client_id
     * @param {module:api/AccountingApi~createOrUpdateSupplierCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AccountingFinalResponseVO}
     */
    this.createOrUpdateSupplier = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.getAccountingVendorInfoUsingClientId = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getAccountingVendorInfoUsingClientId");
      }
    ...
    /**
     * Callback function to receive the result of the updateBill operation.
     * @callback module:api/AccountingApi~updateBillCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AccountingFinalResponseVO} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Update bill in Nucleus for a given nucleus_invoice_id
     * @param {String} nucleusInvoiceId nucleus_invoice_id
     * @param {module:api/AccountingApi~updateBillCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AccountingFinalResponseVO}
     */
    this.updateBill = function(nucleusInvoiceId, callback) {
      var postBody = null;

      // verify the required parameter 'nucleusInvoiceId' is set
      if (nucleusInvoiceId === undefined || nucleusInvoiceId === null) {
        throw new Error("Missing the required parameter 'nucleusInvoiceId' when calling updateBill");
      }
     ...
     * data is of type: {@link module:model/AccountingFinalResponseVO}
     */
    this.updateCustomer = function(nucleusContactId, callback) {
      var postBody = null;

      // verify the required parameter 'nucleusContactId' is set
      if (nucleusContactId === undefined || nucleusContactId === null) {
        throw new Error("Missing the required parameter 'nucleusContactId' when calling updateCustomer");
      }
     ...
     * @callback module:api/AccountingApi~updateSupplierCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AccountingFinalResponseVO} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Update supplier in Nucleus for a given nucleus_contact_id
     * @param {String} nucleusContactId nucleus_contact_id
     * @param {module:api/AccountingApi~updateSupplierCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AccountingFinalResponseVO}
     */
    this.updateSupplier = function(nucleusContactId, callback) {
      var postBody = null;

      // verify the required parameter 'nucleusContactId' is set
      if (nucleusContactId === undefined || nucleusContactId === null) {
        throw new Error("Missing the required parameter 'nucleusContactId' when calling updateSupplier");
      }
