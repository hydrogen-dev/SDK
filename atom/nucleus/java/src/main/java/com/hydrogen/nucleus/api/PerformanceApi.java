...
public class PerformanceApi {
    ...
    /**
     * Build call for getHouseholdClientPerformanceUsingGet
     * @param householdId Household Id -/household (required)
     * @param activePremiumPeriod Q (quarterly), Monthly (M) , Annually (Y), Daily (D) --caps matter, codes in () - (statId: 19, default: &#39;D&#39;) (optional)
     * @param annualizedReturnPeriod Q (quarterly), Monthly (M) , Annually (Y), Daily (D) --caps matter, codes in () - (statId: 19, default: &#39;D&#39;) (optional)
     * @param benchmarkId Client Benchmark or Tenant Benchmark id -/benchmark (optional)
     * @param endDate end date (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getHouseholdClientPerformanceUsingGetCall(UUID householdId, String activePremiumPeriod, String annualizedReturnPeriod, UUID benchmarkId, LocalDate endDate, Double histFactor, Double marDownSideDeviation, Double maxPercentileMonteCarlo, Double meanPercentileMonteCarlo, Double minPercentileMonteCarlo, Integer movingAverageNDay, Integer nDayReturns, Integer nPathMonteCarlo, Integer nRollingMaxDrawdown, Integer nRollingVolatility, Integer numSimMonteCarlo, String periodType, Double riskFreeAlpha, Double riskFreeSharpe, Double riskFreeSortino, Double riskFreeTreynor, LocalDate startDate, String stat, Double varConfInterval, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/household/{household_id}/performance"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getHouseholdClientPerformanceUsingGetValidateBeforeCall(UUID householdId, String activePremiumPeriod, String annualizedReturnPeriod, UUID benchmarkId, LocalDate endDate, Double histFactor, Double marDownSideDeviation, Double maxPercentileMonteCarlo, Double meanPercentileMonteCarlo, Double minPercentileMonteCarlo, Integer movingAverageNDay, Integer nDayReturns, Integer nPathMonteCarlo, Integer nRollingMaxDrawdown, Integer nRollingVolatility, Integer numSimMonteCarlo, String periodType, Double riskFreeAlpha, Double riskFreeSharpe, Double riskFreeSortino, Double riskFreeTreynor, LocalDate startDate, String stat, Double varConfInterval, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'householdId' is set
        if (householdId == null) {
            throw new ApiException("Missing the required parameter 'householdId' when calling getHouseholdClientPerformanceUsingGet(Async)");
        }
        

        com.squareup.okhttp.Call call = getHouseholdClientPerformanceUsingGetCall(householdId, activePremiumPeriod, annualizedReturnPeriod, benchmarkId, endDate, histFactor, marDownSideDeviation, maxPercentileMonteCarlo, meanPercentileMonteCarlo, minPercentileMonteCarlo, movingAverageNDay, nDayReturns, nPathMonteCarlo, nRollingMaxDrawdown, nRollingVolatility, numSimMonteCarlo, periodType, riskFreeAlpha, riskFreeSharpe, riskFreeSortino, riskFreeTreynor, startDate, stat, varConfInterval, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object getHouseholdClientPerformanceUsingGet(UUID householdId, String activePremiumPeriod, String annualizedReturnPeriod, UUID benchmarkId, LocalDate endDate, Double histFactor, Double marDownSideDeviation, Double maxPercentileMonteCarlo, Double meanPercentileMonteCarlo, Double minPercentileMonteCarlo, Integer movingAverageNDay, Integer nDayReturns, Integer nPathMonteCarlo, Integer nRollingMaxDrawdown, Integer nRollingVolatility, Integer numSimMonteCarlo, String periodType, Double riskFreeAlpha, Double riskFreeSharpe, Double riskFreeSortino, Double riskFreeTreynor, LocalDate startDate, String stat, Double varConfInterval) throws ApiException {
        ApiResponse<Object> resp = getHouseholdClientPerformanceUsingGetWithHttpInfo(householdId, activePremiumPeriod, annualizedReturnPeriod, benchmarkId, endDate, histFactor, marDownSideDeviation, maxPercentileMonteCarlo, meanPercentileMonteCarlo, minPercentileMonteCarlo, movingAverageNDay, nDayReturns, nPathMonteCarlo, nRollingMaxDrawdown, nRollingVolatility, numSimMonteCarlo, periodType, riskFreeAlpha, riskFreeSharpe, riskFreeSortino, riskFreeTreynor, startDate, stat, varConfInterval);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> getHouseholdClientPerformanceUsingGetWithHttpInfo(UUID householdId, String activePremiumPeriod, String annualizedReturnPeriod, UUID benchmarkId, LocalDate endDate, Double histFactor, Double marDownSideDeviation, Double maxPercentileMonteCarlo, Double meanPercentileMonteCarlo, Double minPercentileMonteCarlo, Integer movingAverageNDay, Integer nDayReturns, Integer nPathMonteCarlo, Integer nRollingMaxDrawdown, Integer nRollingVolatility, Integer numSimMonteCarlo, String periodType, Double riskFreeAlpha, Double riskFreeSharpe, Double riskFreeSortino, Double riskFreeTreynor, LocalDate startDate, String stat, Double varConfInterval) throws ApiException {
        com.squareup.okhttp.Call call = getHouseholdClientPerformanceUsingGetValidateBeforeCall(householdId, activePremiumPeriod, annualizedReturnPeriod, benchmarkId, endDate, histFactor, marDownSideDeviation, maxPercentileMonteCarlo, meanPercentileMonteCarlo, minPercentileMonteCarlo, movingAverageNDay, nDayReturns, nPathMonteCarlo, nRollingMaxDrawdown, nRollingVolatility, numSimMonteCarlo, periodType, riskFreeAlpha, riskFreeSharpe, riskFreeSortino, riskFreeTreynor, startDate, stat, varConfInterval, null, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Household Performance (asynchronously)
     * Get information on the performance of a Household using IRR (Internal Rate of Return). You must provide the unique household_id.
     * @param householdId Household Id -/household (required)
     * @param activePremiumPeriod Q (quarterly), Monthly (M) , Annually (Y), Daily (D) --caps matter, codes in () - (statId: 19, default: &#39;D&#39;) (optional)
     * @param annualizedReturnPeriod Q (quarterly), Monthly (M) , Annually (Y), Daily (D) --caps matter, codes in () - (statId: 19, default: &#39;D&#39;) (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getHouseholdClientPerformanceUsingGetAsync(UUID householdId, String activePremiumPeriod, String annualizedReturnPeriod, UUID benchmarkId, LocalDate endDate, Double histFactor, Double marDownSideDeviation, Double maxPercentileMonteCarlo, Double meanPercentileMonteCarlo, Double minPercentileMonteCarlo, Integer movingAverageNDay, Integer nDayReturns, Integer nPathMonteCarlo, Integer nRollingMaxDrawdown, Integer nRollingVolatility, Integer numSimMonteCarlo, String periodType, Double riskFreeAlpha, Double riskFreeSharpe, Double riskFreeSortino, Double riskFreeTreynor, LocalDate startDate, String stat, Double varConfInterval, final ApiCallback<Object> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call getPortfolioPerformanceUsingGetValidateBeforeCall(UUID portfolioId, String activePremiumPeriod, String annualizedReturnPeriod, UUID benchmarkId, LocalDate endDate, Double histFactor, Double marDownSideDeviation, Double maxPercentileMonteCarlo, Double meanPercentileMonteCarlo, Double minPercentileMonteCarlo, Integer movingAverageNDay, Integer nDayReturns, Integer nPathMonteCarlo, Integer nRollingMaxDrawdown, Integer nRollingVolatility, Integer numSimMonteCarlo, String periodType, Double riskFreeAlpha, Double riskFreeSharpe, Double riskFreeSortino, Double riskFreeTreynor, LocalDate startDate, String stat, Double varConfInterval, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioPerformanceUsingGetCall(portfolioId, activePremiumPeriod, annualizedReturnPeriod, benchmarkId, endDate, histFactor, marDownSideDeviation, maxPercentileMonteCarlo, meanPercentileMonteCarlo, minPercentileMonteCarlo, movingAverageNDay, nDayReturns, nPathMonteCarlo, nRollingMaxDrawdown, nRollingVolatility, numSimMonteCarlo, periodType, riskFreeAlpha, riskFreeSharpe, riskFreeSortino, riskFreeTreynor, startDate, stat, varConfInterval, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object getPortfolioPerformanceUsingGet(UUID portfolioId, String activePremiumPeriod, String annualizedReturnPeriod, UUID benchmarkId, LocalDate endDate, Double histFactor, Double marDownSideDeviation, Double maxPercentileMonteCarlo, Double meanPercentileMonteCarlo, Double minPercentileMonteCarlo, Integer movingAverageNDay, Integer nDayReturns, Integer nPathMonteCarlo, Integer nRollingMaxDrawdown, Integer nRollingVolatility, Integer numSimMonteCarlo, String periodType, Double riskFreeAlpha, Double riskFreeSharpe, Double riskFreeSortino, Double riskFreeTreynor, LocalDate startDate, String stat, Double varConfInterval) throws ApiException {
        ApiResponse<Object> resp = getPortfolioPerformanceUsingGetWithHttpInfo(portfolioId, activePremiumPeriod, annualizedReturnPeriod, benchmarkId, endDate, histFactor, marDownSideDeviation, maxPercentileMonteCarlo, meanPercentileMonteCarlo, minPercentileMonteCarlo, movingAverageNDay, nDayReturns, nPathMonteCarlo, nRollingMaxDrawdown, nRollingVolatility, numSimMonteCarlo, periodType, riskFreeAlpha, riskFreeSharpe, riskFreeSortino, riskFreeTreynor, startDate, stat, varConfInterval);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioPerformanceUsingGetAsync(UUID portfolioId, String activePremiumPeriod, String annualizedReturnPeriod, UUID benchmarkId, LocalDate endDate, Double histFactor, Double marDownSideDeviation, Double maxPercentileMonteCarlo, Double meanPercentileMonteCarlo, Double minPercentileMonteCarlo, Integer movingAverageNDay, Integer nDayReturns, Integer nPathMonteCarlo, Integer nRollingMaxDrawdown, Integer nRollingVolatility, Integer numSimMonteCarlo, String periodType, Double riskFreeAlpha, Double riskFreeSharpe, Double riskFreeSortino, Double riskFreeTreynor, LocalDate startDate, String stat, Double varConfInterval, final ApiCallback<Object> callback) throws ApiException {
