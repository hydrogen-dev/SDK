...
module AtomApi
  class CashFlowAnalysisPayload
    ...
    def hash
      [client_id, start_date, end_date, benchmark_start_date, benchmark_end_date, currency_code, show_history, show_spending_details].hash
    end
