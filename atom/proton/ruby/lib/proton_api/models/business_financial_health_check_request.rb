...
module ProtonApi
  class BusinessFinancialHealthCheckRequest
    ...
    def hash
      [period_month, period_quarter, client_id, total_liabilities, total_revenue, accounting_method, ratio_targets, period_length, currency_conversion, period_type, period_year, total_assets, currency_code, net_income, total_equity].hash
    end
