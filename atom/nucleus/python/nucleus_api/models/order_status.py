...
class OrderStatus(object):
    ...
    def __init__(self, create_date=None, description=None, id=None, metadata=None, secondary_id=None, status=None, update_date=None, _configuration=None):  # noqa: E501
