  ...
  describe('(package)', function() {
    describe('GetCardStatementResponseVO', function() {
      ...
      it('should create an instance of GetCardStatementResponseVO', function() {
        // TODO: update the code to test GetCardStatementResponseVO
      ...
      it('should have the property endingBalance (base name: "ending_balance")', function() {
        // TODO: update the code to test the property endingBalance
        expect(instance).to.have.property('endingBalance');
        // expect(instance.endingBalance).to.be(expectedValueLiteral);
      });
