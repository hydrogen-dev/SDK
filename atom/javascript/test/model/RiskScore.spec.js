...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.RiskScore();
  });
  ...
  describe('RiskScore', function() {
    it('should create an instance of RiskScore', function() {
      // uncomment below and update the code to test RiskScore
      //var instance = new atom_api.RiskScore();
      //expect(instance).to.be.a(atom_api.RiskScore);
    });
