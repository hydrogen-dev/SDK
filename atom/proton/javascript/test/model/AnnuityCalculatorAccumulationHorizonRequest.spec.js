...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnnuityCalculatorAccumulationHorizonRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.AnnuityCalculatorAccumulationHorizonRequest();
      });

      it('should create an instance of AnnuityCalculatorAccumulationHorizonRequest', function() {
        // TODO: update the code to test AnnuityCalculatorAccumulationHorizonRequest
        expect(instance).to.be.a(HydrogenProtonApi.AnnuityCalculatorAccumulationHorizonRequest);
      });
