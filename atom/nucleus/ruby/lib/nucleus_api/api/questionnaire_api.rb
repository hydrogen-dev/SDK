...
module NucleusApi
  class QuestionnaireApi
    ...
    def create_client_response_using_post_with_http_info(client_response, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuestionnaireApi.create_client_response_using_post ...'
      end
      # verify the required parameter 'client_response' is set
      if @api_client.config.client_side_validation && client_response.nil?
        fail ArgumentError, "Missing the required parameter 'client_response' when calling QuestionnaireApi.create_client_response_using_post"
      end
      # resource path
      local_var_path = '/client_response'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuestionnaireApi#create_client_response_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Create a question
    ...
    def delete_answer_using_delete_with_http_info(answer_id, opts = {})
      ...
      # resource path
      local_var_path = '/answer/{answer_id}'.sub('{' + 'answer_id' + '}', answer_id.to_s)
    ...
    def delete_client_response_using_delete_with_http_info(client_response_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuestionnaireApi.delete_client_response_using_delete ...'
      end
      ...
      if @api_client.config.client_side_validation && client_response_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_response_id' when calling QuestionnaireApi.delete_client_response_using_delete"
      end
      # resource path
      local_var_path = '/client_response/{client_response_id}'.sub('{' + 'client_response_id' + '}', client_response_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuestionnaireApi#delete_client_response_using_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Delete a question
    ...
    def delete_question_using_delete_with_http_info(question_id, opts = {})
      ...
      # resource path
      local_var_path = '/question/{question_id}'.sub('{' + 'question_id' + '}', question_id.to_s)
    ...
    def delete_questionnaire_using_delete_with_http_info(questionnaire_id, opts = {})
      ...
      # resource path
      local_var_path = '/questionnaire/{questionnaire_id}'.sub('{' + 'questionnaire_id' + '}', questionnaire_id.to_s)
    ...
    def get_client_response_all_using_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuestionnaireApi.get_client_response_all_using_get ...'
      end
      # resource path
      local_var_path = '/client_response'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuestionnaireApi#get_client_response_all_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_client_response_using_get_with_http_info(client_response_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuestionnaireApi.get_client_response_using_get ...'
      end
      # verify the required parameter 'client_response_id' is set
      if @api_client.config.client_side_validation && client_response_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_response_id' when calling QuestionnaireApi.get_client_response_using_get"
      end
      # resource path
      local_var_path = '/client_response/{client_response_id}'.sub('{' + 'client_response_id' + '}', client_response_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ClientResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuestionnaireApi#get_client_response_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # List all Questions
    ...
    def update_client_response_using_put_with_http_info(client_response, client_response_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuestionnaireApi.update_client_response_using_put ...'
      end
      # verify the required parameter 'client_response' is set
      if @api_client.config.client_side_validation && client_response.nil?
        fail ArgumentError, "Missing the required parameter 'client_response' when calling QuestionnaireApi.update_client_response_using_put"
      end
      # verify the required parameter 'client_response_id' is set
      if @api_client.config.client_side_validation && client_response_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_response_id' when calling QuestionnaireApi.update_client_response_using_put"
      end
      # resource path
      local_var_path = '/client_response/{client_response_id}'.sub('{' + 'client_response_id' + '}', client_response_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ClientResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuestionnaireApi#update_client_response_using_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Update a question.
