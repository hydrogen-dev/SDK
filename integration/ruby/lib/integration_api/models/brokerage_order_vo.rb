...
module IntegrationApi
  class BrokerageOrderVO
    attr_accessor :message

    attr_accessor :nucleus_order_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nucleus_order_id')
        self.nucleus_order_id = attributes[:'nucleus_order_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          message == o.message &&
          nucleus_order_id == o.nucleus_order_id &&
