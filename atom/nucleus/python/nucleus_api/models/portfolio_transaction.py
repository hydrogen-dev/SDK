...
class PortfolioTransaction(object):
    ...
    def __init__(self, account_id=None, amount=None, balance=None, category=None, create_date=None, currency_code=None, _date=None, date_available=None, description=None, id=None, is_read=None, location=None, memo=None, merchant=None, model_id=None, portfolio_id=None, price=None, quantity=None, secondary_id=None, security_id=None, status=None, subcategory=None, transaction_code_id=None, update_date=None):  # noqa: E501
