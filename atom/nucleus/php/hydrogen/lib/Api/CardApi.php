...
class CardApi
{
    ...
    {
        list($response) = $this->createCardUsingPostWithHttpInfo($card_request, $authorization);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCardUsingPostAsync($card_request, $authorization = null)
    {
        return $this->createCardUsingPostAsyncWithHttpInfo($card_request, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createCardUsingPostRequest($card_request, $authorization = null)
    {
