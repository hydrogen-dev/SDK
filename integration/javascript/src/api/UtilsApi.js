...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateUserRequest', 'model/ExchangePublicTokenVO', 'model/ExchangeTokenCO', 'model/UserResponseVO', 'model/WidgetUrlVO'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateUserRequest'), require('../model/ExchangePublicTokenVO'), require('../model/ExchangeTokenCO'), require('../model/UserResponseVO'), require('../model/WidgetUrlVO'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenIntegrationApi) {
      root.HydrogenIntegrationApi = {};
    }
    root.HydrogenIntegrationApi.UtilsApi = factory(root.HydrogenIntegrationApi.ApiClient, root.HydrogenIntegrationApi.CreateUserRequest, root.HydrogenIntegrationApi.ExchangePublicTokenVO, root.HydrogenIntegrationApi.ExchangeTokenCO, root.HydrogenIntegrationApi.UserResponseVO, root.HydrogenIntegrationApi.WidgetUrlVO);
  }
}(this, function(ApiClient, CreateUserRequest, ExchangePublicTokenVO, ExchangeTokenCO, UserResponseVO, WidgetUrlVO) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getWidgetLinkUsingGet = function(nucleusClientId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'nucleusClientId' is set
      if (nucleusClientId === undefined || nucleusClientId === null) {
        throw new Error("Missing the required parameter 'nucleusClientId' when calling getWidgetLinkUsingGet");
      }
