...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageTransactionCode();
  });
  ...
  describe('PageTransactionCode', function() {
    it('should create an instance of PageTransactionCode', function() {
      // uncomment below and update the code to test PageTransactionCode
      //var instane = new HydrogenNucleusApi.PageTransactionCode();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageTransactionCode);
    });
