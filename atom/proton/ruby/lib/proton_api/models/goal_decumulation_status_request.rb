...
module ProtonApi
  class GoalDecumulationStatusRequest
    ...
    def hash
      [client_id, adjust_for_compounding, compounding_rate, horizon_frequency, conf_tgt, d_horizon, trading_days_per_year, withdrawal_tax, thresh_type, recommend_type, goal_id, deposit_config, n, recommendation_config, thresh, a_horizon, withdrawal_config, curr_inv, p_ret, p_risk, remove_outliers].hash
    end
