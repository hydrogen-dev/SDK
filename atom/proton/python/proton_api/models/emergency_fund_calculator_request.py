...
class EmergencyFundCalculatorRequest(object):
    ...
    def __init__(self, telecom_payments=0.0, frequency_unit='month', debt_payments=0.0, lookback_periods=3, emergency_fund_duration=None, housing_cost=0.0, insurance_payments=0.0, interest_rate=0.0, other_expenses=None, client_id=None, current_emergency_fund_balance=0.0, aggregation_account_ids=None, account_ids=None, utility_payments=0.0, savings_horizon=None, food_costs=0.0, transportation_costs=0.0):  # noqa: E501
