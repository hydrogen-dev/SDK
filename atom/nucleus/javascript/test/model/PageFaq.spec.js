...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageFaq();
  });
  ...
  describe('PageFaq', function() {
    it('should create an instance of PageFaq', function() {
      // uncomment below and update the code to test PageFaq
      //var instane = new HydrogenNucleusApi.PageFaq();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageFaq);
    });
