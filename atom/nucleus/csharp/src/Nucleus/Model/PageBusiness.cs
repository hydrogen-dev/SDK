...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageBusiness :  IEquatable<PageBusiness>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageBusiness" /> class.
        /// </summary>
        ...
        public PageBusiness(List<Business> content = default(List<Business>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Business> Content { get; set; }
        ...
        {
            return this.Equals(input as PageBusiness);
        }

        /// <summary>
        /// Returns true if PageBusiness instances are equal
        /// </summary>
        /// <param name="input">Instance of PageBusiness to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageBusiness input)
        {
            if (input == null)
                return false;
