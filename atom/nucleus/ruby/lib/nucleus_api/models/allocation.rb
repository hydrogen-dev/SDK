...
module NucleusApi
  ...
  class Allocation
    ...
    def hash
      [benchmark_id, category, client_id, create_date, description, id, inception_date, is_active, metadata, name, node_map, performance, secondary_id, update_date, volatility].hash
    end
