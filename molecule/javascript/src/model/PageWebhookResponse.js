...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Sort', 'model/WebhookResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Sort'), require('./WebhookResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.MoleculeApiDocumentation) {
      root.MoleculeApiDocumentation = {};
    }
    root.MoleculeApiDocumentation.PageWebhookResponse = factory(root.MoleculeApiDocumentation.ApiClient, root.MoleculeApiDocumentation.Sort, root.MoleculeApiDocumentation.WebhookResponse);
  }
}(this, function(ApiClient, Sort, WebhookResponse) {
  'use strict';
