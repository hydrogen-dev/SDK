...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageQuestionnaire :  IEquatable<PageQuestionnaire>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageQuestionnaire" /> class.
        /// </summary>
        ...
        public PageQuestionnaire(List<Questionnaire> content = default(List<Questionnaire>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Questionnaire> Content { get; set; }
        ...
        {
            return this.Equals(input as PageQuestionnaire);
        }

        /// <summary>
        /// Returns true if PageQuestionnaire instances are equal
        /// </summary>
        /// <param name="input">Instance of PageQuestionnaire to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageQuestionnaire input)
        {
            if (input == null)
                return false;
