...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AccountAllocationPayload();
  });
  ...
  describe('AccountAllocationPayload', function() {
    it('should create an instance of AccountAllocationPayload', function() {
      // uncomment below and update the code to test AccountAllocationPayload
      //var instance = new atom_api.AccountAllocationPayload();
      //expect(instance).to.be.a(atom_api.AccountAllocationPayload);
    });
