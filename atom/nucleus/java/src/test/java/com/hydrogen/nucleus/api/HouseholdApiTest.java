...
public class HouseholdApiTest {
    ...
    public void getHouseholdClientHoldingUsingGetTest() throws ApiException {
        ...
        Boolean getLatest = null;
        LocalDate startDate = null;
        List<PortfolioHoldingAgg> response = api.getHouseholdClientHoldingUsingGet(householdId, currencyConversion, endDate, getLatest, startDate);
    ...
    public void getHouseholdClientTransactionUsingGetTest() throws ApiException {
        ...
        Integer size = null;
        LocalDate startDate = null;
        PagePortfolioTransaction response = api.getHouseholdClientTransactionUsingGet(householdId, ascending, currencyConversion, endDate, orderBy, page, size, startDate);
