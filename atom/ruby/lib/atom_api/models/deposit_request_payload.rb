...
module AtomApi
  class DepositRequestPayload
    ...
    def hash
      [account_id, amount, funding_id, invested_date, account_number, comments, direction, last_request_date, received_date, status, status_time_stamp, type, secondary_id].hash
    end
