...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.CardLoadUnloadResponseVO();
  });
  ...
  describe('CardLoadUnloadResponseVO', function() {
    it('should create an instance of CardLoadUnloadResponseVO', function() {
      // uncomment below and update the code to test CardLoadUnloadResponseVO
      //var instane = new HydrogenIntegrationApi.CardLoadUnloadResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.CardLoadUnloadResponseVO);
    });
