...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PortfolioAssetSizeLog', 'model/Sort'], factory);
  ...
  /**
   * The PagePortfolioAssetSizeLog model module.
   * @module model/PagePortfolioAssetSizeLog
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PagePortfolioAssetSizeLog</code>.
   * Page Object
   * @alias module:model/PagePortfolioAssetSizeLog
   * @class
   */
  ...
  /**
   * Constructs a <code>PagePortfolioAssetSizeLog</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePortfolioAssetSizeLog} obj Optional instance to populate.
   * @return {module:model/PagePortfolioAssetSizeLog} The populated <code>PagePortfolioAssetSizeLog</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PortfolioAssetSizeLog]);
      }
  ...
  /**
   * @member {Array.<module:model/PortfolioAssetSizeLog>} content
   */
