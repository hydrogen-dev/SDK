...
module NucleusApi
  ...
  class Accounting
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stat_date')
        self.stat_date = attributes[:'stat_date']
      end
    ...
    def list_invalid_properties
      ...
      if @stat_date.nil?
        invalid_properties.push('invalid value for "stat_date", stat_date cannot be nil.')
      end
      ...
      if @stat_value.nil?
        invalid_properties.push('invalid value for "stat_value", stat_value cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @stat_date.nil?
      return false if @stat_name.nil?
      return false if @stat_value.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          stat_date == o.stat_date &&
          stat_name == o.stat_name &&
          stat_value == o.stat_value &&
    ...
    def hash
      [client_id, create_date, currency_code, id, metadata, period_type, period_year, secondary_id, stat_date, stat_name, stat_value, update_date].hash
    end
