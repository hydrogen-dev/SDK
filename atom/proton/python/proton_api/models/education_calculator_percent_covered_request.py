...
class EducationCalculatorPercentCoveredRequest(object):
    ...
    def __init__(self, decumulation_horizon=None, deposit_schedule=None, initial_balance=0.0, portfolio_return=None, education_inflation_rate=0.05, tax_rate=0.0, aggregation_account_ids=None, total_annual_cost=None, account_ids=None, accumulation_horizon=None, general_inflation_rate=0.0):  # noqa: E501
