...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.GoalTrackPayload();
  });
  ...
  describe('GoalTrackPayload', function() {
    it('should create an instance of GoalTrackPayload', function() {
      // uncomment below and update the code to test GoalTrackPayload
      //var instance = new atom_api.GoalTrackPayload();
      //expect(instance).to.be.a(atom_api.GoalTrackPayload);
    });
