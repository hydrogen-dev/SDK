...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenTransferResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.TokenTransferResponse();
      });

      it('should create an instance of TokenTransferResponse', function() {
        // TODO: update the code to test TokenTransferResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.TokenTransferResponse);
      });
