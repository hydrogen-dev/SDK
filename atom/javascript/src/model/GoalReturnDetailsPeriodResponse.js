...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.GoalReturnDetailsPeriodResponse = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The GoalReturnDetailsPeriodResponse model module.
   * @module model/GoalReturnDetailsPeriodResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GoalReturnDetailsPeriodResponse</code>.
   * @alias module:model/GoalReturnDetailsPeriodResponse
   * @class
   * @param periodEarnings {Number} The investment earnings for this period.
   * @param periodDeposit {Number} The deposit made for this period in the accumulation phase.
   ...
   * @param cumulativeDeposits {Number} The cumulative deposits made up to and including this period for the decumulation phase.
   ...
   */
  var exports = function(periodEarnings, periodDeposit, periodWithdrawal, cumulativeEarnings, cumulativeDeposits, cumulativeWithdrawals, endingBalance) {
    var _this = this;

    _this['period_earnings'] = periodEarnings;
    _this['period_deposit'] = periodDeposit;
    _this['period_withdrawal'] = periodWithdrawal;
    _this['cumulative_earnings'] = cumulativeEarnings;
    _this['cumulative_deposits'] = cumulativeDeposits;
    _this['cumulative_withdrawals'] = cumulativeWithdrawals;
    _this['ending_balance'] = endingBalance;
  };

  /**
   * Constructs a <code>GoalReturnDetailsPeriodResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GoalReturnDetailsPeriodResponse} obj Optional instance to populate.
   * @return {module:model/GoalReturnDetailsPeriodResponse} The populated <code>GoalReturnDetailsPeriodResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('period_deposit')) {
        obj['period_deposit'] = ApiClient.convertToType(data['period_deposit'], 'Number');
      }
      ...
      if (data.hasOwnProperty('cumulative_deposits')) {
        obj['cumulative_deposits'] = ApiClient.convertToType(data['cumulative_deposits'], 'Number');
      }
   ...
   * @member {Number} period_deposit
   */
  exports.prototype['period_deposit'] = undefined;
  /**
   ...
   * @member {Number} cumulative_deposits
   */
  exports.prototype['cumulative_deposits'] = undefined;
  /**
