...
module ProtonApi
  class EventStudyRequest
    ...
    def hash
      [events, use_proxy_data, portfolio_tickers, model_id, allocation_id, account_id, portfolio_id, portfolio_weights, aggregation_account_id, market_data_source].hash
    end
