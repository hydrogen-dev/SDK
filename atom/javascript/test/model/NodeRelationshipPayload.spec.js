...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.NodeRelationshipPayload();
  });
  ...
  describe('NodeRelationshipPayload', function() {
    it('should create an instance of NodeRelationshipPayload', function() {
      // uncomment below and update the code to test NodeRelationshipPayload
      //var instance = new atom_api.NodeRelationshipPayload();
      //expect(instance).to.be.a(atom_api.NodeRelationshipPayload);
    });
