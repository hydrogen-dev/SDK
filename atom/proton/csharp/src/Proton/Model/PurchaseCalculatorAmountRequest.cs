...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseCalculatorAmountRequest :  IEquatable<PurchaseCalculatorAmountRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseCalculatorAmountRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PurchaseCalculatorAmountRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseCalculatorAmountRequest" /> class.
        /// </summary>
        ...
        public PurchaseCalculatorAmountRequest(List<Guid?> accountIds = default(List<Guid?>), HorizonFrequencyIntervalEnum? horizonFrequencyInterval = HorizonFrequencyIntervalEnum.Year, int? purchaseHorizon = default(int?), float? investmentTax = 0.0F, float? portfolioReturn = default(float?), CalculatorDepositSchedule1 depositSchedule = default(CalculatorDepositSchedule1), float? currentSavings = 0.0F, float? inflationRate = 0.0F, List<Guid?> aggregationAccountIds = default(List<Guid?>))
        {
            // to ensure "purchaseHorizon" is required (not null)
            if (purchaseHorizon == null)
            {
                throw new InvalidDataException("purchaseHorizon is a required property for PurchaseCalculatorAmountRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioReturn is a required property for PurchaseCalculatorAmountRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PurchaseCalculatorAmountRequest);
        }

        /// <summary>
        /// Returns true if PurchaseCalculatorAmountRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseCalculatorAmountRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseCalculatorAmountRequest input)
        {
            if (input == null)
                return false;
