...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageEscrowTransactionResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageEscrowTransactionResponse();
      });

      it('should create an instance of PageEscrowTransactionResponse', function() {
        // TODO: update the code to test PageEscrowTransactionResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageEscrowTransactionResponse);
      });
