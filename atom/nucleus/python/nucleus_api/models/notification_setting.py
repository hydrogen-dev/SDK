...
class NotificationSetting(object):
    ...
    def __init__(self, client_id=None, create_date=None, frequency=None, frequency_unit=None, id=None, is_receive=None, last_run_date=None, metadata=None, notification_id=None, secondary_id=None, threshold_value=None, update_date=None, _configuration=None):  # noqa: E501
