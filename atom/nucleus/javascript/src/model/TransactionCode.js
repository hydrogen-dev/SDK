...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_buy')) {
        obj['is_buy'] = ApiClient.convertToType(data['is_buy'], 'String');
      }
      if (data.hasOwnProperty('is_deposit')) {
        obj['is_deposit'] = ApiClient.convertToType(data['is_deposit'], 'String');
      }
      if (data.hasOwnProperty('is_fee')) {
        obj['is_fee'] = ApiClient.convertToType(data['is_fee'], 'String');
      }
      if (data.hasOwnProperty('is_transfer')) {
        obj['is_transfer'] = ApiClient.convertToType(data['is_transfer'], 'String');
      }
  ...
  /**
   * @member {module:model/TransactionCode.IsBuyEnum} is_buy
   */
  exports.prototype['is_buy'] = undefined;
  /**
   * @member {module:model/TransactionCode.IsDepositEnum} is_deposit
   */
  exports.prototype['is_deposit'] = undefined;
  /**
   * @member {module:model/TransactionCode.IsFeeEnum} is_fee
   */
  exports.prototype['is_fee'] = undefined;
  /**
   * @member {module:model/TransactionCode.IsTransferEnum} is_transfer
   */
  ...
  /**
   * Allowed values for the <code>is_buy</code> property.
   * @enum {String}
   * @readonly
   */
  exports.IsBuyEnum = {
  ...
  /**
   * Allowed values for the <code>is_deposit</code> property.
   * @enum {String}
   * @readonly
   */
  exports.IsDepositEnum = {
    /**
     * value: "true"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>is_fee</code> property.
   * @enum {String}
   * @readonly
   */
  exports.IsFeeEnum = {
  ...
  /**
   * Allowed values for the <code>is_transfer</code> property.
   * @enum {String}
   * @readonly
   */
