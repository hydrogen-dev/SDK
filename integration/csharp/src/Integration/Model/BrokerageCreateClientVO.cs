...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrokerageCreateClientVO :  IEquatable<BrokerageCreateClientVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerageCreateClientVO" /> class.
        /// </summary>
        ...
        public BrokerageCreateClientVO(string message = default(string), Guid? nucleusClientId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as BrokerageCreateClientVO);
        }

        /// <summary>
        /// Returns true if BrokerageCreateClientVO instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerageCreateClientVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerageCreateClientVO input)
        {
            if (input == null)
                return false;
