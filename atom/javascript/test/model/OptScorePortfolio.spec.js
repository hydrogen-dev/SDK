...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.OptScorePortfolio();
  });
  ...
  describe('OptScorePortfolio', function() {
    it('should create an instance of OptScorePortfolio', function() {
      // uncomment below and update the code to test OptScorePortfolio
      //var instance = new atom_api.OptScorePortfolio();
      //expect(instance).to.be.a(atom_api.OptScorePortfolio);
    });
