...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageModelComment();
  });
  ...
  describe('PageModelComment', function() {
    it('should create an instance of PageModelComment', function() {
      // uncomment below and update the code to test PageModelComment
      //var instane = new HydrogenNucleusApi.PageModelComment();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageModelComment);
    });
