...
public class ScoreApi {
    ...
    /**
     * Build call for createScoreUsingPost1
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createScoreUsingPost1Call(UUID scoreId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createScoreUsingPost1ValidateBeforeCall(UUID scoreId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'scoreId' is set
        if (scoreId == null) {
            throw new ApiException("Missing the required parameter 'scoreId' when calling createScoreUsingPost1(Async)");
        }
        

        com.squareup.okhttp.Call call = createScoreUsingPost1Call(scoreId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Score createScoreUsingPost1(UUID scoreId) throws ApiException {
        ApiResponse<Score> resp = createScoreUsingPost1WithHttpInfo(scoreId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Score> createScoreUsingPost1WithHttpInfo(UUID scoreId) throws ApiException {
        com.squareup.okhttp.Call call = createScoreUsingPost1ValidateBeforeCall(scoreId, null, null);
        Type localVarReturnType = new TypeToken<Score>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createScoreUsingPost1Async(UUID scoreId, final ApiCallback<Score> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createScoreUsingPost1ValidateBeforeCall(scoreId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Score>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
