...
# Unit tests for ProtonApi::AnnuityCalculatorAccumulationHorizonRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnnuityCalculatorAccumulationHorizonRequest' do
  before do
    # run before each test
    @instance = ProtonApi::AnnuityCalculatorAccumulationHorizonRequest.new
  end
  ...
  describe 'test an instance of AnnuityCalculatorAccumulationHorizonRequest' do
    it 'should create an instance of AnnuityCalculatorAccumulationHorizonRequest' do
      expect(@instance).to be_instance_of(ProtonApi::AnnuityCalculatorAccumulationHorizonRequest)
    end
  end
