...
module AtomApi
  class AggregationAccountApi
    ...
    def delete_aggregation_account_transaction_using_delete(aggregation_account_transaction_id, opts = {})
      data, _status_code, _headers = delete_aggregation_account_transaction_using_delete_with_http_info(aggregation_account_transaction_id, opts)
      data
    end
    ...
    # @param aggregation_account_id UUID aggregation_account_id
    # @param [Hash] opts the optional parameters
    # @return [Array<(AggregationAccountAggregateDataVO, Fixnum, Hash)>] AggregationAccountAggregateDataVO data, response status code and response headers
    def get_aggregation_account_aggregate_data_using_get_with_http_info(aggregation_account_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'AggregationAccountAggregateDataVO')
      if @api_client.config.debugging
    ...
    # @param client_id UUID client_id
    # @param [Hash] opts the optional parameters
    # @return [Array<(AggregationDataForClientParentResponseVO, Fixnum, Hash)>] AggregationDataForClientParentResponseVO data, response status code and response headers
    def get_aggregation_account_overview_using_get_with_http_info(client_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'AggregationDataForClientParentResponseVO')
      if @api_client.config.debugging
