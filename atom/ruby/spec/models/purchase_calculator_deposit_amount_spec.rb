...
# Unit tests for AtomApi::PurchaseCalculatorDepositAmount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseCalculatorDepositAmount' do
  before do
    # run before each test
    @instance = AtomApi::PurchaseCalculatorDepositAmount.new
  end
  ...
  describe 'test an instance of PurchaseCalculatorDepositAmount' do
    it 'should create an instance of PurchaseCalculatorDepositAmount' do
      expect(@instance).to be_instance_of(AtomApi::PurchaseCalculatorDepositAmount)
    end
  end
