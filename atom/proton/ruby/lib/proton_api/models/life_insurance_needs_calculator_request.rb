...
module ProtonApi
  class LifeInsuranceNeedsCalculatorRequest
    ...
    def hash
      [existing_life_insurance, mortgage_balance, general_inflation_rate, education_inflation_rate, client_id, beneficiary_bequest_config, liquid_assets, end_of_life_expenses, interest_rate, children_education_config, income_config, tax_rate, margin_of_error, benefit_amount_rounding, other_debt].hash
    end
