...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrokerageBankLinkVO :  IEquatable<BrokerageBankLinkVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerageBankLinkVO" /> class.
        /// </summary>
        ...
        public BrokerageBankLinkVO(string message = default(string), Guid? nucleusBankLinkId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorRequestData = default(Object), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as BrokerageBankLinkVO);
        }

        /// <summary>
        /// Returns true if BrokerageBankLinkVO instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerageBankLinkVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerageBankLinkVO input)
        {
            if (input == null)
                return false;
