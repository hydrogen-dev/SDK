...
# Unit tests for AtomApi::AnnuityCalculatorAnnuityAmount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnnuityCalculatorAnnuityAmount' do
  before do
    # run before each test
    @instance = AtomApi::AnnuityCalculatorAnnuityAmount.new
  end
  ...
  describe 'test an instance of AnnuityCalculatorAnnuityAmount' do
    it 'should create an instance of AnnuityCalculatorAnnuityAmount' do
      expect(@instance).to be_instance_of(AtomApi::AnnuityCalculatorAnnuityAmount)
    end
  end
