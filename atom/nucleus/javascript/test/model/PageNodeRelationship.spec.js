...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageNodeRelationship();
  });
  ...
  describe('PageNodeRelationship', function() {
    it('should create an instance of PageNodeRelationship', function() {
      ...
      //var instane = new HydrogenAtomApi.PageNodeRelationship();
      //expect(instance).to.be.a(HydrogenAtomApi.PageNodeRelationship);
    });
