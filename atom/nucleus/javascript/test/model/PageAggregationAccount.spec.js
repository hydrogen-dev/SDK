...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAggregationAccount();
  });
  ...
  describe('PageAggregationAccount', function() {
    it('should create an instance of PageAggregationAccount', function() {
      // uncomment below and update the code to test PageAggregationAccount
      //var instane = new HydrogenNucleusApi.PageAggregationAccount();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAggregationAccount);
    });
