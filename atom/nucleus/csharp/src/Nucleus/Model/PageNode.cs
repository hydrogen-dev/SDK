...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageNode :  IEquatable<PageNode>, IValidatableObject
    {
        /// <summary>
        ...
        public PageNode(List<Node> content = default(List<Node>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        {
            return this.Equals(input as PageNode);
        }

        /// <summary>
        /// Returns true if PageNode instances are equal
        /// </summary>
        /// <param name="input">Instance of PageNode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageNode input)
        {
            if (input == null)
                return false;
