...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageOrderTrack :  IEquatable<PageOrderTrack>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageOrderTrack" /> class.
        /// </summary>
        ...
        public PageOrderTrack(List<OrderTrack> content = default(List<OrderTrack>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<OrderTrack> Content { get; set; }
        ...
        {
            return this.Equals(input as PageOrderTrack);
        }

        /// <summary>
        /// Returns true if PageOrderTrack instances are equal
        /// </summary>
        /// <param name="input">Instance of PageOrderTrack to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageOrderTrack input)
        {
            if (input == null)
                return false;
