...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageSupportTicket();
  });
  ...
  describe('PageSupportTicket', function() {
    it('should create an instance of PageSupportTicket', function() {
      // uncomment below and update the code to test PageSupportTicket
      //var instane = new HydrogenNucleusApi.PageSupportTicket();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageSupportTicket);
    });
