...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.ChangeModelCompositionResponseInner();
  });
  ...
  describe('ChangeModelCompositionResponseInner', function() {
    it('should create an instance of ChangeModelCompositionResponseInner', function() {
      // uncomment below and update the code to test ChangeModelCompositionResponseInner
      //var instance = new atom_api.ChangeModelCompositionResponseInner();
      //expect(instance).to.be.a(atom_api.ChangeModelCompositionResponseInner);
    });
