...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.AggregationAccount();
  });
  ...
  describe('AggregationAccount', function() {
    it('should create an instance of AggregationAccount', function() {
      ...
      //var instane = new HydrogenAtomApi.AggregationAccount();
      //expect(instance).to.be.a(HydrogenAtomApi.AggregationAccount);
    });
