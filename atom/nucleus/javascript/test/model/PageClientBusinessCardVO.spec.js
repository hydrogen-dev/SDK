...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageClientBusinessCardVO();
  });
  ...
  describe('PageClientBusinessCardVO', function() {
    it('should create an instance of PageClientBusinessCardVO', function() {
      // uncomment below and update the code to test PageClientBusinessCardVO
      //var instane = new HydrogenNucleusApi.PageClientBusinessCardVO();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageClientBusinessCardVO);
    });
