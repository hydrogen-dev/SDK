...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AnnuityDepositamountResponse();
  });
  ...
  describe('AnnuityDepositamountResponse', function() {
    it('should create an instance of AnnuityDepositamountResponse', function() {
      // uncomment below and update the code to test AnnuityDepositamountResponse
      //var instance = new atom_api.AnnuityDepositamountResponse();
      //expect(instance).to.be.a(atom_api.AnnuityDepositamountResponse);
    });
