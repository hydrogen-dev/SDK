...
class RoundupCO(object):
    ...
    def __init__(self, funding_start_date=None, roundup_setting_id=None, transaction_end_date=None, transaction_start_date=None, update_transactions=None, _configuration=None):  # noqa: E501
    ...
    def funding_start_date(self, funding_start_date):
        ...
        :type: date
        """
        if self._configuration.client_side_validation and funding_start_date is None:
    ...
    def transaction_start_date(self, transaction_start_date):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and transaction_start_date is None:
