...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaasBusinessVO :  IEquatable<BaasBusinessVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaasBusinessVO" /> class.
        /// </summary>
        ...
        public BaasBusinessVO(string message = default(string), Guid? nucleusBusinessId = default(Guid?), List<Guid?> nucleusDocumentId = default(List<Guid?>), string status = default(string), string vendorName = default(string), BusinessVendorRequestDataVO vendorRequestData = default(BusinessVendorRequestDataVO), Object vendorResponse = default(Object))
        {
        ...
        public List<Guid?> NucleusDocumentId { get; set; }
        ...
        public BusinessVendorRequestDataVO VendorRequestData { get; set; }
        ...
        {
            return this.Equals(input as BaasBusinessVO);
        }

        /// <summary>
        /// Returns true if BaasBusinessVO instances are equal
        /// </summary>
        /// <param name="input">Instance of BaasBusinessVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaasBusinessVO input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.NucleusDocumentId.SequenceEqual(input.NucleusDocumentId)
                ) && 
                (
