...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.BulkOrderClientPayload = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The BulkOrderClientPayload model module.
   * @module model/BulkOrderClientPayload
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>BulkOrderClientPayload</code>.
   * @alias module:model/BulkOrderClientPayload
   * @class
  ...
  /**
   * Constructs a <code>BulkOrderClientPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BulkOrderClientPayload} obj Optional instance to populate.
   * @return {module:model/BulkOrderClientPayload} The populated <code>BulkOrderClientPayload</code> instance.
   */
