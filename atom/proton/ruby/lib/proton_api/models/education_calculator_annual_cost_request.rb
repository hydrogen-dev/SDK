...
module ProtonApi
  class EducationCalculatorAnnualCostRequest
    ...
    def hash
      [general_inflation_rate, education_inflation_rate, deposit_schedule, portfolio_return, aggregation_account_ids, initial_balance, decumulation_horizon, tax_rate, account_ids, percent_of_costs_covered, accumulation_horizon].hash
    end
