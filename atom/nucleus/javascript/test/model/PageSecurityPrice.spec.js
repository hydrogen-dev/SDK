...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageSecurityPrice();
  });
  ...
  describe('PageSecurityPrice', function() {
    it('should create an instance of PageSecurityPrice', function() {
      // uncomment below and update the code to test PageSecurityPrice
      //var instane = new HydrogenNucleusApi.PageSecurityPrice();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageSecurityPrice);
    });
