...
module NucleusApi
  ...
  class PortfolioTransaction
    ...
    def hash
      [account_id, amount, balance, category, create_date, currency_code, date, date_available, description, id, is_read, location, memo, merchant, model_id, portfolio_id, price, quantity, secondary_id, security_id, status, subcategory, transaction_code_id, update_date].hash
    end
