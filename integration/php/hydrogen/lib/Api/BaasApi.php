...
class BaasApi
{
     ...
     *
     * @param  \com\hydrogen\integration\Model\BaasClientCO $baas_client_co baasClientCO (required)
     *
     * @throws \com\hydrogen\integration\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \com\hydrogen\integration\Model\BaasClientVO
     */
    public function updateBaasClientUsingPut($baas_client_co)
    {
        list($response) = $this->updateBaasClientUsingPutWithHttpInfo($baas_client_co);
        return $response;
    }
     ...
     * @return array of \com\hydrogen\integration\Model\BaasClientVO, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateBaasClientUsingPutWithHttpInfo($baas_client_co)
    {
        $returnType = '\com\hydrogen\integration\Model\BaasClientVO';
        $request = $this->updateBaasClientUsingPutRequest($baas_client_co);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBaasClientUsingPutAsync($baas_client_co)
    {
        return $this->updateBaasClientUsingPutAsyncWithHttpInfo($baas_client_co)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBaasClientUsingPutAsyncWithHttpInfo($baas_client_co)
    {
        $returnType = '\com\hydrogen\integration\Model\BaasClientVO';
        $request = $this->updateBaasClientUsingPutRequest($baas_client_co);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateBaasClientUsingPutRequest($baas_client_co)
    {
        // verify the required parameter 'baas_client_co' is set
        if ($baas_client_co === null || (is_array($baas_client_co) && count($baas_client_co) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $baas_client_co when calling updateBaasClientUsingPut'
            );
        }
