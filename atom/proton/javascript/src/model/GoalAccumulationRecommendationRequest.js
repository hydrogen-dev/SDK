...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccumulationGoalDepositConfig', 'model/GoalConfig', 'model/RecommendationConfig1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccumulationGoalDepositConfig'), require('./GoalConfig'), require('./RecommendationConfig1'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenProtonApi) {
      root.HydrogenProtonApi = {};
    }
    root.HydrogenProtonApi.GoalAccumulationRecommendationRequest = factory(root.HydrogenProtonApi.ApiClient, root.HydrogenProtonApi.AccumulationGoalDepositConfig, root.HydrogenProtonApi.GoalConfig, root.HydrogenProtonApi.RecommendationConfig1);
  }
}(this, function(ApiClient, AccumulationGoalDepositConfig, GoalConfig, RecommendationConfig1) {
  'use strict';
   ...
   */
  var exports = function(pRisk, pRet) {
    this.pRisk = pRisk;
    this.pRet = pRet;
  };
