...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AvailableDateDoubleVO', 'model/Household', 'model/PageHousehold', 'model/PagePortfolioTransaction', 'model/PortfolioHoldingAgg'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AvailableDateDoubleVO'), require('../model/Household'), require('../model/PageHousehold'), require('../model/PagePortfolioTransaction'), require('../model/PortfolioHoldingAgg'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.HouseholdApi = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.AvailableDateDoubleVO, root.HydrogenNucleusApi.Household, root.HydrogenNucleusApi.PageHousehold, root.HydrogenNucleusApi.PagePortfolioTransaction, root.HydrogenNucleusApi.PortfolioHoldingAgg);
  }
}(this, function(ApiClient, AvailableDateDoubleVO, Household, PageHousehold, PagePortfolioTransaction, PortfolioHoldingAgg) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.getHouseholdClientAssetSizeUsingGet = function(householdId, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/household/{household_id}/asset_size', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getHouseholdClientHoldingUsingGet = function(householdId, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/household/{household_id}/holding', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getHouseholdClientTransactionUsingGet = function(householdId, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/household/{household_id}/transaction', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
