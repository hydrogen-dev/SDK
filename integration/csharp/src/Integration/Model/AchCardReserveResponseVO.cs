...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchCardReserveResponseVO :  IEquatable<AchCardReserveResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchCardReserveResponseVO" /> class.
        /// </summary>
        ...
        public AchCardReserveResponseVO(string message = default(string), Guid? nucleusFundingId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as AchCardReserveResponseVO);
        }

        /// <summary>
        /// Returns true if AchCardReserveResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchCardReserveResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchCardReserveResponseVO input)
        {
            if (input == null)
                return false;
