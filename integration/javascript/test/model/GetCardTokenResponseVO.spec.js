...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCardTokenResponseVO', function() {
      beforeEach(function() {
        instance = new HydrogenIntegrationApi.GetCardTokenResponseVO();
      });

      it('should create an instance of GetCardTokenResponseVO', function() {
        // TODO: update the code to test GetCardTokenResponseVO
        expect(instance).to.be.a(HydrogenIntegrationApi.GetCardTokenResponseVO);
      });
      ...
      it('should have the property panReference (base name: "pan_reference")', function() {
        // TODO: update the code to test the property panReference
        expect(instance).to.have.property('panReference');
        // expect(instance.panReference).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property tokenReference (base name: "token_reference")', function() {
        // TODO: update the code to test the property tokenReference
        expect(instance).to.have.property('tokenReference');
        // expect(instance.tokenReference).to.be(expectedValueLiteral);
      });
