...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Pagination', 'model/PaginationSort', 'model/SpecificOrderResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Pagination'), require('./PaginationSort'), require('./SpecificOrderResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.GetOrderResponse = factory(root.atom_api.ApiClient, root.atom_api.Pagination, root.atom_api.PaginationSort, root.atom_api.SpecificOrderResponse);
  }
}(this, function(ApiClient, Pagination, PaginationSort, SpecificOrderResponse) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [SpecificOrderResponse]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/SpecificOrderResponse>} content
   */
