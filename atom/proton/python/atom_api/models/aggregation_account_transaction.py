...
class AggregationAccountTransaction(object):
    ...
    def __init__(self, aggregation_account_id=None, bank_credit=None, cash=None, create_date=None, currency_code=None, id=None, investment=None, is_excluded_analysis=None, is_recurring=None, metadata=None, secondary_id=None, status=None, transaction_date=None, update_date=None):  # noqa: E501
