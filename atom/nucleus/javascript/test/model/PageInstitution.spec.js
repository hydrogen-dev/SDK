...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageInstitution();
  });
  ...
  describe('PageInstitution', function() {
    it('should create an instance of PageInstitution', function() {
      // uncomment below and update the code to test PageInstitution
      //var instane = new HydrogenNucleusApi.PageInstitution();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageInstitution);
    });
