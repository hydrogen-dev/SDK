...
module AtomApi
  class PortfolioRebalanceSellOnlyOrderPayload
    ...
    def hash
      [sell_transaction_code_id, buy_transaction_code_id, cash_sec_id, commit_orders, non_fractional, port_threshold, restrictions_on, buy_threshold, sell_threshold, use_strategic].hash
    end
