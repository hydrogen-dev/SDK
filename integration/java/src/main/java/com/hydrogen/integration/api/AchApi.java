...
public class AchApi {
    ...
    /**
     * Build call for getBusinessBalanceUsingGet
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getBusinessBalanceUsingGetCall(UUID businessId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getBusinessBalanceUsingGetValidateBeforeCall(UUID businessId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'businessId' is set
        if (businessId == null) {
            throw new ApiException("Missing the required parameter 'businessId' when calling getBusinessBalanceUsingGet(Async)");
        }
        

        com.squareup.okhttp.Call call = getBusinessBalanceUsingGetCall(businessId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AchBalanceResponseVO getBusinessBalanceUsingGet(UUID businessId) throws ApiException {
        ApiResponse<AchBalanceResponseVO> resp = getBusinessBalanceUsingGetWithHttpInfo(businessId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AchBalanceResponseVO> getBusinessBalanceUsingGetWithHttpInfo(UUID businessId) throws ApiException {
        com.squareup.okhttp.Call call = getBusinessBalanceUsingGetValidateBeforeCall(businessId, null, null);
        Type localVarReturnType = new TypeToken<AchBalanceResponseVO>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getBusinessBalanceUsingGetAsync(UUID businessId, final ApiCallback<AchBalanceResponseVO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBusinessBalanceUsingGetValidateBeforeCall(businessId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AchBalanceResponseVO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
