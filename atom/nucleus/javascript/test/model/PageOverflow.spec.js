...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageOverflow();
  });
  ...
  describe('PageOverflow', function() {
    it('should create an instance of PageOverflow', function() {
      // uncomment below and update the code to test PageOverflow
      //var instane = new HydrogenNucleusApi.PageOverflow();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageOverflow);
    });
