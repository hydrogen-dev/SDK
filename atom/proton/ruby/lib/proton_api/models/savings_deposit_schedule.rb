...
module ProtonApi
  class SavingsDepositSchedule
    ...
    def list_invalid_properties
      ...
      if !@deposit_duration.nil? && @deposit_duration < 1
        invalid_properties.push('invalid value for "deposit_duration", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@deposit_duration.nil? && @deposit_duration < 1
      true
    end
    ...
    def deposit_duration=(deposit_duration)
      if !deposit_duration.nil? && deposit_duration < 1
        fail ArgumentError, 'invalid value for "deposit_duration", must be greater than or equal to 1.'
      end
    ...
    def hash
      [deposit_frequency_interval, deposit_amount, deposit_duration, adjust_deposit_for_inflation].hash
    end
