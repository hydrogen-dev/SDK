...
module AtomApi
  class FinancialPictureResponseSnapshotByCategory
    ...
    attr_accessor :latest_balance_time_stamp
    ...
    def self.swagger_types
      {
        :'category' => :'String',
        :'balance' => :'Float',
        :'latest_balance_time_stamp' => :'String',
        :'subcategories' => :'Array<FinancialPictureResponseSnapshotSubcategories>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'latest_balance_time_stamp')
        self.latest_balance_time_stamp = attributes[:'latest_balance_time_stamp']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          category == o.category &&
          balance == o.balance &&
          latest_balance_time_stamp == o.latest_balance_time_stamp &&
    ...
    def hash
      [category, balance, latest_balance_time_stamp, subcategories].hash
    end
