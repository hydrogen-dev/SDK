...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageModelAssetSize();
  });
  ...
  describe('PageModelAssetSize', function() {
    it('should create an instance of PageModelAssetSize', function() {
      // uncomment below and update the code to test PageModelAssetSize
      //var instane = new HydrogenNucleusApi.PageModelAssetSize();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageModelAssetSize);
    });
