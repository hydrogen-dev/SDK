...
class MonteCarloRequest(object):
    ...
    def __init__(self, sigma=None, max_bal=None, allocation_id=None, account_id=None, result_type='raw', aggregation_account_id=None, market_data_source='nucleus', max_sample=None, portfolio_id=None, mu=None, frequency_interval='year', ret_mod=None, min_sample=None, n=1000, cf=None, model_id=None, use_proxy_data=False, init_bal=None, remove_outliers=False, min_bal=None, p=None):  # noqa: E501
