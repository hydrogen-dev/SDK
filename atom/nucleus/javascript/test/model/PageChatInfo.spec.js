...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageChatInfo();
  });
  ...
  describe('PageChatInfo', function() {
    it('should create an instance of PageChatInfo', function() {
      // uncomment below and update the code to test PageChatInfo
      //var instane = new HydrogenNucleusApi.PageChatInfo();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageChatInfo);
    });
