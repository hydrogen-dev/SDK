...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageWebhookResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageWebhookResponse();
      });

      it('should create an instance of PageWebhookResponse', function() {
        // TODO: update the code to test PageWebhookResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageWebhookResponse);
      });
