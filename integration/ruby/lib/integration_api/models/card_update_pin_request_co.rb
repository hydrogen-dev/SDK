...
module IntegrationApi
  class CardUpdatePinRequestCO
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'current_pin')
        self.current_pin = attributes[:'current_pin']
      end
    ...
    def hash
      [current_pin, new_pin, reason, vendor_request].hash
    end
