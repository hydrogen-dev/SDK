...
class QuestionnaireApi
{
    ...
    protected function deleteClientResponseUsingDeleteRequest($client_response_id)
    {
        ...
        $resourcePath = '/client_response/{client_response_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteQuestionUsingDeleteRequest($question_id)
    {
        ...
        $resourcePath = '/question/{question_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteQuestionnaireUsingDeleteRequest($questionnaire_id)
    {
        ...
        $resourcePath = '/questionnaire/{questionnaire_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
