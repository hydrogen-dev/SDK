...
module AtomApi
  class CreateAggregationAccountBalanceResponse
    ...
    def hash
      [id, aggregation_account_id, currency_code, balance, available_balance, balance_time_stamp, is_active, secondary_id, create_date].hash
    end
