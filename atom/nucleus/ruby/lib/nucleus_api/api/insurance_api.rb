...
module NucleusApi
  class InsuranceApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_insurance_quote_using_delete(insurance_quote_id, opts = {})
      delete_insurance_quote_using_delete_with_http_info(insurance_quote_id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def delete_insurance_quote_using_delete_with_http_info(insurance_quote_id, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [String] :currency_conversion USD
    # @return [InsuranceQuote]
    def get_insurance_quote_using_get(insurance_quote_id, opts = {})
      data, _status_code, _headers = get_insurance_quote_using_get_with_http_info(insurance_quote_id, opts)
      data
    end
    ...
    # @option opts [String] :currency_conversion USD
    # @return [Array<(InsuranceQuote, Fixnum, Hash)>] InsuranceQuote data, response status code and response headers
    def get_insurance_quote_using_get_with_http_info(insurance_quote_id, opts = {})
      if @api_client.config.debugging
