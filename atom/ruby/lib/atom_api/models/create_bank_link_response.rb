...
module AtomApi
  class CreateBankLinkResponse
    ...
    def hash
      [account_id, bank_account_holder, bank_account_number, name, routing, routing_wire, mask, bank_account_name, client_id, currency_code, balance, available_balance, type, is_active, is_link_verified, link_verified_date, metadata, secondary_id, id, create_date].hash
    end
