...
class FundingRequestPayload(object):
    ...
    def __init__(self, account_id=None, funding_type=None, funding_status=None, frequency_unit=None, is_deposit=None, start_date=None, end_date=None, frequency=None, description=None, amount=None, bank_link_id=None, transfer_id=None, support_ticket_id=None, is_active=True, metadata=None, secondary_id=None):  # noqa: E501
