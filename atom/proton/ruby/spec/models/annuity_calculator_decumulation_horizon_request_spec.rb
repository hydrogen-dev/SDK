...
# Unit tests for ProtonApi::AnnuityCalculatorDecumulationHorizonRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnnuityCalculatorDecumulationHorizonRequest' do
  before do
    # run before each test
    @instance = ProtonApi::AnnuityCalculatorDecumulationHorizonRequest.new
  end
  ...
  describe 'test an instance of AnnuityCalculatorDecumulationHorizonRequest' do
    it 'should create an instance of AnnuityCalculatorDecumulationHorizonRequest' do
      expect(@instance).to be_instance_of(ProtonApi::AnnuityCalculatorDecumulationHorizonRequest)
    end
  end
