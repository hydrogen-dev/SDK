...
module AtomApi
  class SpecificAggregationAccountHoldingResponse
    ...
    def hash
      [id, create_date, aggregation_account_id, currency_code, ticker, ticker_name, shares, amount, holding_type, asset_class, price, cost_basis, exchange, cusip, secondary_id, metadata, update_date].hash
    end
