...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardUnloadRequestCO :  IEquatable<CardUnloadRequestCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardUnloadRequestCO" /> class.
        /// </summary>
        /// <param name="nucleusFundingId">nucleusFundingId.</param>
        /// <param name="reason">reason.</param>
        public CardUnloadRequestCO(Guid? nucleusFundingId = default(Guid?), string reason = default(string))
        {
        ...
        {
            return this.Equals(input as CardUnloadRequestCO);
        }

        /// <summary>
        /// Returns true if CardUnloadRequestCO instances are equal
        /// </summary>
        /// <param name="input">Instance of CardUnloadRequestCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardUnloadRequestCO input)
        {
            if (input == null)
                return false;
