...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AllocationHoldingsResponseInner();
  });
  ...
  describe('AllocationHoldingsResponseInner', function() {
    it('should create an instance of AllocationHoldingsResponseInner', function() {
      // uncomment below and update the code to test AllocationHoldingsResponseInner
      //var instance = new atom_api.AllocationHoldingsResponseInner();
      //expect(instance).to.be.a(atom_api.AllocationHoldingsResponseInner);
    });
