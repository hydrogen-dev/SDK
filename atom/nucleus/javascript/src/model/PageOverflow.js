...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Overflow', 'model/Sort'], factory);
  ...
  /**
   * The PageOverflow model module.
   * @module model/PageOverflow
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageOverflow</code>.
   * Page Object
   * @alias module:model/PageOverflow
   * @class
   */
  ...
  /**
   * Constructs a <code>PageOverflow</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageOverflow} obj Optional instance to populate.
   * @return {module:model/PageOverflow} The populated <code>PageOverflow</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Overflow]);
      }
  ...
  /**
   * @member {Array.<module:model/Overflow>} content
   */
