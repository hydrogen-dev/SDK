...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageNode();
  });
  ...
  describe('PageNode', function() {
    it('should create an instance of PageNode', function() {
      // uncomment below and update the code to test PageNode
      //var instane = new HydrogenNucleusApi.PageNode();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageNode);
    });
