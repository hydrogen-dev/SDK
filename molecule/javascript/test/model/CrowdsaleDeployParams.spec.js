...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CrowdsaleDeployParams', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.CrowdsaleDeployParams();
      });

      it('should create an instance of CrowdsaleDeployParams', function() {
        // TODO: update the code to test CrowdsaleDeployParams
        expect(instance).to.be.a(MoleculeApiDocumentation.CrowdsaleDeployParams);
      });
