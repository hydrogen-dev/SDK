...
class GoalApi
{
     ...
     * @return void
     */
    public function deleteGoalTrackUsingDelete($goal_track_id, $goal_track_id2)
    {
        $this->deleteGoalTrackUsingDeleteWithHttpInfo($goal_track_id, $goal_track_id2);
    }
     ...
     */
    public function deleteGoalTrackUsingDeleteWithHttpInfo($goal_track_id, $goal_track_id2)
    {
        $returnType = '';
        $request = $this->deleteGoalTrackUsingDeleteRequest($goal_track_id, $goal_track_id2);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteGoalTrackUsingDeleteAsync($goal_track_id, $goal_track_id2)
    {
        return $this->deleteGoalTrackUsingDeleteAsyncWithHttpInfo($goal_track_id, $goal_track_id2)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteGoalTrackUsingDeleteAsyncWithHttpInfo($goal_track_id, $goal_track_id2)
    {
        $returnType = '';
        $request = $this->deleteGoalTrackUsingDeleteRequest($goal_track_id, $goal_track_id2);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteGoalTrackUsingDeleteRequest($goal_track_id, $goal_track_id2)
    {
        ...
        // verify the required parameter 'goal_track_id2' is set
        if ($goal_track_id2 === null || (is_array($goal_track_id2) && count($goal_track_id2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $goal_track_id2 when calling deleteGoalTrackUsingDelete'
            );
        }
        ...
        // path params
        if ($goal_track_id2 !== null) {
            $resourcePath = str_replace(
                '{' . 'goal_track_id' . '}',
                ObjectSerializer::toPathValue($goal_track_id2),
                $resourcePath
            );
        }
    ...
    {
        list($response) = $this->getGoalAssetSizeAllUsingGetWithHttpInfo($client_id, $goal_id, $end_date, $get_latest, $portfolio_goal, $sort_type, $start_date);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGoalAssetSizeAllUsingGetAsync($client_id, $goal_id, $end_date = null, $get_latest = 'false', $portfolio_goal = 'false', $sort_type = null, $start_date = null)
    {
        return $this->getGoalAssetSizeAllUsingGetAsyncWithHttpInfo($client_id, $goal_id, $end_date, $get_latest, $portfolio_goal, $sort_type, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGoalAssetSizeAllUsingGetRequest($client_id, $goal_id, $end_date = null, $get_latest = 'false', $portfolio_goal = 'false', $sort_type = null, $start_date = null)
    {
    ...
    {
        list($response) = $this->getGoalHoldingAllUsingGetWithHttpInfo($client_id, $goal_id, $end_date, $portfolio_goal, $start_date);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGoalHoldingAllUsingGetAsync($client_id, $goal_id, $end_date = null, $portfolio_goal = 'false', $start_date = null)
    {
        return $this->getGoalHoldingAllUsingGetAsyncWithHttpInfo($client_id, $goal_id, $end_date, $portfolio_goal, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGoalHoldingAllUsingGetRequest($client_id, $goal_id, $end_date = null, $portfolio_goal = 'false', $start_date = null)
    {
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->getGoalTrackUsingGetWithHttpInfo($goal_track_id, $goal_track_id2);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGoalTrackUsingGetAsync($goal_track_id, $goal_track_id2)
    {
        return $this->getGoalTrackUsingGetAsyncWithHttpInfo($goal_track_id, $goal_track_id2)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGoalTrackUsingGetRequest($goal_track_id, $goal_track_id2)
    {
        // verify the required parameter 'goal_track_id' is set
        if ($goal_track_id === null || (is_array($goal_track_id) && count($goal_track_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($goal_track_id2 === null || (is_array($goal_track_id2) && count($goal_track_id2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $goal_track_id2 when calling getGoalTrackUsingGet'
            );
        }
    ...
    {
        list($response) = $this->getGoalTransactionAllUsingGetWithHttpInfo($client_id, $goal_id, $ascending, $end_date, $order_by, $page, $portfolio_goal, $size, $start_date);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGoalTransactionAllUsingGetAsync($client_id, $goal_id, $ascending = 'false', $end_date = null, $order_by = 'update_date', $page = '0', $portfolio_goal = 'false', $size = '25', $start_date = null)
    {
        return $this->getGoalTransactionAllUsingGetAsyncWithHttpInfo($client_id, $goal_id, $ascending, $end_date, $order_by, $page, $portfolio_goal, $size, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGoalTransactionAllUsingGetRequest($client_id, $goal_id, $ascending = 'false', $end_date = null, $order_by = 'update_date', $page = '0', $portfolio_goal = 'false', $size = '25', $start_date = null)
    {
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
