...
module AtomApi
  class NucleusApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [PerformanceResponse]
    def get_allocation_performance(allocation_id, opts = {})
      data, _status_code, _headers = get_allocation_performance_with_http_info(allocation_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PerformanceResponse, Fixnum, Hash)>] PerformanceResponse data, response status code and response headers
    def get_allocation_performance_with_http_info(allocation_id, opts = {})
      if @api_client.config.debugging
