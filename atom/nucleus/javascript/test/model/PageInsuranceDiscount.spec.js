...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageInsuranceDiscount();
  });
  ...
  describe('PageInsuranceDiscount', function() {
    it('should create an instance of PageInsuranceDiscount', function() {
      // uncomment below and update the code to test PageInsuranceDiscount
      //var instane = new HydrogenNucleusApi.PageInsuranceDiscount();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageInsuranceDiscount);
    });
