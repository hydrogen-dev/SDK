...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrokerageSecuritiesVO :  IEquatable<BrokerageSecuritiesVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerageSecuritiesVO" /> class.
        /// </summary>
        ...
        public BrokerageSecuritiesVO(string message = default(string), Guid? nucleusSecurityId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as BrokerageSecuritiesVO);
        }

        /// <summary>
        /// Returns true if BrokerageSecuritiesVO instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerageSecuritiesVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerageSecuritiesVO input)
        {
            if (input == null)
                return false;
