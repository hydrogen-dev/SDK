...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Address', 'model/CreateClientResponse', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Address'), require('./CreateClientResponse'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.SpecificClientResponse = factory(root.atom_api.ApiClient, root.atom_api.Address, root.atom_api.CreateClientResponse, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, Address, CreateClientResponse, SecondaryId) {
  'use strict';
  ...
  /**
   * The SpecificClientResponse model module.
   * @module model/SpecificClientResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>SpecificClientResponse</code>.
   * @alias module:model/SpecificClientResponse
   * @class
   * @implements module:model/CreateClientResponse
  ...
  var exports = function(username, clientType) {
    ...
    CreateClientResponse.call(_this, username, clientType);

  };

  /**
   * Constructs a <code>SpecificClientResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpecificClientResponse} obj Optional instance to populate.
   * @return {module:model/SpecificClientResponse} The populated <code>SpecificClientResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      CreateClientResponse.constructFromObject(data, obj);
  ...
  // Implement CreateClientResponse interface:
  /**
