...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.molecule_api.WalletUpdatePayload = factory(root.molecule_api.ApiClient, root.molecule_api.SecondaryId, root.molecule_api.WalletCreateClient, root.molecule_api.WalletCreateWhitelist);
  }
  ...
  /**
   * The WalletUpdatePayload model module.
   * @module model/WalletUpdatePayload
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>WalletUpdatePayload</code>.
   * @alias module:model/WalletUpdatePayload
   * @class
   */
  ...
  /**
   * Constructs a <code>WalletUpdatePayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WalletUpdatePayload} obj Optional instance to populate.
   * @return {module:model/WalletUpdatePayload} The populated <code>WalletUpdatePayload</code> instance.
   */
