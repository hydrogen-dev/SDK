...
class WireApi
{
    ...
    /**
     * Operation deleteBankLinkUsingDelete4
     *
     * Delete bank link
     *
     ...
     * @return \com\hydrogen\integration\Model\WireBankLinkResponseVO
     */
    public function deleteBankLinkUsingDelete4($nucleus_bank_link_id)
    {
        list($response) = $this->deleteBankLinkUsingDelete4WithHttpInfo($nucleus_bank_link_id);
        return $response;
    }

    /**
     * Operation deleteBankLinkUsingDelete4WithHttpInfo
     *
     * Delete bank link
     *
     * @param  string $nucleus_bank_link_id nucleus_bank_link_id (required)
     ...
     * @return array of \com\hydrogen\integration\Model\WireBankLinkResponseVO, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteBankLinkUsingDelete4WithHttpInfo($nucleus_bank_link_id)
    {
        $returnType = '\com\hydrogen\integration\Model\WireBankLinkResponseVO';
        $request = $this->deleteBankLinkUsingDelete4Request($nucleus_bank_link_id);
    ...
    /**
     * Operation deleteBankLinkUsingDelete4Async
     *
     * Delete bank link
     *
     * @param  string $nucleus_bank_link_id nucleus_bank_link_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteBankLinkUsingDelete4Async($nucleus_bank_link_id)
    {
        return $this->deleteBankLinkUsingDelete4AsyncWithHttpInfo($nucleus_bank_link_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteBankLinkUsingDelete4AsyncWithHttpInfo
     *
     * Delete bank link
     *
     * @param  string $nucleus_bank_link_id nucleus_bank_link_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteBankLinkUsingDelete4AsyncWithHttpInfo($nucleus_bank_link_id)
    {
        $returnType = '\com\hydrogen\integration\Model\WireBankLinkResponseVO';
        $request = $this->deleteBankLinkUsingDelete4Request($nucleus_bank_link_id);
    ...
    /**
     * Create request for operation 'deleteBankLinkUsingDelete4'
     *
     * @param  string $nucleus_bank_link_id nucleus_bank_link_id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteBankLinkUsingDelete4Request($nucleus_bank_link_id)
    {
        ...
        if ($nucleus_bank_link_id === null || (is_array($nucleus_bank_link_id) && count($nucleus_bank_link_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $nucleus_bank_link_id when calling deleteBankLinkUsingDelete4'
            );
        }
