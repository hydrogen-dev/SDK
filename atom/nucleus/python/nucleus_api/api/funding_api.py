...
class FundingApi(object):
    ...
    def delete_transfer_using_delete(self, transfer, transfer_id, **kwargs):  # noqa: E501
        """Delete a transfer request  # noqa: E501

        Permanently delete a external account transfer from a client account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_transfer_using_delete(transfer, transfer_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str transfer: UUID external_account_transfer_id (required)
        :param str transfer_id: transfer_id (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_transfer_using_delete_with_http_info(transfer, transfer_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_transfer_using_delete_with_http_info(transfer, transfer_id, **kwargs)  # noqa: E501
            return data

    def delete_transfer_using_delete_with_http_info(self, transfer, transfer_id, **kwargs):  # noqa: E501
        """Delete a transfer request  # noqa: E501

        Permanently delete a external account transfer from a client account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_transfer_using_delete_with_http_info(transfer, transfer_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('transfer' not in params or
            ...
            raise ValueError("Missing the required parameter `transfer` when calling `delete_transfer_using_delete`")  # noqa: E501
        ...
        if 'transfer' in params:
            path_params['transfer'] = params['transfer']  # noqa: E501
    ...
    def get_transfer_using_get(self, external_account_transfer_id, transfer_id, **kwargs):  # noqa: E501
        """Retrieve a transfer request  # noqa: E501

        Retrieve the information for a external account transfer for an account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transfer_using_get(external_account_transfer_id, transfer_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str external_account_transfer_id: UUID external_account_transfer_id (required)
        :param str transfer_id: transfer_id (required)
        :return: ExternalAccountTransfer
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_transfer_using_get_with_http_info(external_account_transfer_id, transfer_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_transfer_using_get_with_http_info(external_account_transfer_id, transfer_id, **kwargs)  # noqa: E501
            return data

    def get_transfer_using_get_with_http_info(self, external_account_transfer_id, transfer_id, **kwargs):  # noqa: E501
        """Retrieve a transfer request  # noqa: E501

        Retrieve the information for a external account transfer for an account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transfer_using_get_with_http_info(external_account_transfer_id, transfer_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['external_account_transfer_id', 'transfer_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('external_account_transfer_id' not in params or
                params['external_account_transfer_id'] is None):
            raise ValueError("Missing the required parameter `external_account_transfer_id` when calling `get_transfer_using_get`")  # noqa: E501
        # verify the required parameter 'transfer_id' is set
        if ('transfer_id' not in params or
                params['transfer_id'] is None):
        ...
        path_params = {}
        if 'external_account_transfer_id' in params:
            path_params['external_account_transfer_id'] = params['external_account_transfer_id']  # noqa: E501
        if 'transfer_id' in params:
            path_params['transfer_id'] = params['transfer_id']  # noqa: E501
