...
class BaasSubAccountVO(object):
    ...
    def __init__(self, account_number=None, account_status=None, message=None, nucleus_client_id=None, nucleus_portfolio_id=None, status=None, vendor_name=None, vendor_response=None, _configuration=None):  # noqa: E501
