...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient',  'api/AuthApi','model/Account', 'model/AccountAllocationMapping', 'model/AdminClient', 'model/PageAdminClient', 'api/AdminClientApi', 'model/AccountMap', 'model/AccountPermissionVO', 'model/AccountPortfolioRebalanceRequest', 'model/AccountStatus', 'model/AccountType', 'model/AclClientPermissionVO', 'model/AggregationAccount', 'model/AggregationAccountBalance', 'model/AggregationAccountHolding', 'model/AggregationAccountTransaction', 'model/AggregationAccountsMap', 'model/Allocation', 'model/AllocationAggregatedVO', 'model/AllocationComposition', 'model/AllocationCompositionAggregatedVO', 'model/AllocationCompositionModelHoldingsVO', 'model/AllocationNodeMap', 'model/Answer', 'model/AnswerMap', 'model/Application', 'model/AuditLog', 'model/AvailableDateDoubleVO', 'model/BankCredit', 'model/BankLink', 'model/BankLinkMap', 'model/Benchmark', 'model/BenchmarkComposition', 'model/Brokers', 'model/Budget', 'model/BudgetAggregationAccount', 'model/BudgetObject', 'model/BulkTransaction', 'model/BulkTransactionVO', 'model/Business', 'model/BusinessAddress', 'model/Card', 'model/CardAddress', 'model/CardProgram', 'model/Cash', 'model/CategoriesMap', 'model/CategoryInternalResponseVO', 'model/CategoryResponseVO', 'model/Check', 'model/CheckImages', 'model/Client', 'model/ClientAccountMapping', 'model/ClientAddress', 'model/ClientRelationship', 'model/ClientResponse', 'model/ClientStatus', 'model/ClientViewGoalData', 'model/Country', 'model/Currency', 'model/Customer', 'model/CustomerAddress', 'model/CustomerRevenue', 'model/DailyDeposit', 'model/DailyWithdrawal', 'model/DateDoubleVO', 'model/DecisionTree', 'model/DecisionTreeCO', 'model/DecisionTreeResultVO', 'model/Document', 'model/Employment', 'model/ExternalAccountTransfer', 'model/Feature', 'model/FeatureTrack', 'model/FinancialStatement', 'model/Funding', 'model/FundingRequestMap', 'model/FxRateView', 'model/Goal', 'model/GoalAccountMapping', 'model/GoalTrack', 'model/GoalTrackAccounts', 'model/Household', 'model/Investment', 'model/Invoice', 'model/InvoicePayment', 'model/JsonNode', 'model/LineItems', 'model/Location', 'model/MXMerchantRes', 'model/Member', 'model/MerchantCategoryCode', 'model/MerchantsMap', 'model/Model', 'model/ModelAssetSize', 'model/ModelComment', 'model/ModelHolding', 'model/ModelHoldingVO', 'model/ModelTransaction', 'model/Node', 'model/NodeRelationship', 'model/Notification', 'model/NotificationClient', 'model/NotificationSetting', 'model/Order', 'model/OrderBulk', 'model/OrderReconcileRequest', 'model/OrderReconcileReturnObject', 'model/OrderStatus', 'model/OrderTrack', 'model/OrderVoClone', 'model/Overflow', 'model/OverflowBankLinkMap', 'model/OverflowSettings', 'model/OverflowVO', 'model/Ownership', 'model/PageAccount', 'model/PageAccountAllocationMapping', 'model/PageAccountPermissionVO', 'model/PageAccountStatus', 'model/PageAccountType', 'model/PageAggregationAccount', 'model/PageAggregationAccountBalance', 'model/PageAggregationAccountHolding', 'model/PageAggregationAccountTransaction', 'model/PageAllocation', 'model/PageAllocationComposition', 'model/PageAnswer', 'model/PageApplication', 'model/PageAuditLog', 'model/PageBankLink', 'model/PageBenchmark', 'model/PageBudget', 'model/PageBusiness', 'model/PageCard', 'model/PageCardProgram', 'model/PageClient', 'model/PageClientResponse', 'model/PageClientStatus', 'model/PageCustomer', 'model/PageCustomerRevenue', 'model/PageDailyDeposit', 'model/PageDailyWithdrawal', 'model/PageDecisionTree', 'model/PageDocument', 'model/PageExternalAccountTransfer', 'model/PageFeature', 'model/PageFeatureTrack', 'model/PageFinancialStatement', 'model/PageFunding', 'model/PageGoal', 'model/PageGoalTrack', 'model/PageHousehold', 'model/PageInvoice', 'model/PageInvoicePayment', 'model/PageMXMerchantRes', 'model/PageModel', 'model/PageModelAssetSize', 'model/PageModelComment', 'model/PageModelHolding', 'model/PageModelTransaction', 'model/PageNode', 'model/PageNodeRelationship', 'model/PageNotification', 'model/PageNotificationClient', 'model/PageNotificationSetting', 'model/PageOrder', 'model/PageOrderBulk', 'model/PageOrderStatus', 'model/PageOrderTrack', 'model/PageOverflow', 'model/PageOverflowSettings', 'model/PagePortfolio', 'model/PagePortfolioAssetSizeLog', 'model/PagePortfolioComment', 'model/PagePortfolioGoal', 'model/PagePortfolioHoldingLog', 'model/PagePortfolioTransaction', 'model/PageQuestion', 'model/PageQuestionnaire', 'model/PageReasonCode', 'model/PageRiskProfile', 'model/PageRoundup', 'model/PageRoundupSettings', 'model/PageScore', 'model/PageSecurity', 'model/PageSecurityExclusion', 'model/PageSecurityPrice', 'model/PageSpendingControl', 'model/PageStage', 'model/PageTransactionCode', 'model/PageVAccountAssetSize', 'model/PageWebhook', 'model/PermissionVO', 'model/Portfolio', 'model/PortfolioAssetSizeLog', 'model/PortfolioComment', 'model/PortfolioGoal', 'model/PortfolioGoalMap', 'model/PortfolioHoldingAgg', 'model/PortfolioHoldingLog', 'model/PortfolioTransaction', 'model/Question', 'model/Questionnaire', 'model/ReasonCode', 'model/RiskProfile', 'model/Roundup', 'model/RoundupCO', 'model/RoundupSettings', 'model/Score', 'model/SecuritiesComposition', 'model/SecuritiesCountry', 'model/Security', 'model/SecurityCompositionVO', 'model/SecurityCountryVO', 'model/SecurityExclusion', 'model/SecurityPrice', 'model/Sort', 'model/SpendingControl', 'model/Stage', 'model/Stat', 'model/State', 'model/StatisticResourceVO', 'model/TokenDateRequest', 'model/TransactionCode', 'model/VAccountAssetSize', 'model/VAccountVO', 'model/VClientGoalViewData', 'model/VPortfolioVO', 'model/Webhook', 'api/AccountApi', 'api/AggregationAccountApi', 'api/AllocationApi', 'api/ApplicationApi', 'api/AuditLogApi', 'api/BenchmarkApi', 'api/BudgetApi', 'api/BulkApi', 'api/BusinessApi', 'api/CardApi', 'api/ClientApi', 'api/CustomerApi', 'api/DecisionTreeApi', 'api/DocumentApi', 'api/FeatureApi', 'api/FinancialStatementApi', 'api/FundingApi', 'api/GoalApi', 'api/HouseholdApi', 'api/InvoiceApi', 'api/ModelApi', 'api/NotificationApi', 'api/OrderApi', 'api/OverflowApi', 'api/PerformanceApi', 'api/PortfolioApi', 'api/QuestionnaireApi', 'api/ResourceApi', 'api/RiskProfileApi', 'api/RoundupApi', 'api/ScoreApi', 'api/SecuritiesApi', 'api/SpendingControlApi', 'api/UtilsApi', 'api/WebhookApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./api/AuthApi'), require('./model/AdminClient'), require('./model/PageAdminClient'), require('./api/AdminClientApi') ,require('./model/Account'), require('./model/AccountAllocationMapping'), require('./model/AccountMap'), require('./model/AccountPermissionVO'), require('./model/AccountPortfolioRebalanceRequest'), require('./model/AccountStatus'), require('./model/AccountType'), require('./model/AclClientPermissionVO'), require('./model/AggregationAccount'), require('./model/AggregationAccountBalance'), require('./model/AggregationAccountHolding'), require('./model/AggregationAccountTransaction'), require('./model/AggregationAccountsMap'), require('./model/Allocation'), require('./model/AllocationAggregatedVO'), require('./model/AllocationComposition'), require('./model/AllocationCompositionAggregatedVO'), require('./model/AllocationCompositionModelHoldingsVO'), require('./model/AllocationNodeMap'), require('./model/Answer'), require('./model/AnswerMap'), require('./model/Application'), require('./model/AuditLog'), require('./model/AvailableDateDoubleVO'), require('./model/BankCredit'), require('./model/BankLink'), require('./model/BankLinkMap'), require('./model/Benchmark'), require('./model/BenchmarkComposition'), require('./model/Brokers'), require('./model/Budget'), require('./model/BudgetAggregationAccount'), require('./model/BudgetObject'), require('./model/BulkTransaction'), require('./model/BulkTransactionVO'), require('./model/Business'), require('./model/BusinessAddress'), require('./model/Card'), require('./model/CardAddress'), require('./model/CardProgram'), require('./model/Cash'), require('./model/CategoriesMap'), require('./model/CategoryInternalResponseVO'), require('./model/CategoryResponseVO'), require('./model/Check'), require('./model/CheckImages'), require('./model/Client'), require('./model/ClientAccountMapping'), require('./model/ClientAddress'), require('./model/ClientRelationship'), require('./model/ClientResponse'), require('./model/ClientStatus'), require('./model/ClientViewGoalData'), require('./model/Country'), require('./model/Currency'), require('./model/Customer'), require('./model/CustomerAddress'), require('./model/CustomerRevenue'), require('./model/DailyDeposit'), require('./model/DailyWithdrawal'), require('./model/DateDoubleVO'), require('./model/DecisionTree'), require('./model/DecisionTreeCO'), require('./model/DecisionTreeResultVO'), require('./model/Document'), require('./model/Employment'), require('./model/ExternalAccountTransfer'), require('./model/Feature'), require('./model/FeatureTrack'), require('./model/FinancialStatement'), require('./model/Funding'), require('./model/FundingRequestMap'), require('./model/FxRateView'), require('./model/Goal'), require('./model/GoalAccountMapping'), require('./model/GoalTrack'), require('./model/GoalTrackAccounts'), require('./model/Household'), require('./model/Investment'), require('./model/Invoice'), require('./model/InvoicePayment'), require('./model/JsonNode'), require('./model/LineItems'), require('./model/Location'), require('./model/MXMerchantRes'), require('./model/Member'), require('./model/MerchantCategoryCode'), require('./model/MerchantsMap'), require('./model/Model'), require('./model/ModelAssetSize'), require('./model/ModelComment'), require('./model/ModelHolding'), require('./model/ModelHoldingVO'), require('./model/ModelTransaction'), require('./model/Node'), require('./model/NodeRelationship'), require('./model/Notification'), require('./model/NotificationClient'), require('./model/NotificationSetting'), require('./model/Order'), require('./model/OrderBulk'), require('./model/OrderReconcileRequest'), require('./model/OrderReconcileReturnObject'), require('./model/OrderStatus'), require('./model/OrderTrack'), require('./model/OrderVoClone'), require('./model/Overflow'), require('./model/OverflowBankLinkMap'), require('./model/OverflowSettings'), require('./model/OverflowVO'), require('./model/Ownership'), require('./model/PageAccount'), require('./model/PageAccountAllocationMapping'), require('./model/PageAccountPermissionVO'), require('./model/PageAccountStatus'), require('./model/PageAccountType'), require('./model/PageAggregationAccount'), require('./model/PageAggregationAccountBalance'), require('./model/PageAggregationAccountHolding'), require('./model/PageAggregationAccountTransaction'), require('./model/PageAllocation'), require('./model/PageAllocationComposition'), require('./model/PageAnswer'), require('./model/PageApplication'), require('./model/PageAuditLog'), require('./model/PageBankLink'), require('./model/PageBenchmark'), require('./model/PageBudget'), require('./model/PageBusiness'), require('./model/PageCard'), require('./model/PageCardProgram'), require('./model/PageClient'), require('./model/PageClientResponse'), require('./model/PageClientStatus'), require('./model/PageCustomer'), require('./model/PageCustomerRevenue'), require('./model/PageDailyDeposit'), require('./model/PageDailyWithdrawal'), require('./model/PageDecisionTree'), require('./model/PageDocument'), require('./model/PageExternalAccountTransfer'), require('./model/PageFeature'), require('./model/PageFeatureTrack'), require('./model/PageFinancialStatement'), require('./model/PageFunding'), require('./model/PageGoal'), require('./model/PageGoalTrack'), require('./model/PageHousehold'), require('./model/PageInvoice'), require('./model/PageInvoicePayment'), require('./model/PageMXMerchantRes'), require('./model/PageModel'), require('./model/PageModelAssetSize'), require('./model/PageModelComment'), require('./model/PageModelHolding'), require('./model/PageModelTransaction'), require('./model/PageNode'), require('./model/PageNodeRelationship'), require('./model/PageNotification'), require('./model/PageNotificationClient'), require('./model/PageNotificationSetting'), require('./model/PageOrder'), require('./model/PageOrderBulk'), require('./model/PageOrderStatus'), require('./model/PageOrderTrack'), require('./model/PageOverflow'), require('./model/PageOverflowSettings'), require('./model/PagePortfolio'), require('./model/PagePortfolioAssetSizeLog'), require('./model/PagePortfolioComment'), require('./model/PagePortfolioGoal'), require('./model/PagePortfolioHoldingLog'), require('./model/PagePortfolioTransaction'), require('./model/PageQuestion'), require('./model/PageQuestionnaire'), require('./model/PageReasonCode'), require('./model/PageRiskProfile'), require('./model/PageRoundup'), require('./model/PageRoundupSettings'), require('./model/PageScore'), require('./model/PageSecurity'), require('./model/PageSecurityExclusion'), require('./model/PageSecurityPrice'), require('./model/PageSpendingControl'), require('./model/PageStage'), require('./model/PageTransactionCode'), require('./model/PageVAccountAssetSize'), require('./model/PageWebhook'), require('./model/PermissionVO'), require('./model/Portfolio'), require('./model/PortfolioAssetSizeLog'), require('./model/PortfolioComment'), require('./model/PortfolioGoal'), require('./model/PortfolioGoalMap'), require('./model/PortfolioHoldingAgg'), require('./model/PortfolioHoldingLog'), require('./model/PortfolioTransaction'), require('./model/Question'), require('./model/Questionnaire'), require('./model/ReasonCode'), require('./model/RiskProfile'), require('./model/Roundup'), require('./model/RoundupCO'), require('./model/RoundupSettings'), require('./model/Score'), require('./model/SecuritiesComposition'), require('./model/SecuritiesCountry'), require('./model/Security'), require('./model/SecurityCompositionVO'), require('./model/SecurityCountryVO'), require('./model/SecurityExclusion'), require('./model/SecurityPrice'), require('./model/Sort'), require('./model/SpendingControl'), require('./model/Stage'), require('./model/Stat'), require('./model/State'), require('./model/StatisticResourceVO'), require('./model/TokenDateRequest'), require('./model/TransactionCode'), require('./model/VAccountAssetSize'), require('./model/VAccountVO'), require('./model/VClientGoalViewData'), require('./model/VPortfolioVO'), require('./model/Webhook'), require('./api/AccountApi'), require('./api/AggregationAccountApi'), require('./api/AllocationApi'), require('./api/ApplicationApi'), require('./api/AuditLogApi'), require('./api/BenchmarkApi'), require('./api/BudgetApi'), require('./api/BulkApi'), require('./api/BusinessApi'), require('./api/CardApi'), require('./api/ClientApi'), require('./api/CustomerApi'), require('./api/DecisionTreeApi'), require('./api/DocumentApi'), require('./api/FeatureApi'), require('./api/FinancialStatementApi'), require('./api/FundingApi'), require('./api/GoalApi'), require('./api/HouseholdApi'), require('./api/InvoiceApi'), require('./api/ModelApi'), require('./api/NotificationApi'), require('./api/OrderApi'), require('./api/OverflowApi'), require('./api/PerformanceApi'), require('./api/PortfolioApi'), require('./api/QuestionnaireApi'), require('./api/ResourceApi'), require('./api/RiskProfileApi'), require('./api/RoundupApi'), require('./api/ScoreApi'), require('./api/SecuritiesApi'), require('./api/SpendingControlApi'), require('./api/UtilsApi'), require('./api/WebhookApi'));
  }
}(function(ApiClient, AuthApi,  AdminClient, PageAdminClient, AdminClientApi,  Account, AccountAllocationMapping, AccountMap, AccountPermissionVO, AccountPortfolioRebalanceRequest, AccountStatus, AccountType, AclClientPermissionVO, AggregationAccount, AggregationAccountBalance, AggregationAccountHolding, AggregationAccountTransaction, AggregationAccountsMap, Allocation, AllocationAggregatedVO, AllocationComposition, AllocationCompositionAggregatedVO, AllocationCompositionModelHoldingsVO, AllocationNodeMap, Answer, AnswerMap, Application, AuditLog, AvailableDateDoubleVO, BankCredit, BankLink, BankLinkMap, Benchmark, BenchmarkComposition, Brokers, Budget, BudgetAggregationAccount, BudgetObject, BulkTransaction, BulkTransactionVO, Business, BusinessAddress, Card, CardAddress, CardProgram, Cash, CategoriesMap, CategoryInternalResponseVO, CategoryResponseVO, Check, CheckImages, Client, ClientAccountMapping, ClientAddress, ClientRelationship, ClientResponse, ClientStatus, ClientViewGoalData, Country, Currency, Customer, CustomerAddress, CustomerRevenue, DailyDeposit, DailyWithdrawal, DateDoubleVO, DecisionTree, DecisionTreeCO, DecisionTreeResultVO, Document, Employment, ExternalAccountTransfer, Feature, FeatureTrack, FinancialStatement, Funding, FundingRequestMap, FxRateView, Goal, GoalAccountMapping, GoalTrack, GoalTrackAccounts, Household, Investment, Invoice, InvoicePayment, JsonNode, LineItems, Location, MXMerchantRes, Member, MerchantCategoryCode, MerchantsMap, Model, ModelAssetSize, ModelComment, ModelHolding, ModelHoldingVO, ModelTransaction, Node, NodeRelationship, Notification, NotificationClient, NotificationSetting, Order, OrderBulk, OrderReconcileRequest, OrderReconcileReturnObject, OrderStatus, OrderTrack, OrderVoClone, Overflow, OverflowBankLinkMap, OverflowSettings, OverflowVO, Ownership, PageAccount, PageAccountAllocationMapping, PageAccountPermissionVO, PageAccountStatus, PageAccountType, PageAggregationAccount, PageAggregationAccountBalance, PageAggregationAccountHolding, PageAggregationAccountTransaction, PageAllocation, PageAllocationComposition, PageAnswer, PageApplication, PageAuditLog, PageBankLink, PageBenchmark, PageBudget, PageBusiness, PageCard, PageCardProgram, PageClient, PageClientResponse, PageClientStatus, PageCustomer, PageCustomerRevenue, PageDailyDeposit, PageDailyWithdrawal, PageDecisionTree, PageDocument, PageExternalAccountTransfer, PageFeature, PageFeatureTrack, PageFinancialStatement, PageFunding, PageGoal, PageGoalTrack, PageHousehold, PageInvoice, PageInvoicePayment, PageMXMerchantRes, PageModel, PageModelAssetSize, PageModelComment, PageModelHolding, PageModelTransaction, PageNode, PageNodeRelationship, PageNotification, PageNotificationClient, PageNotificationSetting, PageOrder, PageOrderBulk, PageOrderStatus, PageOrderTrack, PageOverflow, PageOverflowSettings, PagePortfolio, PagePortfolioAssetSizeLog, PagePortfolioComment, PagePortfolioGoal, PagePortfolioHoldingLog, PagePortfolioTransaction, PageQuestion, PageQuestionnaire, PageReasonCode, PageRiskProfile, PageRoundup, PageRoundupSettings, PageScore, PageSecurity, PageSecurityExclusion, PageSecurityPrice, PageSpendingControl, PageStage, PageTransactionCode, PageVAccountAssetSize, PageWebhook, PermissionVO, Portfolio, PortfolioAssetSizeLog, PortfolioComment, PortfolioGoal, PortfolioGoalMap, PortfolioHoldingAgg, PortfolioHoldingLog, PortfolioTransaction, Question, Questionnaire, ReasonCode, RiskProfile, Roundup, RoundupCO, RoundupSettings, Score, SecuritiesComposition, SecuritiesCountry, Security, SecurityCompositionVO, SecurityCountryVO, SecurityExclusion, SecurityPrice, Sort, SpendingControl, Stage, Stat, State, StatisticResourceVO, TokenDateRequest, TransactionCode, VAccountAssetSize, VAccountVO, VClientGoalViewData, VPortfolioVO, Webhook, AccountApi, AggregationAccountApi, AllocationApi, ApplicationApi, AuditLogApi, BenchmarkApi, BudgetApi, BulkApi, BusinessApi, CardApi, ClientApi, CustomerApi, DecisionTreeApi, DocumentApi, FeatureApi, FinancialStatementApi, FundingApi, GoalApi, HouseholdApi, InvoiceApi, ModelApi, NotificationApi, OrderApi, OverflowApi, PerformanceApi, PortfolioApi, QuestionnaireApi, ResourceApi, RiskProfileApi, RoundupApi, ScoreApi, SecuritiesApi, SpendingControlApi, UtilsApi, WebhookApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The CategoryInternalResponseVO model constructor.
     * @property {module:model/CategoryInternalResponseVO}
     */
    CategoryInternalResponseVO: CategoryInternalResponseVO,
    /**
     * The CategoryResponseVO model constructor.
     * @property {module:model/CategoryResponseVO}
     */
    ...
    /**
     * The OverflowVO model constructor.
     * @property {module:model/OverflowVO}
     */
    OverflowVO: OverflowVO,
    /**
    ...
    /**
     * The PageFinancialStatement model constructor.
     * @property {module:model/PageFinancialStatement}
     */
    PageFinancialStatement: PageFinancialStatement,
    /**
    ...
    /**
     * The FinancialStatementApi service constructor.
     * @property {module:api/FinancialStatementApi}
     */
    FinancialStatementApi: FinancialStatementApi,
    /**
