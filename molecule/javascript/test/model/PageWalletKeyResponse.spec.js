...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageWalletKeyResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageWalletKeyResponse();
      });

      it('should create an instance of PageWalletKeyResponse', function() {
        // TODO: update the code to test PageWalletKeyResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageWalletKeyResponse);
      });
