...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenBalanceResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.TokenBalanceResponse();
      });

      it('should create an instance of TokenBalanceResponse', function() {
        // TODO: update the code to test TokenBalanceResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.TokenBalanceResponse);
      });
