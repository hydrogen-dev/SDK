...
public class Security {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assetClass, category, createDate, currencyCode, cusip, exchange, id, industry, isActive, isin, metadata, name, proxyId, secondaryId, sector, securityClass, securityComposition, securityCountry, ticker, totalExpenseRatio, type, updateDate);
  }
