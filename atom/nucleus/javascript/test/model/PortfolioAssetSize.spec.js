...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PortfolioAssetSize();
  });
  ...
  describe('PortfolioAssetSize', function() {
    it('should create an instance of PortfolioAssetSize', function() {
      // uncomment below and update the code to test PortfolioAssetSize
      //var instane = new HydrogenNucleusApi.PortfolioAssetSize();
      //expect(instance).to.be.a(HydrogenNucleusApi.PortfolioAssetSize);
    });
