...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PagePortfolioHoldingLog();
  });
  ...
  describe('PagePortfolioHoldingLog', function() {
    it('should create an instance of PagePortfolioHoldingLog', function() {
      // uncomment below and update the code to test PagePortfolioHoldingLog
      //var instane = new HydrogenNucleusApi.PagePortfolioHoldingLog();
      //expect(instance).to.be.a(HydrogenNucleusApi.PagePortfolioHoldingLog);
    });
