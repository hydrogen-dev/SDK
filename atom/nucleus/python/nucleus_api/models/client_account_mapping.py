...
class ClientAccountMapping(object):
    ...
    def __init__(self, client_account_association_type=None, client_id=None, signature_data=None, _configuration=None):  # noqa: E501
    ...
    def client_account_association_type(self, client_account_association_type):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and client_account_association_type is None:
