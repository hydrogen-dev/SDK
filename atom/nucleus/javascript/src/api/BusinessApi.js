...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AvailableDateDoubleVO', 'model/Business', 'model/PageBusiness', 'model/PagePortfolioTransaction', 'model/PortfolioHoldingAgg'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AvailableDateDoubleVO'), require('../model/Business'), require('../model/PageBusiness'), require('../model/PagePortfolioTransaction'), require('../model/PortfolioHoldingAgg'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.BusinessApi = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.AvailableDateDoubleVO, root.HydrogenNucleusApi.Business, root.HydrogenNucleusApi.PageBusiness, root.HydrogenNucleusApi.PagePortfolioTransaction, root.HydrogenNucleusApi.PortfolioHoldingAgg);
  }
}(this, function(ApiClient, AvailableDateDoubleVO, Business, PageBusiness, PagePortfolioTransaction, PortfolioHoldingAgg) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/Business} business business
     * @param {String} businessId UUID business_id
