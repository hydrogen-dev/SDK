...
class Card(object):
    ...
    def __init__(self, account_id=None, address=None, card_holder_name=None, card_image=None, card_issuance=None, card_name=None, card_network=None, card_program_id=None, card_type=None, client_id=None, create_date=None, credit_limit=None, currency_code=None, expiry_date=None, id=None, institution_name=None, is_active=None, is_primary=None, is_reloadable=None, mask=None, metadata=None, phone_number=None, portfolio_id=None, prepaid_amount=None, secondary_id=None, spending_limit_atm=None, spending_limit_purchase=None, status=None, transaction_limit=None, update_date=None):  # noqa: E501
