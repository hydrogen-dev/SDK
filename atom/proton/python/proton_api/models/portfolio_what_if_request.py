...
class PortfolioWhatIfRequest(object):
    ...
    def __init__(self, use_proxy_data=False, altered_portfolio_tickers=None, current_portfolio_tickers=None, start_date=None, end_date=None, model_id=None, allocation_id=None, account_id=None, portfolio_id=None, aggregation_account_id=None, altered_portfolio_weights=None, market_data_source='nucleus', current_portfolio_weights=None):  # noqa: E501
