...
/**
 * AnnuityCalculatorDecumulationHorizonRequest Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\proton\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AnnuityCalculatorDecumulationHorizonRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'annuityCalculatorDecumulationHorizonRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['decumulation_horizon']) && ($this->container['decumulation_horizon'] < 1)) {
    ...
    public function setAnnuityAmount($annuity_amount)
    {
        ...
        if (($annuity_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $annuity_amount when calling AnnuityCalculatorDecumulationHorizonRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxRate($tax_rate)
    {
        ...
        if (!is_null($tax_rate) && ($tax_rate > 1)) {
            throw new \InvalidArgumentException('invalid value for $tax_rate when calling AnnuityCalculatorDecumulationHorizonRequest., must be smaller than or equal to 1.');
        }
        if (!is_null($tax_rate) && ($tax_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_rate when calling AnnuityCalculatorDecumulationHorizonRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setInitialBalance($initial_balance)
    {
        ...
        if (!is_null($initial_balance) && ($initial_balance < 0)) {
            throw new \InvalidArgumentException('invalid value for $initial_balance when calling AnnuityCalculatorDecumulationHorizonRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setInflationRate($inflation_rate)
    {
        ...
        if (!is_null($inflation_rate) && ($inflation_rate > 20)) {
            throw new \InvalidArgumentException('invalid value for $inflation_rate when calling AnnuityCalculatorDecumulationHorizonRequest., must be smaller than or equal to 20.');
        }
        if (!is_null($inflation_rate) && ($inflation_rate < -1)) {
            throw new \InvalidArgumentException('invalid value for $inflation_rate when calling AnnuityCalculatorDecumulationHorizonRequest., must be bigger than or equal to -1.');
        }
    ...
    public function setDecumulationHorizon($decumulation_horizon)
    {
        ...
        if (!is_null($decumulation_horizon) && ($decumulation_horizon < 1)) {
            throw new \InvalidArgumentException('invalid value for $decumulation_horizon when calling AnnuityCalculatorDecumulationHorizonRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAccumulationHorizon($accumulation_horizon)
    {
        ...
        if (($accumulation_horizon < 0)) {
            throw new \InvalidArgumentException('invalid value for $accumulation_horizon when calling AnnuityCalculatorDecumulationHorizonRequest., must be bigger than or equal to 0.');
        }
