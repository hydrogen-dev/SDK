...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageInvoicePayment();
  });
  ...
  describe('PageInvoicePayment', function() {
    it('should create an instance of PageInvoicePayment', function() {
      ...
      //var instane = new HydrogenAtomApi.PageInvoicePayment();
      //expect(instance).to.be.a(HydrogenAtomApi.PageInvoicePayment);
    });
