...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateCardClientResponseVO :  IEquatable<UpdateCardClientResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCardClientResponseVO" /> class.
        /// </summary>
        ...
        public UpdateCardClientResponseVO(string message = default(string), Guid? nucleusClientId = default(Guid?), string vendorName = default(string), Object vendorRequestData = default(Object), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as UpdateCardClientResponseVO);
        }

        /// <summary>
        /// Returns true if UpdateCardClientResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCardClientResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCardClientResponseVO input)
        {
            if (input == null)
                return false;
