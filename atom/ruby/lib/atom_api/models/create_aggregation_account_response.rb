...
module AtomApi
  class CreateAggregationAccountResponse
    ...
    def hash
      [client_id, account_name, institution_name, category, subcategory, account_number, account_holder, mask, currency_code, is_asset, financial_offer_id, is_active, metadata, secondary_id, id, create_date].hash
    end
