...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.AggregationAccountTransactionAggregateDataVO();
  });
  ...
  describe('AggregationAccountTransactionAggregateDataVO', function() {
    it('should create an instance of AggregationAccountTransactionAggregateDataVO', function() {
      ...
      //var instane = new HydrogenAtomApi.AggregationAccountTransactionAggregateDataVO();
      //expect(instance).to.be.a(HydrogenAtomApi.AggregationAccountTransactionAggregateDataVO);
    });
