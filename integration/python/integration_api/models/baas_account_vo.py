...
class BaasAccountVO(object):
    ...
    def __init__(self, account_number=None, account_status=None, account_type=None, message=None, nucleus_account_id=None, nucleus_client_id=None, status=None, vendor_name=None, vendor_response=None, _configuration=None):  # noqa: E501
