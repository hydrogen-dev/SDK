...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new molecule_api.TokenTransferSpecificResponse();
  });
  ...
  describe('TokenTransferSpecificResponse', function() {
    it('should create an instance of TokenTransferSpecificResponse', function() {
      // uncomment below and update the code to test TokenTransferSpecificResponse
      //var instance = new molecule_api.TokenTransferSpecificResponse();
      //expect(instance).to.be.a(molecule_api.TokenTransferSpecificResponse);
    });
