...
module ProtonApi
  class EducationCalculatorPercentCoveredRequest
    ...
    def hash
      [decumulation_horizon, deposit_schedule, initial_balance, portfolio_return, education_inflation_rate, tax_rate, aggregation_account_ids, total_annual_cost, account_ids, accumulation_horizon, general_inflation_rate].hash
    end
