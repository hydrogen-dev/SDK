...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCardClientResponseVO :  IEquatable<CreateCardClientResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCardClientResponseVO" /> class.
        /// </summary>
        ...
        public CreateCardClientResponseVO(string message = default(string), Guid? nucleusClientId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as CreateCardClientResponseVO);
        }

        /// <summary>
        /// Returns true if CreateCardClientResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCardClientResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCardClientResponseVO input)
        {
            if (input == null)
                return false;
