...
class ACHApi
{
    ...
    /**
     * Operation getBusinessBalanceUsingGet
     *
     ...
     * @return \com\hydrogen\integration\Model\AchBalanceResponseVO
     */
    public function getBusinessBalanceUsingGet($business_id)
    {
        list($response) = $this->getBusinessBalanceUsingGetWithHttpInfo($business_id);
        return $response;
    }

    /**
     * Operation getBusinessBalanceUsingGetWithHttpInfo
     *
     * Get business balance
     *
     * @param  string $business_id business_id (required)
     ...
     * @return array of \com\hydrogen\integration\Model\AchBalanceResponseVO, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBusinessBalanceUsingGetWithHttpInfo($business_id)
    {
        $returnType = '\com\hydrogen\integration\Model\AchBalanceResponseVO';
        $request = $this->getBusinessBalanceUsingGetRequest($business_id);
    ...
    /**
     * Operation getBusinessBalanceUsingGetAsync
     *
     * Get business balance
     *
     * @param  string $business_id business_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBusinessBalanceUsingGetAsync($business_id)
    {
        return $this->getBusinessBalanceUsingGetAsyncWithHttpInfo($business_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBusinessBalanceUsingGetAsyncWithHttpInfo
     *
     * Get business balance
     *
     * @param  string $business_id business_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBusinessBalanceUsingGetAsyncWithHttpInfo($business_id)
    {
        $returnType = '\com\hydrogen\integration\Model\AchBalanceResponseVO';
        $request = $this->getBusinessBalanceUsingGetRequest($business_id);
    ...
    /**
     * Create request for operation 'getBusinessBalanceUsingGet'
     *
     * @param  string $business_id business_id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBusinessBalanceUsingGetRequest($business_id)
    {
        // verify the required parameter 'business_id' is set
        if ($business_id === null || (is_array($business_id) && count($business_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $business_id when calling getBusinessBalanceUsingGet'
            );
        }
