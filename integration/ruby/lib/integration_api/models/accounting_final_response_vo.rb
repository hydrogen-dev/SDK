...
module IntegrationApi
  class AccountingFinalResponseVO
    attr_accessor :integration_type

    attr_accessor :message

    attr_accessor :nucleus_customer_revenues

    attr_accessor :nucleus_customers

    attr_accessor :nucleus_financial_statement

    attr_accessor :nucleus_invoice_payments

    attr_accessor :nucleus_invoices
    ...
    def self.swagger_types
      {
        ...
        :'nucleus_customers' => :'Array<AccountingCustomerResponseVO>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nucleus_customers')
        if (value = attributes[:'nucleus_customers']).is_a?(Array)
          self.nucleus_customers = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          nucleus_customers == o.nucleus_customers &&
    ...
    def hash
      [integration_type, message, nucleus_customer_revenues, nucleus_customers, nucleus_financial_statement, nucleus_invoice_payments, nucleus_invoices, vendor_name].hash
    end
