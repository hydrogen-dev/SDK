...
module MoleculeApi
  class TokenTransferResponse
    ...
    def hash
      [id, sender_wallet_id, receiver_wallet_id, token_id, amount, is_active, record_status, transaction_hash, create_date, update_date].hash
    end
