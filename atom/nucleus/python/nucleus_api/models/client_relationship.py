...
class ClientRelationship(object):
    ...
    def __init__(self, client_id=None, member=None, relationship=None, _configuration=None):  # noqa: E501
    ...
    def relationship(self, relationship):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and relationship is None:
