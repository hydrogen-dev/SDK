...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageQuestionnaire();
  });
  ...
  describe('PageQuestionnaire', function() {
    it('should create an instance of PageQuestionnaire', function() {
      // uncomment below and update the code to test PageQuestionnaire
      //var instane = new HydrogenNucleusApi.PageQuestionnaire();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageQuestionnaire);
    });
