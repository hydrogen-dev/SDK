...
module ProtonApi
  class LifeInsuranceNeedsCalculatorRequest
    ...
    def hash
      [margin_of_error, end_of_life_expenses, interest_rate, existing_life_insurance, tax_rate, education_inflation_rate, liquid_assets, other_debt, client_id, mortgage_balance, benefit_amount_rounding, income_config, beneficiary_bequest_config, general_inflation_rate, children_education_config].hash
    end
