...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Goal', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Goal'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageGoal = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Goal, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, Goal, Sort) {
  'use strict';
  ...
  /**
   * The PageGoal model module.
   * @module model/PageGoal
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageGoal</code>.
   * Page Object
   * @alias module:model/PageGoal
   * @class
   */
  ...
  /**
   * Constructs a <code>PageGoal</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageGoal} obj Optional instance to populate.
   * @return {module:model/PageGoal} The populated <code>PageGoal</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Goal]);
      }
  ...
  /**
   * @member {Array.<module:model/Goal>} content
   */
