...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageModelAssetSize();
  });
  ...
  describe('PageModelAssetSize', function() {
    it('should create an instance of PageModelAssetSize', function() {
      ...
      //var instane = new HydrogenAtomApi.PageModelAssetSize();
      //expect(instance).to.be.a(HydrogenAtomApi.PageModelAssetSize);
    });
