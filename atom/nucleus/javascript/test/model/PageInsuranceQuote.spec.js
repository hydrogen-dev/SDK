...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageInsuranceQuote();
  });
  ...
  describe('PageInsuranceQuote', function() {
    it('should create an instance of PageInsuranceQuote', function() {
      ...
      //var instane = new HydrogenAtomApi.PageInsuranceQuote();
      //expect(instance).to.be.a(HydrogenAtomApi.PageInsuranceQuote);
    });
