...
module AtomApi
  class PurchaseCalculatorHorizon
    ...
    def hash
      [purchase_amount, portfolio_return, horizon_frequency_interval, current_savings, deposit_schedule, inflation_rate, investment_tax].hash
    end
