...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseCalculatorHorizonRequest :  IEquatable<PurchaseCalculatorHorizonRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseCalculatorHorizonRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PurchaseCalculatorHorizonRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseCalculatorHorizonRequest" /> class.
        /// </summary>
        ...
        public PurchaseCalculatorHorizonRequest(List<Guid?> accountIds = default(List<Guid?>), float? investmentTax = 0.0F, float? portfolioReturn = default(float?), CalculatorDepositSchedule1 depositSchedule = default(CalculatorDepositSchedule1), float? currentSavings = 0.0F, float? purchaseAmount = default(float?), float? inflationRate = 0.0F, List<Guid?> aggregationAccountIds = default(List<Guid?>))
        {
            ...
            {
                throw new InvalidDataException("purchaseAmount is a required property for PurchaseCalculatorHorizonRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PurchaseCalculatorHorizonRequest);
        }

        /// <summary>
        /// Returns true if PurchaseCalculatorHorizonRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseCalculatorHorizonRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseCalculatorHorizonRequest input)
        {
            if (input == null)
                return false;
