...
module NucleusApi
  class PerformanceApi
    ...
    def get_goal_performance_using_get_with_http_info(client_id, goal_id, opts = {})
      ...
      # resource path
      local_var_path = '/goal/{goal_id}/performance'.sub('{' + 'client_id' + '}', client_id.to_s).sub('{' + 'goal_id' + '}', goal_id.to_s)
    ...
    # @option opts [Float] :var_conf_interval VaR Confidence Interval ( alpha ) i.entity 99, 95, etc - (statId: 40, default: 95)
    # @return [Object]
    def get_portfolio_performance_using_get(account_id, client_id, portfolio_id, portfolioid, opts = {})
      data, _status_code, _headers = get_portfolio_performance_using_get_with_http_info(account_id, client_id, portfolio_id, portfolioid, opts)
      data
    end
    ...
    # @option opts [Float] :var_conf_interval VaR Confidence Interval ( alpha ) i.entity 99, 95, etc - (statId: 40, default: 95)
    # @return [Array<(Object, Fixnum, Hash)>] Object data, response status code and response headers
    def get_portfolio_performance_using_get_with_http_info(account_id, client_id, portfolio_id, portfolioid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PerformanceApi.get_portfolio_performance_using_get ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling PerformanceApi.get_portfolio_performance_using_get"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PerformanceApi.get_portfolio_performance_using_get"
      end
      ...
      if @api_client.config.client_side_validation && portfolioid.nil?
        fail ArgumentError, "Missing the required parameter 'portfolioid' when calling PerformanceApi.get_portfolio_performance_using_get"
      end
      # resource path
      local_var_path = '/portfolio/{portfolio_id}/performance'.sub('{' + 'account_id' + '}', account_id.to_s).sub('{' + 'client_id' + '}', client_id.to_s).sub('{' + 'portfolio_id' + '}', portfolio_id.to_s).sub('{' + 'portfolioid' + '}', portfolioid.to_s)
