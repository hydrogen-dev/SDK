...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageVAccountAssetSize();
  });
  ...
  describe('PageVAccountAssetSize', function() {
    it('should create an instance of PageVAccountAssetSize', function() {
      // uncomment below and update the code to test PageVAccountAssetSize
      //var instane = new HydrogenNucleusApi.PageVAccountAssetSize();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageVAccountAssetSize);
    });
