...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.AchBusinessResponseVO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
  ...
  /**
   * The AchBusinessResponseVO model module.
   * @module model/AchBusinessResponseVO
   * @version 1.3.0
   */

  /**
   * Constructs a new <code>AchBusinessResponseVO</code>.
   * @alias module:model/AchBusinessResponseVO
   * @class
   */
  ...
  /**
   * Constructs a <code>AchBusinessResponseVO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AchBusinessResponseVO} obj Optional instance to populate.
   * @return {module:model/AchBusinessResponseVO} The populated <code>AchBusinessResponseVO</code> instance.
   */
