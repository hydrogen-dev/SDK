...
module ProtonApi
  class PurchaseCalculatorDepositAmountRequest
    ...
    def hash
      [deposit_schedule, portfolio_return, inflation_rate, investment_tax, purchase_horizon, purchase_amount, aggregation_account_ids, account_ids, current_savings, horizon_frequency_interval].hash
    end
