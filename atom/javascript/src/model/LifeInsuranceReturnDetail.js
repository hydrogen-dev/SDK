...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.LifeInsuranceReturnDetail = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The LifeInsuranceReturnDetail model module.
   * @module model/LifeInsuranceReturnDetail
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>LifeInsuranceReturnDetail</code>.
   * @alias module:model/LifeInsuranceReturnDetail
   * @class
   ...
   */
  var exports = function(periodEarnings, periodWithdrawal, cumulativeEarnings, cumulativeWithdrawals, endingBalance) {
    var _this = this;
  ...
  /**
   * Constructs a <code>LifeInsuranceReturnDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LifeInsuranceReturnDetail} obj Optional instance to populate.
   * @return {module:model/LifeInsuranceReturnDetail} The populated <code>LifeInsuranceReturnDetail</code> instance.
   */
