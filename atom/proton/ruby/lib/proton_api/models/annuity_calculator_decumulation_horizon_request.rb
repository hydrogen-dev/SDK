...
module ProtonApi
  class AnnuityCalculatorDecumulationHorizonRequest
    ...
    def hash
      [inflation_rate, annuity_frequency_interval, deposit_schedule, portfolio_return, create_log, aggregation_account_ids, initial_balance, decumulation_horizon, tax_rate, account_ids, annuity_amount, accumulation_horizon].hash
    end
