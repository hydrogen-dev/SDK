...
namespace Integration.ModelEntity
{
    ...
    public partial class AggregationAccountBalance :  IEquatable<AggregationAccountBalance>, IValidatableObject
    {
        ...
        /// <param name="balanceTimeStamp">balanceTimeStamp (required).</param>
        ...
        {
            // to ensure "balanceTimeStamp" is required (not null)
            if (balanceTimeStamp == null)
            {
                throw new InvalidDataException("balanceTimeStamp is a required property for AggregationAccountBalance and cannot be null");
            }
            else
            {
