...
module IntegrationApi
  class ResponseEntity
    ...
    def valid?
      ...
      return false unless status_code_validator.valid?(@status_code.upcase)
      true
    end
    ...
    def status_code=(status_code)
      ...
      unless validator.valid?(status_code.upcase)
    ...
    def hash
      [body, status, status_code, status_code_value].hash
    end
