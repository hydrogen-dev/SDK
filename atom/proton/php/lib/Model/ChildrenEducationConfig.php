 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ChildrenEducationConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChildrenEducationConfig';
    ...
    protected static $setters = [
        'education_config' => 'setEducationConfig',
    ...
    protected static $getters = [
        'education_config' => 'getEducationConfig',
    ...
    {
        $this->container['education_config'] = isset($data['education_config']) ? $data['education_config'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['education_config'] === null) {
            $invalidProperties[] = "'education_config' can't be null";
        }
    ...
    {
        return $this->container['education_config'];
    }
     ...
     * @return $this
     */
    public function setEducationConfig($education_config)
    {
        $this->container['education_config'] = $education_config;
    ...
    public function setCurrentAge($current_age)
    {
        ...
        if (($current_age < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_age when calling ChildrenEducationConfig., must be bigger than or equal to 0.');
        }
