...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageStage();
  });
  ...
  describe('PageStage', function() {
    it('should create an instance of PageStage', function() {
      // uncomment below and update the code to test PageStage
      //var instane = new HydrogenNucleusApi.PageStage();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageStage);
    });
