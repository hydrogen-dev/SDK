...
class AggregationApi(object):
    ...
    def create_aggregation_account_using_post_with_http_info(self, aggregation_request_object, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('aggregation_request_object' not in params or
                                                       params['aggregation_request_object'] is None):  # noqa: E501
    ...
    def delete_aggregation_account_using_delete(self, nucleus_aggregation_account_id, **kwargs):  # noqa: E501
        ...
        :param str delete_type: delete_type
        :param str nucleus_data: nucleus_data
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_aggregation_account_using_delete_with_http_info(self, nucleus_aggregation_account_id, **kwargs):  # noqa: E501
        ...
        all_params = ['nucleus_aggregation_account_id', 'delete_type', 'nucleus_data']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('nucleus_aggregation_account_id' not in params or
                                                       params['nucleus_aggregation_account_id'] is None):  # noqa: E501
        ...
        query_params = []
        if 'delete_type' in params:
            query_params.append(('delete_type', params['delete_type']))  # noqa: E501
        if 'nucleus_data' in params:
            query_params.append(('nucleus_data', params['nucleus_data']))  # noqa: E501
    ...
    def get_aggregation_account_all_using_get_with_http_info(self, aggregation_account_id_list, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('aggregation_account_id_list' not in params or
                                                       params['aggregation_account_id_list'] is None):  # noqa: E501
    ...
    def get_property_value(self, nucleus_aggregation_account_id, **kwargs):  # noqa: E501
        """Get Value of the given property  # noqa: E501

        Get Value of the given property  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_property_value(nucleus_aggregation_account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_property_value_with_http_info(nucleus_aggregation_account_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_property_value_with_http_info(nucleus_aggregation_account_id, **kwargs)  # noqa: E501
            return data

    def get_property_value_with_http_info(self, nucleus_aggregation_account_id, **kwargs):  # noqa: E501
        """Get Value of the given property  # noqa: E501

        Get Value of the given property  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_property_value_with_http_info(nucleus_aggregation_account_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['nucleus_aggregation_account_id', 'nucleus_business_id', 'nucleus_client_id', 'product']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
