...
module AtomApi
  class BudgetCalculatorResponseBudgetTrack
    ...
    attr_accessor :total_funds_budgeted
    ...
    def self.swagger_types
      {
        ...
        :'budget_components' => :'Array<BudgetCalculatorResponseBudgetComponents>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'total_funds_budgeted')
        self.total_funds_budgeted = attributes[:'total_funds_budgeted']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_funds_budgeted == o.total_funds_budgeted &&
    ...
    def hash
      [period_start, period_end, total_funds_budgeted, total_funds_spent, total_funds_remaining, budget_components].hash
    end
