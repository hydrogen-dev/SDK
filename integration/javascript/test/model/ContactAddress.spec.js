...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.ContactAddress();
  });
  ...
  describe('ContactAddress', function() {
    it('should create an instance of ContactAddress', function() {
      ...
      //var instane = new HydrogenIntegrationApi.ContactAddress();
      //expect(instance).to.be.a(HydrogenIntegrationApi.ContactAddress);
    });
