...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PagePortfolioGoal();
  });
  ...
  describe('PagePortfolioGoal', function() {
    it('should create an instance of PagePortfolioGoal', function() {
      ...
      //var instane = new HydrogenAtomApi.PagePortfolioGoal();
      //expect(instance).to.be.a(HydrogenAtomApi.PagePortfolioGoal);
    });
