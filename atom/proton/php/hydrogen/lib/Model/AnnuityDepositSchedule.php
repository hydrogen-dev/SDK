...
/**
 * AnnuityDepositSchedule Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\proton\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AnnuityDepositSchedule implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AnnuityDepositSchedule';
    ...
    public function setDepositAmount($deposit_amount)
    {
        ...
        if (!is_null($deposit_amount) && ($deposit_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $deposit_amount when calling AnnuityDepositSchedule., must be bigger than or equal to 0.');
        }
