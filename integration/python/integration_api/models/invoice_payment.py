...
class InvoicePayment(object):
    ...
    def __init__(self, create_date=None, currency_code=None, id=None, invoice_id=None, payment_amount=None, payment_date=None, secondary_id=None, update_date=None, _configuration=None):  # noqa: E501
