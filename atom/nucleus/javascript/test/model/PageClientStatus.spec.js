...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageClientStatus();
  });
  ...
  describe('PageClientStatus', function() {
    it('should create an instance of PageClientStatus', function() {
      // uncomment below and update the code to test PageClientStatus
      //var instane = new HydrogenNucleusApi.PageClientStatus();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageClientStatus);
    });
