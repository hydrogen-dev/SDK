...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.FaqPayload();
  });
  ...
  describe('FaqPayload', function() {
    it('should create an instance of FaqPayload', function() {
      // uncomment below and update the code to test FaqPayload
      //var instance = new atom_api.FaqPayload();
      //expect(instance).to.be.a(atom_api.FaqPayload);
    });
