...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageOverflowSettings();
  });
  ...
  describe('PageOverflowSettings', function() {
    it('should create an instance of PageOverflowSettings', function() {
      ...
      //var instane = new HydrogenAtomApi.PageOverflowSettings();
      //expect(instance).to.be.a(HydrogenAtomApi.PageOverflowSettings);
    });
