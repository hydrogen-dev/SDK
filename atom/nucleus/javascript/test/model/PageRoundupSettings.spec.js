...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageRoundupSettings();
  });
  ...
  describe('PageRoundupSettings', function() {
    it('should create an instance of PageRoundupSettings', function() {
      // uncomment below and update the code to test PageRoundupSettings
      //var instane = new HydrogenNucleusApi.PageRoundupSettings();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageRoundupSettings);
    });
