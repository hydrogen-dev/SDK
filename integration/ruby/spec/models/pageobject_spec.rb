...
# Unit tests for IntegrationApi::Pageobject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Pageobject' do
  before do
    # run before each test
    @instance = IntegrationApi::Pageobject.new
  end
  ...
  describe 'test an instance of Pageobject' do
    it 'should create an instance of Pageobject' do
      expect(@instance).to be_instance_of(IntegrationApi::Pageobject)
    end
  end
