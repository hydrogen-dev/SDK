...
module NucleusApi
  class AggregationAccountHoldingAggregateDataVO
    attr_accessor :aggregation_account_holding_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'aggregation_account_holding_id')
        self.aggregation_account_holding_id = attributes[:'aggregation_account_holding_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          aggregation_account_holding_id == o.aggregation_account_holding_id &&
          amount == o.amount &&
    ...
    def hash
      [aggregation_account_holding_id, amount, asset_class, cost_basis, create_date, currency_code, cusip, exchange, holding_date, holding_type, metadata, price, shares, ticker, ticker_name, update_date].hash
    end
