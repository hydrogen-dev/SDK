...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaasSubAccountVO :  IEquatable<BaasSubAccountVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaasSubAccountVO" /> class.
        /// </summary>
        ...
        public BaasSubAccountVO(string accountNumber = default(string), string accountStatus = default(string), string message = default(string), Guid? nucleusClientId = default(Guid?), Guid? nucleusPortfolioId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaasSubAccountVO {\n");
        ...
        {
            return this.Equals(input as BaasSubAccountVO);
        }

        /// <summary>
        /// Returns true if BaasSubAccountVO instances are equal
        /// </summary>
        /// <param name="input">Instance of BaasSubAccountVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaasSubAccountVO input)
        {
            if (input == null)
                return false;
