...
class SMTPApi
{
     ...
     */
    public function sendMail($smtp_vo)
    {
        list($response) = $this->sendMailWithHttpInfo($smtp_vo);
        return $response;
    }
     ...
     */
    public function sendMailWithHttpInfo($smtp_vo)
    {
        $returnType = '\com\hydrogen\integration\Model\SmtpResponseVO';
        $request = $this->sendMailRequest($smtp_vo);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendMailAsync($smtp_vo)
    {
        return $this->sendMailAsyncWithHttpInfo($smtp_vo)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendMailAsyncWithHttpInfo($smtp_vo)
    {
        $returnType = '\com\hydrogen\integration\Model\SmtpResponseVO';
        $request = $this->sendMailRequest($smtp_vo);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendMailRequest($smtp_vo)
    {
        // verify the required parameter 'smtp_vo' is set
        if ($smtp_vo === null || (is_array($smtp_vo) && count($smtp_vo) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $smtp_vo when calling sendMail'
            );
        }
