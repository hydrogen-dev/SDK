...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnnuityCalculatorDepositAmountRequest :  IEquatable<AnnuityCalculatorDepositAmountRequest>, IValidatableObject
    {
        /// <summary>
        ...
        protected AnnuityCalculatorDepositAmountRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnuityCalculatorDepositAmountRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AnnuityCalculatorDepositAmountRequest);
        }

        /// <summary>
        /// Returns true if AnnuityCalculatorDepositAmountRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AnnuityCalculatorDepositAmountRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnuityCalculatorDepositAmountRequest input)
        {
            if (input == null)
                return false;
