...
# Unit tests for IntegrationApi::SMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SMS' do
  before do
    # run before each test
    @instance = IntegrationApi::SMS.new
  end
  ...
  describe 'test an instance of SMS' do
    it 'should create an instance of SMS' do
      expect(@instance).to be_instance_of(IntegrationApi::SMS)
    end
  end
  ...
  describe 'test attribute "reply_message"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "vendor_account_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "vendor_sms_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
