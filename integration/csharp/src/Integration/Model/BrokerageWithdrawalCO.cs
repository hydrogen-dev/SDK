...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrokerageWithdrawalCO :  IEquatable<BrokerageWithdrawalCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerageWithdrawalCO" /> class.
        /// </summary>
        /// <param name="nucleusFundingId">nucleusFundingId.</param>
        public BrokerageWithdrawalCO(Guid? nucleusFundingId = default(Guid?))
        {
        ...
        {
            return this.Equals(input as BrokerageWithdrawalCO);
        }

        /// <summary>
        /// Returns true if BrokerageWithdrawalCO instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerageWithdrawalCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerageWithdrawalCO input)
        {
            if (input == null)
                return false;
