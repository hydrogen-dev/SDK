...
public class InsuranceApiTest {
    ...
    public void deleteInsuranceQuoteUsingDeleteTest() throws ApiException {
        ...
        api.deleteInsuranceQuoteUsingDelete(insuranceQuoteId);
    ...
    public void getInsuranceCoverageAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageInsuranceCoverage response = api.getInsuranceCoverageAllUsingGet(ascending, currencyConversion, filter, orderBy, page, size);
    ...
    public void getInsuranceCoverageUsingGetTest() throws ApiException {
        UUID insuranceCoverageId = null;
        String currencyConversion = null;
        InsuranceCoverage response = api.getInsuranceCoverageUsingGet(insuranceCoverageId, currencyConversion);
    ...
    public void getInsuranceDiscountAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageInsuranceDiscount response = api.getInsuranceDiscountAllUsingGet(ascending, currencyConversion, filter, orderBy, page, size);
    ...
    public void getInsuranceDiscountUsingGetTest() throws ApiException {
        UUID insuranceDiscountId = null;
        String currencyConversion = null;
        InsuranceDiscount response = api.getInsuranceDiscountUsingGet(insuranceDiscountId, currencyConversion);
    ...
    public void getInsuranceQuoteAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageInsuranceQuote response = api.getInsuranceQuoteAllUsingGet(ascending, currencyConversion, filter, orderBy, page, size);
    ...
    public void getInsuranceQuoteUsingGetTest() throws ApiException {
        UUID insuranceQuoteId = null;
        String currencyConversion = null;
        InsuranceQuote response = api.getInsuranceQuoteUsingGet(insuranceQuoteId, currencyConversion);
