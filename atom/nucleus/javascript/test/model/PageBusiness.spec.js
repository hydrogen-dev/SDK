...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageBusiness();
  });
  ...
  describe('PageBusiness', function() {
    it('should create an instance of PageBusiness', function() {
      // uncomment below and update the code to test PageBusiness
      //var instane = new HydrogenNucleusApi.PageBusiness();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageBusiness);
    });
