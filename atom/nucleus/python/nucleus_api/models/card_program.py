...
class CardProgram(object):
    ...
    def __init__(self, card_issuer=None, card_network=None, card_processor=None, card_type=None, client_id=None, code=None, create_date=None, description=None, id=None, is_delegated_authority=None, issuing_bank=None, metadata=None, name=None, secondary_id=None, update_date=None):  # noqa: E501
    ...
    def card_issuer(self):
        """Gets the card_issuer of this CardProgram.  # noqa: E501

        cardIssuer  # noqa: E501

        :return: The card_issuer of this CardProgram.  # noqa: E501
        :rtype: str
        """
    ...
    def card_issuer(self, card_issuer):
        """Sets the card_issuer of this CardProgram.

        cardIssuer  # noqa: E501

        :param card_issuer: The card_issuer of this CardProgram.  # noqa: E501
        :type: str
        """
        if card_issuer is None:
            raise ValueError("Invalid value for `card_issuer`, must not be `None`")  # noqa: E501
    ...
    def card_processor(self, card_processor):
        ...
        :type: str
        """
        if card_processor is None:
            raise ValueError("Invalid value for `card_processor`, must not be `None`")  # noqa: E501
