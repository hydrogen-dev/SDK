...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrokerageWithdrawalVO :  IEquatable<BrokerageWithdrawalVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerageWithdrawalVO" /> class.
        /// </summary>
        ...
        public BrokerageWithdrawalVO(string message = default(string), Guid? nucleusFundingId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as BrokerageWithdrawalVO);
        }

        /// <summary>
        /// Returns true if BrokerageWithdrawalVO instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerageWithdrawalVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerageWithdrawalVO input)
        {
            if (input == null)
                return false;
