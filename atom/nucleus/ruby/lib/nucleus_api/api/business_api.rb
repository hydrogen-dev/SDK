...
module NucleusApi
  class BusinessApi
    ...
    def delete_business_using_delete_with_http_info(business_id, opts = {})
      ...
      # resource path
      local_var_path = '/business/{business_id}'.sub('{' + 'business_id' + '}', business_id.to_s)
    ...
    def get_business_asset_size_using_get_with_http_info(business_id, opts = {})
      ...
      # resource path
      local_var_path = '/business/{business_id}/asset_size'.sub('{' + 'business_id' + '}', business_id.to_s)
    ...
    def get_business_client_transaction_all_using_get_with_http_info(business_id, opts = {})
      ...
      # resource path
      local_var_path = '/business/{business_id}/transaction'.sub('{' + 'business_id' + '}', business_id.to_s)
    ...
    def get_business_holding_using_get_with_http_info(business_id, opts = {})
      ...
      # resource path
      local_var_path = '/business/{business_id}/holding'.sub('{' + 'business_id' + '}', business_id.to_s)
