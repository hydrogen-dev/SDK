...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.RetirementCalculatorPctcoveredResponse();
  });
  ...
  describe('RetirementCalculatorPctcoveredResponse', function() {
    it('should create an instance of RetirementCalculatorPctcoveredResponse', function() {
      // uncomment below and update the code to test RetirementCalculatorPctcoveredResponse
      //var instance = new atom_api.RetirementCalculatorPctcoveredResponse();
      //expect(instance).to.be.a(atom_api.RetirementCalculatorPctcoveredResponse);
    });

    it('should have the property achievableExpenses (base name: "achievable_expenses")', function() {
      // uncomment below and update the code to test the property achievableExpenses
      //var instance = new atom_api.RetirementCalculatorPctcoveredResponse();
      //expect(instance).to.be();
    });

    it('should have the property targetExpenses (base name: "target_expenses")', function() {
      // uncomment below and update the code to test the property targetExpenses
      //var instance = new atom_api.RetirementCalculatorPctcoveredResponse();
      //expect(instance).to.be();
    });
