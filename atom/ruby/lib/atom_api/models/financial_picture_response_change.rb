...
module AtomApi
  ...
  class FinancialPictureResponseChange
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'analysis_start')
        self.analysis_start = attributes[:'analysis_start']
      end

      if attributes.has_key?(:'analysis_end')
        self.analysis_end = attributes[:'analysis_end']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          analysis_start == o.analysis_start &&
          analysis_end == o.analysis_end &&
    ...
    def hash
      [analysis_start, analysis_end, total_assets, total_liabilities, net_worth].hash
    end
