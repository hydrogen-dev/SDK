...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AchBalanceResponseVO', 'model/AchBankLinkRequestCO', 'model/AchBankLinkResponseVO', 'model/AchBusinessRequestCO', 'model/AchCardLinkRequestCO', 'model/AchCardLinkResponseVO', 'model/AchClientRequestCO', 'model/AchClientResponseVO', 'model/AchTransferRequestCO', 'model/AchTransferResponseVO', 'model/BaseResponseVO', 'model/PageAchTransferResponseVO'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AchBalanceResponseVO'), require('../model/AchBankLinkRequestCO'), require('../model/AchBankLinkResponseVO'), require('../model/AchBusinessRequestCO'), require('../model/AchCardLinkRequestCO'), require('../model/AchCardLinkResponseVO'), require('../model/AchClientRequestCO'), require('../model/AchClientResponseVO'), require('../model/AchTransferRequestCO'), require('../model/AchTransferResponseVO'), require('../model/BaseResponseVO'), require('../model/PageAchTransferResponseVO'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenIntegrationApi) {
      root.HydrogenIntegrationApi = {};
    }
    root.HydrogenIntegrationApi.ACHApi = factory(root.HydrogenIntegrationApi.ApiClient, root.HydrogenIntegrationApi.AchBalanceResponseVO, root.HydrogenIntegrationApi.AchBankLinkRequestCO, root.HydrogenIntegrationApi.AchBankLinkResponseVO, root.HydrogenIntegrationApi.AchBusinessRequestCO, root.HydrogenIntegrationApi.AchCardLinkRequestCO, root.HydrogenIntegrationApi.AchCardLinkResponseVO, root.HydrogenIntegrationApi.AchClientRequestCO, root.HydrogenIntegrationApi.AchClientResponseVO, root.HydrogenIntegrationApi.AchTransferRequestCO, root.HydrogenIntegrationApi.AchTransferResponseVO, root.HydrogenIntegrationApi.BaseResponseVO, root.HydrogenIntegrationApi.PageAchTransferResponseVO);
  }
}(this, function(ApiClient, AchBalanceResponseVO, AchBankLinkRequestCO, AchBankLinkResponseVO, AchBusinessRequestCO, AchCardLinkRequestCO, AchCardLinkResponseVO, AchClientRequestCO, AchClientResponseVO, AchTransferRequestCO, AchTransferResponseVO, BaseResponseVO, PageAchTransferResponseVO) {
  'use strict';
