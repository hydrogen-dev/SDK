...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageClient();
  });
  ...
  describe('PageClient', function() {
    it('should create an instance of PageClient', function() {
      // uncomment below and update the code to test PageClient
      //var instane = new HydrogenNucleusApi.PageClient();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageClient);
    });
