...
namespace Nucleus.ModelEntity
{
    ...
    public partial class PageStage :  IEquatable<PageStage>, IValidatableObject
    {
        ...
        public PageStage(List<Stage> content = default(List<Stage>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Stage> Content { get; set; }
