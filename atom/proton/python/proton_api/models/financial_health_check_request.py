...
class FinancialHealthCheckRequest(object):
    ...
    def __init__(self, client_id=None, ratio_targets=None, liquid_assets=None, total_liabilities=None, gross_annual_income=None, short_term_liabilities=None, lookback_periods=3, non_liquid_assets=None, monthly_expenses=None, net_monthly_income=None, _configuration=None):  # noqa: E501
    ...
    def gross_annual_income(self, gross_annual_income):
        ...
        """
        if (self._configuration.client_side_validation and
                gross_annual_income is not None and gross_annual_income < 0):  # noqa: E501
    ...
    def short_term_liabilities(self, short_term_liabilities):
        ...
        """
        if (self._configuration.client_side_validation and
                short_term_liabilities is not None and short_term_liabilities < 0):  # noqa: E501
    ...
    def non_liquid_assets(self, non_liquid_assets):
        ...
        """
        if (self._configuration.client_side_validation and
                non_liquid_assets is not None and non_liquid_assets < 0):  # noqa: E501
    ...
    def monthly_expenses(self, monthly_expenses):
        ...
        """
        if (self._configuration.client_side_validation and
                monthly_expenses is not None and monthly_expenses < 0):  # noqa: E501
    ...
    def net_monthly_income(self, net_monthly_income):
        ...
        """
        if (self._configuration.client_side_validation and
                net_monthly_income is not None and net_monthly_income < 0):  # noqa: E501
