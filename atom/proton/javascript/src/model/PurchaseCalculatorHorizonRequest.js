...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenProtonApi.PurchaseCalculatorHorizonRequest = factory(root.HydrogenProtonApi.ApiClient, root.HydrogenProtonApi.CalculatorDepositSchedule1);
  }
}(this, function(ApiClient, CalculatorDepositSchedule1) {
  'use strict';

  /**
   * The PurchaseCalculatorHorizonRequest model module.
   * @module model/PurchaseCalculatorHorizonRequest
   * @version 1.8.0
   */

  /**
   * Constructs a new <code>PurchaseCalculatorHorizonRequest</code>.
   * @alias module:model/PurchaseCalculatorHorizonRequest
   * @class
   * @param portfolioReturn {Number} 
   * @param purchaseAmount {Number} 
   */
  var exports = function(portfolioReturn, purchaseAmount) {
    this.portfolioReturn = portfolioReturn;
    this.purchaseAmount = purchaseAmount;
  };

  /**
   * Constructs a <code>PurchaseCalculatorHorizonRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseCalculatorHorizonRequest} obj Optional instance to populate.
   * @return {module:model/PurchaseCalculatorHorizonRequest} The populated <code>PurchaseCalculatorHorizonRequest</code> instance.
   */
