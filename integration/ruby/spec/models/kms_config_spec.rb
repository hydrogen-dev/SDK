...
# Unit tests for IntegrationApi::KmsConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KmsConfig' do
  before do
    # run before each test
    @instance = IntegrationApi::KmsConfig.new
  end
  ...
  describe 'test an instance of KmsConfig' do
    it 'should create an instance of KmsConfig' do
      expect(@instance).to be_instance_of(IntegrationApi::KmsConfig)
    end
  end
