...
class BrokerageBankLinkVO(object):
    ...
    def __init__(self, message=None, nucleus_bank_link_id=None, status=None, vendor_name=None, vendor_request_data=None, vendor_response=None, _configuration=None):  # noqa: E501
