...
module AtomApi
  class CampaignManagementPayload
    ...
    def hash
      [title, description, start_date, end_date, is_acquisition, campaign_category, campaign_plan_id, cookie_code, is_active, landing_page, rate, utm_campaign, utm_content, utm_medium, utm_source, utm_term, secondary_id].hash
    end
