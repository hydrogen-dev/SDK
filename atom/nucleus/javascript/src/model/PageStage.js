...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Sort', 'model/Stage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Sort'), require('./Stage'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageStage = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Sort, root.HydrogenNucleusApi.Stage);
  }
}(this, function(ApiClient, Sort, Stage) {
  'use strict';
  ...
  /**
   * The PageStage model module.
   * @module model/PageStage
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageStage</code>.
   * Page Object
   * @alias module:model/PageStage
   * @class
   */
  ...
  /**
   * Constructs a <code>PageStage</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStage} obj Optional instance to populate.
   * @return {module:model/PageStage} The populated <code>PageStage</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Stage]);
      }
  ...
  /**
   * @member {Array.<module:model/Stage>} content
   */
