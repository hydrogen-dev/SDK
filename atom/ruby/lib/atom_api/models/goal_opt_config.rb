...
module AtomApi
  class GoalOptConfig
    ...
    def list_invalid_properties
      ...
      if @min_assets <= 0
        invalid_properties.push('invalid value for "min_assets", must be greater than 0.')
      end
    ...
    def min_assets=(min_assets)
      ...
      if min_assets <= 0
        fail ArgumentError, 'invalid value for "min_assets", must be greater than 0.'
      end
    ...
    def hash
      [tickers, min_assets, w_config, w_asset_config, sec_types, start_date, end_date].hash
    end
