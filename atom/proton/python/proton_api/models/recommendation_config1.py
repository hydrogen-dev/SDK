...
class RecommendationConfig1(object):
    ...
    def __init__(self, horizon_max=64, dep_min=None, inv_max=None, inv_min=None, recommended_inflation=0.0, horizon_min=1, dep_max=None, _configuration=None):  # noqa: E501
