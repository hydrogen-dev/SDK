...
# create an instance of the API class
api_instance = atom_api.BudgetApi(atom_api.ApiClient(configuration))
budget_request = atom_api.Budget() # Budget | budgetRequest
...
> PageBudget get_budget_all_using_get(ascending=ascending, filter=filter, order_by=order_by, page=page, size=size)
...
try:
    # List all budget requests
    api_response = api_instance.get_budget_all_using_get(ascending=ascending, filter=filter, order_by=order_by, page=page, size=size)
    pprint(api_response)
except ApiException as e:
...
try:
    # Retrieve a budget request
    api_response = api_instance.get_budget_using_get(budget_id)
    pprint(api_response)
except ApiException as e:
...
# create an instance of the API class
api_instance = atom_api.BudgetApi(atom_api.ApiClient(configuration))
budget = atom_api.Budget() # Budget | budget
budget_id = 'budget_id_example' # str | UUID budget_id
