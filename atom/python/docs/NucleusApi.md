...
> GetAccountPermissionsResponse get_account_permissions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all account permissions
    api_response = api_instance.get_account_permissions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_account_stages**
> GetAccountStageResponse get_account_stages(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all account stages
    api_response = api_instance.get_account_stages(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> GetAccountStatusResponse get_account_statuses(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all account statuses
    api_response = api_instance.get_account_statuses(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> AccountTransactionResponse get_account_transactions(account_id, filter=filter)
...
try:
    # List all account transactions
    api_response = api_instance.get_account_transactions(account_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_account_type**
> GetAccountTypeSubresponse get_account_type(account_type_id)
...
# **get_account_types**
> GetAccountTypeResponse get_account_types(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all account types
    api_response = api_instance.get_account_types(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_accounts**
> GetAccountResponse get_accounts(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # Get information for all accounts for all clients defined for your firm
    api_response = api_instance.get_accounts(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_aggregation_account**
> SpecificAggregationAccountResponse get_aggregation_account(aggregation_account_id)
...
try:
    # Retrieve an aggregation account
    api_response = api_instance.get_aggregation_account(aggregation_account_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_aggregation_account: %s\n" % e)
```
...
# **get_aggregation_account_balance**
> SpecificAggregationAccountBalanceResponse get_aggregation_account_balance(aggregation_account_balance_id)
...
try:
    # Retrieve an aggregation account balance
    api_response = api_instance.get_aggregation_account_balance(aggregation_account_balance_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_aggregation_account_balance: %s\n" % e)
```
...
# **get_aggregation_account_balances**
> GetAggregationAccountBalanceResponse get_aggregation_account_balances(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all aggregation account balances
    api_response = api_instance.get_aggregation_account_balances(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_aggregation_account_balances: %s\n" % e)
```
...
try:
    # List all aggregation accounts
    api_response = api_instance.get_aggregation_accounts(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_aggregation_accounts: %s\n" % e)
```
...
> AllocationAssetSizeResponse get_allocation_asset_sizes(allocation_id, filter=filter)
...
try:
    # List all allocation asset sizes
    api_response = api_instance.get_allocation_asset_sizes(allocation_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_allocation_composition**
> SpecificAllocationCompositionResponse get_allocation_composition(allocation_composition_id)
...
# **get_allocation_compositions**
> GetAllocationCompositionResponse get_allocation_compositions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all allocation compositions
    api_response = api_instance.get_allocation_compositions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> AllocationHoldingsResponse get_allocation_holdings(allocation_id, filter=filter)
...
try:
    # List all allocation holdings
    api_response = api_instance.get_allocation_holdings(allocation_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> AllocationTransactionResponse get_allocation_transactions(allocation_id, filter=filter)
...
try:
    # List all allocation transactions
    api_response = api_instance.get_allocation_transactions(allocation_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_allocations**
> GetAllocationResponse get_allocations(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all allocations
    api_response = api_instance.get_allocations(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_bank_link**
> SpecificBankLinkResponse get_bank_link(bank_link_id)
...
# **get_bank_links**
> GetBankLinkResponse get_bank_links(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all bank links
    api_response = api_instance.get_bank_links(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_benchmark**
> SpecificBenchmarkResponse get_benchmark(benchmark_id)
...
# **get_benchmark_asset_sizes**
> BenchmarkAssetSizeResponse get_benchmark_asset_sizes(benchmark_id, filter=filter)
...
try:
    # List all benchmark asset sizes
    api_response = api_instance.get_benchmark_asset_sizes(benchmark_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> PerformanceResponse get_benchmark_performance(benchmark_id, stat)
...
try:
    # Get benchmark performance
    api_response = api_instance.get_benchmark_performance(benchmark_id, stat)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_benchmark_performance: %s\n" % e)
```
...
# **get_benchmarks**
> GetBenchmarkResponse get_benchmarks(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all benchmarks
    api_response = api_instance.get_benchmarks(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
try:
    # List all bulk orders
    api_response = api_instance.get_bulk_orders(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_bulk_orders: %s\n" % e)
```
...
# **get_client**
> SpecificClientResponse get_client(client_id)
...
# **get_client_asset_sizes**
> ClientAssetSizeResponse get_client_asset_sizes(client_id, filter=filter)
...
try:
    # List all client asset sizes
    api_response = api_instance.get_client_asset_sizes(client_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_client_holdings**
> ClientHoldingsResponse get_client_holdings(client_id, filter=filter)
...
try:
    # List all client holdings
    api_response = api_instance.get_client_holdings(client_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_client_hydro**
> SpecificClientHydroResponse get_client_hydro(client_hydro_id)
...
# **get_client_hydros**
> GetClientHydroResponse get_client_hydros(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all client-hydro relationships
    api_response = api_instance.get_client_hydros(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> PerformanceResponse get_client_performance(client_id, stat)
...
try:
    # Get client performance
    api_response = api_instance.get_client_performance(client_id, stat)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_client_performance: %s\n" % e)
```
...
# **get_client_response**
> SpecificClientResponseResponse get_client_response(client_response_id)
...
> GetClientResponseResponse get_client_responses(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all client responses
    api_response = api_instance.get_client_responses(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> ClientTransactionResponse get_client_transactions(client_id, filter=filter)
...
try:
    # List all client transactions
    api_response = api_instance.get_client_transactions(client_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_clients**
> GetClientResponse get_clients(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all clients
    api_response = api_instance.get_clients(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_decision_tree**
> SpecificDecisionTreeResponse get_decision_tree(decision_tree_id)
...
# **get_decision_trees**
> GetDecisionTreeResponse get_decision_trees(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all decision trees
    api_response = api_instance.get_decision_trees(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_deposit_request**
> SpecificDepositRequestResponse get_deposit_request(deposit_id)
...
> GetDepositRequestResponse get_deposit_requests(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all deposit requests
    api_response = api_instance.get_deposit_requests(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> GetFundingRequestResponse get_funding_requests(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all funding requests
    api_response = api_instance.get_funding_requests(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_goal**
> SpecificGoalResponse get_goal(goal_id)
...
# **get_goal_asset_sizes**
> GoalAssetSizeResponse get_goal_asset_sizes(goal_id, client_id, filter=filter)
...
try:
    # List goal asset sizes
    api_response = api_instance.get_goal_asset_sizes(goal_id, client_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_goal_holdings**
> GoalHoldingsResponse get_goal_holdings(goal_id, client_id, filter=filter)
...
try:
    # List goal holdings
    api_response = api_instance.get_goal_holdings(goal_id, client_id, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_goal_performance**
> PerformanceResponse get_goal_performance(goal_id, stat, client_id)
...
try:
    # Get goal performance
    api_response = api_instance.get_goal_performance(goal_id, stat, client_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_goal_performance: %s\n" % e)
```
...
# **get_goal_track_record**
> SpecificGoalTrackResponse get_goal_track_record(goal_track_id)
...
try:
    # Retrieve a goal track record
    api_response = api_instance.get_goal_track_record(goal_track_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_goal_track_record: %s\n" % e)
```
...
# **get_goal_track_records**
> GetGoalTrackResponse get_goal_track_records(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all goal track records
    api_response = api_instance.get_goal_track_records(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> GoalTransactionsResponse get_goal_transactions(goal_id, client_id, page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List goal transactions
    api_response = api_instance.get_goal_transactions(goal_id, client_id, page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_goals**
> GetGoalResponse get_goals(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all goals
    api_response = api_instance.get_goals(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_model**
> SpecificModelResponse get_model(model_id)
...
try:
    ...
    print("Exception when calling NucleusApi->get_model: %s\n" % e)
```
...
# **get_model_asset_size**
> SpecificModelAssetSizeResponse get_model_asset_size(model_asset_size_id)
...
try:
    # Retrieve a model asset size
    api_response = api_instance.get_model_asset_size(model_asset_size_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_model_asset_size: %s\n" % e)
```
...
# **get_model_asset_sizes**
> GetModelAssetSizeResponse get_model_asset_sizes(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all model asset sizes
    api_response = api_instance.get_model_asset_sizes(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_model_asset_sizes: %s\n" % e)
```
...
# **get_model_comment**
> SpecificModelCommentResponse get_model_comment(model_comment_id)
...
try:
    # Retrieve a model commentary
    api_response = api_instance.get_model_comment(model_comment_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_model_comment: %s\n" % e)
```
...
# **get_model_comments**
> GetModelCommentResponse get_model_comments(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all model commentary
    api_response = api_instance.get_model_comments(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_model_comments: %s\n" % e)
```
...
# **get_model_holding**
> SpecificModelHoldingResponse get_model_holding(model_holding_id)
...
try:
    # Retrieve a model holding
    api_response = api_instance.get_model_holding(model_holding_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_model_holding: %s\n" % e)
```
...
# **get_model_holdings**
> GetModelHoldingResponse get_model_holdings(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all model holdings
    api_response = api_instance.get_model_holdings(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_model_holdings: %s\n" % e)
```
...
> PerformanceResponse get_model_performance(model_id, stat)
...
try:
    # Get model performance
    api_response = api_instance.get_model_performance(model_id, stat)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_model_performance: %s\n" % e)
```
...
> SpecificModelTransactionResponse get_model_transaction(model_transaction_id)
...
try:
    # Retrieve a model transaction
    api_response = api_instance.get_model_transaction(model_transaction_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_model_transaction: %s\n" % e)
```
...
# **get_model_transactions**
> GetModelTransactionResponse get_model_transactions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all model transactions
    api_response = api_instance.get_model_transactions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_model_transactions: %s\n" % e)
```
...
# **get_models**
> GetModelResponse get_models(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all models
    api_response = api_instance.get_models(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_models: %s\n" % e)
```
...
# **get_node**
> SpecificNodeResponse get_node(node_id)
...
# **get_node_relationship**
> SpecificNodeRelationshipResponse get_node_relationship(node_relationship_id)
...
> GetNodeRelationshipResponse get_node_relationships(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all node relationships
    api_response = api_instance.get_node_relationships(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_nodes**
> GetNodeResponse get_nodes(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all nodes
    api_response = api_instance.get_nodes(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_order_record**
> SpecificOrderResponse get_order_record(order_id)
...
try:
    # Retrieve an order record
    api_response = api_instance.get_order_record(order_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_order_record: %s\n" % e)
```
...
# **get_order_records**
> GetOrderResponse get_order_records(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all order records
    api_response = api_instance.get_order_records(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_order_records: %s\n" % e)
```
...
# **get_order_status**
> SpecificOrderStatusResponse get_order_status(order_status_id)
...
try:
    # Retrieve an order status
    api_response = api_instance.get_order_status(order_status_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_order_status: %s\n" % e)
```
...
# **get_order_statuses**
> GetOrderStatusResponse get_order_statuses(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all order statuses
    api_response = api_instance.get_order_statuses(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_order_statuses: %s\n" % e)
```
...
# **get_order_tracking_record**
> SpecificOrderTrackResponse get_order_tracking_record(order_track_id)
...
try:
    # Retrieve an order tracking record
    api_response = api_instance.get_order_tracking_record(order_track_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_order_tracking_record: %s\n" % e)
```
...
# **get_order_tracking_records**
> GetOrderTrackResponse get_order_tracking_records(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all order tracking records
    api_response = api_instance.get_order_tracking_records(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_order_tracking_records: %s\n" % e)
```
...
# **get_portfolio**
> SpecificPortfolioResponse get_portfolio(portfolio_id)
...
try:
    # Retrieve a portfolio
    api_response = api_instance.get_portfolio(portfolio_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio: %s\n" % e)
```
...
# **get_portfolio_asset_size**
> SpecificPortfolioAssetSizeResponse get_portfolio_asset_size(portfolio_asset_size_id)
...
try:
    # Retrieve a portfolio asset size
    api_response = api_instance.get_portfolio_asset_size(portfolio_asset_size_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio_asset_size: %s\n" % e)
```
...
# **get_portfolio_asset_sizes**
> GetPortfolioAssetSizeResponse get_portfolio_asset_sizes(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all portfolio asset sizes
    api_response = api_instance.get_portfolio_asset_sizes(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio_asset_sizes: %s\n" % e)
```
...
> SpecificPortfolioCommentResponse get_portfolio_comment(portfolio_comment_id)
...
try:
    # Retrieve a portfolio commentary
    api_response = api_instance.get_portfolio_comment(portfolio_comment_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio_comment: %s\n" % e)
```
...
# **get_portfolio_comments**
> GetPortfolioCommentResponse get_portfolio_comments(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all portfolio commentary
    api_response = api_instance.get_portfolio_comments(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio_comments: %s\n" % e)
```
...
> SpecificPortfolioHoldingResponse get_portfolio_holding(portfolio_holding_id)
...
try:
    # Retrieve a portfolio holding
    api_response = api_instance.get_portfolio_holding(portfolio_holding_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio_holding: %s\n" % e)
```
...
> GetPortfolioHoldingResponse get_portfolio_holdings(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all portfolio holdings
    api_response = api_instance.get_portfolio_holdings(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio_holdings: %s\n" % e)
```
...
> PerformanceResponse get_portfolio_performance(portfolio_id, stat)
...
try:
    # Get portfolio performance
    api_response = api_instance.get_portfolio_performance(portfolio_id, stat)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio_performance: %s\n" % e)
```
...
> SpecificPortfolioTransactionResponse get_portfolio_transaction(portfolio_transaction_id)
...
try:
    # Retrieve a portfolio transaction
    api_response = api_instance.get_portfolio_transaction(portfolio_transaction_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio_transaction: %s\n" % e)
```
...
> GetPortfolioTransactionResponse get_portfolio_transactions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all portfolio transactions
    api_response = api_instance.get_portfolio_transactions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolio_transactions: %s\n" % e)
```
...
# **get_portfolios**
> GetPortfolioResponse get_portfolios(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all portfolios
    api_response = api_instance.get_portfolios(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_portfolios: %s\n" % e)
```
...
# **get_questionnaire**
> SpecificQuestionnaireResponse get_questionnaire(questionnaire_id)
...
# **get_questionnaires**
> GetQuestionnaireResponse get_questionnaires(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all questionnaires
    api_response = api_instance.get_questionnaires(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_score**
> SpecificScoreResponse get_score(score_id)
...
# **get_scores**
> GetScoreResponse get_scores(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all scores
    api_response = api_instance.get_scores(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **get_securities**
> GetSecurityResponse get_securities(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all securities
    api_response = api_instance.get_securities(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_securities: %s\n" % e)
```
...
# **get_security**
> SpecificSecurityResponse get_security(security_id)
...
try:
    # Retrieve a security
    api_response = api_instance.get_security(security_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_security: %s\n" % e)
```
...
# **get_security_exclusion**
> SpecificSecurityExclusionResponse get_security_exclusion(security_exclusion_id)
...
try:
    # Retrieve a security exclusion
    api_response = api_instance.get_security_exclusion(security_exclusion_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_security_exclusion: %s\n" % e)
```
...
# **get_security_exclusions**
> GetSecurityExclusionResponse get_security_exclusions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all security exclusions
    api_response = api_instance.get_security_exclusions(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_security_exclusions: %s\n" % e)
```
...
> PerformanceResponse get_security_performance(security_id, stat)
...
try:
    # Get security performance
    api_response = api_instance.get_security_performance(security_id, stat)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_security_performance: %s\n" % e)
```
...
# **get_security_price**
> SpecificSecurityPriceResponse get_security_price(security_price_id)
...
try:
    # Retrieve a security price
    api_response = api_instance.get_security_price(security_price_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_security_price: %s\n" % e)
```
...
# **get_security_prices**
> GetSecurityPriceResponse get_security_prices(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all security prices
    api_response = api_instance.get_security_prices(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_security_prices: %s\n" % e)
```
...
> SpecificTransactionCodeResponse get_transaction_code(transaction_code_id)
...
try:
    # Retrieve a transaction code
    api_response = api_instance.get_transaction_code(transaction_code_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_transaction_code: %s\n" % e)
```
...
> GetTransactionCodeResponse get_transaction_codes(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all transaction codes
    api_response = api_instance.get_transaction_codes(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->get_transaction_codes: %s\n" % e)
```
...
> SpecificTransferResponse get_transfer_request(transfer_id)
...
> GetTransferResponse get_transfer_requests(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all transfer requests
    api_response = api_instance.get_transfer_requests(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
> SpecificWithdrawalResponse get_withdrawal_request(withdrawal_id)
...
> GetWithdrawalResponse get_withdrawal_requests(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
...
try:
    # List all withdrawal requests
    api_response = api_instance.get_withdrawal_requests(page=page, size=size, order_by=order_by, ascending=ascending, filter=filter)
    pprint(api_response)
except ApiException as e:
...
# **post_account**
> CreateAccountResponse post_account(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.AccountCreatePayload() # AccountCreatePayload | 
...
# **post_account_allocation**
> SpecificAccountAllocationResponse post_account_allocation(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.AccountAllocationPayload() # AccountAllocationPayload | 
...
# **post_account_bulk_order**
> BulkOrderFirmclientaccountResponse post_account_bulk_order(account_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
account_id = 'account_id_example' # str | UUID of an account
payload = atom_api.BulkOrderAccountPayload() # BulkOrderAccountPayload | 

try:
    # Bulk orders for an account
    api_response = api_instance.post_account_bulk_order(account_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_account_bulk_order: %s\n" % e)
```
...
# **post_account_rebalance_buy_only_order**
> post_account_rebalance_buy_only_order(account_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
account_id = 'account_id_example' # str | UUID of an account
payload = atom_api.AccountRebalanceBuyOnlyOrderPayload() # AccountRebalanceBuyOnlyOrderPayload | 

try:
    # Create buy-only account rebalance orders
    api_instance.post_account_rebalance_buy_only_order(account_id, payload)
except ApiException as e:
    print("Exception when calling NucleusApi->post_account_rebalance_buy_only_order: %s\n" % e)
```
...
# **post_account_rebalance_order**
> SpecificOrderTrackResponse post_account_rebalance_order(account_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
account_id = 'account_id_example' # str | UUID of an account
payload = atom_api.AccountRebalanceOrderPayload() # AccountRebalanceOrderPayload | 

try:
    # Create account rebalance orders
    api_response = api_instance.post_account_rebalance_order(account_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_account_rebalance_order: %s\n" % e)
```
...
# **post_account_rebalance_sell_only_order**
> post_account_rebalance_sell_only_order(account_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
account_id = 'account_id_example' # str | UUID of an account
payload = atom_api.AccountRebalanceSellOnlyOrderPayload() # AccountRebalanceSellOnlyOrderPayload | 

try:
    # Create sell-only account rebalance orders
    api_instance.post_account_rebalance_sell_only_order(account_id, payload)
except ApiException as e:
    print("Exception when calling NucleusApi->post_account_rebalance_sell_only_order: %s\n" % e)
```
...
# **post_account_sell_all_order**
> SellAllAccountResponse post_account_sell_all_order(account_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
account_id = 'account_id_example' # str | UUID of an account
payload = atom_api.SellAllAccountPayload() # SellAllAccountPayload | 

try:
    # Sell all account order
    api_response = api_instance.post_account_sell_all_order(account_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_account_sell_all_order: %s\n" % e)
```
...
# **post_account_stage**
> SpecificAccountStageResponse post_account_stage(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.AccountStagePayload() # AccountStagePayload | 
...
# **post_account_status**
> CreateAccountStatusResponse post_account_status(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.AccountStatusPayload() # AccountStatusPayload | 
...
# **post_account_type**
> GetAccountTypeSubresponse post_account_type(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.AccountTypePayload() # AccountTypePayload | 
...
# **post_aggregation_account**
> CreateAggregationAccountResponse post_aggregation_account(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.AggregationAccountPayload() # AggregationAccountPayload | 

try:
    # Create an aggregation account
    api_response = api_instance.post_aggregation_account(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_aggregation_account: %s\n" % e)
```
...
# **post_aggregation_account_balance**
> CreateAggregationAccountBalanceResponse post_aggregation_account_balance(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.AggregationAccountBalancePayload() # AggregationAccountBalancePayload | 

try:
    # Create an aggregation account balance
    api_response = api_instance.post_aggregation_account_balance(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_aggregation_account_balance: %s\n" % e)
```
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.AllocationPayload() # AllocationPayload | 
...
# **post_allocation_composition**
> CreateAllocationCompositionResponse post_allocation_composition(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.AllocationCompositionPayload() # AllocationCompositionPayload | 
...
# **post_bank_link**
> CreateBankLinkResponse post_bank_link(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.BankLinkPayload() # BankLinkPayload | 
...
# **post_benchmark**
> CreateBenchmarkResponse post_benchmark(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.BenchmarkPayload() # BenchmarkPayload | 
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.BulkOrderFirmPayload() # BulkOrderFirmPayload | 

try:
    # Bulk orders for your firm
    api_response = api_instance.post_bulk_order(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_bulk_order: %s\n" % e)
```
...
# **post_client**
> CreateClientResponse post_client(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.ClientPayload() # ClientPayload | 
...
# **post_client_bulk_order**
> BulkOrderFirmclientaccountResponse post_client_bulk_order(client_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
client_id = 'client_id_example' # str | UUID of a client
payload = atom_api.BulkOrderClientPayload() # BulkOrderClientPayload | 

try:
    # Bulk orders for a client
    api_response = api_instance.post_client_bulk_order(client_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_client_bulk_order: %s\n" % e)
```
...
# **post_client_hydro**
> CreateClientHydroResponse post_client_hydro(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.ClientHydroPayload() # ClientHydroPayload | 
...
> CreateClientResponseResponse post_client_response(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.ClientResponsePayload() # ClientResponsePayload | 
...
# **post_decision_tree**
> CreateDecisionTreeResponse post_decision_tree(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.DecisionTreePayload() # DecisionTreePayload | 
...
> CreateDepositRequestResponse post_deposit_request(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.DepositRequestPayload() # DepositRequestPayload | 
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.FundingRequestPayload() # FundingRequestPayload | 
...
# **post_goal**
> CreateGoalResponse post_goal(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.GoalPayload() # GoalPayload | 
...
# **post_goal_track_record**
> CreateGoalTrackResponse post_goal_track_record(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.GoalTrackPayload() # GoalTrackPayload | 

try:
    # Create a goal track record
    api_response = api_instance.post_goal_track_record(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_goal_track_record: %s\n" % e)
```
...
# **post_model**
> CreateModelResponse post_model(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.ModelPayload() # ModelPayload | 

try:
    # Create a model
    api_response = api_instance.post_model(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_model: %s\n" % e)
```
...
# **post_model_asset_size**
> CreateModelAssetSizeResponse post_model_asset_size(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.ModelAssetSizePayload() # ModelAssetSizePayload | 

try:
    # Create a model asset size
    api_response = api_instance.post_model_asset_size(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_model_asset_size: %s\n" % e)
```
...
# **post_model_comment**
> CreateModelCommentResponse post_model_comment(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.ModelCommentPayload() # ModelCommentPayload | 

try:
    # Create a model commentary
    api_response = api_instance.post_model_comment(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_model_comment: %s\n" % e)
```
...
# **post_model_holding**
> CreateModelHoldingResponse post_model_holding(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.ModelHoldingPayload() # ModelHoldingPayload | 

try:
    # Create a model holding
    api_response = api_instance.post_model_holding(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_model_holding: %s\n" % e)
```
...
# **post_model_transaction**
> CreateModelTransactionResponse post_model_transaction(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.ModelTransactionPayload() # ModelTransactionPayload | 

try:
    # Create a model transaction
    api_response = api_instance.post_model_transaction(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_model_transaction: %s\n" % e)
```
...
# **post_node**
> CreateNodeResponse post_node(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.NodePayload() # NodePayload | 
...
# **post_node_relationship**
> CreateNodeRelationshipResponse post_node_relationship(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.NodeRelationshipPayload() # NodeRelationshipPayload | 
...
# **post_order_record**
> CreateOrderResponse post_order_record(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.OrderPayload() # OrderPayload | 

try:
    # Create an order record
    api_response = api_instance.post_order_record(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_order_record: %s\n" % e)
```
...
# **post_order_status**
> CreateOrderStatusResponse post_order_status(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.OrderStatusPayload() # OrderStatusPayload | 

try:
    # Create an order status
    api_response = api_instance.post_order_status(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_order_status: %s\n" % e)
```
...
# **post_order_tracking_record**
> CreateOrderTrackResponse post_order_tracking_record(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.OrderTrackPayload() # OrderTrackPayload | 

try:
    # Create an order tracking record
    api_response = api_instance.post_order_tracking_record(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_order_tracking_record: %s\n" % e)
```
...
# **post_portfolio**
> CreatePortfolioResponse post_portfolio(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.PortfolioPayload() # PortfolioPayload | 

try:
    # Create a portfolio
    api_response = api_instance.post_portfolio(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_portfolio: %s\n" % e)
```
...
# **post_portfolio_asset_size**
> CreatePortfolioAssetSizeResponse post_portfolio_asset_size(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.PortfolioAssetSizePayload() # PortfolioAssetSizePayload | 

try:
    # Create a portfolio asset size
    api_response = api_instance.post_portfolio_asset_size(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_portfolio_asset_size: %s\n" % e)
```
...
# **post_portfolio_comment**
> CreatePortfolioCommentResponse post_portfolio_comment(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.PortfolioCommentPayload() # PortfolioCommentPayload | 

try:
    # Create a portfolio commentary
    api_response = api_instance.post_portfolio_comment(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_portfolio_comment: %s\n" % e)
```
...
# **post_portfolio_holding**
> CreatePortfolioHoldingResponse post_portfolio_holding(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.PortfolioHoldingPayload() # PortfolioHoldingPayload | 

try:
    # Create a portfolio holding
    api_response = api_instance.post_portfolio_holding(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_portfolio_holding: %s\n" % e)
```
...
# **post_portfolio_rebalance_buy_only_order**
> PortfolioRebalanceBuyOnlyOrderPayload post_portfolio_rebalance_buy_only_order(portfolio_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
portfolio_id = 'portfolio_id_example' # str | UUID of a portfolio
payload = atom_api.PortfolioRebalanceBuyOnlyOrderPayload() # PortfolioRebalanceBuyOnlyOrderPayload | 

try:
    # Create buy-only portfolio rebalance orders
    api_response = api_instance.post_portfolio_rebalance_buy_only_order(portfolio_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_portfolio_rebalance_buy_only_order: %s\n" % e)
```
...
# **post_portfolio_rebalance_order**
> PortfolioRebalanceOrderPayload post_portfolio_rebalance_order(portfolio_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
portfolio_id = 'portfolio_id_example' # str | UUID of a portfolio
payload = atom_api.PortfolioRebalanceOrderPayload() # PortfolioRebalanceOrderPayload | 

try:
    # Create portfolio rebalance orders
    api_response = api_instance.post_portfolio_rebalance_order(portfolio_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_portfolio_rebalance_order: %s\n" % e)
```
...
# **post_portfolio_rebalance_sell_only_order**
> PortfolioRebalanceSellOnlyOrderPayload post_portfolio_rebalance_sell_only_order(portfolio_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
portfolio_id = 'portfolio_id_example' # str | UUID of a portfolio
payload = atom_api.PortfolioRebalanceSellOnlyOrderPayload() # PortfolioRebalanceSellOnlyOrderPayload | 

try:
    # Create sell-only portfolio rebalance orders
    api_response = api_instance.post_portfolio_rebalance_sell_only_order(portfolio_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_portfolio_rebalance_sell_only_order: %s\n" % e)
```
...
# **post_portfolio_sell_all_order**
> SellAllPortfolioResponse post_portfolio_sell_all_order(portfolio_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
portfolio_id = 'portfolio_id_example' # str | UUID of a portfolio
payload = atom_api.SellAllPortfolioPayload() # SellAllPortfolioPayload | 

try:
    # Sell all portfolio order
    api_response = api_instance.post_portfolio_sell_all_order(portfolio_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_portfolio_sell_all_order: %s\n" % e)
```
...
# **post_portfolio_transaction**
> CreatePortfolioTransactionResponse post_portfolio_transaction(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.PortfolioTransactionPayload() # PortfolioTransactionPayload | 

try:
    # Create a portfolio transaction
    api_response = api_instance.post_portfolio_transaction(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_portfolio_transaction: %s\n" % e)
```
...
# **post_questionnaire**
> CreateQuestionnaireResponse post_questionnaire(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.QuestionnairePayload() # QuestionnairePayload | 
...
# **post_score**
> CreateScoreResponse post_score(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.ScorePayload() # ScorePayload | 
...
# **post_security**
> CreateSecurityResponse post_security(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.SecurityPayload() # SecurityPayload | 

try:
    # Create a security
    api_response = api_instance.post_security(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_security: %s\n" % e)
```
...
# **post_security_exclusion**
> CreateSecurityExclusionResponse post_security_exclusion(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.SecurityExclusionPayload() # SecurityExclusionPayload | 

try:
    # Create a security exclusion
    api_response = api_instance.post_security_exclusion(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_security_exclusion: %s\n" % e)
```
...
# **post_security_price**
> CreateSecurityPriceResponse post_security_price(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.SecurityPricePayload() # SecurityPricePayload | 

try:
    # Create a security price
    api_response = api_instance.post_security_price(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_security_price: %s\n" % e)
```
...
> CreateTransactionCodeResponse post_transaction_code(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.TransactionCodePayload() # TransactionCodePayload | 

try:
    # Create a transaction code
    api_response = api_instance.post_transaction_code(payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->post_transaction_code: %s\n" % e)
```
...
> CreateTransferResponse post_transfer_request(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.TransferRequestPayload() # TransferRequestPayload | 
...
> CreateWithdrawalResponse post_withdrawal_request(payload)
...
# create an instance of the API class
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
payload = atom_api.WithdrawalPayload() # WithdrawalPayload | 
...
# **subscribe_account**
> SubscribeAccountResponse subscribe_account(account_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
account_id = 'account_id_example' # str | UUID of an account
payload = atom_api.AccountSubscribePayload() # AccountSubscribePayload | 
...
# **update_account**
> SpecificAccountResponse update_account(account_id, payload)
...
> SpecificAccountAllocationResponse update_account_allocation(account_allocation_id, payload)
...
> SpecificAccountPermissionResponse update_account_permission(account_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
account_id = 'account_id_example' # str | UUID of an account
payload = atom_api.AccountPermissionPayload() # AccountPermissionPayload | 
...
> SpecificAccountStageResponse update_account_stage(stage_id, payload)
...
> SpecificAccountStatusResponse update_account_status(account_status_id, payload)
...
# **update_account_type**
> GetAccountTypeSubresponse update_account_type(account_type_id, payload)
...
# **update_aggregation_account**
> SpecificAggregationAccountResponse update_aggregation_account(aggregation_account_id, payload)
...
try:
    # Update an aggregation account
    api_response = api_instance.update_aggregation_account(aggregation_account_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_aggregation_account: %s\n" % e)
```
...
# **update_aggregation_account_balance**
> SpecificAggregationAccountBalanceResponse update_aggregation_account_balance(aggregation_account_balance_id, payload)
...
try:
    # Update an aggregation account balance
    api_response = api_instance.update_aggregation_account_balance(aggregation_account_balance_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_aggregation_account_balance: %s\n" % e)
```
...
# **update_allocation_composition**
> GetAllocationCompositionResponse update_allocation_composition(allocation_composition_id, payload)
...
# **update_bank_link**
> SpecificBankLinkResponse update_bank_link(bank_link_id, payload)
...
# **update_benchmark**
> SpecificBenchmarkResponse update_benchmark(benchmark_id, payload)
...
# **update_client_hydro**
> SpecificClientHydroResponse update_client_hydro(client_hydro_id, payload)
...
> SpecificClientResponseResponse update_client_response(client_response_id, payload)
...
> SpecificDecisionTreeResponse update_decision_tree(decision_tree_id, payload)
...
> SpecificDepositRequestResponse update_deposit_request(deposit_id, payload)
...
# **update_goal**
> SpecificGoalResponse update_goal(goal_id, payload)
...
# **update_goal_track_record**
> SpecificGoalTrackResponse update_goal_track_record(goal_track_id, payload)
...
try:
    # Update a goal track record
    api_response = api_instance.update_goal_track_record(goal_track_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_goal_track_record: %s\n" % e)
```
...
# **update_model**
> SpecificModelResponse update_model(model_id, payload)
...
try:
    # Update a model
    api_response = api_instance.update_model(model_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_model: %s\n" % e)
```
...
# **update_model_asset_size**
> SpecificModelAssetSizeResponse update_model_asset_size(model_asset_size_id, payload)
...
try:
    # Update a model asset size
    api_response = api_instance.update_model_asset_size(model_asset_size_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_model_asset_size: %s\n" % e)
```
...
> SpecificModelCommentResponse update_model_comment(model_comment_id, payload)
...
try:
    # Update a model commentary
    api_response = api_instance.update_model_comment(model_comment_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_model_comment: %s\n" % e)
```
...
# **update_model_composition**
> ChangeModelCompositionResponse update_model_composition(model_id, payload)
...
api_instance = atom_api.NucleusApi(atom_api.ApiClient(configuration))
model_id = 'model_id_example' # str | UUID of a model
payload = atom_api.ModelCompositionPayload() # ModelCompositionPayload | 

try:
    # Change a model composition
    api_response = api_instance.update_model_composition(model_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_model_composition: %s\n" % e)
```
...
# **update_model_holding**
> SpecificModelHoldingResponse update_model_holding(model_holding_id, payload)
...
try:
    # Update a model holding
    api_response = api_instance.update_model_holding(model_holding_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_model_holding: %s\n" % e)
```
...
# **update_model_transaction**
> SpecificModelTransactionResponse update_model_transaction(model_transaction_id, payload)
...
try:
    # Update a model transaction
    api_response = api_instance.update_model_transaction(model_transaction_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_model_transaction: %s\n" % e)
```
...
# **update_node**
> SpecificNodeResponse update_node(node_id, payload)
...
> SpecificNodeRelationshipResponse update_node_relationship(node_relationship_id, payload)
...
# **update_order_record**
> SpecificOrderResponse update_order_record(order_id, payload)
...
try:
    # Update an order record
    api_response = api_instance.update_order_record(order_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_order_record: %s\n" % e)
```
...
# **update_order_status**
> SpecificOrderStatusResponse update_order_status(order_status_id, payload)
...
try:
    # Update an order status
    api_response = api_instance.update_order_status(order_status_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_order_status: %s\n" % e)
```
...
# **update_order_tracking_record**
> SpecificOrderTrackResponse update_order_tracking_record(order_track_id, payload)
...
try:
    # Update an order tracking record
    api_response = api_instance.update_order_tracking_record(order_track_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_order_tracking_record: %s\n" % e)
```
...
# **update_portfolio**
> SpecificPortfolioResponse update_portfolio(portfolio_id, payload)
...
try:
    # Update a portfolio
    api_response = api_instance.update_portfolio(portfolio_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_portfolio: %s\n" % e)
```
...
# **update_portfolio_asset_size**
> SpecificPortfolioAssetSizeResponse update_portfolio_asset_size(portfolio_asset_size_id, payload)
...
try:
    # Update a portfolio asset size
    api_response = api_instance.update_portfolio_asset_size(portfolio_asset_size_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_portfolio_asset_size: %s\n" % e)
```
...
> SpecificPortfolioCommentResponse update_portfolio_comment(portfolio_comment_id, payload)
...
try:
    # Update a portfolio commentary
    api_response = api_instance.update_portfolio_comment(portfolio_comment_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_portfolio_comment: %s\n" % e)
```
...
> SpecificPortfolioHoldingResponse update_portfolio_holding(portfolio_holding_id, payload)
...
try:
    # Update a portfolio holding
    api_response = api_instance.update_portfolio_holding(portfolio_holding_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_portfolio_holding: %s\n" % e)
```
...
> SpecificPortfolioTransactionResponse update_portfolio_transaction(portfolio_transaction_id, payload)
...
try:
    # Update a portfolio transaction
    api_response = api_instance.update_portfolio_transaction(portfolio_transaction_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_portfolio_transaction: %s\n" % e)
```
...
> SpecificQuestionnaireResponse update_questionnaire(questionnaire_id, payload)
...
# **update_score**
> SpecificScoreResponse update_score(score_id, payload)
...
# **update_security**
> SpecificSecurityResponse update_security(security_id, payload)
...
try:
    # Update a security
    api_response = api_instance.update_security(security_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_security: %s\n" % e)
```
...
# **update_security_exclusion**
> SpecificSecurityExclusionResponse update_security_exclusion(security_exclusion_id, payload)
...
try:
    # Update a security exclusion
    api_response = api_instance.update_security_exclusion(security_exclusion_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_security_exclusion: %s\n" % e)
```
...
> SpecificSecurityPriceResponse update_security_price(security_price_id, payload)
...
try:
    # Update a security price
    api_response = api_instance.update_security_price(security_price_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_security_price: %s\n" % e)
```
...
> SpecificTransactionCodeResponse update_transaction_code(transaction_code_id, payload)
...
try:
    # Update a transaction code
    api_response = api_instance.update_transaction_code(transaction_code_id, payload)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NucleusApi->update_transaction_code: %s\n" % e)
```
...
> SpecificTransferResponse update_transfer_request(transfer_id, payload)
...
> SpecificWithdrawalResponse update_withdrawal_request(withdrawal_id, payload)
