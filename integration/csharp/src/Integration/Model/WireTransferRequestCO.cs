...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class WireTransferRequestCO :  IEquatable<WireTransferRequestCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WireTransferRequestCO" /> class.
        /// </summary>
        /// <param name="nucleusFundingId">nucleusFundingId.</param>
        /// <param name="vendorRequest">vendorRequest.</param>
        public WireTransferRequestCO(Guid? nucleusFundingId = default(Guid?), Object vendorRequest = default(Object))
        {
        ...
        {
            return this.Equals(input as WireTransferRequestCO);
        }

        /// <summary>
        /// Returns true if WireTransferRequestCO instances are equal
        /// </summary>
        /// <param name="input">Instance of WireTransferRequestCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WireTransferRequestCO input)
        {
            if (input == null)
                return false;
