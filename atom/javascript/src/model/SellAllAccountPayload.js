...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.SellAllAccountPayload = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The SellAllAccountPayload model module.
   * @module model/SellAllAccountPayload
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>SellAllAccountPayload</code>.
   * @alias module:model/SellAllAccountPayload
   * @class
  ...
  /**
   * Constructs a <code>SellAllAccountPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SellAllAccountPayload} obj Optional instance to populate.
   * @return {module:model/SellAllAccountPayload} The populated <code>SellAllAccountPayload</code> instance.
   */
