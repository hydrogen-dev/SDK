...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.AnnuityCalculatorInitialBalance = factory(root.atom_api.ApiClient, root.atom_api.AnnuityDepositSchedule);
  }
  ...
  /**
   * The AnnuityCalculatorInitialBalance model module.
   * @module model/AnnuityCalculatorInitialBalance
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>AnnuityCalculatorInitialBalance</code>.
   * @alias module:model/AnnuityCalculatorInitialBalance
   * @class
   ...
   */
  var exports = function(portfolioReturn, accumulationHorizon, decumulationHorizon, annuityAmount) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AnnuityCalculatorInitialBalance</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AnnuityCalculatorInitialBalance} obj Optional instance to populate.
   * @return {module:model/AnnuityCalculatorInitialBalance} The populated <code>AnnuityCalculatorInitialBalance</code> instance.
   */
   ...
   * @member {module:model/AnnuityCalculatorInitialBalance.AnnuityFrequencyIntervalEnum} annuity_frequency_interval
   * @default 'year'
   */
