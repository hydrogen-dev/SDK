...
class GoalApi(object):
    ...
    def delete_goal_track_using_delete(self, goal_track_id, goal_track_id2, **kwargs):  # noqa: E501
        """Delete a goal track record  # noqa: E501

        Permanently delete an goal track record for a goal under a client.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_goal_track_using_delete(goal_track_id, goal_track_id2, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str goal_track_id: UUID goal_track_id (required)
        :param str goal_track_id2: goal_track_id (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_goal_track_using_delete_with_http_info(goal_track_id, goal_track_id2, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_goal_track_using_delete_with_http_info(goal_track_id, goal_track_id2, **kwargs)  # noqa: E501
            return data

    def delete_goal_track_using_delete_with_http_info(self, goal_track_id, goal_track_id2, **kwargs):  # noqa: E501
        """Delete a goal track record  # noqa: E501

        Permanently delete an goal track record for a goal under a client.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_goal_track_using_delete_with_http_info(goal_track_id, goal_track_id2, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['goal_track_id', 'goal_track_id2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('goal_track_id2' not in params or
                params['goal_track_id2'] is None):
            raise ValueError("Missing the required parameter `goal_track_id2` when calling `delete_goal_track_using_delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'goal_track_id' in params:
            path_params['goalTrackId'] = params['goal_track_id']  # noqa: E501
        if 'goal_track_id2' in params:
            path_params['goal_track_id'] = params['goal_track_id2']  # noqa: E501
    ...
    def get_goal_asset_size_all_using_get_with_http_info(self, client_id, goal_id, **kwargs):  # noqa: E501
        ...
        all_params = ['client_id', 'goal_id', 'end_date', 'get_latest', 'portfolio_goal', 'sort_type', 'start_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_goal_holding_all_using_get_with_http_info(self, client_id, goal_id, **kwargs):  # noqa: E501
        ...
        all_params = ['client_id', 'goal_id', 'end_date', 'portfolio_goal', 'start_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_goal_track_using_get(self, goal_track_id, goal_track_id2, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_goal_track_using_get(goal_track_id, goal_track_id2, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_goal_track_using_get_with_http_info(goal_track_id, goal_track_id2, **kwargs)  # noqa: E501
        else:
            (data) = self.get_goal_track_using_get_with_http_info(goal_track_id, goal_track_id2, **kwargs)  # noqa: E501
            return data

    def get_goal_track_using_get_with_http_info(self, goal_track_id, goal_track_id2, **kwargs):  # noqa: E501
        """Retrieve a goal track record  # noqa: E501

        Retrieve the information for a specific goal track record for a goal under a client.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_goal_track_using_get_with_http_info(goal_track_id, goal_track_id2, async_req=True)
        >>> result = thread.get()
        ...
        if ('goal_track_id2' not in params or
                params['goal_track_id2'] is None):
            raise ValueError("Missing the required parameter `goal_track_id2` when calling `get_goal_track_using_get`")  # noqa: E501
    ...
    def get_goal_transaction_all_using_get_with_http_info(self, client_id, goal_id, **kwargs):  # noqa: E501
        ...
        all_params = ['client_id', 'goal_id', 'ascending', 'end_date', 'order_by', 'page', 'portfolio_goal', 'size', 'start_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
