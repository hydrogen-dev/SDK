...
class AccountApi(object):
    ...
    def delete_account_type_using_delete(self, account_type_id, account_type_id2, **kwargs):  # noqa: E501
        """Delete an account type  # noqa: E501

        Permanently delete a possible account type defined for your firm.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_account_type_using_delete(account_type_id, account_type_id2, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str account_type_id: UUID account_type_id (required)
        :param str account_type_id2: account_type_id (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_account_type_using_delete_with_http_info(account_type_id, account_type_id2, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_account_type_using_delete_with_http_info(account_type_id, account_type_id2, **kwargs)  # noqa: E501
            return data

    def delete_account_type_using_delete_with_http_info(self, account_type_id, account_type_id2, **kwargs):  # noqa: E501
        """Delete an account type  # noqa: E501

        Permanently delete a possible account type defined for your firm.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_account_type_using_delete_with_http_info(account_type_id, account_type_id2, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['account_type_id', 'account_type_id2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('account_type_id2' not in params or
                params['account_type_id2'] is None):
            raise ValueError("Missing the required parameter `account_type_id2` when calling `delete_account_type_using_delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'account_type_id' in params:
            path_params['accountTypeId'] = params['account_type_id']  # noqa: E501
        if 'account_type_id2' in params:
            path_params['account_type_id'] = params['account_type_id2']  # noqa: E501
    ...
    def get_account_asset_size_agg_all_using_get_with_http_info(self, account_id, **kwargs):  # noqa: E501
        ...
        all_params = ['account_id', 'end_date', 'exclude_subledger', 'get_latest', 'sort_type', 'start_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_account_overview_using_get_with_http_info(self, account_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='AccountOverviewVO',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_account_type_using_get(self, account_type_id, account_type_id2, **kwargs):  # noqa: E501
        """Get an Account Type  # noqa: E501

        Get an account types defined for your firm.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_account_type_using_get(account_type_id, account_type_id2, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_account_type_using_get_with_http_info(account_type_id, account_type_id2, **kwargs)  # noqa: E501
        else:
            (data) = self.get_account_type_using_get_with_http_info(account_type_id, account_type_id2, **kwargs)  # noqa: E501
            return data

    def get_account_type_using_get_with_http_info(self, account_type_id, account_type_id2, **kwargs):  # noqa: E501
        """Get an Account Type  # noqa: E501

        Get an account types defined for your firm.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_account_type_using_get_with_http_info(account_type_id, account_type_id2, async_req=True)
        >>> result = thread.get()
        ...
        if ('account_type_id2' not in params or
                params['account_type_id2'] is None):
            raise ValueError("Missing the required parameter `account_type_id2` when calling `get_account_type_using_get`")  # noqa: E501
    ...
    def get_portfolio_holding_agg_all_using_get_with_http_info(self, account_id, **kwargs):  # noqa: E501
        ...
        all_params = ['account_id', 'end_date', 'get_latest', 'start_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_portfolio_transaction_agg_all_using_get_with_http_info(self, account_id, **kwargs):  # noqa: E501
        ...
        all_params = ['account_id', 'ascending', 'end_date', 'order_by', 'page', 'size', 'start_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
