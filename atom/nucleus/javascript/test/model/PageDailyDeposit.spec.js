...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageDailyDeposit();
  });
  ...
  describe('PageDailyDeposit', function() {
    it('should create an instance of PageDailyDeposit', function() {
      // uncomment below and update the code to test PageDailyDeposit
      //var instane = new HydrogenNucleusApi.PageDailyDeposit();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageDailyDeposit);
    });
