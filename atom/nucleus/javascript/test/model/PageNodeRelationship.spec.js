...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageNodeRelationship();
  });
  ...
  describe('PageNodeRelationship', function() {
    it('should create an instance of PageNodeRelationship', function() {
      // uncomment below and update the code to test PageNodeRelationship
      //var instane = new HydrogenNucleusApi.PageNodeRelationship();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageNodeRelationship);
    });
