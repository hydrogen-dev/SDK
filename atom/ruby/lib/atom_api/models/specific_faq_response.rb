...
module AtomApi
  class SpecificFaqResponse
    ...
    def hash
      [id, create_date, question, answer, category, subcategory, is_active, number, seo_name, faq_keywords, is_featured, secondary_id, metadata, update_date].hash
    end
