...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PagePortfolioHoldingAgg();
  });
  ...
  describe('PagePortfolioHoldingAgg', function() {
    it('should create an instance of PagePortfolioHoldingAgg', function() {
      // uncomment below and update the code to test PagePortfolioHoldingAgg
      //var instane = new HydrogenNucleusApi.PagePortfolioHoldingAgg();
      //expect(instance).to.be.a(HydrogenNucleusApi.PagePortfolioHoldingAgg);
    });
