...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.PageKmsConfig();
  });
  ...
  describe('PageKmsConfig', function() {
    it('should create an instance of PageKmsConfig', function() {
      // uncomment below and update the code to test PageKmsConfig
      //var instane = new HydrogenIntegrationApi.PageKmsConfig();
      //expect(instance).to.be.a(HydrogenIntegrationApi.PageKmsConfig);
    });
