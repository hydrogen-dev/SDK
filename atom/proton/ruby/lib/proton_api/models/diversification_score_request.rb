...
module ProtonApi
  class DiversificationScoreRequest
    ...
    def hash
      [portfolio_tickers, create_log, aggregation_account_id, allocation_id, model_id, portfolio_weights, end_date, start_date, use_proxy_data, account_id, market_data_source, portfolio_id].hash
    end
