...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAdminClient();
  });
  ...
  describe('PageAdminClient', function() {
    it('should create an instance of PageAdminClient', function() {
      // uncomment below and update the code to test PageAdminClient
      //var instane = new HydrogenNucleusApi.PageAdminClient();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAdminClient);
    });
