...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageNotificationClient();
  });
  ...
  describe('PageNotificationClient', function() {
    it('should create an instance of PageNotificationClient', function() {
      ...
      //var instane = new HydrogenAtomApi.PageNotificationClient();
      //expect(instance).to.be.a(HydrogenAtomApi.PageNotificationClient);
    });
