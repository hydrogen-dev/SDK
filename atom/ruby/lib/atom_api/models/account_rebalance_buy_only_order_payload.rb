...
module AtomApi
  class AccountRebalanceBuyOnlyOrderPayload
    ...
    def hash
      [buy_transaction_code_id, sell_transaction_code_id, buy_threshold, cash_portfolio_id, commit_orders, non_fractional, port_threshold, restrictions_on, sell_threshold, use_strategic].hash
    end
