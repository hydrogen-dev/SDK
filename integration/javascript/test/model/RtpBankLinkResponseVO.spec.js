...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.RtpBankLinkResponseVO();
  });
  ...
  describe('RtpBankLinkResponseVO', function() {
    it('should create an instance of RtpBankLinkResponseVO', function() {
      // uncomment below and update the code to test RtpBankLinkResponseVO
      //var instane = new HydrogenIntegrationApi.RtpBankLinkResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.RtpBankLinkResponseVO);
    });
