...
public class SpecificGoalTrackResponse {
  @SerializedName("id")
  ...
  public SpecificGoalTrackResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public SpecificGoalTrackResponse createDate(String createDate) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse goalId(UUID goalId) {
    this.goalId = goalId;
    return this;
  }
  ...
  **/
  ...
  public SpecificGoalTrackResponse clientId(UUID clientId) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse goalAmount(Double goalAmount) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse accumulationHorizon(Double accumulationHorizon) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse decumulationHorizon(Double decumulationHorizon) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse accounts(List<UUID> accounts) {
    this.accounts = accounts;
    return this;
  }

  public SpecificGoalTrackResponse addAccountsItem(UUID accountsItem) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse currentInvestment(Double currentInvestment) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse onTrack(Boolean onTrack) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse progress(Double progress) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse goalProbability(Double goalProbability) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse goalAchievementScore(Double goalAchievementScore) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse projectionBalance(Double projectionBalance) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse projectionDate(LocalDate projectionDate) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse statusTimeStamp(String statusTimeStamp) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse metadata(Object metadata) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse secondaryId(String secondaryId) {
  ...
  **/
  ...
  public SpecificGoalTrackResponse updateDate(String updateDate) {
   ...
   * @return updateDate
  **/
  @ApiModelProperty(value = "Datetime the goal track record was last updated")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SpecificGoalTrackResponse specificGoalTrackResponse = (SpecificGoalTrackResponse) o;
    return Objects.equals(this.id, specificGoalTrackResponse.id) &&
        Objects.equals(this.createDate, specificGoalTrackResponse.createDate) &&
        Objects.equals(this.goalId, specificGoalTrackResponse.goalId) &&
        Objects.equals(this.clientId, specificGoalTrackResponse.clientId) &&
        Objects.equals(this.goalAmount, specificGoalTrackResponse.goalAmount) &&
        Objects.equals(this.accumulationHorizon, specificGoalTrackResponse.accumulationHorizon) &&
        Objects.equals(this.decumulationHorizon, specificGoalTrackResponse.decumulationHorizon) &&
        Objects.equals(this.accounts, specificGoalTrackResponse.accounts) &&
        Objects.equals(this.currentInvestment, specificGoalTrackResponse.currentInvestment) &&
        Objects.equals(this.onTrack, specificGoalTrackResponse.onTrack) &&
        Objects.equals(this.progress, specificGoalTrackResponse.progress) &&
        Objects.equals(this.goalProbability, specificGoalTrackResponse.goalProbability) &&
        Objects.equals(this.goalAchievementScore, specificGoalTrackResponse.goalAchievementScore) &&
        Objects.equals(this.projectionBalance, specificGoalTrackResponse.projectionBalance) &&
        Objects.equals(this.projectionDate, specificGoalTrackResponse.projectionDate) &&
        Objects.equals(this.statusTimeStamp, specificGoalTrackResponse.statusTimeStamp) &&
        Objects.equals(this.metadata, specificGoalTrackResponse.metadata) &&
        Objects.equals(this.secondaryId, specificGoalTrackResponse.secondaryId) &&
        Objects.equals(this.updateDate, specificGoalTrackResponse.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createDate, goalId, clientId, goalAmount, accumulationHorizon, decumulationHorizon, accounts, currentInvestment, onTrack, progress, goalProbability, goalAchievementScore, projectionBalance, projectionDate, statusTimeStamp, metadata, secondaryId, updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class SpecificGoalTrackResponse {\n");
