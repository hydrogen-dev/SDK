...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageAggregationAccount();
  });
  ...
  describe('PageAggregationAccount', function() {
    it('should create an instance of PageAggregationAccount', function() {
      ...
      //var instane = new HydrogenAtomApi.PageAggregationAccount();
      //expect(instance).to.be.a(HydrogenAtomApi.PageAggregationAccount);
    });
