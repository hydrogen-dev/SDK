...
${nuget_cmd} install src/Proton/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Proton.dll"
...
then
  ...
  echo "[INFO] bin/Proton.dll was created successfully"
fi
