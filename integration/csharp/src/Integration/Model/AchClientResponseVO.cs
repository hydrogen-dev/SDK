...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchClientResponseVO :  IEquatable<AchClientResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchClientResponseVO" /> class.
        /// </summary>
        ...
        public AchClientResponseVO(string message = default(string), Guid? nucleusClientId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as AchClientResponseVO);
        }

        /// <summary>
        /// Returns true if AchClientResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchClientResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchClientResponseVO input)
        {
            if (input == null)
                return false;
