...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenBurnParams', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.TokenBurnParams();
      });

      it('should create an instance of TokenBurnParams', function() {
        // TODO: update the code to test TokenBurnParams
        expect(instance).to.be.a(MoleculeApiDocumentation.TokenBurnParams);
      });
