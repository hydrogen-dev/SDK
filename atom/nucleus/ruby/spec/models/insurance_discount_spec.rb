...
# Unit tests for NucleusApi::InsuranceDiscount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InsuranceDiscount' do
  before do
    # run before each test
    @instance = NucleusApi::InsuranceDiscount.new
  end
  ...
  describe 'test an instance of InsuranceDiscount' do
    it 'should create an instance of InsuranceDiscount' do
      expect(@instance).to be_instance_of(NucleusApi::InsuranceDiscount)
    end
  end
