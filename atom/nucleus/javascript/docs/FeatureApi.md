...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **featureTrackId** | [**String**](.md)| UUID feature_track_id | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **featureId** | [**String**](.md)| UUID feature_id | 
...
var featureTrack = null; // Object | feature_track
...
var feature = null; // Object | feature
