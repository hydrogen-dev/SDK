...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAccountAllocationMapping();
  });
  ...
  describe('PageAccountAllocationMapping', function() {
    it('should create an instance of PageAccountAllocationMapping', function() {
      // uncomment below and update the code to test PageAccountAllocationMapping
      //var instane = new HydrogenNucleusApi.PageAccountAllocationMapping();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAccountAllocationMapping);
    });
