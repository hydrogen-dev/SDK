...
module AtomApi
  class LifeInsuranceReturnDetail
    ...
    def list_invalid_properties
      ...
      if !@cumulative_withdrawals.nil? && @cumulative_withdrawals < 0
    ...
    def valid?
      ...
      return false if !@cumulative_withdrawals.nil? && @cumulative_withdrawals < 0
    ...
    def hash
      [period_earnings, period_withdrawal, cumulative_earnings, cumulative_withdrawals, ending_balance].hash
    end
