...
module ProtonApi
  class PurchaseCalculatorDepositAmountRequest
    ...
    def hash
      [inflation_rate, purchase_horizon, investment_tax, deposit_schedule, portfolio_return, aggregation_account_ids, horizon_frequency_interval, account_ids, purchase_amount, current_savings].hash
    end
