...
module AtomApi
  class AggregationAccountTransactionPayload
    ...
    def hash
      [aggregation_account_id, currency_code, transaction_date, bank_credit, investment, is_excluded_analysis, secondary_id, metadata].hash
    end
