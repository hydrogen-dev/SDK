...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.AchBusinessResponseVO();
  });
  ...
  describe('AchBusinessResponseVO', function() {
    it('should create an instance of AchBusinessResponseVO', function() {
      // uncomment below and update the code to test AchBusinessResponseVO
      //var instane = new HydrogenIntegrationApi.AchBusinessResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.AchBusinessResponseVO);
    });
