...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.RetirementCalculatorExpenses = factory(root.atom_api.ApiClient, root.atom_api.DepositSchedule);
  }
  ...
  /**
   * The RetirementCalculatorExpenses model module.
   * @module model/RetirementCalculatorExpenses
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>RetirementCalculatorExpenses</code>.
   * @alias module:model/RetirementCalculatorExpenses
   * @class
  ...
  /**
   * Constructs a <code>RetirementCalculatorExpenses</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RetirementCalculatorExpenses} obj Optional instance to populate.
   * @return {module:model/RetirementCalculatorExpenses} The populated <code>RetirementCalculatorExpenses</code> instance.
   */
