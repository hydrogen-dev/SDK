...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageRoundupSettings();
  });
  ...
  describe('PageRoundupSettings', function() {
    it('should create an instance of PageRoundupSettings', function() {
      ...
      //var instane = new HydrogenAtomApi.PageRoundupSettings();
      //expect(instance).to.be.a(HydrogenAtomApi.PageRoundupSettings);
    });
