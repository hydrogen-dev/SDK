...
class TokenCreateResponse(object):
    ...
    def __init__(self, symbol=None, name=None, nucleus_model_id=None, owner_wallet_id=None, total_supply=None, circulating_supply=None, whitelist_address=None, conract_address=None, crowdsale_address=None, restrictions=None, offering_settings=None, metadata=None, secondary_id=None, id=None, create_date=None):  # noqa: E501
