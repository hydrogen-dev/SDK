...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.PropertyValueResponseVO();
  });
  ...
  describe('PropertyValueResponseVO', function() {
    it('should create an instance of PropertyValueResponseVO', function() {
      // uncomment below and update the code to test PropertyValueResponseVO
      //var instane = new HydrogenIntegrationApi.PropertyValueResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.PropertyValueResponseVO);
    });
