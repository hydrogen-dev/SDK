...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.BusinessAddress();
  });
  ...
  describe('BusinessAddress', function() {
    it('should create an instance of BusinessAddress', function() {
      ...
      //var instane = new HydrogenNucleusApi.BusinessAddress();
      //expect(instance).to.be.a(HydrogenNucleusApi.BusinessAddress);
    });
