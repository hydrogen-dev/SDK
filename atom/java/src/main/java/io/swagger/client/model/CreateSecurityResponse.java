...
public class CreateSecurityResponse {
  ...
  public CreateSecurityResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CreateSecurityResponse ticker(String ticker) {
    this.ticker = ticker;
    return this;
  }
  ...
  **/
  ...
  public CreateSecurityResponse assetClass(String assetClass) {
  ...
  **/
  ...
  public CreateSecurityResponse sector(String sector) {
    this.sector = sector;
    return this;
  }
  ...
  **/
  ...
  public CreateSecurityResponse industry(String industry) {
  ...
  **/
  ...
  public CreateSecurityResponse securityClass(String securityClass) {
  ...
  **/
  ...
  public CreateSecurityResponse exchange(String exchange) {
  ...
  **/
  ...
  public CreateSecurityResponse proxyId(UUID proxyId) {
  ...
  **/
  ...
  public CreateSecurityResponse currencyCode(String currencyCode) {
  ...
  **/
  ...
  public CreateSecurityResponse isActive(Boolean isActive) {
  ...
  **/
  ...
  public CreateSecurityResponse securityComposition(List<SecurityPayloadSecurityComposition> securityComposition) {
    this.securityComposition = securityComposition;
    return this;
  }

  public CreateSecurityResponse addSecurityCompositionItem(SecurityPayloadSecurityComposition securityCompositionItem) {
  ...
  **/
  ...
  public CreateSecurityResponse securityCountry(List<SecurityPayloadSecurityCountry> securityCountry) {
    this.securityCountry = securityCountry;
    return this;
  }

  public CreateSecurityResponse addSecurityCountryItem(SecurityPayloadSecurityCountry securityCountryItem) {
  ...
  **/
  ...
  public CreateSecurityResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public CreateSecurityResponse createDate(String createDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateSecurityResponse createSecurityResponse = (CreateSecurityResponse) o;
    return Objects.equals(this.name, createSecurityResponse.name) &&
        Objects.equals(this.ticker, createSecurityResponse.ticker) &&
        Objects.equals(this.assetClass, createSecurityResponse.assetClass) &&
        Objects.equals(this.sector, createSecurityResponse.sector) &&
        Objects.equals(this.industry, createSecurityResponse.industry) &&
        Objects.equals(this.securityClass, createSecurityResponse.securityClass) &&
        Objects.equals(this.exchange, createSecurityResponse.exchange) &&
        Objects.equals(this.proxyId, createSecurityResponse.proxyId) &&
        Objects.equals(this.currencyCode, createSecurityResponse.currencyCode) &&
        Objects.equals(this.isActive, createSecurityResponse.isActive) &&
        Objects.equals(this.securityComposition, createSecurityResponse.securityComposition) &&
        Objects.equals(this.securityCountry, createSecurityResponse.securityCountry) &&
        Objects.equals(this.id, createSecurityResponse.id) &&
        Objects.equals(this.createDate, createSecurityResponse.createDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, ticker, assetClass, sector, industry, securityClass, exchange, proxyId, currencyCode, isActive, securityComposition, securityCountry, id, createDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSecurityResponse {\n");
