...
public class GoalApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getGoalHoldingAllUsingGetCall(UUID clientId, UUID goalId, String currencyConversion, LocalDate endDate, Boolean portfolioGoal, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getGoalHoldingAllUsingGetValidateBeforeCall(UUID clientId, UUID goalId, String currencyConversion, LocalDate endDate, Boolean portfolioGoal, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getGoalHoldingAllUsingGetCall(clientId, goalId, currencyConversion, endDate, portfolioGoal, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<PortfolioHoldingAgg> getGoalHoldingAllUsingGet(UUID clientId, UUID goalId, String currencyConversion, LocalDate endDate, Boolean portfolioGoal, LocalDate startDate) throws ApiException {
        ApiResponse<List<PortfolioHoldingAgg>> resp = getGoalHoldingAllUsingGetWithHttpInfo(clientId, goalId, currencyConversion, endDate, portfolioGoal, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<PortfolioHoldingAgg>> getGoalHoldingAllUsingGetWithHttpInfo(UUID clientId, UUID goalId, String currencyConversion, LocalDate endDate, Boolean portfolioGoal, LocalDate startDate) throws ApiException {
        com.squareup.okhttp.Call call = getGoalHoldingAllUsingGetValidateBeforeCall(clientId, goalId, currencyConversion, endDate, portfolioGoal, startDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getGoalHoldingAllUsingGetAsync(UUID clientId, UUID goalId, String currencyConversion, LocalDate endDate, Boolean portfolioGoal, LocalDate startDate, final ApiCallback<List<PortfolioHoldingAgg>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getGoalHoldingAllUsingGetValidateBeforeCall(clientId, goalId, currencyConversion, endDate, portfolioGoal, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<PortfolioHoldingAgg>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getGoalTransactionAllUsingGetCall(UUID clientId, UUID goalId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Boolean portfolioGoal, Integer size, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getGoalTransactionAllUsingGetValidateBeforeCall(UUID clientId, UUID goalId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Boolean portfolioGoal, Integer size, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getGoalTransactionAllUsingGetCall(clientId, goalId, ascending, currencyConversion, endDate, orderBy, page, portfolioGoal, size, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PagePortfolioTransaction getGoalTransactionAllUsingGet(UUID clientId, UUID goalId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Boolean portfolioGoal, Integer size, LocalDate startDate) throws ApiException {
        ApiResponse<PagePortfolioTransaction> resp = getGoalTransactionAllUsingGetWithHttpInfo(clientId, goalId, ascending, currencyConversion, endDate, orderBy, page, portfolioGoal, size, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PagePortfolioTransaction> getGoalTransactionAllUsingGetWithHttpInfo(UUID clientId, UUID goalId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Boolean portfolioGoal, Integer size, LocalDate startDate) throws ApiException {
        com.squareup.okhttp.Call call = getGoalTransactionAllUsingGetValidateBeforeCall(clientId, goalId, ascending, currencyConversion, endDate, orderBy, page, portfolioGoal, size, startDate, null, null);
    ...
    public com.squareup.okhttp.Call getGoalTransactionAllUsingGetAsync(UUID clientId, UUID goalId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Boolean portfolioGoal, Integer size, LocalDate startDate, final ApiCallback<PagePortfolioTransaction> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getGoalTransactionAllUsingGetValidateBeforeCall(clientId, goalId, ascending, currencyConversion, endDate, orderBy, page, portfolioGoal, size, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PagePortfolioTransaction>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
