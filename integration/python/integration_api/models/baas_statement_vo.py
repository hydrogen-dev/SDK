...
class BaasStatementVO(object):
    ...
    def __init__(self, statement_content=None, statement_content_type=None, statement_date=None, statement_link=None, statement_link_expiry=None, statement_name=None, _configuration=None):  # noqa: E501
