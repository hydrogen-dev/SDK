...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageAccountPermissionVO();
  });
  ...
  describe('PageAccountPermissionVO', function() {
    it('should create an instance of PageAccountPermissionVO', function() {
      ...
      //var instane = new HydrogenAtomApi.PageAccountPermissionVO();
      //expect(instance).to.be.a(HydrogenAtomApi.PageAccountPermissionVO);
    });
