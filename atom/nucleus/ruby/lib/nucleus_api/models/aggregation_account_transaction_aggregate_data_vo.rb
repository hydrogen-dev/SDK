...
module NucleusApi
  class AggregationAccountTransactionAggregateDataVO
    attr_accessor :aggregation_account_transaction_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'aggregation_account_transaction_id')
        self.aggregation_account_transaction_id = attributes[:'aggregation_account_transaction_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          aggregation_account_transaction_id == o.aggregation_account_transaction_id &&
    ...
    def hash
      [aggregation_account_transaction_id, bank_credit, create_date, currency_code, investment, is_excluded_analysis, metadata, secondary_id, status, transaction_date, update_date].hash
    end
