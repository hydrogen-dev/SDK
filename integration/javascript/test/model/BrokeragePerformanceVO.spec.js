  ...
  describe('(package)', function() {
    describe('BrokeragePerformanceVO', function() {
      ...
      it('should create an instance of BrokeragePerformanceVO', function() {
        // TODO: update the code to test BrokeragePerformanceVO
      ...
      it('should have the property holdingsPerformance (base name: "holdings_performance")', function() {
        // TODO: update the code to test the property holdingsPerformance
        expect(instance).to.have.property('holdingsPerformance');
        // expect(instance.holdingsPerformance).to.be(expectedValueLiteral);
      });
