...
module NucleusApi
  class OverflowApi
    ...
    def create_overflow_settings_using_post_with_http_info(overflow_settings, opts = {})
      ...
      # resource path
      local_var_path = '/overflow_setting'
    ...
    def delete_overflow_settings_using_delete_with_http_info(overflow_settings_id, opts = {})
      ...
      # resource path
      local_var_path = '/overflow_setting/{overflow_settings_id}'.sub('{' + 'overflow_settings_id' + '}', overflow_settings_id.to_s)
    ...
    def get_overflow_using_get_with_http_info(overflow_id, opts = {})
      ...
      # resource path
      local_var_path = '/overflow/{overflow_id}'.sub('{' + 'overflow_id' + '}', overflow_id.to_s)
