...
# Unit tests for NucleusApi::Portfolio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Portfolio' do
  before do
    # run before each test
    @instance = NucleusApi::Portfolio.new
  end
  ...
  describe 'test an instance of Portfolio' do
    it 'should create an instance of Portfolio' do
      expect(@instance).to be_instance_of(NucleusApi::Portfolio)
    end
  end
  ...
  describe 'test attribute "is_subledger"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
