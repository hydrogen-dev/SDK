...
module IntegrationApi
  class AccountingApi
    ...
    def create_or_update_bill_payment(nucleus_invoice_id, opts = {})
      data, _status_code, _headers = create_or_update_bill_payment_with_http_info(nucleus_invoice_id, opts)
      data
    end
    ...
    def create_or_update_bill_payment_with_http_info(nucleus_invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.create_or_update_bill_payment ...'
      end
      ...
      if @api_client.config.client_side_validation && nucleus_invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'nucleus_invoice_id' when calling AccountingApi.create_or_update_bill_payment"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingApi#create_or_update_bill_payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [AccountingFinalResponseVO]
    def create_or_update_bills(nucleus_contact_id, start_date, opts = {})
      data, _status_code, _headers = create_or_update_bills_with_http_info(nucleus_contact_id, start_date, opts)
      data
    end
    ...
    # @return [Array<(AccountingFinalResponseVO, Fixnum, Hash)>] AccountingFinalResponseVO data, response status code and response headers
    def create_or_update_bills_with_http_info(nucleus_contact_id, start_date, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.create_or_update_bills ...'
      end
      ...
      if @api_client.config.client_side_validation && nucleus_contact_id.nil?
        fail ArgumentError, "Missing the required parameter 'nucleus_contact_id' when calling AccountingApi.create_or_update_bills"
      end
      # verify the required parameter 'start_date' is set
      if @api_client.config.client_side_validation && start_date.nil?
        fail ArgumentError, "Missing the required parameter 'start_date' when calling AccountingApi.create_or_update_bills"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'AccountingFinalResponseVO')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingApi#create_or_update_bills\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [AccountingFinalResponseVO]
    def create_or_update_customer(opts = {})
      data, _status_code, _headers = create_or_update_customer_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :nucleus_client_id nucleus_client_id
    # @return [Array<(AccountingFinalResponseVO, Fixnum, Hash)>] AccountingFinalResponseVO data, response status code and response headers
    def create_or_update_customer_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [DateTime] :end_date end_date (default to null)
    # @return [AccountingFinalResponseVO]
    def create_or_update_customer_revenue(nucleus_contact_id, start_date, opts = {})
      data, _status_code, _headers = create_or_update_customer_revenue_with_http_info(nucleus_contact_id, start_date, opts)
      data
    end
    ...
    # @option opts [DateTime] :end_date end_date
    # @return [Array<(AccountingFinalResponseVO, Fixnum, Hash)>] AccountingFinalResponseVO data, response status code and response headers
    def create_or_update_customer_revenue_with_http_info(nucleus_contact_id, start_date, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.create_or_update_customer_revenue ...'
      end
      # verify the required parameter 'nucleus_contact_id' is set
      if @api_client.config.client_side_validation && nucleus_contact_id.nil?
        fail ArgumentError, "Missing the required parameter 'nucleus_contact_id' when calling AccountingApi.create_or_update_customer_revenue"
      end
      # verify the required parameter 'start_date' is set
      if @api_client.config.client_side_validation && start_date.nil?
    ...
    # @option opts [DateTime] :end_date end_date (default to null)
    # @return [AccountingFinalResponseVO]
    def create_or_update_invoices(nucleus_contact_id, start_date, opts = {})
      data, _status_code, _headers = create_or_update_invoices_with_http_info(nucleus_contact_id, start_date, opts)
      data
    end
    ...
    # @option opts [DateTime] :end_date end_date
    # @return [Array<(AccountingFinalResponseVO, Fixnum, Hash)>] AccountingFinalResponseVO data, response status code and response headers
    def create_or_update_invoices_with_http_info(nucleus_contact_id, start_date, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.create_or_update_invoices ...'
      end
      # verify the required parameter 'nucleus_contact_id' is set
      if @api_client.config.client_side_validation && nucleus_contact_id.nil?
        fail ArgumentError, "Missing the required parameter 'nucleus_contact_id' when calling AccountingApi.create_or_update_invoices"
      end
      # verify the required parameter 'start_date' is set
      if @api_client.config.client_side_validation && start_date.nil?
    ...
    # @option opts [String] :nucleus_client_id nucleus_client_id
    # @return [AccountingFinalResponseVO]
    def create_or_update_supplier(opts = {})
      data, _status_code, _headers = create_or_update_supplier_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :nucleus_client_id nucleus_client_id
    # @return [Array<(AccountingFinalResponseVO, Fixnum, Hash)>] AccountingFinalResponseVO data, response status code and response headers
    def create_or_update_supplier_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.create_or_update_supplier ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'AccountingFinalResponseVO')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingApi#create_or_update_supplier\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_accounting_vendor_info_using_client_id(id, opts = {})
      data, _status_code, _headers = get_accounting_vendor_info_using_client_id_with_http_info(id, opts)
      data
    end
    ...
    def get_accounting_vendor_info_using_client_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.get_accounting_vendor_info_using_client_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountingApi.get_accounting_vendor_info_using_client_id"
      end
      # resource path
      local_var_path = '/accounting/vendor/{id}'.sub('{' + 'id' + '}', id.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [AccountingFinalResponseVO]
    def update_bill(nucleus_invoice_id, opts = {})
      data, _status_code, _headers = update_bill_with_http_info(nucleus_invoice_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountingFinalResponseVO, Fixnum, Hash)>] AccountingFinalResponseVO data, response status code and response headers
    def update_bill_with_http_info(nucleus_invoice_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.update_bill ...'
      end
      # verify the required parameter 'nucleus_invoice_id' is set
      if @api_client.config.client_side_validation && nucleus_invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'nucleus_invoice_id' when calling AccountingApi.update_bill"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [AccountingFinalResponseVO]
    def update_customer(nucleus_contact_id, opts = {})
      data, _status_code, _headers = update_customer_with_http_info(nucleus_contact_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountingFinalResponseVO, Fixnum, Hash)>] AccountingFinalResponseVO data, response status code and response headers
    def update_customer_with_http_info(nucleus_contact_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.update_customer ...'
      end
      # verify the required parameter 'nucleus_contact_id' is set
      if @api_client.config.client_side_validation && nucleus_contact_id.nil?
        fail ArgumentError, "Missing the required parameter 'nucleus_contact_id' when calling AccountingApi.update_customer"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [AccountingFinalResponseVO]
    def update_supplier(nucleus_contact_id, opts = {})
      data, _status_code, _headers = update_supplier_with_http_info(nucleus_contact_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountingFinalResponseVO, Fixnum, Hash)>] AccountingFinalResponseVO data, response status code and response headers
    def update_supplier_with_http_info(nucleus_contact_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountingApi.update_supplier ...'
      end
      # verify the required parameter 'nucleus_contact_id' is set
      if @api_client.config.client_side_validation && nucleus_contact_id.nil?
        fail ArgumentError, "Missing the required parameter 'nucleus_contact_id' when calling AccountingApi.update_supplier"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'AccountingFinalResponseVO')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountingApi#update_supplier\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
