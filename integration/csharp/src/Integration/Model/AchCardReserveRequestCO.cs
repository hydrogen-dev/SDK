...
{
    /// <summary>
    /// AchCardReserveRequestCO
    /// </summary>
    [DataContract]
    public partial class AchCardReserveRequestCO :  IEquatable<AchCardReserveRequestCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchCardReserveRequestCO" /> class.
        /// </summary>
        /// <param name="nucleusFundingId">nucleusFundingId.</param>
        public AchCardReserveRequestCO(Guid? nucleusFundingId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AchCardReserveRequestCO {\n");
        ...
        {
            return this.Equals(input as AchCardReserveRequestCO);
        }

        /// <summary>
        /// Returns true if AchCardReserveRequestCO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchCardReserveRequestCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchCardReserveRequestCO input)
        {
            if (input == null)
                return false;
