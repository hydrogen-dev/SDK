...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAccountPermissionVO();
  });
  ...
  describe('PageAccountPermissionVO', function() {
    it('should create an instance of PageAccountPermissionVO', function() {
      // uncomment below and update the code to test PageAccountPermissionVO
      //var instane = new HydrogenNucleusApi.PageAccountPermissionVO();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAccountPermissionVO);
    });
