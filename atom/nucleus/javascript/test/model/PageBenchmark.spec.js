...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageBenchmark();
  });
  ...
  describe('PageBenchmark', function() {
    it('should create an instance of PageBenchmark', function() {
      // uncomment below and update the code to test PageBenchmark
      //var instane = new HydrogenNucleusApi.PageBenchmark();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageBenchmark);
    });
