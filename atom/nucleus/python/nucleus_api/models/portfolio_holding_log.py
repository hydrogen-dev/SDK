...
class PortfolioHoldingLog(object):
    ...
    def __init__(self, account_id=None, amount=None, cost_basis=None, create_date=None, currency_code=None, _date=None, id=None, model_id=None, portfolio_id=None, secondary_id=None, security_id=None, shares=None, update_date=None, weight=None, _configuration=None):  # noqa: E501
