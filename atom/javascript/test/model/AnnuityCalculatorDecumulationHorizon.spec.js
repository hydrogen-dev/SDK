...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AnnuityCalculatorDecumulationHorizon();
  });
  ...
  describe('AnnuityCalculatorDecumulationHorizon', function() {
    it('should create an instance of AnnuityCalculatorDecumulationHorizon', function() {
      // uncomment below and update the code to test AnnuityCalculatorDecumulationHorizon
      //var instance = new atom_api.AnnuityCalculatorDecumulationHorizon();
      //expect(instance).to.be.a(atom_api.AnnuityCalculatorDecumulationHorizon);
    });
