...
class SensitivityAnalysisRequest(object):
    ...
    def __init__(self, use_proxy_data=False, start_date=None, portfolio_tickers=None, trading_days_per_year=252, end_date=None, model_id=None, allocation_id=None, account_id=None, portfolio_id=None, sensitivity_factor=None, portfolio_weights=None, frequency_interval=None, aggregation_account_id=None, market_data_source='nucleus'):  # noqa: E501
