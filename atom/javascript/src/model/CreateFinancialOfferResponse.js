...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FinancialOfferPayload', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FinancialOfferPayload'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.CreateFinancialOfferResponse = factory(root.atom_api.ApiClient, root.atom_api.FinancialOfferPayload, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, FinancialOfferPayload, SecondaryId) {
  'use strict';
  ...
  /**
   * The CreateFinancialOfferResponse model module.
   * @module model/CreateFinancialOfferResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateFinancialOfferResponse</code>.
   * @alias module:model/CreateFinancialOfferResponse
   * @class
   * @implements module:model/FinancialOfferPayload
  ...
  var exports = function(name, institutionName, offerLink) {
    ...
    FinancialOfferPayload.call(_this, name, institutionName, offerLink);


  };

  /**
   * Constructs a <code>CreateFinancialOfferResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateFinancialOfferResponse} obj Optional instance to populate.
   * @return {module:model/CreateFinancialOfferResponse} The populated <code>CreateFinancialOfferResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      FinancialOfferPayload.constructFromObject(data, obj);
  ...
  // Implement FinancialOfferPayload interface:
  /**
