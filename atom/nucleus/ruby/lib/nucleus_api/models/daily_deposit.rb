...
module NucleusApi
  ...
  class DailyDeposit
    ...
    def hash
      [account_id, account_number, amount, comments, create_date, currency_code, direction, funding_id, id, invested_date, last_request_date, metadata, notes, portfolio_id, portfolio_transaction_id, received_date, secondary_id, status, status_time_stamp, type, update_date].hash
    end
