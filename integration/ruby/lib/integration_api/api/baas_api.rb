...
module IntegrationApi
  class BaasApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [BaasClientVO]
    def update_baas_client_using_put(baas_client_co, opts = {})
      data, _status_code, _headers = update_baas_client_using_put_with_http_info(baas_client_co, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(BaasClientVO, Fixnum, Hash)>] BaasClientVO data, response status code and response headers
    def update_baas_client_using_put_with_http_info(baas_client_co, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BaasApi.update_baas_client_using_put ...'
      end
      # verify the required parameter 'baas_client_co' is set
      if @api_client.config.client_side_validation && baas_client_co.nil?
        fail ArgumentError, "Missing the required parameter 'baas_client_co' when calling BaasApi.update_baas_client_using_put"
      end
      # resource path
      local_var_path = '/baas/client'
