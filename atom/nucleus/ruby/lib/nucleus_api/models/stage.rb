...
module NucleusApi
  ...
  class Stage
    ...
    def hash
      [category, create_date, description, id, is_account, is_active, is_client, is_closed, is_converted, is_verified, metadata, name, order_index, secondary_id, update_date].hash
    end
