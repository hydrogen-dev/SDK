...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PagePortfolioTransaction();
  });
  ...
  describe('PagePortfolioTransaction', function() {
    it('should create an instance of PagePortfolioTransaction', function() {
      // uncomment below and update the code to test PagePortfolioTransaction
      //var instane = new HydrogenNucleusApi.PagePortfolioTransaction();
      //expect(instance).to.be.a(HydrogenNucleusApi.PagePortfolioTransaction);
    });
