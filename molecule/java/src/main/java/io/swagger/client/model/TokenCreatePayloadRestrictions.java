...
public class TokenCreatePayloadRestrictions {
  ...
  public TokenCreatePayloadRestrictions minAge(BigDecimal minAge) {
    this.minAge = minAge;
    return this;
  }
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions maxAge(BigDecimal maxAge) {
    this.maxAge = maxAge;
    return this;
  }
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions minAnnualIncome(BigDecimal minAnnualIncome) {
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions maxAnnualIncome(BigDecimal maxAnnualIncome) {
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions minHouseholdIncome(BigDecimal minHouseholdIncome) {
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions maxHouseholdIncome(BigDecimal maxHouseholdIncome) {
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions minNetWorth(BigDecimal minNetWorth) {
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions maxNetWorth(BigDecimal maxNetWorth) {
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions minCreditScore(BigDecimal minCreditScore) {
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions maxCreditScore(BigDecimal maxCreditScore) {
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions accreditationRequired(Boolean accreditationRequired) {
  ...
  **/
  ...
  public TokenCreatePayloadRestrictions kycRequired(Boolean kycRequired) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TokenCreatePayloadRestrictions tokenCreatePayloadRestrictions = (TokenCreatePayloadRestrictions) o;
    return Objects.equals(this.minAge, tokenCreatePayloadRestrictions.minAge) &&
        Objects.equals(this.maxAge, tokenCreatePayloadRestrictions.maxAge) &&
        Objects.equals(this.minAnnualIncome, tokenCreatePayloadRestrictions.minAnnualIncome) &&
        Objects.equals(this.maxAnnualIncome, tokenCreatePayloadRestrictions.maxAnnualIncome) &&
        Objects.equals(this.minHouseholdIncome, tokenCreatePayloadRestrictions.minHouseholdIncome) &&
        Objects.equals(this.maxHouseholdIncome, tokenCreatePayloadRestrictions.maxHouseholdIncome) &&
        Objects.equals(this.minNetWorth, tokenCreatePayloadRestrictions.minNetWorth) &&
        Objects.equals(this.maxNetWorth, tokenCreatePayloadRestrictions.maxNetWorth) &&
        Objects.equals(this.minCreditScore, tokenCreatePayloadRestrictions.minCreditScore) &&
        Objects.equals(this.maxCreditScore, tokenCreatePayloadRestrictions.maxCreditScore) &&
        Objects.equals(this.accreditationRequired, tokenCreatePayloadRestrictions.accreditationRequired) &&
        Objects.equals(this.kycRequired, tokenCreatePayloadRestrictions.kycRequired);
  }
  ...
  public String toString() {
    ...
    sb.append("class TokenCreatePayloadRestrictions {\n");
