...
module AtomApi
  class CreateGoalResponse
    ...
    def hash
      [name, parent_goal_id, questionnaire_id, is_decumulation, type, category, client_id, goal_amount, accumulation_horizon, decumulation_horizon, is_active, metadata, secondary_id, id, create_date].hash
    end
