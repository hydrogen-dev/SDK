...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageFeature :  IEquatable<PageFeature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageFeature" /> class.
        /// </summary>
        ...
        public PageFeature(List<Feature> content = default(List<Feature>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        {
            return this.Equals(input as PageFeature);
        }

        /// <summary>
        /// Returns true if PageFeature instances are equal
        /// </summary>
        /// <param name="input">Instance of PageFeature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageFeature input)
        {
            if (input == null)
                return false;
