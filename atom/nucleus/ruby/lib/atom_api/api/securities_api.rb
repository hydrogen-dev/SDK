...
module AtomApi
  class SecuritiesApi
    ...
    def get_security_exclusion_all_using_get(security_exclusion_id, opts = {})
      data, _status_code, _headers = get_security_exclusion_all_using_get_with_http_info(security_exclusion_id, opts)
      data
    end
    ...
    def get_security_exclusion_all_using_get_with_http_info(security_exclusion_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SecuritiesApi.get_security_exclusion_all_using_get ...'
      end
      # verify the required parameter 'security_exclusion_id' is set
      if @api_client.config.client_side_validation && security_exclusion_id.nil?
        fail ArgumentError, "Missing the required parameter 'security_exclusion_id' when calling SecuritiesApi.get_security_exclusion_all_using_get"
      end
      # resource path
      local_var_path = '/security_exclusion'.sub('{' + 'security_exclusion_id' + '}', security_exclusion_id.to_s)
