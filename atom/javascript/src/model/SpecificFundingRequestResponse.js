...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateFundingRequestResponse', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CreateFundingRequestResponse'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.SpecificFundingRequestResponse = factory(root.atom_api.ApiClient, root.atom_api.CreateFundingRequestResponse, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, CreateFundingRequestResponse, SecondaryId) {
  'use strict';
  ...
  /**
   * The SpecificFundingRequestResponse model module.
   * @module model/SpecificFundingRequestResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>SpecificFundingRequestResponse</code>.
   * @alias module:model/SpecificFundingRequestResponse
   * @class
   * @implements module:model/CreateFundingRequestResponse
  ...
  var exports = function(accountId, fundingType, fundingStatus, frequencyUnit, isDeposit, startDate) {
    ...
    CreateFundingRequestResponse.call(_this, accountId, fundingType, fundingStatus, frequencyUnit, isDeposit, startDate);

  };

  /**
   * Constructs a <code>SpecificFundingRequestResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpecificFundingRequestResponse} obj Optional instance to populate.
   * @return {module:model/SpecificFundingRequestResponse} The populated <code>SpecificFundingRequestResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      CreateFundingRequestResponse.constructFromObject(data, obj);
  ...
  // Implement CreateFundingRequestResponse interface:
  /**
