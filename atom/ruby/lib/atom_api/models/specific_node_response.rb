...
module AtomApi
  class SpecificNodeResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_first')
        self.is_first = attributes[:'is_first']
      else
        self.is_first = false
      end
    ...
    def hash
      [id, create_date, name, question_id, is_first, secondary_id, metadata, update_date].hash
    end
