...
class GoalWithdrawalConfig(object):
    ...
    def __init__(self, with_start_reference='a_end', with_start_period=None, with_end_reference='d_end', with_end_period=None, with_amount=None, with_frequency='year', with_inflation=None):  # noqa: E501
    ...
    def with_start_reference(self):
        ...
        The reference for the starting point of the withdrawal  # noqa: E501
    ...
    def with_start_period(self):
        ...
        The starting period for the withdrawal  # noqa: E501
    ...
    def with_end_reference(self):
        ...
        The reference for the ending point of the withdrawal  # noqa: E501
    ...
    def with_end_period(self):
        ...
        The ending point for the withdrawal  # noqa: E501
    ...
    def with_amount(self):
        ...
        The withdrawal amount in today's dollars  # noqa: E501
    ...
    def with_amount(self, with_amount):
        ...
        :type: float
        """
        if with_amount is None:
            raise ValueError("Invalid value for `with_amount`, must not be `None`")  # noqa: E501
        if with_amount is not None and with_amount <= 0:  # noqa: E501
            raise ValueError("Invalid value for `with_amount`, must be a value greater than `0`")  # noqa: E501
    ...
    def with_frequency(self):
        ...
        The frequency of the withdrawal  # noqa: E501
    ...
    def with_inflation(self):
        ...
        The annualized inflation for the withdrawals  # noqa: E501
    ...
    def with_inflation(self, with_inflation):
        ...
        :type: float
        """
        if with_inflation is not None and with_inflation >= 20:  # noqa: E501
            raise ValueError("Invalid value for `with_inflation`, must be a value less than `20`")  # noqa: E501
        if with_inflation is not None and with_inflation <= -1:  # noqa: E501
            raise ValueError("Invalid value for `with_inflation`, must be a value greater than `-1`")  # noqa: E501
