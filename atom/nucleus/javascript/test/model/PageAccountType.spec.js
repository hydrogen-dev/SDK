...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAccountType();
  });
  ...
  describe('PageAccountType', function() {
    it('should create an instance of PageAccountType', function() {
      // uncomment below and update the code to test PageAccountType
      //var instane = new HydrogenNucleusApi.PageAccountType();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAccountType);
    });
