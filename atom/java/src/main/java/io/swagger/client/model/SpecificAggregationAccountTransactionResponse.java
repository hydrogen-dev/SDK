...
public class SpecificAggregationAccountTransactionResponse {
  @SerializedName("id")
  ...
  public SpecificAggregationAccountTransactionResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse createDate(String createDate) {
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse aggregationAccountId(UUID aggregationAccountId) {
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse currencyCode(String currencyCode) {
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse transactionDate(String transactionDate) {
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse bankCredit(AggregationAccountTransactionPayloadBankCredit bankCredit) {
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse investment(AggregationAccountTransactionPayloadInvestment investment) {
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse isExcludedAnalysis(Boolean isExcludedAnalysis) {
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse secondaryId(String secondaryId) {
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse metadata(Object metadata) {
  ...
  **/
  ...
  public SpecificAggregationAccountTransactionResponse updateDate(String updateDate) {
   ...
   * @return updateDate
  **/
  @ApiModelProperty(value = "Datetime the aggregation account transaction was last updated")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SpecificAggregationAccountTransactionResponse specificAggregationAccountTransactionResponse = (SpecificAggregationAccountTransactionResponse) o;
    return Objects.equals(this.id, specificAggregationAccountTransactionResponse.id) &&
        Objects.equals(this.createDate, specificAggregationAccountTransactionResponse.createDate) &&
        Objects.equals(this.aggregationAccountId, specificAggregationAccountTransactionResponse.aggregationAccountId) &&
        Objects.equals(this.currencyCode, specificAggregationAccountTransactionResponse.currencyCode) &&
        Objects.equals(this.transactionDate, specificAggregationAccountTransactionResponse.transactionDate) &&
        Objects.equals(this.bankCredit, specificAggregationAccountTransactionResponse.bankCredit) &&
        Objects.equals(this.investment, specificAggregationAccountTransactionResponse.investment) &&
        Objects.equals(this.isExcludedAnalysis, specificAggregationAccountTransactionResponse.isExcludedAnalysis) &&
        Objects.equals(this.secondaryId, specificAggregationAccountTransactionResponse.secondaryId) &&
        Objects.equals(this.metadata, specificAggregationAccountTransactionResponse.metadata) &&
        Objects.equals(this.updateDate, specificAggregationAccountTransactionResponse.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createDate, aggregationAccountId, currencyCode, transactionDate, bankCredit, investment, isExcludedAnalysis, secondaryId, metadata, updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class SpecificAggregationAccountTransactionResponse {\n");
