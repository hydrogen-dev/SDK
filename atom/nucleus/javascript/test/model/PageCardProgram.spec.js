...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageCardProgram();
  });
  ...
  describe('PageCardProgram', function() {
    it('should create an instance of PageCardProgram', function() {
      // uncomment below and update the code to test PageCardProgram
      //var instane = new HydrogenNucleusApi.PageCardProgram();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageCardProgram);
    });
