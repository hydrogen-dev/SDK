...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.ClientTransactionResponseContent();
  });
  ...
  describe('ClientTransactionResponseContent', function() {
    it('should create an instance of ClientTransactionResponseContent', function() {
      // uncomment below and update the code to test ClientTransactionResponseContent
      //var instance = new atom_api.ClientTransactionResponseContent();
      //expect(instance).to.be.a(atom_api.ClientTransactionResponseContent);
    });
