...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmtpResponseVO :  IEquatable<SmtpResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SmtpResponseVO" /> class.
        /// </summary>
        ...
        public SmtpResponseVO(Guid? emailId = default(Guid?), string message = default(string), Guid? nucleusBusinessId = default(Guid?), Guid? nucleusClientId = default(Guid?), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as SmtpResponseVO);
        }

        /// <summary>
        /// Returns true if SmtpResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of SmtpResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmtpResponseVO input)
        {
            if (input == null)
                return false;
