...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageFinancialOffer();
  });
  ...
  describe('PageFinancialOffer', function() {
    it('should create an instance of PageFinancialOffer', function() {
      // uncomment below and update the code to test PageFinancialOffer
      //var instane = new HydrogenNucleusApi.PageFinancialOffer();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageFinancialOffer);
    });
