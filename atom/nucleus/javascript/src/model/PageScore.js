...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Score', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Score'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageScore = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Score, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, Score, Sort) {
  'use strict';
  ...
  /**
   * The PageScore model module.
   * @module model/PageScore
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageScore</code>.
   * Page Object
   * @alias module:model/PageScore
   * @class
   */
  ...
  /**
   * Constructs a <code>PageScore</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageScore} obj Optional instance to populate.
   * @return {module:model/PageScore} The populated <code>PageScore</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Score]);
      }
  ...
  /**
   * @member {Array.<module:model/Score>} content
   */
