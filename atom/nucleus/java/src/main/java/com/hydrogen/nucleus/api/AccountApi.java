...
public class AccountApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPortfolioHoldingAggAllUsingGetCall(UUID accountId, String currencyConversion, LocalDate endDate, Boolean getLatest, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPortfolioHoldingAggAllUsingGetValidateBeforeCall(UUID accountId, String currencyConversion, LocalDate endDate, Boolean getLatest, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioHoldingAggAllUsingGetCall(accountId, currencyConversion, endDate, getLatest, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<PortfolioHoldingAgg> getPortfolioHoldingAggAllUsingGet(UUID accountId, String currencyConversion, LocalDate endDate, Boolean getLatest, LocalDate startDate) throws ApiException {
        ApiResponse<List<PortfolioHoldingAgg>> resp = getPortfolioHoldingAggAllUsingGetWithHttpInfo(accountId, currencyConversion, endDate, getLatest, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<PortfolioHoldingAgg>> getPortfolioHoldingAggAllUsingGetWithHttpInfo(UUID accountId, String currencyConversion, LocalDate endDate, Boolean getLatest, LocalDate startDate) throws ApiException {
        com.squareup.okhttp.Call call = getPortfolioHoldingAggAllUsingGetValidateBeforeCall(accountId, currencyConversion, endDate, getLatest, startDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioHoldingAggAllUsingGetAsync(UUID accountId, String currencyConversion, LocalDate endDate, Boolean getLatest, LocalDate startDate, final ApiCallback<List<PortfolioHoldingAgg>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioHoldingAggAllUsingGetValidateBeforeCall(accountId, currencyConversion, endDate, getLatest, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<PortfolioHoldingAgg>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPortfolioTransactionAggAllUsingGetCall(UUID accountId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPortfolioTransactionAggAllUsingGetValidateBeforeCall(UUID accountId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioTransactionAggAllUsingGetCall(accountId, ascending, currencyConversion, endDate, orderBy, page, size, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PagePortfolioTransaction getPortfolioTransactionAggAllUsingGet(UUID accountId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate) throws ApiException {
        ApiResponse<PagePortfolioTransaction> resp = getPortfolioTransactionAggAllUsingGetWithHttpInfo(accountId, ascending, currencyConversion, endDate, orderBy, page, size, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PagePortfolioTransaction> getPortfolioTransactionAggAllUsingGetWithHttpInfo(UUID accountId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate) throws ApiException {
        com.squareup.okhttp.Call call = getPortfolioTransactionAggAllUsingGetValidateBeforeCall(accountId, ascending, currencyConversion, endDate, orderBy, page, size, startDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioTransactionAggAllUsingGetAsync(UUID accountId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate, final ApiCallback<PagePortfolioTransaction> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioTransactionAggAllUsingGetValidateBeforeCall(accountId, ascending, currencyConversion, endDate, orderBy, page, size, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PagePortfolioTransaction>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
