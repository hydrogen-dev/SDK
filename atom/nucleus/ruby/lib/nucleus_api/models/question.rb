...
module NucleusApi
  ...
  class Question
    ...
    def hash
      [answers, category, create_date, description, document, id, image, is_account, metadata, order_index, question_type, questionnaire, questionnaire_id, secondary_id, subcategory, title, tooltip, update_date, weight].hash
    end
