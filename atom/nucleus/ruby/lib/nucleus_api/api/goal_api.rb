...
module NucleusApi
  class GoalApi
    ...
    # @param goal_track_id2 goal_track_id
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_goal_track_using_delete(goal_track_id, goal_track_id2, opts = {})
      delete_goal_track_using_delete_with_http_info(goal_track_id, goal_track_id2, opts)
      nil
    end
    ...
    def delete_goal_track_using_delete_with_http_info(goal_track_id, goal_track_id2, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && goal_track_id2.nil?
        fail ArgumentError, "Missing the required parameter 'goal_track_id2' when calling GoalApi.delete_goal_track_using_delete"
      end
      # resource path
      local_var_path = '/goal_track/{goal_track_id}'.sub('{' + 'goalTrackId' + '}', goal_track_id.to_s).sub('{' + 'goal_track_id' + '}', goal_track_id2.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [GoalTrack]
    def get_goal_track_using_get(goal_track_id, goal_track_id2, opts = {})
      data, _status_code, _headers = get_goal_track_using_get_with_http_info(goal_track_id, goal_track_id2, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GoalTrack, Fixnum, Hash)>] GoalTrack data, response status code and response headers
    def get_goal_track_using_get_with_http_info(goal_track_id, goal_track_id2, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'goal_track_id2' is set
      if @api_client.config.client_side_validation && goal_track_id2.nil?
        fail ArgumentError, "Missing the required parameter 'goal_track_id2' when calling GoalApi.get_goal_track_using_get"
      end
      # resource path
      local_var_path = '/goal_track/{goal_track_id}'.sub('{' + 'goalTrackId' + '}', goal_track_id.to_s).sub('{' + 'goal_track_id' + '}', goal_track_id2.to_s)
