...
/**
 * CurrencyTransferParams Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\molecule
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CurrencyTransferParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CurrencyTransferParams';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sender_wallet_id'] === null) {
            $invalidProperties[] = "'sender_wallet_id' can't be null";
        }
