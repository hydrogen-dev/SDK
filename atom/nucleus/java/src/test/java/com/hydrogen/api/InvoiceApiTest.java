...
public class InvoiceApiTest {
    ...
    public void getInvoiceAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageInvoice response = api.getInvoiceAllUsingGet(ascending, filter, orderBy, page, size);
    ...
    public void getInvoicePaymentAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageInvoicePayment response = api.getInvoicePaymentAllUsingGet(ascending, filter, orderBy, page, size);
    ...
    public void getInvoicePaymentUsingGetTest() throws ApiException {
        UUID invoicePaymentId = null;
        InvoicePayment response = api.getInvoicePaymentUsingGet(invoicePaymentId);
    ...
    public void getInvoiceUsingGetTest() throws ApiException {
        UUID invoiceId = null;
        Invoice response = api.getInvoiceUsingGet(invoiceId);
