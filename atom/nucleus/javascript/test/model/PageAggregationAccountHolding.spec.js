...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAggregationAccountHolding();
  });
  ...
  describe('PageAggregationAccountHolding', function() {
    it('should create an instance of PageAggregationAccountHolding', function() {
      // uncomment below and update the code to test PageAggregationAccountHolding
      //var instane = new HydrogenNucleusApi.PageAggregationAccountHolding();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAggregationAccountHolding);
    });
