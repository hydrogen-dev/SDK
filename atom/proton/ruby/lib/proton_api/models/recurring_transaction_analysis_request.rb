...
module ProtonApi
  class RecurringTransactionAnalysisRequest
    ...
    def hash
      [scope, amount_deviation_threshold, analyze_transactions, interval_deviation_threshold, client_id, currency_conversion, start_date, aggregation_account_ids, end_date, show_recurring_details, currency_code, account_ids].hash
    end
