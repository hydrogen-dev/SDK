...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageTokenSupplyResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageTokenSupplyResponse();
      });

      it('should create an instance of PageTokenSupplyResponse', function() {
        // TODO: update the code to test PageTokenSupplyResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageTokenSupplyResponse);
      });
