...
module AtomApi
  class GoalDecumulationRecommendation
    ...
    def list_invalid_properties
      ...
      if @a_horizon.nil?
        invalid_properties.push('invalid value for "a_horizon", a_horizon cannot be nil.')
      end

      if @a_horizon >= 350
        invalid_properties.push('invalid value for "a_horizon", must be smaller than 350.')
      end
      ...
      if @d_horizon.nil?
        invalid_properties.push('invalid value for "d_horizon", d_horizon cannot be nil.')
      end

      if @d_horizon >= 350
        invalid_properties.push('invalid value for "d_horizon", must be smaller than 350.')
      end
      ...
      if @withdrawal_config.nil?
        invalid_properties.push('invalid value for "withdrawal_config", withdrawal_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @a_horizon.nil?
      return false if @a_horizon >= 350
      return false if @a_horizon < 0
      return false if @d_horizon.nil?
      return false if @d_horizon >= 350
      return false if @d_horizon < 0
      ...
      return false if @withdrawal_config.nil?
    ...
    def a_horizon=(a_horizon)
      if a_horizon.nil?
        fail ArgumentError, 'a_horizon cannot be nil'
      end

      if a_horizon >= 350
        fail ArgumentError, 'invalid value for "a_horizon", must be smaller than 350.'
      end
    ...
    def d_horizon=(d_horizon)
      if d_horizon.nil?
        fail ArgumentError, 'd_horizon cannot be nil'
      end

      if d_horizon >= 350
        fail ArgumentError, 'invalid value for "d_horizon", must be smaller than 350.'
      end
    ...
    def hash
      [p_ret, p_risk, curr_inv, a_horizon, d_horizon, horizon_frequency, withdrawal_config, deposit_config, recommendation_config, recommend_type, conf_tgt, n, remove_outliers, thresh_type, thresh, withdrawal_tax, trading_days_per_year, adjust_for_compounding, compounding_rate].hash
    end
