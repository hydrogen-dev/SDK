...
/**
 * SavingsDepositSchedule Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\proton
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SavingsDepositSchedule implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SavingsDepositSchedule';
    ...
    protected static $setters = [
        ...
        'deposit_duration' => 'setDepositDuration',
    ...
    protected static $getters = [
        ...
        'deposit_duration' => 'getDepositDuration',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['deposit_duration'] = isset($data['deposit_duration']) ? $data['deposit_duration'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['deposit_duration']) && ($this->container['deposit_duration'] < 1)) {
            $invalidProperties[] = "invalid value for 'deposit_duration', must be bigger than or equal to 1.";
        }
    ...
    public function setDepositAmount($deposit_amount)
    {
        ...
        if (!is_null($deposit_amount) && ($deposit_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $deposit_amount when calling SavingsDepositSchedule., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets deposit_duration
     *
     * @return int
     */
    public function getDepositDuration()
    {
        return $this->container['deposit_duration'];
    }

    /**
     * Sets deposit_duration
     *
     * @param int $deposit_duration deposit_duration
     *
     * @return $this
     */
    public function setDepositDuration($deposit_duration)
    {

        if (!is_null($deposit_duration) && ($deposit_duration < 1)) {
            throw new \InvalidArgumentException('invalid value for $deposit_duration when calling SavingsDepositSchedule., must be bigger than or equal to 1.');
        }

        $this->container['deposit_duration'] = $deposit_duration;
