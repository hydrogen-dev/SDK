...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageVAccountAssetSize();
  });
  ...
  describe('PageVAccountAssetSize', function() {
    it('should create an instance of PageVAccountAssetSize', function() {
      ...
      //var instane = new HydrogenAtomApi.PageVAccountAssetSize();
      //expect(instance).to.be.a(HydrogenAtomApi.PageVAccountAssetSize);
    });
