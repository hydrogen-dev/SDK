...
# Unit tests for AtomApi::AnnuityCalculatorAccumulationHorizon
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnnuityCalculatorAccumulationHorizon' do
  before do
    # run before each test
    @instance = AtomApi::AnnuityCalculatorAccumulationHorizon.new
  end
  ...
  describe 'test an instance of AnnuityCalculatorAccumulationHorizon' do
    it 'should create an instance of AnnuityCalculatorAccumulationHorizon' do
      expect(@instance).to be_instance_of(AtomApi::AnnuityCalculatorAccumulationHorizon)
    end
  end
