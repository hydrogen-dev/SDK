...
module NucleusApi
  ...
  class InsuranceDiscount
    ...
    def hash
      [category, create_date, currency_code, description, discount_amount, discount_percentage, id, is_active, metadata, name, node_map, secondary_id, subcategory, update_date].hash
    end
