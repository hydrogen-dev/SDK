...
module ProtonApi
  class ChildrenEducationConfig
    attr_accessor :current_age

    attr_accessor :education_config
    ...
    def self.swagger_types
      {
        :'current_age' => :'Integer',
        :'education_config' => :'Array<EducationConfig>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'education_config')
        if (value = attributes[:'education_config']).is_a?(Array)
          self.education_config = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @education_config.nil?
        invalid_properties.push('invalid value for "education_config", education_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @education_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          education_config == o.education_config
    end
    ...
    def hash
      [current_age, education_config].hash
    end
