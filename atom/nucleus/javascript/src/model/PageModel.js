...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Model', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Model'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageModel = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Model, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, Model, Sort) {
  'use strict';
  ...
  /**
   * The PageModel model module.
   * @module model/PageModel
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageModel</code>.
   * Page Object
   * @alias module:model/PageModel
   * @class
   */
  ...
  /**
   * Constructs a <code>PageModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageModel} obj Optional instance to populate.
   * @return {module:model/PageModel} The populated <code>PageModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Model]);
      }
  ...
  /**
   * @member {Array.<module:model/Model>} content
   */
