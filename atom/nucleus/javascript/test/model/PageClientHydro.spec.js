...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageClientHydro();
  });
  ...
  describe('PageClientHydro', function() {
    it('should create an instance of PageClientHydro', function() {
      // uncomment below and update the code to test PageClientHydro
      //var instane = new HydrogenNucleusApi.PageClientHydro();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageClientHydro);
    });
