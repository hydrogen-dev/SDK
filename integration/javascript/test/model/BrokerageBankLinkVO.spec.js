...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.BrokerageBankLinkVO();
  });
  ...
  describe('BrokerageBankLinkVO', function() {
    it('should create an instance of BrokerageBankLinkVO', function() {
      // uncomment below and update the code to test BrokerageBankLinkVO
      //var instane = new HydrogenIntegrationApi.BrokerageBankLinkVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.BrokerageBankLinkVO);
    });
