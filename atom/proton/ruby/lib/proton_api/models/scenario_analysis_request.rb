...
module ProtonApi
  class ScenarioAnalysisRequest
    ...
    def hash
      [trading_days_per_year, portfolio_tickers, frequency_interval, create_log, aggregation_account_id, allocation_id, model_id, portfolio_weights, end_date, scenario, start_date, use_proxy_data, account_id, market_data_source, portfolio_id].hash
    end
