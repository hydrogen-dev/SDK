...
class MoleculeApi(object):
    ...
    def get_token_restriction(self, token_restriction_id, **kwargs):  # noqa: E501
        """Retrieve a token restriction  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_token_restriction(token_restriction_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str token_restriction_id: UUID of a token restriction (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_token_restriction_with_http_info(token_restriction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_token_restriction_with_http_info(token_restriction_id, **kwargs)  # noqa: E501
            return data

    def get_token_restriction_with_http_info(self, token_restriction_id, **kwargs):  # noqa: E501
        """Retrieve a token restriction  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_token_restriction_with_http_info(token_restriction_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['token_restriction_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_token_restriction" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'token_restriction_id' is set
        if ('token_restriction_id' not in params or
                params['token_restriction_id'] is None):
            raise ValueError("Missing the required parameter `token_restriction_id` when calling `get_token_restriction`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'token_restriction_id' in params:
            path_params['token_restriction_id'] = params['token_restriction_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TokenRestrictionSpecificResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_token_restrictions(self, **kwargs):  # noqa: E501
        """Get information for all token restrictions defined for your firm  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_token_restrictions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_token_restrictions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_token_restrictions_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_token_restrictions_with_http_info(self, **kwargs):  # noqa: E501
        """Get information for all token restrictions defined for your firm  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_token_restrictions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_token_restrictions" % key
                )
            params[key] = val
        del params['kwargs']

        if 'page' in params and params['page'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `get_token_restrictions`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'size' in params and params['size'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `size` when calling `get_token_restrictions`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TokenRestrictionGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_token_restriction(self, payload, **kwargs):  # noqa: E501
        """Create a token restriction under your firm.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_token_restriction(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TokenRestrictionCreatePayload payload: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_token_restriction_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.post_token_restriction_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def post_token_restriction_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Create a token restriction under your firm.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_token_restriction_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_token_restriction" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `post_token_restriction`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TokenRestrictionCreateResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_token_restriction(self, token_restriction_id, payload, **kwargs):  # noqa: E501
        """Update a token restriction  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_token_restriction(token_restriction_id, payload, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_token_restriction_with_http_info(token_restriction_id, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_token_restriction_with_http_info(token_restriction_id, payload, **kwargs)  # noqa: E501
            return data

    def update_token_restriction_with_http_info(self, token_restriction_id, payload, **kwargs):  # noqa: E501
        """Update a token restriction  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_token_restriction_with_http_info(token_restriction_id, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['token_restriction_id', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_token_restriction" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'token_restriction_id' is set
        if ('token_restriction_id' not in params or
                params['token_restriction_id'] is None):
            raise ValueError("Missing the required parameter `token_restriction_id` when calling `update_token_restriction`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_token_restriction`")  # noqa: E501
