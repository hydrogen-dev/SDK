...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageModelTransaction();
  });
  ...
  describe('PageModelTransaction', function() {
    it('should create an instance of PageModelTransaction', function() {
      ...
      //var instane = new HydrogenAtomApi.PageModelTransaction();
      //expect(instance).to.be.a(HydrogenAtomApi.PageModelTransaction);
    });
