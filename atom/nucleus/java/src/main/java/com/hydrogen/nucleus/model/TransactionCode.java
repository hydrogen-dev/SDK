...
public class TransactionCode {
   ...
   */
  @JsonAdapter(IsDepositEnum.Adapter.class)
  public enum IsDepositEnum {
    ...
    public static IsDepositEnum fromValue(String text) {
      for (IsDepositEnum b : IsDepositEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<IsDepositEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final IsDepositEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public IsDepositEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return IsDepositEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("is_deposit")
  private IsDepositEnum isDeposit = IsDepositEnum.NULL;
  ...
  **/
  @ApiModelProperty(example = "false", value = "")
  public IsDepositEnum getIsDeposit() {
    return isDeposit;
  }
