...
class AggregationApi
{
     ...
     * @return void
     */
    public function deleteAggregationAccountUsingDelete($nucleus_aggregation_account_id, $delete_type = 'delink', $nucleus_data = null)
    {
        $this->deleteAggregationAccountUsingDeleteWithHttpInfo($nucleus_aggregation_account_id, $delete_type, $nucleus_data);
    }
     ...
     */
    public function deleteAggregationAccountUsingDeleteWithHttpInfo($nucleus_aggregation_account_id, $delete_type = 'delink', $nucleus_data = null)
    {
        $returnType = '';
        $request = $this->deleteAggregationAccountUsingDeleteRequest($nucleus_aggregation_account_id, $delete_type, $nucleus_data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAggregationAccountUsingDeleteAsync($nucleus_aggregation_account_id, $delete_type = 'delink', $nucleus_data = null)
    {
        return $this->deleteAggregationAccountUsingDeleteAsyncWithHttpInfo($nucleus_aggregation_account_id, $delete_type, $nucleus_data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAggregationAccountUsingDeleteAsyncWithHttpInfo($nucleus_aggregation_account_id, $delete_type = 'delink', $nucleus_data = null)
    {
        $returnType = '';
        $request = $this->deleteAggregationAccountUsingDeleteRequest($nucleus_aggregation_account_id, $delete_type, $nucleus_data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteAggregationAccountUsingDeleteRequest($nucleus_aggregation_account_id, $delete_type = 'delink', $nucleus_data = null)
    {
     ...
     */
    public function getPropertyValue($nucleus_aggregation_account_id, $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {
        list($response) = $this->getPropertyValueWithHttpInfo($nucleus_aggregation_account_id, $nucleus_business_id, $nucleus_client_id, $product);
        return $response;
    }
     ...
     */
    public function getPropertyValueWithHttpInfo($nucleus_aggregation_account_id, $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {
        $returnType = '\com\hydrogen\integration\Model\PropertyValueResponseVO';
        $request = $this->getPropertyValueRequest($nucleus_aggregation_account_id, $nucleus_business_id, $nucleus_client_id, $product);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPropertyValueAsync($nucleus_aggregation_account_id, $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {
        return $this->getPropertyValueAsyncWithHttpInfo($nucleus_aggregation_account_id, $nucleus_business_id, $nucleus_client_id, $product)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPropertyValueAsyncWithHttpInfo($nucleus_aggregation_account_id, $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {
        $returnType = '\com\hydrogen\integration\Model\PropertyValueResponseVO';
        $request = $this->getPropertyValueRequest($nucleus_aggregation_account_id, $nucleus_business_id, $nucleus_client_id, $product);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPropertyValueRequest($nucleus_aggregation_account_id, $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {
        // verify the required parameter 'nucleus_aggregation_account_id' is set
        if ($nucleus_aggregation_account_id === null || (is_array($nucleus_aggregation_account_id) && count($nucleus_aggregation_account_id) === 0)) {
            throw new \InvalidArgumentException(
