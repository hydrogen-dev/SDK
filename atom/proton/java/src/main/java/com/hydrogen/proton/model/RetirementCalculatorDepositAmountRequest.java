...
public class RetirementCalculatorDepositAmountRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(retirementSavings, currentAge, accountIds, retirementIncome, retirementTax, deathAge, retirementAge, percentOfExpensesCovered, portfolioReturn, retirementExpenses, depositSchedule, inflationRate, aggregationAccountIds);
  }
