...
# Unit tests for AtomApi::AnnuityCalculatorInitialBalance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnnuityCalculatorInitialBalance' do
  before do
    # run before each test
    @instance = AtomApi::AnnuityCalculatorInitialBalance.new
  end
  ...
  describe 'test an instance of AnnuityCalculatorInitialBalance' do
    it 'should create an instance of AnnuityCalculatorInitialBalance' do
      expect(@instance).to be_instance_of(AtomApi::AnnuityCalculatorInitialBalance)
    end
  end
