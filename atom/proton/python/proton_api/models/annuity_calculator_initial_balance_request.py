...
class AnnuityCalculatorInitialBalanceRequest(object):
    ...
    def __init__(self, decumulation_horizon=None, annuity_amount=None, deposit_schedule=None, initial_balance=0.0, portfolio_return=None, tax_rate=0.0, inflation_rate=0.0, aggregation_account_ids=None, account_ids=None, accumulation_horizon=None, annuity_frequency_interval='year'):  # noqa: E501
