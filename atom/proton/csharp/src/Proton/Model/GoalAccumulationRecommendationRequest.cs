...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalAccumulationRecommendationRequest :  IEquatable<GoalAccumulationRecommendationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoalAccumulationRecommendationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GoalAccumulationRecommendationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GoalAccumulationRecommendationRequest" /> class.
        /// </summary>
        ...
        public GoalAccumulationRecommendationRequest(RecommendationConfig1 recommendationConfig = default(RecommendationConfig1), float? compoundingRate = 0.0F, RecommendTypeEnum? recommendType = RecommendTypeEnum.Horizon, bool? createLog = false, GoalConfig goalConfig = default(GoalConfig), int? n = 1000, List<float?> pRisk = default(List<float?>), bool? removeOutliers = true, bool? adjustForCompounding = false, Guid? goalId = default(Guid?), float? confTgt = 0.9F, int? tradingDaysPerYear = 252, decimal? thresh = default(decimal?), float? withdrawalTax = 0.0F, Guid? clientId = default(Guid?), ThreshTypeEnum? threshType = ThreshTypeEnum.Perc, HorizonFrequencyEnum? horizonFrequency = HorizonFrequencyEnum.Year, int? horizon = default(int?), decimal? currInv = default(decimal?), List<AccumulationGoalDepositConfig> depositConfig = default(List<AccumulationGoalDepositConfig>), List<float?> pRet = default(List<float?>))
        {
            ...
            if (pRet == null)
            {
                throw new InvalidDataException("pRet is a required property for GoalAccumulationRecommendationRequest and cannot be null");
            }
            else
            {
                this.PRet = pRet;
        ...
        {
            return this.Equals(input as GoalAccumulationRecommendationRequest);
        }

        /// <summary>
        /// Returns true if GoalAccumulationRecommendationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalAccumulationRecommendationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalAccumulationRecommendationRequest input)
        {
            if (input == null)
                return false;
