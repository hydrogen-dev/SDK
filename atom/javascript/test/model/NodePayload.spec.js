...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.NodePayload();
  });
  ...
  describe('NodePayload', function() {
    it('should create an instance of NodePayload', function() {
      // uncomment below and update the code to test NodePayload
      //var instance = new atom_api.NodePayload();
      //expect(instance).to.be.a(atom_api.NodePayload);
    });
