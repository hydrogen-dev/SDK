...
module NucleusApi
  ...
  class Document
    ...
    def hash
      [account_id, client_id, country_of_issue, create_date, doc_file, doc_image_back, doc_image_front, doc_name, doc_number, doc_size, doc_type, expiry_date, id, is_active, is_verified, issue_date, metadata, secondary_id, state_of_issue, update_date, url_path].hash
    end
