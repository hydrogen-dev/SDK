...
module AtomApi
  class BeneficiaryBequestConfig
    ...
    def list_invalid_properties
      ...
      if !@bequest_duration.nil? && @bequest_duration <= 0
        invalid_properties.push('invalid value for "bequest_duration", must be greater than 0.')
      end
    ...
    def valid?
      ...
      return false if !@bequest_duration.nil? && @bequest_duration <= 0
      true
    end
    ...
    def bequest_duration=(bequest_duration)
      if !bequest_duration.nil? && bequest_duration <= 0
        fail ArgumentError, 'invalid value for "bequest_duration", must be greater than 0.'
      end
    ...
    def hash
      [years_until_bequest, bequest_amount, bequest_duration].hash
    end
