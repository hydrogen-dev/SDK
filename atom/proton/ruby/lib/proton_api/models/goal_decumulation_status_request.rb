...
module ProtonApi
  class GoalDecumulationStatusRequest
    ...
    def hash
      [goal_id, curr_inv, d_horizon, n, horizon_frequency, client_id, remove_outliers, withdrawal_config, a_horizon, conf_tgt, p_ret, thresh_type, thresh, deposit_config, recommendation_config, compounding_rate, withdrawal_tax, trading_days_per_year, adjust_for_compounding, p_risk, create_log, recommend_type].hash
    end
