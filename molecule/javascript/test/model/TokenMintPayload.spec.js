...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new molecule_api.TokenMintPayload();
  });
  ...
  describe('TokenMintPayload', function() {
    it('should create an instance of TokenMintPayload', function() {
      // uncomment below and update the code to test TokenMintPayload
      //var instance = new molecule_api.TokenMintPayload();
      //expect(instance).to.be.a(molecule_api.TokenMintPayload);
    });
