...
class CardApi(object):
    ...
    def create_card_program_using_post_with_http_info(self, card_program_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('card_program_request' not in params or
                                                       params['card_program_request'] is None):  # noqa: E501
    ...
    def delete_card_program_using_delete_with_http_info(self, card_program_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('card_program_id' not in params or
                                                       params['card_program_id'] is None):  # noqa: E501
    ...
    def get_all_client_cards_using_get(self, **kwargs):  # noqa: E501
        """List all client cards  # noqa: E501

        Get the information for all cards for an client.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_client_cards_using_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_client_cards_using_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_client_cards_using_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_client_cards_using_get_with_http_info(self, **kwargs):  # noqa: E501
        """List all client cards  # noqa: E501

        Get the information for all cards for an client.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_client_cards_using_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_client_cards_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PageClientBusinessCardVO',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_card_transaction_agg_all_using_get_with_http_info(self, card_id, **kwargs):  # noqa: E501
        ...
        all_params = ['card_id', 'ascending', 'currency_conversion', 'end_date', 'filter', 'order_by', 'page', 'size', 'start_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_card_transaction_agg_all_using_get1(self, card_id, **kwargs):  # noqa: E501
        """List all card transactions  # noqa: E501

        Get the information for all transactions for an card.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_card_transaction_agg_all_using_get1(card_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_card_transaction_agg_all_using_get1_with_http_info(card_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_card_transaction_agg_all_using_get1_with_http_info(card_id, **kwargs)  # noqa: E501
            return data

    def get_card_transaction_agg_all_using_get1_with_http_info(self, card_id, **kwargs):  # noqa: E501
        """List all card transactions  # noqa: E501

        Get the information for all transactions for an card.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_card_transaction_agg_all_using_get1_with_http_info(card_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_card_transaction_agg_all_using_get1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'card_id' is set
        if self.api_client.client_side_validation and ('card_id' not in params or
                                                       params['card_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `card_id` when calling `get_card_transaction_agg_all_using_get1`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/nucleus/v1/card/{card_id}/transaction', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_card_program_using_put_with_http_info(self, card_program, card_program_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('card_program' not in params or
                                                       params['card_program'] is None):  # noqa: E501
