...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageQuestion();
  });
  ...
  describe('PageQuestion', function() {
    it('should create an instance of PageQuestion', function() {
      // uncomment below and update the code to test PageQuestion
      //var instane = new HydrogenNucleusApi.PageQuestion();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageQuestion);
    });
