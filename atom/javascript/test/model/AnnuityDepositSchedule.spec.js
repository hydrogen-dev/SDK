...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AnnuityDepositSchedule();
  });
  ...
  describe('AnnuityDepositSchedule', function() {
    it('should create an instance of AnnuityDepositSchedule', function() {
      // uncomment below and update the code to test AnnuityDepositSchedule
      //var instance = new atom_api.AnnuityDepositSchedule();
      //expect(instance).to.be.a(atom_api.AnnuityDepositSchedule);
    });
