...
class RetirementCalculatorPercentCoveredRequest(object):
    ...
    def __init__(self, retirement_savings=0.0, current_age=None, account_ids=None, retirement_income=0.0, retirement_tax=0.0, death_age=None, retirement_age=65, portfolio_return=None, retirement_expenses=None, deposit_schedule=None, inflation_rate=0.0, aggregation_account_ids=None, _configuration=None):  # noqa: E501
