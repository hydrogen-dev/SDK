...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.PurchaseCalculatorAmount();
  });
  ...
  describe('PurchaseCalculatorAmount', function() {
    it('should create an instance of PurchaseCalculatorAmount', function() {
      // uncomment below and update the code to test PurchaseCalculatorAmount
      //var instance = new atom_api.PurchaseCalculatorAmount();
      //expect(instance).to.be.a(atom_api.PurchaseCalculatorAmount);
    });
