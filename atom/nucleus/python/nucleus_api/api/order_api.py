...
class OrderApi(object):
    ...
    def get_order_all_using_get(self, order_info_request, **kwargs):  # noqa: E501
        """Create an order record  # noqa: E501

        Create an order record defined for your firm.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_order_all_using_get(order_info_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_order_all_using_get_with_http_info(order_info_request, **kwargs)  # noqa: E501
        else:
            (data) = self.get_order_all_using_get_with_http_info(order_info_request, **kwargs)  # noqa: E501
            return data

    def get_order_all_using_get_with_http_info(self, order_info_request, **kwargs):  # noqa: E501
        """Create an order record  # noqa: E501

        Create an order record defined for your firm.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_order_all_using_get_with_http_info(order_info_request, async_req=True)
        >>> result = thread.get()
        ...
        if ('order_info_request' not in params or
            ...
            raise ValueError("Missing the required parameter `order_info_request` when calling `get_order_all_using_get`")  # noqa: E501
    ...
    def get_order_all_using_get1(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_order_all_using_get1_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_order_all_using_get1_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_order_all_using_get1_with_http_info(self, **kwargs):  # noqa: E501
        """List all order records  # noqa: E501

        Get the information for all order records defined for your firm.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_order_all_using_get1_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_order_all_using_get1" % key
                )
            params[key] = val
        del params['kwargs']
