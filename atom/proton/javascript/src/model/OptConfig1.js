...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenProtonApi.OptConfig1 = factory(root.HydrogenProtonApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('w_config'))
        obj.wConfig = ApiClient.convertToType(data['w_config'], Object);
