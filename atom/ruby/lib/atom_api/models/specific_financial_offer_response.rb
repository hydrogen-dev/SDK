...
module AtomApi
  class SpecificFinancialOfferResponse
    ...
    def hash
      [id, create_date, name, institution_name, offer_link, category, subcategory, description, image, currency_code, financial_rate, financial_rate_type, financial_rate_term, financial_rate_term_unit, fee_amount, fee_type, offer_term, offer_term_unit, minimum_contribution, minimum_contribution_term, minimum_contribution_term_unit, prerequisite, prerequisite_type, affiliate_rate, client_review, rating, document_id, campaign_id, metadata, secondary_id, update_date].hash
    end
