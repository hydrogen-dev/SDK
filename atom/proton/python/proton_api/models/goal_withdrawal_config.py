...
class GoalWithdrawalConfig(object):
    ...
    def __init__(self, with_start_reference='a_end', with_end_reference='d_end', with_frequency='year', with_inflation=0.0, with_end_period=0, with_amount=None, with_start_period=0):  # noqa: E501
