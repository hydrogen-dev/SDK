 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TokenParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TokenParams';
    ...
    protected static $swaggerTypes = [
        ...
        'offering_settings' => '\com\hydrogen\molecule\Model\TokenParamsOfferingSettings',
        'metadata' => 'object',
        'restrictions' => 'object'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['nucleus_model_id'] === null) {
            $invalidProperties[] = "'nucleus_model_id' can't be null";
        }
        if ($this->container['owner_wallet_id'] === null) {
            $invalidProperties[] = "'owner_wallet_id' can't be null";
        }
        if ($this->container['offering_settings'] === null) {
            $invalidProperties[] = "'offering_settings' can't be null";
        }
     ...
     *
     * @return \com\hydrogen\molecule\Model\TokenParamsOfferingSettings
     */
     ...
     *
     * @param \com\hydrogen\molecule\Model\TokenParamsOfferingSettings $offering_settings offering_settings
     *
     * @return $this
     */
