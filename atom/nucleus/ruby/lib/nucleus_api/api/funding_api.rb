...
module NucleusApi
  class FundingApi
    ...
    # @param transfer UUID external_account_transfer_id
    # @param transfer_id transfer_id
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_transfer_using_delete(transfer, transfer_id, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def delete_transfer_using_delete_with_http_info(transfer, transfer_id, opts = {})
      if @api_client.config.debugging
    ...
    # @param external_account_transfer_id UUID external_account_transfer_id
    # @param transfer_id transfer_id
    # @param [Hash] opts the optional parameters
    # @return [ExternalAccountTransfer]
    def get_transfer_using_get(external_account_transfer_id, transfer_id, opts = {})
