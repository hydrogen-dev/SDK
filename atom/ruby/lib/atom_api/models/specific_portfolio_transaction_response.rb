...
module AtomApi
  class SpecificPortfolioTransactionResponse
    ...
    def hash
      [id, create_date, portfolio_id, security_id, transaction_code_id, date, is_read, price, quantity, secondary_id, update_date].hash
    end
