...
/**
 * CardReplaceResponseVO Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\electron
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CardReplaceResponseVO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CardReplaceResponseVO';
    ...
    protected static $swaggerFormats = [
        'card_status' => null,
        'message' => null,
        'new_nucleus_card_id' => 'uuid',
        'nucleus_card_id' => 'uuid',
        'replaced_nucleus_card_id' => 'uuid',
        'vendor_name' => null,
    ...
    protected static $setters = [
        ...
        'message' => 'setMessage',
        'new_nucleus_card_id' => 'setNewNucleusCardId',
        'nucleus_card_id' => 'setNucleusCardId',
        'replaced_nucleus_card_id' => 'setReplacedNucleusCardId',
    ...
    protected static $getters = [
        ...
        'message' => 'getMessage',
        'new_nucleus_card_id' => 'getNewNucleusCardId',
        'nucleus_card_id' => 'getNucleusCardId',
        'replaced_nucleus_card_id' => 'getReplacedNucleusCardId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['new_nucleus_card_id'] = isset($data['new_nucleus_card_id']) ? $data['new_nucleus_card_id'] : null;
        $this->container['nucleus_card_id'] = isset($data['nucleus_card_id']) ? $data['nucleus_card_id'] : null;
        $this->container['replaced_nucleus_card_id'] = isset($data['replaced_nucleus_card_id']) ? $data['replaced_nucleus_card_id'] : null;
    ...
    /**
     * Gets new_nucleus_card_id
     *
     * @return string
     */
    public function getNewNucleusCardId()
    {
        return $this->container['new_nucleus_card_id'];
    }

    /**
     * Sets new_nucleus_card_id
     *
     * @param string $new_nucleus_card_id new_nucleus_card_id
     *
     * @return $this
     */
    public function setNewNucleusCardId($new_nucleus_card_id)
    {
        $this->container['new_nucleus_card_id'] = $new_nucleus_card_id;
    ...
    /**
     * Gets replaced_nucleus_card_id
     *
     * @return string
     */
    public function getReplacedNucleusCardId()
    {
        return $this->container['replaced_nucleus_card_id'];
    }

    /**
     * Sets replaced_nucleus_card_id
     *
     * @param string $replaced_nucleus_card_id replaced_nucleus_card_id
     *
     * @return $this
     */
    public function setReplacedNucleusCardId($replaced_nucleus_card_id)
    {
        $this->container['replaced_nucleus_card_id'] = $replaced_nucleus_card_id;
