...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WalletClients', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.WalletClients();
      });

      it('should create an instance of WalletClients', function() {
        // TODO: update the code to test WalletClients
        expect(instance).to.be.a(MoleculeApiDocumentation.WalletClients);
      });
