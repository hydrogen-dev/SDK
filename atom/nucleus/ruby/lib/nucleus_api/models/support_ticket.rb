...
module NucleusApi
  ...
  class SupportTicket
    ...
    def hash
      [account_id, assigned_to, client_id, close_time, create_date, description, id, metadata, open_time, secondary_id, status, subject, support_ticket_documents, update_date].hash
    end
