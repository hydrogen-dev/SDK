...
module AtomApi
  class SpecificAccountResponse
    ...
    def hash
      [id, create_date, name, account_type_id, managed, clients, goals, metadata, secondary_id, last, total_pages, total_elements, sort, first, number_of_elements, size, number, update_date].hash
    end
