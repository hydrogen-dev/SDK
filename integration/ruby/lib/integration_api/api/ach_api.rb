...
module IntegrationApi
  class ACHApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [AchBalanceResponseVO]
    def get_business_balance_using_get(business_id, opts = {})
      data, _status_code, _headers = get_business_balance_using_get_with_http_info(business_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AchBalanceResponseVO, Fixnum, Hash)>] AchBalanceResponseVO data, response status code and response headers
    def get_business_balance_using_get_with_http_info(business_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ACHApi.get_business_balance_using_get ...'
      end
      # verify the required parameter 'business_id' is set
      if @api_client.config.client_side_validation && business_id.nil?
        fail ArgumentError, "Missing the required parameter 'business_id' when calling ACHApi.get_business_balance_using_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'AchBalanceResponseVO')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ACHApi#get_business_balance_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
