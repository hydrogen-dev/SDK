...
module ProtonApi
  class GoalDecumulationAllocationRequest
    ...
    def hash
      [goal_id, allocation_method, curr_inv, risk_score, d_horizon, n, allocation_priority, horizon_frequency, allocations, client_id, remove_outliers, withdrawal_config, a_horizon, use_proxy_data, conf_tgt, thresh_type, thresh, deposit_config, market_data_source, recommendation_config, opt_config, withdrawal_tax, trading_days_per_year, compounding_rate, adjust_for_compounding, create_log, recommend_type].hash
    end
