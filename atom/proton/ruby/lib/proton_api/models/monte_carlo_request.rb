...
module ProtonApi
  class MonteCarloRequest
    ...
    def hash
      [sigma, max_bal, allocation_id, account_id, result_type, aggregation_account_id, market_data_source, max_sample, portfolio_id, mu, frequency_interval, ret_mod, min_sample, n, cf, model_id, use_proxy_data, init_bal, remove_outliers, min_bal, p].hash
    end
