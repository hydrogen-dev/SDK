...
module IntegrationApi
  class AchReserveLinkResponseVO
    ...
    def self.swagger_types
      {
        :'funding_source_id' => :'Array<String>',
        :'message' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'funding_source_id')
        if (value = attributes[:'funding_source_id']).is_a?(Array)
          self.funding_source_id = value
        end
      end
    ...
    def hash
      [funding_source_id, message, nucleus_business_id, vendor_name, vendor_response].hash
    end
