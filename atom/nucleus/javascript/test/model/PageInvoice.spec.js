...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageInvoice();
  });
  ...
  describe('PageInvoice', function() {
    it('should create an instance of PageInvoice', function() {
      // uncomment below and update the code to test PageInvoice
      //var instane = new HydrogenNucleusApi.PageInvoice();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageInvoice);
    });
