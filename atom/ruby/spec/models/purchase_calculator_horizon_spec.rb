...
# Unit tests for AtomApi::PurchaseCalculatorHorizon
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseCalculatorHorizon' do
  before do
    # run before each test
    @instance = AtomApi::PurchaseCalculatorHorizon.new
  end
  ...
  describe 'test an instance of PurchaseCalculatorHorizon' do
    it 'should create an instance of PurchaseCalculatorHorizon' do
      expect(@instance).to be_instance_of(AtomApi::PurchaseCalculatorHorizon)
    end
  end
