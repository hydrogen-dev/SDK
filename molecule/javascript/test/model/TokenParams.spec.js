...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenParams', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.TokenParams();
      });

      it('should create an instance of TokenParams', function() {
        // TODO: update the code to test TokenParams
        expect(instance).to.be.a(MoleculeApiDocumentation.TokenParams);
      });
