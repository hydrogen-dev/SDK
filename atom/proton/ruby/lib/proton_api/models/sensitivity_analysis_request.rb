...
module ProtonApi
  class SensitivityAnalysisRequest
    ...
    def hash
      [trading_days_per_year, portfolio_tickers, frequency_interval, sensitivity_factor, create_log, aggregation_account_id, allocation_id, model_id, portfolio_weights, end_date, start_date, use_proxy_data, account_id, market_data_source, portfolio_id].hash
    end
