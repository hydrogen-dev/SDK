...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnnuityCalculatorAnnuityAmountRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.AnnuityCalculatorAnnuityAmountRequest();
      });

      it('should create an instance of AnnuityCalculatorAnnuityAmountRequest', function() {
        // TODO: update the code to test AnnuityCalculatorAnnuityAmountRequest
        expect(instance).to.be.a(HydrogenProtonApi.AnnuityCalculatorAnnuityAmountRequest);
      });
