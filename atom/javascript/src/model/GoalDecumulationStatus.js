...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GoalDepositConfig', 'model/GoalRecommendationConfigStatus', 'model/GoalWithdrawalConfig'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GoalDepositConfig'), require('./GoalRecommendationConfigStatus'), require('./GoalWithdrawalConfig'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.GoalDecumulationStatus = factory(root.atom_api.ApiClient, root.atom_api.GoalDepositConfig, root.atom_api.GoalRecommendationConfigStatus, root.atom_api.GoalWithdrawalConfig);
  }
}(this, function(ApiClient, GoalDepositConfig, GoalRecommendationConfigStatus, GoalWithdrawalConfig) {
  'use strict';
  ...
  /**
   * The GoalDecumulationStatus model module.
   * @module model/GoalDecumulationStatus
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GoalDecumulationStatus</code>.
   * @alias module:model/GoalDecumulationStatus
   * @class
   ...
   * @param horizonFrequency {module:model/GoalDecumulationStatus.HorizonFrequencyEnum} Frequency in relation to the horizon
  ...
  /**
   * Constructs a <code>GoalDecumulationStatus</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GoalDecumulationStatus} obj Optional instance to populate.
   * @return {module:model/GoalDecumulationStatus} The populated <code>GoalDecumulationStatus</code> instance.
   */
   ...
   * @member {module:model/GoalDecumulationStatus.HorizonFrequencyEnum} horizon_frequency
   */
   ...
   * @member {module:model/GoalDecumulationStatus.RecommendTypeEnum} recommend_type
   * @default 'horizon'
   */
   ...
   * @member {module:model/GoalDecumulationStatus.ThreshTypeEnum} thresh_type
   * @default 'perc'
   */
