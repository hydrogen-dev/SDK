...
class EventStudyRequest(object):
    ...
    def __init__(self, portfolio_tickers=None, events=None, create_log=False, aggregation_account_id=None, allocation_id=None, model_id=None, portfolio_weights=None, use_proxy_data=False, account_id=None, market_data_source='nucleus', portfolio_id=None):  # noqa: E501
