...
public class SecuritiesApiTest {
    ...
    public void getSecurityExclusionAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageSecurityExclusion response = api.getSecurityExclusionAllUsingGet(securityExclusionId, ascending, filter, orderBy, page, size);
    ...
    public void getSecurityPriceAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageSecurityPrice response = api.getSecurityPriceAllUsingGet(ascending, filter, orderBy, page, size);
    ...
    public void getSecurityPriceUsingGetTest() throws ApiException {
        UUID securityPriceId = null;
        SecurityPrice response = api.getSecurityPriceUsingGet(securityPriceId);
