...
# create an instance of the API class
api_instance = atom_api.FeatureApi(atom_api.ApiClient(configuration))
feature_track = atom_api.FeatureTrack() # FeatureTrack | featureTrack
...
# create an instance of the API class
api_instance = atom_api.FeatureApi(atom_api.ApiClient(configuration))
feature = atom_api.Feature() # Feature | feature
...
# create an instance of the API class
api_instance = atom_api.FeatureApi(atom_api.ApiClient(configuration))
feature_track = atom_api.FeatureTrack() # FeatureTrack | feature_track
feature_track_id = 'feature_track_id_example' # str | UUID feature_track_id
