...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageCurrencyBalanceResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageCurrencyBalanceResponse();
      });

      it('should create an instance of PageCurrencyBalanceResponse', function() {
        // TODO: update the code to test PageCurrencyBalanceResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageCurrencyBalanceResponse);
      });
