...
module AtomApi
  class CreateSupportTicketCommentResponse
    ...
    def hash
      [support_ticket_id, description, has_attachment, is_admin, is_read, metadata, support_ticket_document, secondary_id, id, create_date].hash
    end
