...
# **getAccountStages**
> GetAccountStageResponse getAccountStages(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetAccountStageResponse result = apiInstance.getAccountStages(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getAccountStatuses**
> GetAccountStatusResponse getAccountStatuses(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetAccountStatusResponse result = apiInstance.getAccountStatuses(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
> AccountTransactionResponse getAccountTransactions(accountId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    AccountTransactionResponse result = apiInstance.getAccountTransactions(accountId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getAccountTypes**
> GetAccountTypeResponse getAccountTypes(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetAccountTypeResponse result = apiInstance.getAccountTypes(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getAccounts**
> GetAccountResponse getAccounts(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetAccountResponse result = apiInstance.getAccounts(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
UUID aggregationAccountId = new UUID(); // UUID | UUID of an aggregation account
try {
    SpecificAggregationAccountResponse result = apiInstance.getAggregationAccount(aggregationAccountId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getAggregationAccount");
    e.printStackTrace();
}
```
...
UUID aggregationAccountBalanceId = new UUID(); // UUID | UUID of an aggregation account balance
try {
    SpecificAggregationAccountBalanceResponse result = apiInstance.getAggregationAccountBalance(aggregationAccountBalanceId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getAggregationAccountBalance");
    e.printStackTrace();
}
```
...
> GetAggregationAccountBalanceResponse getAggregationAccountBalances(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetAggregationAccountBalanceResponse result = apiInstance.getAggregationAccountBalances(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getAggregationAccountBalances");
    e.printStackTrace();
}
```
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetAggregationAccountsResponse result = apiInstance.getAggregationAccounts(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getAggregationAccounts");
    e.printStackTrace();
}
```
...
> AllocationAssetSizeResponse getAllocationAssetSizes(allocationId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    AllocationAssetSizeResponse result = apiInstance.getAllocationAssetSizes(allocationId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
> GetAllocationCompositionResponse getAllocationCompositions(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetAllocationCompositionResponse result = apiInstance.getAllocationCompositions(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
> AllocationHoldingsResponse getAllocationHoldings(allocationId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    AllocationHoldingsResponse result = apiInstance.getAllocationHoldings(allocationId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
> AllocationTransactionResponse getAllocationTransactions(allocationId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    AllocationTransactionResponse result = apiInstance.getAllocationTransactions(allocationId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getAllocations**
> GetAllocationResponse getAllocations(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetAllocationResponse result = apiInstance.getAllocations(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getBankLinks**
> GetBankLinkResponse getBankLinks(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetBankLinkResponse result = apiInstance.getBankLinks(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
> BenchmarkAssetSizeResponse getBenchmarkAssetSizes(benchmarkId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    BenchmarkAssetSizeResponse result = apiInstance.getBenchmarkAssetSizes(benchmarkId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
String stat = "stat_example"; // String | Performance statistic
try {
    PerformanceResponse result = apiInstance.getBenchmarkPerformance(benchmarkId, stat);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getBenchmarkPerformance");
    e.printStackTrace();
}
```
...
# **getBenchmarks**
> GetBenchmarkResponse getBenchmarks(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetBenchmarkResponse result = apiInstance.getBenchmarks(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getBulkOrders**
> GetBulkOrderResponse getBulkOrders(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetBulkOrderResponse result = apiInstance.getBulkOrders(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getBulkOrders");
    e.printStackTrace();
}
```
...
# **getClientAssetSizes**
> ClientAssetSizeResponse getClientAssetSizes(clientId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    ClientAssetSizeResponse result = apiInstance.getClientAssetSizes(clientId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getClientHoldings**
> ClientHoldingsResponse getClientHoldings(clientId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    ClientHoldingsResponse result = apiInstance.getClientHoldings(clientId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getClientHydros**
> GetClientHydroResponse getClientHydros(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetClientHydroResponse result = apiInstance.getClientHydros(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
String stat = "stat_example"; // String | Performance statistic
try {
    PerformanceResponse result = apiInstance.getClientPerformance(clientId, stat);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getClientPerformance");
    e.printStackTrace();
}
```
...
# **getClientResponses**
> GetClientResponseResponse getClientResponses(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetClientResponseResponse result = apiInstance.getClientResponses(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
> ClientTransactionResponse getClientTransactions(clientId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    ClientTransactionResponse result = apiInstance.getClientTransactions(clientId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="getClients"></a>
# **getClients**
> GetClientResponse getClients(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetClientResponse result = apiInstance.getClients(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getDecisionTrees**
> GetDecisionTreeResponse getDecisionTrees(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetDecisionTreeResponse result = apiInstance.getDecisionTrees(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getDepositRequests**
> GetDepositRequestResponse getDepositRequests(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetDepositRequestResponse result = apiInstance.getDepositRequests(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getFundingRequests**
> GetFundingRequestResponse getFundingRequests(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetFundingRequestResponse result = apiInstance.getFundingRequests(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getGoalAssetSizes**
> GoalAssetSizeResponse getGoalAssetSizes(goalId, clientId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GoalAssetSizeResponse result = apiInstance.getGoalAssetSizes(goalId, clientId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getGoalHoldings**
> GoalHoldingsResponse getGoalHoldings(goalId, clientId, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GoalHoldingsResponse result = apiInstance.getGoalHoldings(goalId, clientId, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getGoalPerformance**
> PerformanceResponse getGoalPerformance(goalId, stat, clientId)
...
UUID clientId = new UUID(); // UUID | UUID of a client
try {
    PerformanceResponse result = apiInstance.getGoalPerformance(goalId, stat, clientId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getGoalPerformance");
    e.printStackTrace();
}
```
...
UUID goalTrackId = new UUID(); // UUID | UUID of a goal tracking record
try {
    SpecificGoalTrackResponse result = apiInstance.getGoalTrackRecord(goalTrackId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getGoalTrackRecord");
    e.printStackTrace();
}
```
...
# **getGoalTrackRecords**
> GetGoalTrackResponse getGoalTrackRecords(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetGoalTrackResponse result = apiInstance.getGoalTrackRecords(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getGoalTrackRecords");
    e.printStackTrace();
}
```
...
# **getGoalTransactions**
> GoalTransactionsResponse getGoalTransactions(goalId, clientId, page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GoalTransactionsResponse result = apiInstance.getGoalTransactions(goalId, clientId, page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="getGoals"></a>
# **getGoals**
> GetGoalResponse getGoals(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetGoalResponse result = apiInstance.getGoals(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
UUID modelId = new UUID(); // UUID | UUID of a model
try {
    SpecificModelResponse result = apiInstance.getModel(modelId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModel");
    e.printStackTrace();
}
```
...
UUID modelAssetSizeId = new UUID(); // UUID | UUID of a model asset size record
try {
    SpecificModelAssetSizeResponse result = apiInstance.getModelAssetSize(modelAssetSizeId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModelAssetSize");
    e.printStackTrace();
}
```
...
# **getModelAssetSizes**
> GetModelAssetSizeResponse getModelAssetSizes(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetModelAssetSizeResponse result = apiInstance.getModelAssetSizes(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModelAssetSizes");
    e.printStackTrace();
}
```
...
UUID modelCommentId = new UUID(); // UUID | UUID of a model comment
try {
    SpecificModelCommentResponse result = apiInstance.getModelComment(modelCommentId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModelComment");
    e.printStackTrace();
}
```
...
# **getModelComments**
> GetModelCommentResponse getModelComments(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetModelCommentResponse result = apiInstance.getModelComments(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModelComments");
    e.printStackTrace();
}
```
...
UUID modelHoldingId = new UUID(); // UUID | UUID of a model holding record
try {
    SpecificModelHoldingResponse result = apiInstance.getModelHolding(modelHoldingId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModelHolding");
    e.printStackTrace();
}
```
...
# **getModelHoldings**
> GetModelHoldingResponse getModelHoldings(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetModelHoldingResponse result = apiInstance.getModelHoldings(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModelHoldings");
    e.printStackTrace();
}
```
...
String stat = "stat_example"; // String | Performance statistic
try {
    PerformanceResponse result = apiInstance.getModelPerformance(modelId, stat);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModelPerformance");
    e.printStackTrace();
}
```
...
UUID modelTransactionId = new UUID(); // UUID | UUID of a model transaction record
try {
    SpecificModelTransactionResponse result = apiInstance.getModelTransaction(modelTransactionId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModelTransaction");
    e.printStackTrace();
}
```
...
> GetModelTransactionResponse getModelTransactions(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetModelTransactionResponse result = apiInstance.getModelTransactions(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModelTransactions");
    e.printStackTrace();
}
```
...
<a name="getModels"></a>
# **getModels**
> GetModelResponse getModels(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetModelResponse result = apiInstance.getModels(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getModels");
    e.printStackTrace();
}
```
...
> GetNodeRelationshipResponse getNodeRelationships(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetNodeRelationshipResponse result = apiInstance.getNodeRelationships(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="getNodes"></a>
# **getNodes**
> GetNodeResponse getNodes(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetNodeResponse result = apiInstance.getNodes(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
UUID orderId = new UUID(); // UUID | UUID of an order record
try {
    SpecificOrderResponse result = apiInstance.getOrderRecord(orderId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getOrderRecord");
    e.printStackTrace();
}
```
...
# **getOrderRecords**
> GetOrderResponse getOrderRecords(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetOrderResponse result = apiInstance.getOrderRecords(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getOrderRecords");
    e.printStackTrace();
}
```
...
UUID orderStatusId = new UUID(); // UUID | UUID of an order status record
try {
    SpecificOrderStatusResponse result = apiInstance.getOrderStatus(orderStatusId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getOrderStatus");
    e.printStackTrace();
}
```
...
# **getOrderStatuses**
> GetOrderStatusResponse getOrderStatuses(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetOrderStatusResponse result = apiInstance.getOrderStatuses(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getOrderStatuses");
    e.printStackTrace();
}
```
...
UUID orderTrackId = new UUID(); // UUID | UUID of an order tracking record
try {
    SpecificOrderTrackResponse result = apiInstance.getOrderTrackingRecord(orderTrackId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getOrderTrackingRecord");
    e.printStackTrace();
}
```
...
> GetOrderTrackResponse getOrderTrackingRecords(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetOrderTrackResponse result = apiInstance.getOrderTrackingRecords(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getOrderTrackingRecords");
    e.printStackTrace();
}
```
...
UUID portfolioId = new UUID(); // UUID | UUID of a portfolio
try {
    SpecificPortfolioResponse result = apiInstance.getPortfolio(portfolioId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolio");
    e.printStackTrace();
}
```
...
UUID portfolioAssetSizeId = new UUID(); // UUID | UUID of a portfolio asset size record
try {
    SpecificPortfolioAssetSizeResponse result = apiInstance.getPortfolioAssetSize(portfolioAssetSizeId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolioAssetSize");
    e.printStackTrace();
}
```
...
> GetPortfolioAssetSizeResponse getPortfolioAssetSizes(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetPortfolioAssetSizeResponse result = apiInstance.getPortfolioAssetSizes(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolioAssetSizes");
    e.printStackTrace();
}
```
...
UUID portfolioCommentId = new UUID(); // UUID | UUID of a portfolio comment
try {
    SpecificPortfolioCommentResponse result = apiInstance.getPortfolioComment(portfolioCommentId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolioComment");
    e.printStackTrace();
}
```
...
> GetPortfolioCommentResponse getPortfolioComments(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetPortfolioCommentResponse result = apiInstance.getPortfolioComments(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolioComments");
    e.printStackTrace();
}
```
...
UUID portfolioHoldingId = new UUID(); // UUID | UUID of a portfolio holding record
try {
    SpecificPortfolioHoldingResponse result = apiInstance.getPortfolioHolding(portfolioHoldingId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolioHolding");
    e.printStackTrace();
}
```
...
> GetPortfolioHoldingResponse getPortfolioHoldings(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetPortfolioHoldingResponse result = apiInstance.getPortfolioHoldings(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolioHoldings");
    e.printStackTrace();
}
```
...
> PerformanceResponse getPortfolioPerformance(portfolioId, stat)
...
String stat = "stat_example"; // String | Performance statistic
try {
    PerformanceResponse result = apiInstance.getPortfolioPerformance(portfolioId, stat);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolioPerformance");
    e.printStackTrace();
}
```
...
UUID portfolioTransactionId = new UUID(); // UUID | UUID of a portfolio transaction record
try {
    SpecificPortfolioTransactionResponse result = apiInstance.getPortfolioTransaction(portfolioTransactionId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolioTransaction");
    e.printStackTrace();
}
```
...
> GetPortfolioTransactionResponse getPortfolioTransactions(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetPortfolioTransactionResponse result = apiInstance.getPortfolioTransactions(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolioTransactions");
    e.printStackTrace();
}
```
...
# **getPortfolios**
> GetPortfolioResponse getPortfolios(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetPortfolioResponse result = apiInstance.getPortfolios(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getPortfolios");
    e.printStackTrace();
}
```
...
# **getQuestionnaires**
> GetQuestionnaireResponse getQuestionnaires(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetQuestionnaireResponse result = apiInstance.getQuestionnaires(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="getScores"></a>
# **getScores**
> GetScoreResponse getScores(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetScoreResponse result = apiInstance.getScores(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
# **getSecurities**
> GetSecurityResponse getSecurities(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetSecurityResponse result = apiInstance.getSecurities(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getSecurities");
    e.printStackTrace();
}
```
...
UUID securityId = new UUID(); // UUID | UUID of a security
try {
    SpecificSecurityResponse result = apiInstance.getSecurity(securityId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getSecurity");
    e.printStackTrace();
}
```
...
UUID securityExclusionId = new UUID(); // UUID | UUID of a security exclusion record
try {
    SpecificSecurityExclusionResponse result = apiInstance.getSecurityExclusion(securityExclusionId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getSecurityExclusion");
    e.printStackTrace();
}
```
...
> GetSecurityExclusionResponse getSecurityExclusions(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetSecurityExclusionResponse result = apiInstance.getSecurityExclusions(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getSecurityExclusions");
    e.printStackTrace();
}
```
...
> PerformanceResponse getSecurityPerformance(securityId, stat)
...
String stat = "stat_example"; // String | Performance statistic
try {
    PerformanceResponse result = apiInstance.getSecurityPerformance(securityId, stat);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getSecurityPerformance");
    e.printStackTrace();
}
```
...
UUID securityPriceId = new UUID(); // UUID | UUID of a security price record
try {
    SpecificSecurityPriceResponse result = apiInstance.getSecurityPrice(securityPriceId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getSecurityPrice");
    e.printStackTrace();
}
```
...
# **getSecurityPrices**
> GetSecurityPriceResponse getSecurityPrices(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetSecurityPriceResponse result = apiInstance.getSecurityPrices(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getSecurityPrices");
    e.printStackTrace();
}
```
...
UUID transactionCodeId = new UUID(); // UUID | UUID of a transaction code
try {
    SpecificTransactionCodeResponse result = apiInstance.getTransactionCode(transactionCodeId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getTransactionCode");
    e.printStackTrace();
}
```
...
# **getTransactionCodes**
> GetTransactionCodeResponse getTransactionCodes(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetTransactionCodeResponse result = apiInstance.getTransactionCodes(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#getTransactionCodes");
    e.printStackTrace();
}
```
...
# **getTransferRequests**
> GetTransferResponse getTransferRequests(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetTransferResponse result = apiInstance.getTransferRequests(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
> GetWithdrawalResponse getWithdrawalRequests(page, size, orderBy, ascending, filter)
...
String filter = "filter_example"; // String | Every field within an object using the GET method can be filtered except for fields stored under metadata. Filtering is especially useful for calls that return many different fields.
try {
    GetWithdrawalResponse result = apiInstance.getWithdrawalRequests(page, size, orderBy, ascending, filter);
    System.out.println(result);
} catch (ApiException e) {
...
> BulkOrderFirmclientaccountResponse postAccountBulkOrder(accountId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID accountId = new UUID(); // UUID | UUID of an account
BulkOrderAccountPayload payload = new BulkOrderAccountPayload(); // BulkOrderAccountPayload | 
try {
    BulkOrderFirmclientaccountResponse result = apiInstance.postAccountBulkOrder(accountId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postAccountBulkOrder");
    e.printStackTrace();
}
```
...
> postAccountRebalanceBuyOnlyOrder(accountId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID accountId = new UUID(); // UUID | UUID of an account
AccountRebalanceBuyOnlyOrderPayload payload = new AccountRebalanceBuyOnlyOrderPayload(); // AccountRebalanceBuyOnlyOrderPayload | 
try {
    apiInstance.postAccountRebalanceBuyOnlyOrder(accountId, payload);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postAccountRebalanceBuyOnlyOrder");
    e.printStackTrace();
}
```
...
> SpecificOrderTrackResponse postAccountRebalanceOrder(accountId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID accountId = new UUID(); // UUID | UUID of an account
AccountRebalanceOrderPayload payload = new AccountRebalanceOrderPayload(); // AccountRebalanceOrderPayload | 
try {
    SpecificOrderTrackResponse result = apiInstance.postAccountRebalanceOrder(accountId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postAccountRebalanceOrder");
    e.printStackTrace();
}
```
...
> postAccountRebalanceSellOnlyOrder(accountId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID accountId = new UUID(); // UUID | UUID of an account
AccountRebalanceSellOnlyOrderPayload payload = new AccountRebalanceSellOnlyOrderPayload(); // AccountRebalanceSellOnlyOrderPayload | 
try {
    apiInstance.postAccountRebalanceSellOnlyOrder(accountId, payload);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postAccountRebalanceSellOnlyOrder");
    e.printStackTrace();
}
```
...
> SellAllAccountResponse postAccountSellAllOrder(accountId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID accountId = new UUID(); // UUID | UUID of an account
SellAllAccountPayload payload = new SellAllAccountPayload(); // SellAllAccountPayload | 
try {
    SellAllAccountResponse result = apiInstance.postAccountSellAllOrder(accountId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postAccountSellAllOrder");
    e.printStackTrace();
}
```
...
try {
    CreateAggregationAccountResponse result = apiInstance.postAggregationAccount(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postAggregationAccount");
    e.printStackTrace();
}
```
...
try {
    CreateAggregationAccountBalanceResponse result = apiInstance.postAggregationAccountBalance(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postAggregationAccountBalance");
    e.printStackTrace();
}
```
...
try {
    BulkOrderFirmclientaccountResponse result = apiInstance.postBulkOrder(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postBulkOrder");
    e.printStackTrace();
}
```
...
NucleusApi apiInstance = new NucleusApi();
UUID clientId = new UUID(); // UUID | UUID of a client
BulkOrderClientPayload payload = new BulkOrderClientPayload(); // BulkOrderClientPayload | 
try {
    BulkOrderFirmclientaccountResponse result = apiInstance.postClientBulkOrder(clientId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postClientBulkOrder");
    e.printStackTrace();
}
```
...
try {
    CreateGoalTrackResponse result = apiInstance.postGoalTrackRecord(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postGoalTrackRecord");
    e.printStackTrace();
}
```
...
try {
    CreateModelResponse result = apiInstance.postModel(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postModel");
    e.printStackTrace();
}
```
...
try {
    CreateModelAssetSizeResponse result = apiInstance.postModelAssetSize(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postModelAssetSize");
    e.printStackTrace();
}
```
...
try {
    CreateModelCommentResponse result = apiInstance.postModelComment(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postModelComment");
    e.printStackTrace();
}
```
...
try {
    CreateModelHoldingResponse result = apiInstance.postModelHolding(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postModelHolding");
    e.printStackTrace();
}
```
...
try {
    CreateModelTransactionResponse result = apiInstance.postModelTransaction(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postModelTransaction");
    e.printStackTrace();
}
```
...
try {
    CreateOrderResponse result = apiInstance.postOrderRecord(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postOrderRecord");
    e.printStackTrace();
}
```
...
try {
    CreateOrderStatusResponse result = apiInstance.postOrderStatus(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postOrderStatus");
    e.printStackTrace();
}
```
...
try {
    CreateOrderTrackResponse result = apiInstance.postOrderTrackingRecord(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postOrderTrackingRecord");
    e.printStackTrace();
}
```
...
try {
    CreatePortfolioResponse result = apiInstance.postPortfolio(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postPortfolio");
    e.printStackTrace();
}
```
...
try {
    CreatePortfolioAssetSizeResponse result = apiInstance.postPortfolioAssetSize(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postPortfolioAssetSize");
    e.printStackTrace();
}
```
...
try {
    CreatePortfolioCommentResponse result = apiInstance.postPortfolioComment(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postPortfolioComment");
    e.printStackTrace();
}
```
...
try {
    CreatePortfolioHoldingResponse result = apiInstance.postPortfolioHolding(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postPortfolioHolding");
    e.printStackTrace();
}
```
...
> PortfolioRebalanceBuyOnlyOrderPayload postPortfolioRebalanceBuyOnlyOrder(portfolioId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID portfolioId = new UUID(); // UUID | UUID of a portfolio
PortfolioRebalanceBuyOnlyOrderPayload payload = new PortfolioRebalanceBuyOnlyOrderPayload(); // PortfolioRebalanceBuyOnlyOrderPayload | 
try {
    PortfolioRebalanceBuyOnlyOrderPayload result = apiInstance.postPortfolioRebalanceBuyOnlyOrder(portfolioId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postPortfolioRebalanceBuyOnlyOrder");
    e.printStackTrace();
}
```
...
> PortfolioRebalanceOrderPayload postPortfolioRebalanceOrder(portfolioId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID portfolioId = new UUID(); // UUID | UUID of a portfolio
PortfolioRebalanceOrderPayload payload = new PortfolioRebalanceOrderPayload(); // PortfolioRebalanceOrderPayload | 
try {
    PortfolioRebalanceOrderPayload result = apiInstance.postPortfolioRebalanceOrder(portfolioId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postPortfolioRebalanceOrder");
    e.printStackTrace();
}
```
...
> PortfolioRebalanceSellOnlyOrderPayload postPortfolioRebalanceSellOnlyOrder(portfolioId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID portfolioId = new UUID(); // UUID | UUID of a portfolio
PortfolioRebalanceSellOnlyOrderPayload payload = new PortfolioRebalanceSellOnlyOrderPayload(); // PortfolioRebalanceSellOnlyOrderPayload | 
try {
    PortfolioRebalanceSellOnlyOrderPayload result = apiInstance.postPortfolioRebalanceSellOnlyOrder(portfolioId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postPortfolioRebalanceSellOnlyOrder");
    e.printStackTrace();
}
```
...
> SellAllPortfolioResponse postPortfolioSellAllOrder(portfolioId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID portfolioId = new UUID(); // UUID | UUID of a portfolio
SellAllPortfolioPayload payload = new SellAllPortfolioPayload(); // SellAllPortfolioPayload | 
try {
    SellAllPortfolioResponse result = apiInstance.postPortfolioSellAllOrder(portfolioId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postPortfolioSellAllOrder");
    e.printStackTrace();
}
```
...
try {
    CreatePortfolioTransactionResponse result = apiInstance.postPortfolioTransaction(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postPortfolioTransaction");
    e.printStackTrace();
}
```
...
try {
    CreateSecurityResponse result = apiInstance.postSecurity(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postSecurity");
    e.printStackTrace();
}
```
...
try {
    CreateSecurityExclusionResponse result = apiInstance.postSecurityExclusion(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postSecurityExclusion");
    e.printStackTrace();
}
```
...
try {
    CreateSecurityPriceResponse result = apiInstance.postSecurityPrice(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postSecurityPrice");
    e.printStackTrace();
}
```
...
try {
    CreateTransactionCodeResponse result = apiInstance.postTransactionCode(payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#postTransactionCode");
    e.printStackTrace();
}
```
...
# **subscribeAccount**
> SubscribeAccountResponse subscribeAccount(accountId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID accountId = new UUID(); // UUID | UUID of an account
AccountSubscribePayload payload = new AccountSubscribePayload(); // AccountSubscribePayload | 
try {
...
# **updateAccount**
> SpecificAccountResponse updateAccount(accountId, payload)
...
> SpecificAccountAllocationResponse updateAccountAllocation(accountAllocationId, payload)
...
> SpecificAccountPermissionResponse updateAccountPermission(accountId, payload)
...
NucleusApi apiInstance = new NucleusApi();
UUID accountId = new UUID(); // UUID | UUID of an account
AccountPermissionPayload payload = new AccountPermissionPayload(); // AccountPermissionPayload | 
try {
...
# **updateAccountStage**
> SpecificAccountStageResponse updateAccountStage(stageId, payload)
...
# **updateAccountStatus**
> SpecificAccountStatusResponse updateAccountStatus(accountStatusId, payload)
...
# **updateAccountType**
> GetAccountTypeSubresponse updateAccountType(accountTypeId, payload)
...
> SpecificAggregationAccountResponse updateAggregationAccount(aggregationAccountId, payload)
...
AggregationAccountPayload payload = new AggregationAccountPayload(); // AggregationAccountPayload | 
try {
    SpecificAggregationAccountResponse result = apiInstance.updateAggregationAccount(aggregationAccountId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateAggregationAccount");
    e.printStackTrace();
}
```
...
> SpecificAggregationAccountBalanceResponse updateAggregationAccountBalance(aggregationAccountBalanceId, payload)
...
AggregationAccountBalancePayload payload = new AggregationAccountBalancePayload(); // AggregationAccountBalancePayload | 
try {
    SpecificAggregationAccountBalanceResponse result = apiInstance.updateAggregationAccountBalance(aggregationAccountBalanceId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateAggregationAccountBalance");
    e.printStackTrace();
}
```
...
> GetAllocationCompositionResponse updateAllocationComposition(allocationCompositionId, payload)
...
# **updateBankLink**
> SpecificBankLinkResponse updateBankLink(bankLinkId, payload)
...
# **updateClientHydro**
> SpecificClientHydroResponse updateClientHydro(clientHydroId, payload)
...
> SpecificClientResponseResponse updateClientResponse(clientResponseId, payload)
...
# **updateDecisionTree**
> SpecificDecisionTreeResponse updateDecisionTree(decisionTreeId, payload)
...
> SpecificDepositRequestResponse updateDepositRequest(depositId, payload)
...
> SpecificFundingRequestResponse updateFundingRequest(fundingId, payload)
...
> SpecificGoalTrackResponse updateGoalTrackRecord(goalTrackId, payload)
...
GoalTrackPayload payload = new GoalTrackPayload(); // GoalTrackPayload | 
try {
    SpecificGoalTrackResponse result = apiInstance.updateGoalTrackRecord(goalTrackId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateGoalTrackRecord");
    e.printStackTrace();
}
```
...
ModelPayload payload = new ModelPayload(); // ModelPayload | 
try {
    SpecificModelResponse result = apiInstance.updateModel(modelId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateModel");
    e.printStackTrace();
}
```
...
> SpecificModelAssetSizeResponse updateModelAssetSize(modelAssetSizeId, payload)
...
ModelAssetSizePayload payload = new ModelAssetSizePayload(); // ModelAssetSizePayload | 
try {
    SpecificModelAssetSizeResponse result = apiInstance.updateModelAssetSize(modelAssetSizeId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateModelAssetSize");
    e.printStackTrace();
}
```
...
# **updateModelComment**
> SpecificModelCommentResponse updateModelComment(modelCommentId, payload)
...
ModelCommentPayload payload = new ModelCommentPayload(); // ModelCommentPayload | 
try {
    SpecificModelCommentResponse result = apiInstance.updateModelComment(modelCommentId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateModelComment");
    e.printStackTrace();
}
```
...
NucleusApi apiInstance = new NucleusApi();
UUID modelId = new UUID(); // UUID | UUID of a model
ModelCompositionPayload payload = new ModelCompositionPayload(); // ModelCompositionPayload | 
try {
    ChangeModelCompositionResponse result = apiInstance.updateModelComposition(modelId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateModelComposition");
    e.printStackTrace();
}
```
...
# **updateModelHolding**
> SpecificModelHoldingResponse updateModelHolding(modelHoldingId, payload)
...
ModelHoldingPayload payload = new ModelHoldingPayload(); // ModelHoldingPayload | 
try {
    SpecificModelHoldingResponse result = apiInstance.updateModelHolding(modelHoldingId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateModelHolding");
    e.printStackTrace();
}
```
...
> SpecificModelTransactionResponse updateModelTransaction(modelTransactionId, payload)
...
ModelTransactionPayload payload = new ModelTransactionPayload(); // ModelTransactionPayload | 
try {
    SpecificModelTransactionResponse result = apiInstance.updateModelTransaction(modelTransactionId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateModelTransaction");
    e.printStackTrace();
}
```
...
<a name="updateNode"></a>
# **updateNode**
> SpecificNodeResponse updateNode(nodeId, payload)
...
> SpecificNodeRelationshipResponse updateNodeRelationship(nodeRelationshipId, payload)
...
# **updateOrderRecord**
> SpecificOrderResponse updateOrderRecord(orderId, payload)
...
OrderPayload payload = new OrderPayload(); // OrderPayload | 
try {
    SpecificOrderResponse result = apiInstance.updateOrderRecord(orderId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateOrderRecord");
    e.printStackTrace();
}
```
...
# **updateOrderStatus**
> SpecificOrderStatusResponse updateOrderStatus(orderStatusId, payload)
...
OrderStatusPayload payload = new OrderStatusPayload(); // OrderStatusPayload | 
try {
    SpecificOrderStatusResponse result = apiInstance.updateOrderStatus(orderStatusId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateOrderStatus");
    e.printStackTrace();
}
```
...
> SpecificOrderTrackResponse updateOrderTrackingRecord(orderTrackId, payload)
...
OrderTrackPayload payload = new OrderTrackPayload(); // OrderTrackPayload | 
try {
    SpecificOrderTrackResponse result = apiInstance.updateOrderTrackingRecord(orderTrackId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateOrderTrackingRecord");
    e.printStackTrace();
}
```
...
# **updatePortfolio**
> SpecificPortfolioResponse updatePortfolio(portfolioId, payload)
...
PortfolioPayload payload = new PortfolioPayload(); // PortfolioPayload | 
try {
    SpecificPortfolioResponse result = apiInstance.updatePortfolio(portfolioId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updatePortfolio");
    e.printStackTrace();
}
```
...
> SpecificPortfolioAssetSizeResponse updatePortfolioAssetSize(portfolioAssetSizeId, payload)
...
PortfolioAssetSizePayload payload = new PortfolioAssetSizePayload(); // PortfolioAssetSizePayload | 
try {
    SpecificPortfolioAssetSizeResponse result = apiInstance.updatePortfolioAssetSize(portfolioAssetSizeId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updatePortfolioAssetSize");
    e.printStackTrace();
}
```
...
> SpecificPortfolioCommentResponse updatePortfolioComment(portfolioCommentId, payload)
...
PortfolioCommentPayload payload = new PortfolioCommentPayload(); // PortfolioCommentPayload | 
try {
    SpecificPortfolioCommentResponse result = apiInstance.updatePortfolioComment(portfolioCommentId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updatePortfolioComment");
    e.printStackTrace();
}
```
...
> SpecificPortfolioHoldingResponse updatePortfolioHolding(portfolioHoldingId, payload)
...
PortfolioHoldingPayload payload = new PortfolioHoldingPayload(); // PortfolioHoldingPayload | 
try {
    SpecificPortfolioHoldingResponse result = apiInstance.updatePortfolioHolding(portfolioHoldingId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updatePortfolioHolding");
    e.printStackTrace();
}
```
...
> SpecificPortfolioTransactionResponse updatePortfolioTransaction(portfolioTransactionId, payload)
...
PortfolioTransactionPayload payload = new PortfolioTransactionPayload(); // PortfolioTransactionPayload | 
try {
    SpecificPortfolioTransactionResponse result = apiInstance.updatePortfolioTransaction(portfolioTransactionId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updatePortfolioTransaction");
    e.printStackTrace();
}
```
...
# **updateQuestionnaire**
> SpecificQuestionnaireResponse updateQuestionnaire(questionnaireId, payload)
...
# **updateScore**
> SpecificScoreResponse updateScore(scoreId, payload)
...
# **updateSecurity**
> SpecificSecurityResponse updateSecurity(securityId, payload)
...
SecurityPayload payload = new SecurityPayload(); // SecurityPayload | 
try {
    SpecificSecurityResponse result = apiInstance.updateSecurity(securityId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateSecurity");
    e.printStackTrace();
}
```
...
> SpecificSecurityExclusionResponse updateSecurityExclusion(securityExclusionId, payload)
...
SecurityExclusionPayload payload = new SecurityExclusionPayload(); // SecurityExclusionPayload | 
try {
    SpecificSecurityExclusionResponse result = apiInstance.updateSecurityExclusion(securityExclusionId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateSecurityExclusion");
    e.printStackTrace();
}
```
...
# **updateSecurityPrice**
> SpecificSecurityPriceResponse updateSecurityPrice(securityPriceId, payload)
...
SecurityPricePayload payload = new SecurityPricePayload(); // SecurityPricePayload | 
try {
    SpecificSecurityPriceResponse result = apiInstance.updateSecurityPrice(securityPriceId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateSecurityPrice");
    e.printStackTrace();
}
```
...
> SpecificTransactionCodeResponse updateTransactionCode(transactionCodeId, payload)
...
TransactionCodePayload payload = new TransactionCodePayload(); // TransactionCodePayload | 
try {
    SpecificTransactionCodeResponse result = apiInstance.updateTransactionCode(transactionCodeId, payload);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling NucleusApi#updateTransactionCode");
    e.printStackTrace();
}
```
...
> SpecificTransferResponse updateTransferRequest(transferId, payload)
...
> SpecificWithdrawalResponse updateWithdrawalRequest(withdrawalId, payload)
