...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DepositRequestPayload', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DepositRequestPayload'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.CreateDepositRequestResponse = factory(root.atom_api.ApiClient, root.atom_api.DepositRequestPayload, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, DepositRequestPayload, SecondaryId) {
  'use strict';
  ...
  /**
   * The CreateDepositRequestResponse model module.
   * @module model/CreateDepositRequestResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateDepositRequestResponse</code>.
   * @alias module:model/CreateDepositRequestResponse
   * @class
   * @implements module:model/DepositRequestPayload
  ...
  var exports = function(accountId, amount, fundingId, investedDate) {
    ...
    DepositRequestPayload.call(_this, accountId, amount, fundingId, investedDate);


  };

  /**
   * Constructs a <code>CreateDepositRequestResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateDepositRequestResponse} obj Optional instance to populate.
   * @return {module:model/CreateDepositRequestResponse} The populated <code>CreateDepositRequestResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      DepositRequestPayload.constructFromObject(data, obj);
  ...
  // Implement DepositRequestPayload interface:
  /**
