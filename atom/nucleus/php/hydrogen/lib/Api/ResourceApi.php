...
class ResourceApi
{
     ...
     */
    public function getAllMerchantCategoryCodeUsingGet()
    {
        list($response) = $this->getAllMerchantCategoryCodeUsingGetWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getAllMerchantCategoryCodeUsingGetWithHttpInfo()
    {
        $returnType = '\com\hydrogen\nucleus\Model\MerchantCategoryCode[]';
        $request = $this->getAllMerchantCategoryCodeUsingGetRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllMerchantCategoryCodeUsingGetAsync()
    {
        return $this->getAllMerchantCategoryCodeUsingGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllMerchantCategoryCodeUsingGetAsyncWithHttpInfo()
    {
        $returnType = '\com\hydrogen\nucleus\Model\MerchantCategoryCode[]';
        $request = $this->getAllMerchantCategoryCodeUsingGetRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllMerchantCategoryCodeUsingGetRequest()
    {
