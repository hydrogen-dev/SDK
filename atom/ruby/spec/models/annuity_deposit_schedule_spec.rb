...
# Unit tests for AtomApi::AnnuityDepositSchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnnuityDepositSchedule' do
  before do
    # run before each test
    @instance = AtomApi::AnnuityDepositSchedule.new
  end
  ...
  describe 'test an instance of AnnuityDepositSchedule' do
    it 'should create an instance of AnnuityDepositSchedule' do
      expect(@instance).to be_instance_of(AtomApi::AnnuityDepositSchedule)
    end
  end
