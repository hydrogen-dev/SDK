...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/IAVApi~deleteBankLinkUsingDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/IAVApi~deleteBankLinkUsingDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteBankLinkUsingDelete = function(nucleusBankLinkId, opts, callback) {
      opts = opts || {};
      var postBody = null;
