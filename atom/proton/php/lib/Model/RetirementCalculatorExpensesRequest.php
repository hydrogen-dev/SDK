...
/**
 * RetirementCalculatorExpensesRequest Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\proton
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RetirementCalculatorExpensesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'retirementCalculatorExpensesRequest';
    ...
    public function setRetirementSavings($retirement_savings)
    {
        ...
        if (!is_null($retirement_savings) && ($retirement_savings < 0)) {
            throw new \InvalidArgumentException('invalid value for $retirement_savings when calling RetirementCalculatorExpensesRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrentAge($current_age)
    {
        ...
        if (($current_age < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_age when calling RetirementCalculatorExpensesRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setRetirementIncome($retirement_income)
    {
        ...
        if (!is_null($retirement_income) && ($retirement_income < 0)) {
            throw new \InvalidArgumentException('invalid value for $retirement_income when calling RetirementCalculatorExpensesRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setRetirementTax($retirement_tax)
    {
        ...
        if (!is_null($retirement_tax) && ($retirement_tax > 1)) {
            throw new \InvalidArgumentException('invalid value for $retirement_tax when calling RetirementCalculatorExpensesRequest., must be smaller than or equal to 1.');
        }
        if (!is_null($retirement_tax) && ($retirement_tax < 0)) {
            throw new \InvalidArgumentException('invalid value for $retirement_tax when calling RetirementCalculatorExpensesRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDeathAge($death_age)
    {
        ...
        if (($death_age < 0)) {
            throw new \InvalidArgumentException('invalid value for $death_age when calling RetirementCalculatorExpensesRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setRetirementAge($retirement_age)
    {
        ...
        if (!is_null($retirement_age) && ($retirement_age < 0)) {
            throw new \InvalidArgumentException('invalid value for $retirement_age when calling RetirementCalculatorExpensesRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setPercentOfExpensesCovered($percent_of_expenses_covered)
    {
        ...
        if (!is_null($percent_of_expenses_covered) && ($percent_of_expenses_covered > 1)) {
            throw new \InvalidArgumentException('invalid value for $percent_of_expenses_covered when calling RetirementCalculatorExpensesRequest., must be smaller than or equal to 1.');
        }
        if (!is_null($percent_of_expenses_covered) && ($percent_of_expenses_covered < 0)) {
            throw new \InvalidArgumentException('invalid value for $percent_of_expenses_covered when calling RetirementCalculatorExpensesRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setPortfolioReturn($portfolio_return)
    {
        ...
        if (($portfolio_return < -1)) {
            throw new \InvalidArgumentException('invalid value for $portfolio_return when calling RetirementCalculatorExpensesRequest., must be bigger than or equal to -1.');
        }
    ...
    public function setInflationRate($inflation_rate)
    {
        ...
        if (!is_null($inflation_rate) && ($inflation_rate < -1)) {
            throw new \InvalidArgumentException('invalid value for $inflation_rate when calling RetirementCalculatorExpensesRequest., must be bigger than or equal to -1.');
        }
