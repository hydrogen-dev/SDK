...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateNodeRelationshipResponse', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CreateNodeRelationshipResponse'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.SpecificNodeRelationshipResponse = factory(root.atom_api.ApiClient, root.atom_api.CreateNodeRelationshipResponse, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, CreateNodeRelationshipResponse, SecondaryId) {
  'use strict';
  ...
  /**
   * The SpecificNodeRelationshipResponse model module.
   * @module model/SpecificNodeRelationshipResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>SpecificNodeRelationshipResponse</code>.
   * @alias module:model/SpecificNodeRelationshipResponse
   * @class
   * @implements module:model/CreateNodeRelationshipResponse
  ...
  var exports = function(answerId, value, decisionTreeId, nodeParentId) {
    ...
    CreateNodeRelationshipResponse.call(_this, answerId, value, decisionTreeId, nodeParentId);

  };

  /**
   * Constructs a <code>SpecificNodeRelationshipResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpecificNodeRelationshipResponse} obj Optional instance to populate.
   * @return {module:model/SpecificNodeRelationshipResponse} The populated <code>SpecificNodeRelationshipResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      CreateNodeRelationshipResponse.constructFromObject(data, obj);
  ...
  // Implement CreateNodeRelationshipResponse interface:
  /**
