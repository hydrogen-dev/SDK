...
module ProtonApi
  class RetirementCalculatorPercentCoveredRequest
    ...
    def hash
      [inflation_rate, current_age, deposit_schedule, portfolio_return, retirement_income, aggregation_account_ids, retirement_expenses, retirement_tax, account_ids, retirement_age, death_age, retirement_savings].hash
    end
