...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageModelHolding();
  });
  ...
  describe('PageModelHolding', function() {
    it('should create an instance of PageModelHolding', function() {
      // uncomment below and update the code to test PageModelHolding
      //var instane = new HydrogenNucleusApi.PageModelHolding();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageModelHolding);
    });
