...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageOrderBulk :  IEquatable<PageOrderBulk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageOrderBulk" /> class.
        /// </summary>
        ...
        public PageOrderBulk(List<OrderBulk> content = default(List<OrderBulk>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<OrderBulk> Content { get; set; }
        ...
        {
            return this.Equals(input as PageOrderBulk);
        }

        /// <summary>
        /// Returns true if PageOrderBulk instances are equal
        /// </summary>
        /// <param name="input">Instance of PageOrderBulk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageOrderBulk input)
        {
            if (input == null)
                return false;
