...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAccountStatus();
  });
  ...
  describe('PageAccountStatus', function() {
    it('should create an instance of PageAccountStatus', function() {
      // uncomment below and update the code to test PageAccountStatus
      //var instane = new HydrogenNucleusApi.PageAccountStatus();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAccountStatus);
    });
