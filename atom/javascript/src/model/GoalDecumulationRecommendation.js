...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GoalDepositConfig', 'model/GoalRecommendationConfigRec', 'model/GoalWithdrawalConfig'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GoalDepositConfig'), require('./GoalRecommendationConfigRec'), require('./GoalWithdrawalConfig'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.GoalDecumulationRecommendation = factory(root.atom_api.ApiClient, root.atom_api.GoalDepositConfig, root.atom_api.GoalRecommendationConfigRec, root.atom_api.GoalWithdrawalConfig);
  }
}(this, function(ApiClient, GoalDepositConfig, GoalRecommendationConfigRec, GoalWithdrawalConfig) {
  'use strict';
  ...
  /**
   * The GoalDecumulationRecommendation model module.
   * @module model/GoalDecumulationRecommendation
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GoalDecumulationRecommendation</code>.
   * @alias module:model/GoalDecumulationRecommendation
   * @class
   ...
   * @param horizonFrequency {module:model/GoalDecumulationRecommendation.HorizonFrequencyEnum} Frequency in relation to the horizon
   * @param withdrawalConfig {Array.<module:model/GoalWithdrawalConfig>} The withdrawal attributes
   */
  var exports = function(pRet, pRisk, currInv, aHorizon, dHorizon, horizonFrequency, withdrawalConfig) {
    var _this = this;
  ...
  /**
   * Constructs a <code>GoalDecumulationRecommendation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GoalDecumulationRecommendation} obj Optional instance to populate.
   * @return {module:model/GoalDecumulationRecommendation} The populated <code>GoalDecumulationRecommendation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('recommendation_config')) {
        obj['recommendation_config'] = GoalRecommendationConfigRec.constructFromObject(data['recommendation_config']);
      }
   ...
   * @member {module:model/GoalDecumulationRecommendation.HorizonFrequencyEnum} horizon_frequency
   */
  ...
  /**
   * @member {module:model/GoalRecommendationConfigRec} recommendation_config
   */
  exports.prototype['recommendation_config'] = undefined;
  /**
   * The type of recommended action
   * @member {module:model/GoalDecumulationRecommendation.RecommendTypeEnum} recommend_type
   * @default 'horizon'
   */
   ...
   * @member {module:model/GoalDecumulationRecommendation.ThreshTypeEnum} thresh_type
   * @default 'perc'
   */
