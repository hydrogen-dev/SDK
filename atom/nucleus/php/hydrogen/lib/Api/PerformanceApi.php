...
class PerformanceApi
{
     ...
     * Goal Performance
     *
     * @param  string $client_id Client associated with the account - /client (required)
     ...
     * @param  string $portfolioid Portfolio Id -/portoflio (required)
     * @param  string $active_premium_period Q (quarterly), Monthly (M) , Annually (Y), Daily (D) --caps matter, codes in () - (statId: 19, default: &#39;D&#39;) (optional)
     * @param  string $annualized_return_period Q (quarterly), Monthly (M) , Annually (Y), Daily (D) --caps matter, codes in () - (statId: 19, default: &#39;D&#39;) (optional)
     ...
     * @return object
     */
    public function getPortfolioPerformanceUsingGet($account_id, $client_id, $portfolio_id, $portfolioid, $active_premium_period = null, $annualized_return_period = null, $benchmark_id = null, $end_date = null, $hist_factor = null, $mar_down_side_deviation = null, $max_percentile_monte_carlo = null, $mean_percentile_monte_carlo = null, $min_percentile_monte_carlo = null, $moving_average_n_day = null, $n_day_returns = null, $n_path_monte_carlo = null, $n_rolling_max_drawdown = null, $n_rolling_volatility = null, $num_sim_monte_carlo = null, $period_type = null, $risk_free_alpha = null, $risk_free_sharpe = null, $risk_free_sortino = null, $risk_free_treynor = null, $start_date = null, $stat = null, $var_conf_interval = null)
    {
        list($response) = $this->getPortfolioPerformanceUsingGetWithHttpInfo($account_id, $client_id, $portfolio_id, $portfolioid, $active_premium_period, $annualized_return_period, $benchmark_id, $end_date, $hist_factor, $mar_down_side_deviation, $max_percentile_monte_carlo, $mean_percentile_monte_carlo, $min_percentile_monte_carlo, $moving_average_n_day, $n_day_returns, $n_path_monte_carlo, $n_rolling_max_drawdown, $n_rolling_volatility, $num_sim_monte_carlo, $period_type, $risk_free_alpha, $risk_free_sharpe, $risk_free_sortino, $risk_free_treynor, $start_date, $stat, $var_conf_interval);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPortfolioPerformanceUsingGetWithHttpInfo($account_id, $client_id, $portfolio_id, $portfolioid, $active_premium_period = null, $annualized_return_period = null, $benchmark_id = null, $end_date = null, $hist_factor = null, $mar_down_side_deviation = null, $max_percentile_monte_carlo = null, $mean_percentile_monte_carlo = null, $min_percentile_monte_carlo = null, $moving_average_n_day = null, $n_day_returns = null, $n_path_monte_carlo = null, $n_rolling_max_drawdown = null, $n_rolling_volatility = null, $num_sim_monte_carlo = null, $period_type = null, $risk_free_alpha = null, $risk_free_sharpe = null, $risk_free_sortino = null, $risk_free_treynor = null, $start_date = null, $stat = null, $var_conf_interval = null)
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioPerformanceUsingGetAsync($account_id, $client_id, $portfolio_id, $portfolioid, $active_premium_period = null, $annualized_return_period = null, $benchmark_id = null, $end_date = null, $hist_factor = null, $mar_down_side_deviation = null, $max_percentile_monte_carlo = null, $mean_percentile_monte_carlo = null, $min_percentile_monte_carlo = null, $moving_average_n_day = null, $n_day_returns = null, $n_path_monte_carlo = null, $n_rolling_max_drawdown = null, $n_rolling_volatility = null, $num_sim_monte_carlo = null, $period_type = null, $risk_free_alpha = null, $risk_free_sharpe = null, $risk_free_sortino = null, $risk_free_treynor = null, $start_date = null, $stat = null, $var_conf_interval = null)
    {
        return $this->getPortfolioPerformanceUsingGetAsyncWithHttpInfo($account_id, $client_id, $portfolio_id, $portfolioid, $active_premium_period, $annualized_return_period, $benchmark_id, $end_date, $hist_factor, $mar_down_side_deviation, $max_percentile_monte_carlo, $mean_percentile_monte_carlo, $min_percentile_monte_carlo, $moving_average_n_day, $n_day_returns, $n_path_monte_carlo, $n_rolling_max_drawdown, $n_rolling_volatility, $num_sim_monte_carlo, $period_type, $risk_free_alpha, $risk_free_sharpe, $risk_free_sortino, $risk_free_treynor, $start_date, $stat, $var_conf_interval)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioPerformanceUsingGetAsyncWithHttpInfo($account_id, $client_id, $portfolio_id, $portfolioid, $active_premium_period = null, $annualized_return_period = null, $benchmark_id = null, $end_date = null, $hist_factor = null, $mar_down_side_deviation = null, $max_percentile_monte_carlo = null, $mean_percentile_monte_carlo = null, $min_percentile_monte_carlo = null, $moving_average_n_day = null, $n_day_returns = null, $n_path_monte_carlo = null, $n_rolling_max_drawdown = null, $n_rolling_volatility = null, $num_sim_monte_carlo = null, $period_type = null, $risk_free_alpha = null, $risk_free_sharpe = null, $risk_free_sortino = null, $risk_free_treynor = null, $start_date = null, $stat = null, $var_conf_interval = null)
    {
        $returnType = 'object';
        $request = $this->getPortfolioPerformanceUsingGetRequest($account_id, $client_id, $portfolio_id, $portfolioid, $active_premium_period, $annualized_return_period, $benchmark_id, $end_date, $hist_factor, $mar_down_side_deviation, $max_percentile_monte_carlo, $mean_percentile_monte_carlo, $min_percentile_monte_carlo, $moving_average_n_day, $n_day_returns, $n_path_monte_carlo, $n_rolling_max_drawdown, $n_rolling_volatility, $num_sim_monte_carlo, $period_type, $risk_free_alpha, $risk_free_sharpe, $risk_free_sortino, $risk_free_treynor, $start_date, $stat, $var_conf_interval);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioPerformanceUsingGetRequest($account_id, $client_id, $portfolio_id, $portfolioid, $active_premium_period = null, $annualized_return_period = null, $benchmark_id = null, $end_date = null, $hist_factor = null, $mar_down_side_deviation = null, $max_percentile_monte_carlo = null, $mean_percentile_monte_carlo = null, $min_percentile_monte_carlo = null, $moving_average_n_day = null, $n_day_returns = null, $n_path_monte_carlo = null, $n_rolling_max_drawdown = null, $n_rolling_volatility = null, $num_sim_monte_carlo = null, $period_type = null, $risk_free_alpha = null, $risk_free_sharpe = null, $risk_free_sortino = null, $risk_free_treynor = null, $start_date = null, $stat = null, $var_conf_interval = null)
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling getPortfolioPerformanceUsingGet'
            );
        }
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_id when calling getPortfolioPerformanceUsingGet'
            );
        }
        ...
        if ($portfolioid === null || (is_array($portfolioid) && count($portfolioid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $portfolioid when calling getPortfolioPerformanceUsingGet'
            );
        }
        ...
        if ($portfolioid !== null) {
            $resourcePath = str_replace(
                '{' . 'portfolioid' . '}',
                ObjectSerializer::toPathValue($portfolioid),
                $resourcePath
            );
        }
