...
public class GoalApiTest {
    ...
    public void getGoalHoldingAllUsingGetTest() throws ApiException {
        ...
        Boolean portfolioGoal = null;
        LocalDate startDate = null;
        List<PortfolioHoldingAgg> response = api.getGoalHoldingAllUsingGet(clientId, goalId, currencyConversion, endDate, portfolioGoal, startDate);
    ...
    public void getGoalTransactionAllUsingGetTest() throws ApiException {
        ...
        Integer size = null;
        LocalDate startDate = null;
        PagePortfolioTransaction response = api.getGoalTransactionAllUsingGet(clientId, goalId, ascending, currencyConversion, endDate, orderBy, page, portfolioGoal, size, startDate);
