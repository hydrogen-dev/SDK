...
module AtomApi
  class AggregationAccountHoldingPayload
    ...
    def hash
      [aggregation_account_id, currency_code, ticker, ticker_name, shares, amount, holding_type, asset_class, price, cost_basis, exchange, cusip, secondary_id, metadata].hash
    end
