...
module AtomApi
  ...
  class CardProgram
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'card_issuer')
        self.card_issuer = attributes[:'card_issuer']
      end
    ...
    def list_invalid_properties
      ...
      if @card_issuer.nil?
        invalid_properties.push('invalid value for "card_issuer", card_issuer cannot be nil.')
      end
      ...
      if @card_processor.nil?
        invalid_properties.push('invalid value for "card_processor", card_processor cannot be nil.')
      end
    ...
    def valid?
      return false if @card_issuer.nil?
      return false if @card_network.nil?
      return false if @card_processor.nil?
    ...
    def hash
      [card_issuer, card_network, card_processor, card_type, client_id, code, create_date, description, id, issuing_bank, metadata, name, secondary_id, update_date].hash
    end
