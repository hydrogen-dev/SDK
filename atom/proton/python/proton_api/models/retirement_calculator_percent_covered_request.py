...
class RetirementCalculatorPercentCoveredRequest(object):
    ...
    def __init__(self, retirement_income=0.0, deposit_schedule=None, retirement_age=65, portfolio_return=None, retirement_expenses=None, inflation_rate=0.0, aggregation_account_ids=None, current_age=None, account_ids=None, retirement_savings=0.0, retirement_tax=0.0, death_age=None):  # noqa: E501
