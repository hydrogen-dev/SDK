  ...
  var exports = function(apiClient) {
    ...
    this.createInvoicePaymentUsingPost = function(invoicePayment, callback) {
      ...
      return this.apiClient.callApi(
        '/nucleus/v1/invoice_payment', 'POST',
    ...
    this.deleteInvoicePaymentUsingDelete = function(invoicePaymentId, callback) {
      ...
      return this.apiClient.callApi(
        '/nucleus/v1/invoice_payment/{invoice_payment_id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.deleteInvoiceUsingDelete = function(invoiceId, callback) {
      ...
      return this.apiClient.callApi(
        '/nucleus/v1/invoice/{invoice_id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.getInvoicePaymentAllUsingGet = function(opts, callback) {
      ...
      return this.apiClient.callApi(
        '/nucleus/v1/invoice_payment', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * data is of type: {@link module:model/InvoicePayment}
     */
    this.getInvoicePaymentUsingGet = function(invoicePaymentId, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      return this.apiClient.callApi(
        '/nucleus/v1/invoice_payment/{invoice_payment_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * data is of type: {@link module:model/Invoice}
     */
    this.getInvoiceUsingGet = function(invoiceId, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      return this.apiClient.callApi(
        '/nucleus/v1/invoice/{invoice_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.updateInvoicePaymentUsingPut = function(invoicePayment, invoicePaymentId, callback) {
      ...
      return this.apiClient.callApi(
        '/nucleus/v1/invoice_payment/{invoice_payment_id}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    this.updateInvoiceUsingPut = function(invoice, invoiceId, callback) {
      ...
      return this.apiClient.callApi(
        '/nucleus/v1/invoice/{invoice_id}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
