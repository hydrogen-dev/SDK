...
describe 'BrokerageApi' do
  ...
  # unit tests for cancel_brokerage_order_using_put
  # Cancel an Order
  # @param nucleus_order_id nucleus_order_id
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'cancel_brokerage_order_using_put test' do
    it 'should work' do
  ...
  # unit tests for create_brokerage_bank_link_using_post
  # create a Bank Link
  # @param brokerage_bank_link_co brokerageBankLinkCO
  # @param [Hash] opts the optional parameters
  # @return [BrokerageBankLinkVO]
  describe 'create_brokerage_bank_link_using_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for create_brokerage_deposit_using_post
  # Create a deposit
  # @param brokerage_deposit_co brokerageDepositCO
  # @param [Hash] opts the optional parameters
  # @return [BrokerageDepositVO]
  describe 'create_brokerage_deposit_using_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_brokerage_document_using_post
  # Create a Brokerage document
  # @param document_co documentCO
  # @param [Hash] opts the optional parameters
  # @return [BrokerageDocumentVO]
  describe 'create_brokerage_document_using_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_brokerage_order_using_post
  # Create an Order
  # @param brokerage_order_co brokerageOrderCO
  # @param [Hash] opts the optional parameters
  # @return [BrokerageOrderVO]
  describe 'create_brokerage_order_using_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_brokerage_withdrawal_using_post
  # Create a withdrawal
  # @param brokerage_withdrawal_co brokerageWithdrawalCO
  # @param [Hash] opts the optional parameters
  # @return [BrokerageWithdrawalVO]
  describe 'create_brokerage_withdrawal_using_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_brokerage_bank_link_using_delete
  # Delete a Bank Link
  # @param nucleus_bank_link_id nucleus_bank_link_id
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_brokerage_bank_link_using_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for get_brokerage_balance_using_get
  # Get account balance
  # @param nucleus_portfolio_id nucleus_portfolio_id
  # @param [Hash] opts the optional parameters
  # @return [BrokerageBalanceVO]
  describe 'get_brokerage_balance_using_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_brokerage_bank_link_using_get
  # Get a Bank Link
  # @param nucleus_bank_link_id nucleus_bank_link_id
  # @param [Hash] opts the optional parameters
  # @return [BrokerageBankLinkVO]
  describe 'get_brokerage_bank_link_using_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_brokerage_document_using_get
  # Get a Brokerage document
  # @param nucleus_document_id nucleus_document_id
  # @param [Hash] opts the optional parameters
  # @return [BrokerageDocumentVO]
  describe 'get_brokerage_document_using_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_brokerage_holding_performance_using_get
  # Get portfolio holding performance
  # @param nucleus_portfolio_id nucleus_portfolio_id
  # @param [Hash] opts the optional parameters
  # @return [BrokeragePerformanceVO]
  describe 'get_brokerage_holding_performance_using_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_brokerage_holding_using_get
  # Get portfolio holdings
  # @param nucleus_portfolio_id nucleus_portfolio_id
  # @param [Hash] opts the optional parameters
  # @return [BrokerageHoldingVO]
  describe 'get_brokerage_holding_using_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_brokerage_order_using_get
  # Get an Order
  # @param nucleus_order_id nucleus_order_id
  # @param [Hash] opts the optional parameters
  # @return [BrokerageOrderVO]
  describe 'get_brokerage_order_using_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_brokerage_securities_using_get
  ...
  describe 'get_brokerage_securities_using_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_brokerage_transactions_using_get
  ...
  describe 'get_brokerage_transactions_using_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_brokerage_bank_link_using_put
  # Update a Bank Link
  # @param nucleus_bank_link_id nucleus_bank_link_id
  # @param [Hash] opts the optional parameters
  # @return [BrokerageBankLinkVO]
  describe 'update_brokerage_bank_link_using_put test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
