...
module NucleusApi
  ...
  class NotificationSetting
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'last_run_date')
        self.last_run_date = attributes[:'last_run_date']
      end
    ...
    def hash
      [client_id, create_date, frequency, frequency_unit, id, is_receive, last_run_date, metadata, notification_id, secondary_id, threshold_value, update_date].hash
    end
