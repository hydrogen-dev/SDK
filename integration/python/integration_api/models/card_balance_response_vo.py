...
class CardBalanceResponseVO(object):
    ...
    def __init__(self, message=None, nucleus_asset_sizes_posted=None, nucleus_asset_sizes_updated=None, nucleus_card_id=None, vendor_name=None, vendor_response=None):  # noqa: E501
