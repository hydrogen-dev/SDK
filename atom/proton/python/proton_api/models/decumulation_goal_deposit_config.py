...
class DecumulationGoalDepositConfig(object):
    ...
    def __init__(self, dep_inflation=0.0, dep_amount=None, dep_frequency='year', dep_start_reference='a_start', dep_end_period=0, dep_start_period=0, dep_end_reference='a_end'):  # noqa: E501
