...
module ProtonApi
  class EventStudyRequest
    ...
    def hash
      [portfolio_tickers, events, create_log, aggregation_account_id, allocation_id, model_id, portfolio_weights, use_proxy_data, account_id, market_data_source, portfolio_id].hash
    end
