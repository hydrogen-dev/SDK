...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.GoalPayload();
  });
  ...
  describe('GoalPayload', function() {
    it('should create an instance of GoalPayload', function() {
      // uncomment below and update the code to test GoalPayload
      //var instance = new atom_api.GoalPayload();
      //expect(instance).to.be.a(atom_api.GoalPayload);
    });
