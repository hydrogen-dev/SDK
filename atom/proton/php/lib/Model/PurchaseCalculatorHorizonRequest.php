...
/**
 * PurchaseCalculatorHorizonRequest Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\proton
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PurchaseCalculatorHorizonRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'purchaseCalculatorHorizonRequest';
    ...
    public function setInvestmentTax($investment_tax)
    {
        ...
        if (!is_null($investment_tax) && ($investment_tax > 1)) {
            throw new \InvalidArgumentException('invalid value for $investment_tax when calling PurchaseCalculatorHorizonRequest., must be smaller than or equal to 1.');
        }
        if (!is_null($investment_tax) && ($investment_tax < 0)) {
            throw new \InvalidArgumentException('invalid value for $investment_tax when calling PurchaseCalculatorHorizonRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setPortfolioReturn($portfolio_return)
    {
        ...
        if (($portfolio_return < -1)) {
            throw new \InvalidArgumentException('invalid value for $portfolio_return when calling PurchaseCalculatorHorizonRequest., must be bigger than or equal to -1.');
        }
    ...
    public function setCurrentSavings($current_savings)
    {
        ...
        if (!is_null($current_savings) && ($current_savings < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_savings when calling PurchaseCalculatorHorizonRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setPurchaseAmount($purchase_amount)
    {
        ...
        if (($purchase_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $purchase_amount when calling PurchaseCalculatorHorizonRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setInflationRate($inflation_rate)
    {
        ...
        if (!is_null($inflation_rate) && ($inflation_rate < -1)) {
            throw new \InvalidArgumentException('invalid value for $inflation_rate when calling PurchaseCalculatorHorizonRequest., must be bigger than or equal to -1.');
        }
