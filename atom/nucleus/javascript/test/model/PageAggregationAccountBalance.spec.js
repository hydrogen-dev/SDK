...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAggregationAccountBalance();
  });
  ...
  describe('PageAggregationAccountBalance', function() {
    it('should create an instance of PageAggregationAccountBalance', function() {
      // uncomment below and update the code to test PageAggregationAccountBalance
      //var instane = new HydrogenNucleusApi.PageAggregationAccountBalance();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAggregationAccountBalance);
    });
