...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoleculeApiDocumentation.TokenTransferApi();
  });

  describe('(package)', function() {
    describe('TokenTransferApi', function() {
      describe('createTokenTransferUsingPost', function() {
        it('should call createTokenTransferUsingPost successfully', function(done) {
          // TODO: uncomment, update parameter values for createTokenTransferUsingPost call and complete the assertions
          /*
          var tokenTransferParams = new MoleculeApiDocumentation.TokenTransferParams();
          tokenTransferParams.senderWalletId = """00000000-0000-0000-0000-000000000000";
          tokenTransferParams.receiverWalletId = """00000000-0000-0000-0000-000000000000";
          tokenTransferParams.tokenId = """00000000-0000-0000-0000-000000000000";
          tokenTransferParams.amount = 0.0;
          tokenTransferParams.isActive = false;
          tokenTransferParams.recordStatus = "";

          instance.createTokenTransferUsingPost(tokenTransferParams, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getTokenTransferAllUsingGet', function() {
        it('should call getTokenTransferAllUsingGet successfully', function(done) {
          // TODO: uncomment, update parameter values for getTokenTransferAllUsingGet call and complete the assertions
          /*
          var opts = {};
          ...
          instance.getTokenTransferAllUsingGet(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MoleculeApiDocumentation.PageTokenTransferResponse);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MoleculeApiDocumentation.TokenTransferResponse);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("""00000000-0000-0000-0000-000000000000");
      ...
      describe('getTokenTransferUsingGet', function() {
        it('should call getTokenTransferUsingGet successfully', function(done) {
          // TODO: uncomment, update parameter values for getTokenTransferUsingGet call and complete the assertions
          /*
          var tokenTransferId = "tokenTransferId_example";

          instance.getTokenTransferUsingGet(tokenTransferId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
