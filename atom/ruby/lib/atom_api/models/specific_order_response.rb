...
module AtomApi
  class SpecificOrderResponse
    ...
    def hash
      [id, create_date, transaction_code_id, quantity, security_id, date, price, order_bulk_id, is_read, order_type, order_ticket_id, portfolio_id, account_id, model_id, metadata, update_date].hash
    end
