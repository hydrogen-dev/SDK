...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenProtonApi.AccumulationGoalDepositConfig = factory(root.HydrogenProtonApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AccumulationGoalDepositConfig model module.
   * @module model/AccumulationGoalDepositConfig
   * @version 1.8.0
   */

  /**
   * Constructs a new <code>AccumulationGoalDepositConfig</code>.
   * @alias module:model/AccumulationGoalDepositConfig
   * @class
   */
  ...
  /**
   * Constructs a <code>AccumulationGoalDepositConfig</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccumulationGoalDepositConfig} obj Optional instance to populate.
   * @return {module:model/AccumulationGoalDepositConfig} The populated <code>AccumulationGoalDepositConfig</code> instance.
   */
  ...
  /**
   * @member {module:model/AccumulationGoalDepositConfig.DepEndReferenceEnum} depEndReference
   * @default 'a_end'
   */
  exports.prototype.depEndReference = 'a_end';

  /**
   * @member {module:model/AccumulationGoalDepositConfig.DepFrequencyEnum} depFrequency
   * @default 'year'
   */
  ...
  /**
   * @member {module:model/AccumulationGoalDepositConfig.DepStartReferenceEnum} depStartReference
   * @default 'a_start'
   */
