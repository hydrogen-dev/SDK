...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.CashFlowAnalysisResponseSpendingDetailsSubcategories();
  });
  ...
  describe('CashFlowAnalysisResponseSpendingDetailsSubcategories', function() {
    it('should create an instance of CashFlowAnalysisResponseSpendingDetailsSubcategories', function() {
      // uncomment below and update the code to test CashFlowAnalysisResponseSpendingDetailsSubcategories
      //var instance = new atom_api.CashFlowAnalysisResponseSpendingDetailsSubcategories();
      //expect(instance).to.be.a(atom_api.CashFlowAnalysisResponseSpendingDetailsSubcategories);
    });
