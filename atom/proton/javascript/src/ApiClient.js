...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenProtonApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.hydrogenplatform.com/proton/v1
     */
    this.basePath = 'https://api.hydrogenplatform.com/proton/v1'.replace(/\/+$/, '');
    this.SANDBOX  = 'https://sandbox.hydrogenplatform.com/proton/v1';
    this.PRODUCTION = 'https://api.hydrogenplatform.com/proton/v1';
    /**
