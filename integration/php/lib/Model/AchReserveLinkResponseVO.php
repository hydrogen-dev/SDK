...
/**
 * AchReserveLinkResponseVO Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\integration
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AchReserveLinkResponseVO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AchReserveLinkResponseVO';
    ...
    protected static $setters = [
        'funding_source_id' => 'setFundingSourceId',
        'message' => 'setMessage',
    ...
    protected static $getters = [
        'funding_source_id' => 'getFundingSourceId',
        'message' => 'getMessage',
    ...
    {
        $this->container['funding_source_id'] = isset($data['funding_source_id']) ? $data['funding_source_id'] : null;
    ...
    /**
     * Gets funding_source_id
     *
     * @return string[]
     */
    public function getFundingSourceId()
    {
        return $this->container['funding_source_id'];
    }

    /**
     * Sets funding_source_id
     *
     * @param string[] $funding_source_id funding_source_id
     *
     * @return $this
     */
    public function setFundingSourceId($funding_source_id)
    {
        $this->container['funding_source_id'] = $funding_source_id;
