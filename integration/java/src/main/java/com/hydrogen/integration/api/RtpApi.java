...
public class RtpApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RtpBankLinkResponseVO deleteBankLinkUsingDelete3(UUID nucleusBankLinkId) throws ApiException {
        ApiResponse<RtpBankLinkResponseVO> resp = deleteBankLinkUsingDelete3WithHttpInfo(nucleusBankLinkId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RtpBankLinkResponseVO> deleteBankLinkUsingDelete3WithHttpInfo(UUID nucleusBankLinkId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteBankLinkUsingDelete3Async(UUID nucleusBankLinkId, final ApiCallback<RtpBankLinkResponseVO> callback) throws ApiException {
