...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AnnuityDecumulationResponse();
  });
  ...
  describe('AnnuityDecumulationResponse', function() {
    it('should create an instance of AnnuityDecumulationResponse', function() {
      // uncomment below and update the code to test AnnuityDecumulationResponse
      //var instance = new atom_api.AnnuityDecumulationResponse();
      //expect(instance).to.be.a(atom_api.AnnuityDecumulationResponse);
    });
