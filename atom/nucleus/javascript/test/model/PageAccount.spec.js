...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAccount();
  });
  ...
  describe('PageAccount', function() {
    it('should create an instance of PageAccount', function() {
      // uncomment below and update the code to test PageAccount
      //var instane = new HydrogenNucleusApi.PageAccount();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAccount);
    });
