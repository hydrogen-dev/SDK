...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageSale();
  });
  ...
  describe('PageSale', function() {
    it('should create an instance of PageSale', function() {
      // uncomment below and update the code to test PageSale
      //var instane = new HydrogenNucleusApi.PageSale();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageSale);
    });
