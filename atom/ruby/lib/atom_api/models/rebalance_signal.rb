...
module AtomApi
  class RebalanceSignal
    ...
    def list_invalid_properties
      ...
      if @signal.nil?
        invalid_properties.push('invalid value for "signal", signal cannot be nil.')
      end
    ...
    def valid?
      ...
      signal_validator = EnumAttributeValidator.new('String', ['SELL', 'BUY'])
    ...
    def signal=(signal)
      validator = EnumAttributeValidator.new('String', ['SELL', 'BUY'])
    ...
    def hash
      [date, ticker, signal, amount, type].hash
    end
