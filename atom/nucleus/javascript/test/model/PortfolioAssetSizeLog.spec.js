...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PortfolioAssetSizeLog();
  });
  ...
  describe('PortfolioAssetSizeLog', function() {
    it('should create an instance of PortfolioAssetSizeLog', function() {
      ...
      //var instane = new HydrogenAtomApi.PortfolioAssetSizeLog();
      //expect(instance).to.be.a(HydrogenAtomApi.PortfolioAssetSizeLog);
    });
