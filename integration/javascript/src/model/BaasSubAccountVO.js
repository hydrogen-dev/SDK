...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.BaasSubAccountVO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The BaasSubAccountVO model module.
   * @module model/BaasSubAccountVO
   * @version 1.2.1
   */

  /**
   * Constructs a new <code>BaasSubAccountVO</code>.
   * @alias module:model/BaasSubAccountVO
   * @class
   */
  ...
  /**
   * Constructs a <code>BaasSubAccountVO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BaasSubAccountVO} obj Optional instance to populate.
   * @return {module:model/BaasSubAccountVO} The populated <code>BaasSubAccountVO</code> instance.
   */
