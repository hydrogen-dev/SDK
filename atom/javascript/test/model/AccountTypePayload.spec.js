...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AccountTypePayload();
  });
  ...
  describe('AccountTypePayload', function() {
    it('should create an instance of AccountTypePayload', function() {
      // uncomment below and update the code to test AccountTypePayload
      //var instance = new atom_api.AccountTypePayload();
      //expect(instance).to.be.a(atom_api.AccountTypePayload);
    });
