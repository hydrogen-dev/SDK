...
class AccountingFinalResponseVO(object):
    ...
    swagger_types = {
        ...
        'message': 'str',
        'nucleus_contacts': 'list[AccountingCustomerResponseVO]',
    ...
    def __init__(self, integration_type=None, message=None, nucleus_contacts=None, nucleus_customer_revenues=None, nucleus_financial_statement=None, nucleus_invoice_payments=None, nucleus_invoices=None, vendor_name=None, _configuration=None):  # noqa: E501
        ...
        if nucleus_contacts is not None:
            self.nucleus_contacts = nucleus_contacts
    ...
    @property
    def nucleus_contacts(self):
        """Gets the nucleus_contacts of this AccountingFinalResponseVO.  # noqa: E501


        :return: The nucleus_contacts of this AccountingFinalResponseVO.  # noqa: E501
        :rtype: list[AccountingCustomerResponseVO]
        """
        return self._nucleus_contacts

    @nucleus_contacts.setter
    def nucleus_contacts(self, nucleus_contacts):
        """Sets the nucleus_contacts of this AccountingFinalResponseVO.


        :param nucleus_contacts: The nucleus_contacts of this AccountingFinalResponseVO.  # noqa: E501
        :type: list[AccountingCustomerResponseVO]
        """

        self._nucleus_contacts = nucleus_contacts
