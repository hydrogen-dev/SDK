...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageOverflowSettings();
  });
  ...
  describe('PageOverflowSettings', function() {
    it('should create an instance of PageOverflowSettings', function() {
      // uncomment below and update the code to test PageOverflowSettings
      //var instane = new HydrogenNucleusApi.PageOverflowSettings();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageOverflowSettings);
    });
