...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.EducationCalculatorReturnDetail = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The EducationCalculatorReturnDetail model module.
   * @module model/EducationCalculatorReturnDetail
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>EducationCalculatorReturnDetail</code>.
   * @alias module:model/EducationCalculatorReturnDetail
   * @class
  ...
  /**
   * Constructs a <code>EducationCalculatorReturnDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EducationCalculatorReturnDetail} obj Optional instance to populate.
   * @return {module:model/EducationCalculatorReturnDetail} The populated <code>EducationCalculatorReturnDetail</code> instance.
   */
