...
class GoalAccumulationAllocationRequest(object):
    ...
    def __init__(self, allocations=None, client_id=None, adjust_for_compounding=False, compounding_rate=0.0, horizon_frequency='year', conf_tgt=0.9, risk_score=None, market_data_source='nucleus', trading_days_per_year=252, withdrawal_tax=0.0, thresh_type='perc', recommend_type='horizon', goal_id=None, deposit_config=None, opt_config=None, goal_config=None, n=1000, recommendation_config=None, use_proxy_data=False, thresh=None, curr_inv=None, remove_outliers=True, allocation_priority=None, allocation_method=None, horizon=None):  # noqa: E501
