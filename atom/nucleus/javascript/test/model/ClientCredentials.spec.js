...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.ClientCredentials();
  });
  ...
  describe('ClientCredentials', function() {
    it('should create an instance of ClientCredentials', function() {
      ...
      //var instane = new HydrogenNucleusApi.ClientCredentials();
      //expect(instance).to.be.a(HydrogenNucleusApi.ClientCredentials);
    });
