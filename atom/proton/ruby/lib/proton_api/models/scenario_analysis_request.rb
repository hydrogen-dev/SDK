...
module ProtonApi
  class ScenarioAnalysisRequest
    ...
    def hash
      [use_proxy_data, start_date, portfolio_tickers, trading_days_per_year, end_date, model_id, allocation_id, account_id, portfolio_id, portfolio_weights, frequency_interval, scenario, aggregation_account_id, market_data_source].hash
    end
