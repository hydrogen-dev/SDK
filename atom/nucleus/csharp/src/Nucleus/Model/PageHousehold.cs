...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageHousehold :  IEquatable<PageHousehold>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageHousehold" /> class.
        /// </summary>
        ...
        public PageHousehold(List<Household> content = default(List<Household>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Household> Content { get; set; }
        ...
        {
            return this.Equals(input as PageHousehold);
        }

        /// <summary>
        /// Returns true if PageHousehold instances are equal
        /// </summary>
        /// <param name="input">Instance of PageHousehold to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageHousehold input)
        {
            if (input == null)
                return false;
