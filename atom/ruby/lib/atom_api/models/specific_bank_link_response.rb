...
module AtomApi
  class SpecificBankLinkResponse
    ...
    def hash
      [id, create_date, account_id, bank_account_holder, bank_account_number, name, routing, routing_wire, bank_account_name, currency_code, balance, available_balance, type, is_active, is_link_verified, link_verified_date, metadata, secondary_id, update_date].hash
    end
