...
module AtomApi
  class SpecificGoalResponse
    ...
    def hash
      [id, create_date, name, parent_goal_id, questionnaire_id, is_decumulation, type, category, client_id, goal_amount, accumulation_horizon, decumulation_horizon, is_active, metadata, secondary_id, update_date].hash
    end
