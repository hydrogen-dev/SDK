...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrokerageBankLinkCO :  IEquatable<BrokerageBankLinkCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerageBankLinkCO" /> class.
        /// </summary>
        /// <param name="nucleusBankLinkId">nucleusBankLinkId.</param>
        public BrokerageBankLinkCO(Guid? nucleusBankLinkId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BrokerageBankLinkCO {\n");
        ...
        {
            return this.Equals(input as BrokerageBankLinkCO);
        }

        /// <summary>
        /// Returns true if BrokerageBankLinkCO instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerageBankLinkCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerageBankLinkCO input)
        {
            if (input == null)
                return false;
