...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.BacktestResponse();
  });
  ...
  describe('BacktestResponse', function() {
    it('should create an instance of BacktestResponse', function() {
      // uncomment below and update the code to test BacktestResponse
      //var instance = new atom_api.BacktestResponse();
      //expect(instance).to.be.a(atom_api.BacktestResponse);
    });
