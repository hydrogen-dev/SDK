...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageDecisionTree();
  });
  ...
  describe('PageDecisionTree', function() {
    it('should create an instance of PageDecisionTree', function() {
      // uncomment below and update the code to test PageDecisionTree
      //var instane = new HydrogenNucleusApi.PageDecisionTree();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageDecisionTree);
    });
