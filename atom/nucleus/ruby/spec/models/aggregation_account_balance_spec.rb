...
# Unit tests for AtomApi::AggregationAccountBalance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AggregationAccountBalance' do
  before do
    # run before each test
    @instance = AtomApi::AggregationAccountBalance.new
  end
  ...
  describe 'test an instance of AggregationAccountBalance' do
    it 'should create an instance of AggregationAccountBalance' do
      expect(@instance).to be_instance_of(AtomApi::AggregationAccountBalance)
    end
  end
