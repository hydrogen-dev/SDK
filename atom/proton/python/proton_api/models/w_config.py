...
class WConfig(object):
    ...
    def __init__(self, w_min_minor=None, w_min_major=None, cash_amount=None, w_max_major=None, w_max_minor=None, _configuration=None):  # noqa: E501
        """WConfig - a model defined in Swagger"""  # noqa: E501
    ...
    def w_min_minor(self):
        """Gets the w_min_minor of this WConfig.  # noqa: E501


        :return: The w_min_minor of this WConfig.  # noqa: E501
        :rtype: float
        """
    ...
    def w_min_minor(self, w_min_minor):
        """Sets the w_min_minor of this WConfig.


        :param w_min_minor: The w_min_minor of this WConfig.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and w_min_minor is None:
    ...
    def w_min_major(self):
        """Gets the w_min_major of this WConfig.  # noqa: E501


        :return: The w_min_major of this WConfig.  # noqa: E501
        :rtype: float
        """
    ...
    def w_min_major(self, w_min_major):
        """Sets the w_min_major of this WConfig.


        :param w_min_major: The w_min_major of this WConfig.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and w_min_major is None:
    ...
    def cash_amount(self):
        """Gets the cash_amount of this WConfig.  # noqa: E501


        :return: The cash_amount of this WConfig.  # noqa: E501
        :rtype: float
        """
    ...
    def cash_amount(self, cash_amount):
        """Sets the cash_amount of this WConfig.


        :param cash_amount: The cash_amount of this WConfig.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and cash_amount is None:
    ...
    def w_max_major(self):
        """Gets the w_max_major of this WConfig.  # noqa: E501


        :return: The w_max_major of this WConfig.  # noqa: E501
        :rtype: float
        """
    ...
    def w_max_major(self, w_max_major):
        """Sets the w_max_major of this WConfig.


        :param w_max_major: The w_max_major of this WConfig.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and w_max_major is None:
    ...
    def w_max_minor(self):
        """Gets the w_max_minor of this WConfig.  # noqa: E501


        :return: The w_max_minor of this WConfig.  # noqa: E501
        :rtype: float
        """
    ...
    def w_max_minor(self, w_max_minor):
        """Sets the w_max_minor of this WConfig.


        :param w_max_minor: The w_max_minor of this WConfig.  # noqa: E501
        :type: float
        """
        if self._configuration.client_side_validation and w_max_minor is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WConfig):
            return False
