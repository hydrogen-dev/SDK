...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AnnuityCalculatorAnnuityAmount();
  });
  ...
  describe('AnnuityCalculatorAnnuityAmount', function() {
    it('should create an instance of AnnuityCalculatorAnnuityAmount', function() {
      // uncomment below and update the code to test AnnuityCalculatorAnnuityAmount
      //var instance = new atom_api.AnnuityCalculatorAnnuityAmount();
      //expect(instance).to.be.a(atom_api.AnnuityCalculatorAnnuityAmount);
    });
