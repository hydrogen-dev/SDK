    ...
    describe('BaasApi', function() {
      ...
      describe('createBaasBusinessUsingPost', function() {
        it('should call createBaasBusinessUsingPost successfully', function(done) {
          // TODO: uncomment, update parameter values for createBaasBusinessUsingPost call and complete the assertions
          /*
          var baasBusinessCO = new HydrogenIntegrationApi.CreateBaasBusinessCO();
          baasBusinessCO.nucleusBusinessId = """00000000-0000-0000-0000-000000000000";
          baasBusinessCO.nucleusDocumentIds = ["""00000000-0000-0000-0000-000000000000"];

          instance.createBaasBusinessUsingPost(baasBusinessCO, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(HydrogenIntegrationApi.BaasBusinessVO);
            expect(data.message).to.be.a('string');
            expect(data.message).to.be("");
            expect(data.nucleusBusinessId).to.be.a('string');
            expect(data.nucleusBusinessId).to.be("""00000000-0000-0000-0000-000000000000");
            {
              let dataCtr = data.nucleusDocumentId;
      ...
      describe('createBaasClientUsingPost', function() {
        it('should call createBaasClientUsingPost successfully', function(done) {
          ...
          /*
          var baasClientCO = new HydrogenIntegrationApi.CreateBaasClientCO();
          baasClientCO.nucleusClientId = """00000000-0000-0000-0000-000000000000";
          baasClientCO.nucleusDocumentIds = ["""00000000-0000-0000-0000-000000000000"];
          ...
          instance.createBaasClientUsingPost(baasClientCO, function(error, data, response) {
            ...
            expect(data.vendorName).to.be.a('string');
            expect(data.vendorName).to.be("");
            expect(data.vendorRequestData).to.be.a(HydrogenIntegrationApi.ClientVendorRequestDataVO);
                  {
              ...
              expect(data.vendorRequestData.businessName).to.be.a('string');
              expect(data.vendorRequestData.businessName).to.be("");
              ...
              expect(data.vendorRequestData.prefix).to.be.a('string');
              expect(data.vendorRequestData.prefix).to.be("");
      ...
      describe('updateBaasBusinessUsingPut', function() {
        it('should call updateBaasBusinessUsingPut successfully', function(done) {
          // TODO: uncomment, update parameter values for updateBaasBusinessUsingPut call and complete the assertions
          /*
          var nucleusBusinessId = "nucleusBusinessId_example";
          var opts = {};
          opts.baasBusinessCO = new HydrogenIntegrationApi.UpdateBaasBusinessCO();
          opts.baasBusinessCO.nucleusDocumentIds = ["""00000000-0000-0000-0000-000000000000"];

          instance.updateBaasBusinessUsingPut(nucleusBusinessId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateBaasClientUsingPut', function() {
        it('should call updateBaasClientUsingPut successfully', function(done) {
          ...
          var opts = {};
          opts.baasClientCO = new HydrogenIntegrationApi.UpdateBaasClientCO();
          opts.baasClientCO.nucleusDocumentIds = ["""00000000-0000-0000-0000-000000000000"];

          instance.updateBaasClientUsingPut(nucleusClientId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
