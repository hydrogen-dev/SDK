...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageWalletResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageWalletResponse();
      });

      it('should create an instance of PageWalletResponse', function() {
        // TODO: update the code to test PageWalletResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageWalletResponse);
      });
