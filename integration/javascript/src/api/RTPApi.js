...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/RTPApi~deleteBankLinkUsingDelete3Callback
     * @param {String} error Error message, if any.
     * @param {module:model/RtpBankLinkResponseVO} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/RTPApi~deleteBankLinkUsingDelete3Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RtpBankLinkResponseVO}
     */
