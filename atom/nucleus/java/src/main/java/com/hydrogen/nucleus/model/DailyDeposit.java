...
public class DailyDeposit {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountNumber, amount, comments, createDate, currencyCode, direction, fundingId, id, investedDate, lastRequestDate, metadata, notes, portfolioId, receivedDate, secondaryId, status, statusTimeStamp, type, updateDate);
  }
