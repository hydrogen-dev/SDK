...
class AccountApi
{
    ...
    protected function createAccountAllocationMappingUsingPostRequest($alloc_request)
    {
        ...
        $resourcePath = '/account_allocation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteAccountAllocationMappingUsingDeleteRequest($account_allocation_id)
    {
        ...
        $resourcePath = '/account_allocation/{account_allocation_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteAccountPermissionUsingDELETERequest($account_id)
    {
        ...
        $resourcePath = '/account_permission/{account_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function deleteAccountTypeUsingDelete($account_type_id, $account_type_id2)
    {
        $this->deleteAccountTypeUsingDeleteWithHttpInfo($account_type_id, $account_type_id2);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteAccountTypeUsingDeleteWithHttpInfo($account_type_id, $account_type_id2)
    {
        $returnType = '';
        $request = $this->deleteAccountTypeUsingDeleteRequest($account_type_id, $account_type_id2);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAccountTypeUsingDeleteAsync($account_type_id, $account_type_id2)
    {
        return $this->deleteAccountTypeUsingDeleteAsyncWithHttpInfo($account_type_id, $account_type_id2)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAccountTypeUsingDeleteAsyncWithHttpInfo($account_type_id, $account_type_id2)
    {
        $returnType = '';
        $request = $this->deleteAccountTypeUsingDeleteRequest($account_type_id, $account_type_id2);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteAccountTypeUsingDeleteRequest($account_type_id, $account_type_id2)
    {
        ...
        // verify the required parameter 'account_type_id2' is set
        if ($account_type_id2 === null || (is_array($account_type_id2) && count($account_type_id2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_type_id2 when calling deleteAccountTypeUsingDelete'
            );
        }

        $resourcePath = '/account_type/{account_type_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($account_type_id2 !== null) {
            $resourcePath = str_replace(
                '{' . 'account_type_id' . '}',
                ObjectSerializer::toPathValue($account_type_id2),
                $resourcePath
            );
        }
    ...
    protected function deleteAccountUsingDeleteRequest($account_id)
    {
        ...
        $resourcePath = '/account/{account_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getAccountAssetSizeAggAllUsingGetWithHttpInfo($account_id, $end_date, $exclude_subledger, $get_latest, $sort_type, $start_date);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountAssetSizeAggAllUsingGetAsync($account_id, $end_date = null, $exclude_subledger = 'false', $get_latest = null, $sort_type = null, $start_date = null)
    {
        return $this->getAccountAssetSizeAggAllUsingGetAsyncWithHttpInfo($account_id, $end_date, $exclude_subledger, $get_latest, $sort_type, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAccountAssetSizeAggAllUsingGetRequest($account_id, $end_date = null, $exclude_subledger = 'false', $get_latest = null, $sort_type = null, $start_date = null)
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/account/{account_id}/asset_size';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getAccountAssetSizeAllUsingGet
     *
     * List all account asset sizes
     *
     * @param  bool $ascending ascending (optional, default to false)
    ...
    {
        list($response) = $this->getAccountAssetSizeAllUsingGetWithHttpInfo($ascending, $filter, $order_by, $page, $size);
        return $response;
    }

    /**
     * Operation getAccountAssetSizeAllUsingGetWithHttpInfo
     *
     * List all account asset sizes
     *
     * @param  bool $ascending ascending (optional, default to false)
    ...
    /**
     * Operation getAccountAssetSizeAllUsingGetAsync
     *
     * List all account asset sizes
     *
     * @param  bool $ascending ascending (optional, default to false)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountAssetSizeAllUsingGetAsync($ascending = 'false', $filter = null, $order_by = 'date', $page = '0', $size = '25')
    {
        return $this->getAccountAssetSizeAllUsingGetAsyncWithHttpInfo($ascending, $filter, $order_by, $page, $size)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAccountAssetSizeAllUsingGetAsyncWithHttpInfo
     *
     * List all account asset sizes
     *
     * @param  bool $ascending ascending (optional, default to false)
    ...
    /**
     * Create request for operation 'getAccountAssetSizeAllUsingGet'
     *
     * @param  bool $ascending ascending (optional, default to false)
     * @param  string $filter filter (optional)
     * @param  string $order_by order_by (optional, default to date)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAccountAssetSizeAllUsingGetRequest($ascending = 'false', $filter = null, $order_by = 'date', $page = '0', $size = '25')
    {

        $resourcePath = '/account_asset_size';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getAccountOverviewUsingGetRequest($account_id, $ascending = 'false', $order_by = 'update_date')
    {
        ...
        $resourcePath = '/account/{account_id}/account_overview';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getAccountTypeUsingGetWithHttpInfo($account_type_id, $account_type_id2);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountTypeUsingGetAsync($account_type_id, $account_type_id2)
    {
        return $this->getAccountTypeUsingGetAsyncWithHttpInfo($account_type_id, $account_type_id2)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAccountTypeUsingGetRequest($account_type_id, $account_type_id2)
    {
        // verify the required parameter 'account_type_id' is set
        if ($account_type_id === null || (is_array($account_type_id) && count($account_type_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($account_type_id2 === null || (is_array($account_type_id2) && count($account_type_id2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_type_id2 when calling getAccountTypeUsingGet'
            );
        }
    ...
    protected function getAllAccountPermissionUsingGETRequest($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
        ...
        $resourcePath = '/account_permission';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getPortfolioHoldingAggAllUsingGetWithHttpInfo($account_id, $end_date, $get_latest, $start_date);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioHoldingAggAllUsingGetAsync($account_id, $end_date = null, $get_latest = null, $start_date = null)
    {
        return $this->getPortfolioHoldingAggAllUsingGetAsyncWithHttpInfo($account_id, $end_date, $get_latest, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioHoldingAggAllUsingGetRequest($account_id, $end_date = null, $get_latest = null, $start_date = null)
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/account/{account_id}/holding';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getPortfolioTransactionAggAllUsingGetWithHttpInfo($account_id, $ascending, $end_date, $order_by, $page, $size, $start_date);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioTransactionAggAllUsingGetAsync($account_id, $ascending = 'false', $end_date = 'null', $order_by = 'update_date', $page = '0', $size = '25', $start_date = 'null')
    {
        return $this->getPortfolioTransactionAggAllUsingGetAsyncWithHttpInfo($account_id, $ascending, $end_date, $order_by, $page, $size, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioTransactionAggAllUsingGetRequest($account_id, $ascending = 'false', $end_date = 'null', $order_by = 'update_date', $page = '0', $size = '25', $start_date = 'null')
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/account/{account_id}/transaction';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function subscribeAccountUsingPostRequest($account_id, $alloc_request)
    {
        ...
        $resourcePath = '/account/{account_id}/subscribe';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
