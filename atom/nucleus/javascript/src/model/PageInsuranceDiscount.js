...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InsuranceDiscount', 'model/Sort'], factory);
  ...
  /**
   * The PageInsuranceDiscount model module.
   * @module model/PageInsuranceDiscount
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageInsuranceDiscount</code>.
   * Page Object
   * @alias module:model/PageInsuranceDiscount
   * @class
   */
  ...
  /**
   * Constructs a <code>PageInsuranceDiscount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageInsuranceDiscount} obj Optional instance to populate.
   * @return {module:model/PageInsuranceDiscount} The populated <code>PageInsuranceDiscount</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [InsuranceDiscount]);
      }
  ...
  /**
   * @member {Array.<module:model/InsuranceDiscount>} content
   */
