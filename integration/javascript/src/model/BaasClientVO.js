...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('vendor_request_data'))
        obj.vendorRequestData = ClientVendorRequestDataVO.constructFromObject(data['vendor_request_data']);
  ...
  /**
   * @member {module:model/ClientVendorRequestDataVO} vendorRequestData
   */
