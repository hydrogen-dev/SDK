...
module AtomApi
  class SpecificAccountResponse
    ...
    def self.swagger_types
      {
        ...
        :'managed' => :'BOOLEAN',
        :'clients' => :'Array<AccountCreateClient>',
        :'goals' => :'Array<AccountCreateGoal>',
    ...
    def hash
      [id, create_date, name, account_type_id, managed, clients, goals, currency_code, metadata, secondary_id, last, total_pages, total_elements, sort, first, number_of_elements, size, number, update_date].hash
    end
