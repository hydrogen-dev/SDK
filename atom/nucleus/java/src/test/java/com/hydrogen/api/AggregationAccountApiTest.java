...
public class AggregationAccountApiTest {
    ...
    public void deleteAggregationAccountTransactionUsingDeleteTest() throws ApiException {
        ...
        AggregationAccountTransaction response = api.deleteAggregationAccountTransactionUsingDelete(aggregationAccountTransactionId);
    ...
    public void getAggregationAccountAggregateDataUsingGetTest() throws ApiException {
        UUID aggregationAccountId = null;
        AggregationAccountAggregateDataVO response = api.getAggregationAccountAggregateDataUsingGet(aggregationAccountId);
    ...
    public void getAggregationAccountBalanceAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageAggregationAccountBalance response = api.getAggregationAccountBalanceAllUsingGet(ascending, filter, orderBy, page, size);
    ...
    public void getAggregationAccountBalanceUsingGetTest() throws ApiException {
        UUID aggregationAccountBalanceId = null;
        AggregationAccountBalance response = api.getAggregationAccountBalanceUsingGet(aggregationAccountBalanceId);
    ...
    public void getAggregationAccountHoldingAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageAggregationAccountHolding response = api.getAggregationAccountHoldingAllUsingGet(ascending, filter, orderBy, page, size);
    ...
    public void getAggregationAccountHoldingUsingGetTest() throws ApiException {
        UUID aggregationAccountHoldingId = null;
        AggregationAccountHolding response = api.getAggregationAccountHoldingUsingGet(aggregationAccountHoldingId);
    ...
    public void getAggregationAccountOverviewUsingGetTest() throws ApiException {
        UUID clientId = null;
        AggregationDataForClientParentResponseVO response = api.getAggregationAccountOverviewUsingGet(clientId);
    ...
    public void getAggregationAccountTransactionAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PageAggregationAccountTransaction response = api.getAggregationAccountTransactionAllUsingGet(ascending, filter, orderBy, page, size);
    ...
    public void getAggregationAccountTransactionUsingGetTest() throws ApiException {
        UUID aggregationAccountTransactionId = null;
        AggregationAccountTransaction response = api.getAggregationAccountTransactionUsingGet(aggregationAccountTransactionId);
    ...
    public void updateAggregationAccountBulkUsingPutTest() throws ApiException {
        List<AggregationAccount> aggregationAccountList = null;
        AggregationAccount response = api.updateAggregationAccountBulkUsingPut(aggregationAccountList);
