...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageHousehold();
  });
  ...
  describe('PageHousehold', function() {
    it('should create an instance of PageHousehold', function() {
      // uncomment below and update the code to test PageHousehold
      //var instane = new HydrogenNucleusApi.PageHousehold();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageHousehold);
    });
