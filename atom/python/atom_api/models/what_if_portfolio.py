...
class WhatIfPortfolio(object):
    ...
    def __init__(self, current_portfolio_tickers=None, current_portfolio_weights=None, altered_portfolio_tickers=None, altered_portfolio_weights=None, start_date=None, end_date=None):  # noqa: E501
