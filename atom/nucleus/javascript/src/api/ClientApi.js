...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AvailableDateDoubleVO', 'model/Client', 'model/ClientResponse', 'model/ClientStatus', 'model/PageClient', 'model/PageClientResponse', 'model/PageClientStatus', 'model/PagePortfolioTransaction', 'model/PortfolioHoldingAgg', 'model/VClientGoalViewData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AvailableDateDoubleVO'), require('../model/Client'), require('../model/ClientResponse'), require('../model/ClientStatus'), require('../model/PageClient'), require('../model/PageClientResponse'), require('../model/PageClientStatus'), require('../model/PagePortfolioTransaction'), require('../model/PortfolioHoldingAgg'), require('../model/VClientGoalViewData'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.ClientApi = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.AvailableDateDoubleVO, root.HydrogenNucleusApi.Client, root.HydrogenNucleusApi.ClientResponse, root.HydrogenNucleusApi.ClientStatus, root.HydrogenNucleusApi.PageClient, root.HydrogenNucleusApi.PageClientResponse, root.HydrogenNucleusApi.PageClientStatus, root.HydrogenNucleusApi.PagePortfolioTransaction, root.HydrogenNucleusApi.PortfolioHoldingAgg, root.HydrogenNucleusApi.VClientGoalViewData);
  }
}(this, function(ApiClient, AvailableDateDoubleVO, Client, ClientResponse, ClientStatus, PageClient, PageClientResponse, PageClientStatus, PagePortfolioTransaction, PortfolioHoldingAgg, VClientGoalViewData) {
  'use strict';
