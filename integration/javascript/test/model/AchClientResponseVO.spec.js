...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.AchClientResponseVO();
  });
  ...
  describe('AchClientResponseVO', function() {
    it('should create an instance of AchClientResponseVO', function() {
      // uncomment below and update the code to test AchClientResponseVO
      //var instane = new HydrogenIntegrationApi.AchClientResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.AchClientResponseVO);
    });
