...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.SpendingAnalysisResponseSubcategories();
  });
  ...
  describe('SpendingAnalysisResponseSubcategories', function() {
    it('should create an instance of SpendingAnalysisResponseSubcategories', function() {
      // uncomment below and update the code to test SpendingAnalysisResponseSubcategories
      //var instance = new atom_api.SpendingAnalysisResponseSubcategories();
      //expect(instance).to.be.a(atom_api.SpendingAnalysisResponseSubcategories);
    });
