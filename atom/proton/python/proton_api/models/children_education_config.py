...
class ChildrenEducationConfig(object):
    ...
    def __init__(self, education_config=None, current_age=None, _configuration=None):  # noqa: E501
    ...
    def education_config(self, education_config):
        ...
        """
        if self._configuration.client_side_validation and education_config is None:
