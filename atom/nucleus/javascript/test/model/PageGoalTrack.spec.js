...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageGoalTrack();
  });
  ...
  describe('PageGoalTrack', function() {
    it('should create an instance of PageGoalTrack', function() {
      // uncomment below and update the code to test PageGoalTrack
      //var instane = new HydrogenNucleusApi.PageGoalTrack();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageGoalTrack);
    });
