...
namespace Integration.ModelEntity
{
    ...
    public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Mailing_2 for value: Mailing
            /// </summary>
            [EnumMember(Value = "Mailing")]
            Mailing_2 = 8,
            
            /// <summary>
            /// Enum Residence_2 for value: Residence
            /// </summary>
            [EnumMember(Value = "Residence")]
            Residence_2 = 9,
            
            /// <summary>
            /// Enum Home_2 for value: Home
            /// </summary>
            [EnumMember(Value = "Home")]
            Home_2 = 10,
            
            /// <summary>
            /// Enum Work_2 for value: Work
            /// </summary>
            [EnumMember(Value = "Work")]
            Work_2 = 11,
        ...
        public Address(string addressLine1 = default(string), string addressLine2 = default(string), string city = default(string), string country = default(string), bool? isPrimary = default(bool?), string postalcode = default(string), string state = default(string), TypeEnum? type = default(TypeEnum?))
        {
