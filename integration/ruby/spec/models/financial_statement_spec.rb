...
# Unit tests for IntegrationApi::FinancialStatement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinancialStatement' do
  before do
    # run before each test
    @instance = IntegrationApi::FinancialStatement.new
  end
  ...
  describe 'test an instance of FinancialStatement' do
    it 'should create an instance of FinancialStatement' do
      expect(@instance).to be_instance_of(IntegrationApi::FinancialStatement)
    end
  end
