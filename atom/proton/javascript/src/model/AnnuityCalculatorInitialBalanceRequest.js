...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenProtonApi.AnnuityCalculatorInitialBalanceRequest = factory(root.HydrogenProtonApi.ApiClient, root.HydrogenProtonApi.AnnuityDepositSchedule);
  }
}(this, function(ApiClient, AnnuityDepositSchedule) {
  'use strict';

  /**
   * The AnnuityCalculatorInitialBalanceRequest model module.
   * @module model/AnnuityCalculatorInitialBalanceRequest
   * @version 1.9.1
   */

  /**
   * Constructs a new <code>AnnuityCalculatorInitialBalanceRequest</code>.
   * @alias module:model/AnnuityCalculatorInitialBalanceRequest
   * @class
   ...
   */
  var exports = function(decumulationHorizon, accumulationHorizon, annuityAmount, portfolioReturn) {
  ...
  /**
   * Constructs a <code>AnnuityCalculatorInitialBalanceRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AnnuityCalculatorInitialBalanceRequest} obj Optional instance to populate.
   * @return {module:model/AnnuityCalculatorInitialBalanceRequest} The populated <code>AnnuityCalculatorInitialBalanceRequest</code> instance.
   */
  ...
  /**
   * @member {module:model/AnnuityCalculatorInitialBalanceRequest.AnnuityFrequencyIntervalEnum} annuityFrequencyInterval
   * @default 'year'
   */
