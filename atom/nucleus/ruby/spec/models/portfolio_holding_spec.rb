...
# Unit tests for NucleusApi::PortfolioHolding
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PortfolioHolding' do
  before do
    # run before each test
    @instance = NucleusApi::PortfolioHolding.new
  end
  ...
  describe 'test an instance of PortfolioHolding' do
    it 'should create an instance of PortfolioHolding' do
      expect(@instance).to be_instance_of(NucleusApi::PortfolioHolding)
    end
  end
