  ...
  class CardClientRequestCO
    ...
    def self.swagger_types
      {
          ...
          :'vendor_request' => :'Hash<String, String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vendor_request')
        if (value = attributes[:'vendor_request']).is_a?(Hash)
          self.vendor_request = value
        end
      end
    end
    ...
    def hash
      [nucleus_card_id, nucleus_client_id, vendor_request].hash
    end
