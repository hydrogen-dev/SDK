...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageTokenBalanceResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageTokenBalanceResponse();
      });

      it('should create an instance of PageTokenBalanceResponse', function() {
        // TODO: update the code to test PageTokenBalanceResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageTokenBalanceResponse);
      });
