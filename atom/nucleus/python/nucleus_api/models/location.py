...
class Location(object):
    ...
    def __init__(self, address_line1=None, address_line2=None, city=None, country=None, latitude=None, longitude=None, postalcode=None, state=None, _configuration=None):  # noqa: E501
