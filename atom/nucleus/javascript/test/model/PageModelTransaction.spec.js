...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageModelTransaction();
  });
  ...
  describe('PageModelTransaction', function() {
    it('should create an instance of PageModelTransaction', function() {
      // uncomment below and update the code to test PageModelTransaction
      //var instane = new HydrogenNucleusApi.PageModelTransaction();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageModelTransaction);
    });
