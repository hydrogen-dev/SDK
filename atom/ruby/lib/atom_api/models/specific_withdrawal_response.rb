...
module AtomApi
  class SpecificWithdrawalResponse
    ...
    def hash
      [id, create_date, account_id, amount, funding_id, withdrawal_date, account_number, comments, direction, fees, last_request_date, received_date, status, status_time_stamp, type, secondary_id, update_date].hash
    end
