...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.SavingsCalculatorReturnDetailsPeriodResponse();
  });
  ...
  describe('SavingsCalculatorReturnDetailsPeriodResponse', function() {
    it('should create an instance of SavingsCalculatorReturnDetailsPeriodResponse', function() {
      // uncomment below and update the code to test SavingsCalculatorReturnDetailsPeriodResponse
      //var instance = new atom_api.SavingsCalculatorReturnDetailsPeriodResponse();
      //expect(instance).to.be.a(atom_api.SavingsCalculatorReturnDetailsPeriodResponse);
    });
