...
module AtomApi
  class AllocationApi
    ...
    def create_allocation_composition_using_post_with_http_info(alloc_request, opts = {})
      ...
      # resource path
      local_var_path = '/allocation_composition'
    ...
    def delete_allocation_composition_using_delete_with_http_info(allocation_composition_id, opts = {})
      ...
      # resource path
      local_var_path = '/allocation_composition/{allocation_composition_id}'.sub('{' + 'allocation_composition_id' + '}', allocation_composition_id.to_s)
    ...
    def delete_allocation_using_delete_with_http_info(allocation_id, opts = {})
      ...
      # resource path
      local_var_path = '/allocation/{allocation_id}'.sub('{' + 'allocation_id' + '}', allocation_id.to_s)
    ...
    def get_all_holdings_using_get(allocation_id, opts = {})
      data, _status_code, _headers = get_all_holdings_using_get_with_http_info(allocation_id, opts)
      data
    end
    ...
    # @return [Array<(Array<ModelHoldingAgg>, Fixnum, Hash)>] Array<ModelHoldingAgg> data, response status code and response headers
    def get_all_holdings_using_get_with_http_info(allocation_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AllocationApi.get_all_holdings_using_get ...'
      end
      # verify the required parameter 'allocation_id' is set
      if @api_client.config.client_side_validation && allocation_id.nil?
        fail ArgumentError, "Missing the required parameter 'allocation_id' when calling AllocationApi.get_all_holdings_using_get"
      end
      # resource path
      local_var_path = '/allocation/{allocation_id}/holding'.sub('{' + 'allocation_id' + '}', allocation_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<ModelHoldingAgg>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AllocationApi#get_all_holdings_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_all_transactions_using_get(allocation_id, opts = {})
      data, _status_code, _headers = get_all_transactions_using_get_with_http_info(allocation_id, opts)
      data
    end
    ...
    def get_all_transactions_using_get_with_http_info(allocation_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AllocationApi.get_all_transactions_using_get ...'
      end
      # verify the required parameter 'allocation_id' is set
      if @api_client.config.client_side_validation && allocation_id.nil?
        fail ArgumentError, "Missing the required parameter 'allocation_id' when calling AllocationApi.get_all_transactions_using_get"
      end
      # resource path
      local_var_path = '/allocation/{allocation_id}/transaction'.sub('{' + 'allocation_id' + '}', allocation_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AllocationApi#get_all_transactions_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_allocation_aggregated_data_using_get(allocation_id, opts = {})
      data, _status_code, _headers = get_allocation_aggregated_data_using_get_with_http_info(allocation_id, opts)
      data
    end
    ...
    def get_allocation_aggregated_data_using_get_with_http_info(allocation_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AllocationApi.get_allocation_aggregated_data_using_get ...'
      end
      # verify the required parameter 'allocation_id' is set
      if @api_client.config.client_side_validation && allocation_id.nil?
        fail ArgumentError, "Missing the required parameter 'allocation_id' when calling AllocationApi.get_allocation_aggregated_data_using_get"
      end
      # resource path
      local_var_path = '/allocation/{allocation_id}/aggregate_data'.sub('{' + 'allocation_id' + '}', allocation_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AllocationApi#get_allocation_aggregated_data_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_assetsize_using_get(allocation_id, opts = {})
      data, _status_code, _headers = get_assetsize_using_get_with_http_info(allocation_id, opts)
      data
    end
    ...
    def get_assetsize_using_get_with_http_info(allocation_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AllocationApi.get_assetsize_using_get ...'
      end
      # verify the required parameter 'allocation_id' is set
      if @api_client.config.client_side_validation && allocation_id.nil?
        fail ArgumentError, "Missing the required parameter 'allocation_id' when calling AllocationApi.get_assetsize_using_get"
      end
      # resource path
      local_var_path = '/allocation/{allocation_id}/asset_size'.sub('{' + 'allocation_id' + '}', allocation_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AllocationApi#get_assetsize_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
