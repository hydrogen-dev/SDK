...
*SMSApi* | [**get_sms_status**](docs/SMSApi.md#get_sms_status) | **GET** /sms/status/{sms_id} | Fetch details for corresponding sms_id
*SMSApi* | [**send_mail**](docs/SMSApi.md#send_mail) | **POST** /sms | Send SMS to recipient
*SMTPApi* | [**get_smtp_status**](docs/SMTPApi.md#get_smtp_status) | **GET** /smtp/status/{email_id} | Fetch details for corresponding email_id
