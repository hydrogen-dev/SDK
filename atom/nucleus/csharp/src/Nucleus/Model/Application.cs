...
namespace Nucleus.ModelEntity
{
    ...
    public partial class Application :  IEquatable<Application>, IValidatableObject
    {
        ...
        public Application(DateTime? createDate = default(DateTime?), string description = default(string), string device = default(string), Guid? id = default(Guid?), Dictionary<string, string> metadata = default(Dictionary<string, string>), string name = default(string), string secondaryId = default(string), DateTime? updateDate = default(DateTime?))
        {
