...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_converted')) {
        obj['is_converted'] = ApiClient.convertToType(data['is_converted'], 'Boolean');
      }
   ...
   */
  exports.prototype['is_closed'] = undefined;
  /**
   * is_converted
   * @member {Boolean} is_converted
   */
  exports.prototype['is_converted'] = undefined;
  /**
   * is_verified
