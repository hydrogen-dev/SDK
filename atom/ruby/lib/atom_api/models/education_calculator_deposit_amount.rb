...
module AtomApi
  class EducationCalculatorDepositAmount
    ...
    def list_invalid_properties
      ...
      if !@percent_of_costs_covered.nil? && @percent_of_costs_covered <= 0
        invalid_properties.push('invalid value for "percent_of_costs_covered", must be greater than 0.')
      end
    ...
    def percent_of_costs_covered=(percent_of_costs_covered)
      ...
      if !percent_of_costs_covered.nil? && percent_of_costs_covered <= 0
        fail ArgumentError, 'invalid value for "percent_of_costs_covered", must be greater than 0.'
      end
    ...
    def hash
      [initial_balance, accumulation_horizon, decumulation_horizon, total_annual_cost, portfolio_return, percent_of_costs_covered, education_inflation_rate, general_inflation_rate, tax_rate, deposit_schedule].hash
    end
