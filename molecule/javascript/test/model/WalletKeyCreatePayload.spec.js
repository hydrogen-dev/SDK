...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new molecule_api.WalletKeyCreatePayload();
  });
  ...
  describe('WalletKeyCreatePayload', function() {
    it('should create an instance of WalletKeyCreatePayload', function() {
      // uncomment below and update the code to test WalletKeyCreatePayload
      //var instance = new molecule_api.WalletKeyCreatePayload();
      //expect(instance).to.be.a(molecule_api.WalletKeyCreatePayload);
    });
