...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.PortfolioRebalanceBuyOnlyOrderPayload();
  });
  ...
  describe('PortfolioRebalanceBuyOnlyOrderPayload', function() {
    it('should create an instance of PortfolioRebalanceBuyOnlyOrderPayload', function() {
      // uncomment below and update the code to test PortfolioRebalanceBuyOnlyOrderPayload
      //var instance = new atom_api.PortfolioRebalanceBuyOnlyOrderPayload();
      //expect(instance).to.be.a(atom_api.PortfolioRebalanceBuyOnlyOrderPayload);
    });
