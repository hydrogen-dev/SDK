...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EducationCalculatorAnnualCostRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.EducationCalculatorAnnualCostRequest();
      });

      it('should create an instance of EducationCalculatorAnnualCostRequest', function() {
        // TODO: update the code to test EducationCalculatorAnnualCostRequest
        expect(instance).to.be.a(HydrogenProtonApi.EducationCalculatorAnnualCostRequest);
      });
