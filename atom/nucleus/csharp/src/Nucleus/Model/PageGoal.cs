...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageGoal :  IEquatable<PageGoal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageGoal" /> class.
        /// </summary>
        ...
        public PageGoal(List<Goal> content = default(List<Goal>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Goal> Content { get; set; }
        ...
        {
            return this.Equals(input as PageGoal);
        }

        /// <summary>
        /// Returns true if PageGoal instances are equal
        /// </summary>
        /// <param name="input">Instance of PageGoal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageGoal input)
        {
            if (input == null)
                return false;
