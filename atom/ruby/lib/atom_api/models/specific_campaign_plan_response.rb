...
module AtomApi
  class SpecificCampaignPlanResponse
    ...
    def self.swagger_types
      {
        ...
        :'description' => :'String',
        :'is_active' => :'BOOLEAN',
        :'plan_rates' => :'Array<CampaignPlanPayloadPlanRates>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'plan_rates')
        if (value = attributes[:'plan_rates']).is_a?(Array)
          self.plan_rates = value
        end
      end
    ...
    def hash
      [id, create_date, description, is_active, plan_rates, secondary_id, metadata, update_date].hash
    end
