...
# Unit tests for AtomApi::SpecificAccountResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SpecificAccountResponse' do
  before do
    # run before each test
    @instance = AtomApi::SpecificAccountResponse.new
  end
  ...
  describe 'test an instance of SpecificAccountResponse' do
    it 'should create an instance of SpecificAccountResponse' do
      expect(@instance).to be_instance_of(AtomApi::SpecificAccountResponse)
    end
  end
