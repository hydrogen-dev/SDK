...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.AggregationAccountTransaction();
  });
  ...
  describe('AggregationAccountTransaction', function() {
    it('should create an instance of AggregationAccountTransaction', function() {
      ...
      //var instane = new HydrogenAtomApi.AggregationAccountTransaction();
      //expect(instance).to.be.a(HydrogenAtomApi.AggregationAccountTransaction);
    });
