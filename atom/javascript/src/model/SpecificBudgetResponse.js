...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BudgetPayloadBudget', 'model/CreateBudgetResponse', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BudgetPayloadBudget'), require('./CreateBudgetResponse'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.SpecificBudgetResponse = factory(root.atom_api.ApiClient, root.atom_api.BudgetPayloadBudget, root.atom_api.CreateBudgetResponse, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, BudgetPayloadBudget, CreateBudgetResponse, SecondaryId) {
  'use strict';
