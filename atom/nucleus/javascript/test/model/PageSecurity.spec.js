...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageSecurity();
  });
  ...
  describe('PageSecurity', function() {
    it('should create an instance of PageSecurity', function() {
      // uncomment below and update the code to test PageSecurity
      //var instane = new HydrogenNucleusApi.PageSecurity();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageSecurity);
    });
