...
module NucleusApi
  ...
  class ModelHoldingAgg
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'securities_id')
        self.securities_id = attributes[:'securities_id']
      end
    ...
    def hash
      [asset_class, current_weight, securities_id, strategic_weight, ticker].hash
    end
