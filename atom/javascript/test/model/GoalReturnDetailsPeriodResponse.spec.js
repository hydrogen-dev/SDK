...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.GoalReturnDetailsPeriodResponse();
  });
  ...
  describe('GoalReturnDetailsPeriodResponse', function() {
    it('should create an instance of GoalReturnDetailsPeriodResponse', function() {
      // uncomment below and update the code to test GoalReturnDetailsPeriodResponse
      //var instance = new atom_api.GoalReturnDetailsPeriodResponse();
      //expect(instance).to.be.a(atom_api.GoalReturnDetailsPeriodResponse);
    });
    ...
    it('should have the property periodDeposit (base name: "period_deposit")', function() {
      // uncomment below and update the code to test the property periodDeposit
      //var instance = new atom_api.GoalReturnDetailsPeriodResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cumulativeDeposits (base name: "cumulative_deposits")', function() {
      // uncomment below and update the code to test the property cumulativeDeposits
      //var instance = new atom_api.GoalReturnDetailsPeriodResponse();
      //expect(instance).to.be();
    });
