...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.BulkOrderAccountPayload();
  });
  ...
  describe('BulkOrderAccountPayload', function() {
    it('should create an instance of BulkOrderAccountPayload', function() {
      // uncomment below and update the code to test BulkOrderAccountPayload
      //var instance = new atom_api.BulkOrderAccountPayload();
      //expect(instance).to.be.a(atom_api.BulkOrderAccountPayload);
    });
