...
class ModelComment(object):
    ...
    def __init__(self, comment=None, create_date=None, _date=None, id=None, metadata=None, model_id=None, secondary_id=None, update_date=None, _configuration=None):  # noqa: E501
