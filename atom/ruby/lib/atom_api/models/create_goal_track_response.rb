...
module AtomApi
  class CreateGoalTrackResponse
    ...
    def hash
      [goal_id, client_id, goal_amount, accumulation_horizon, decumulation_horizon, accounts, current_investment, on_track, progress, goal_probability, goal_achievement_score, projection_balance, projection_date, status_time_stamp, metadata, secondary_id, id, create_date].hash
    end
