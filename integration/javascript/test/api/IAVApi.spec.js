    ...
    describe('IAVApi', function() {
      describe('createIAVUsingPost', function() {
        it('should call createIAVUsingPost successfully', function(done) {
          ...
          instance.createIAVUsingPost(iavRequestCO, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            expect(data.bankLink).to.be.a(HydrogenIntegrationApi.IavBankLinkResponseVo);
                  expect(data.bankLink.isErrorOccurred).to.be.a('boolean');
              expect(data.bankLink.isErrorOccurred).to.be(false);
              ...
              expect(data.bankLink.message).to.be("");
              {
                ...
                for (let p in dataCtr) {
                  ...
                  expect(data.nucleusBankLink).to.be.a(HydrogenIntegrationApi.BankLink);
                    ...
                    expect(data.nucleusBankLink.availableBalance).to.be.a('string');
                    expect(data.nucleusBankLink.availableBalance).to.be("1000");
                    expect(data.nucleusBankLink.balance).to.be.a('string');
      ...
      describe('getIAVUsingGet', function() {
        it('should call getIAVUsingGet successfully', function(done) {
          ...
          instance.getIAVUsingGet(authorization, nucleusBankLinkId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
