...
module AtomApi
  class CreateModelAssetSizeResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_reconciled')
    ...
    def list_invalid_properties
      ...
      if @is_reconciled.nil?
        invalid_properties.push('invalid value for "is_reconciled", is_reconciled cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_reconciled.nil?
    ...
    def hash
      [date, asset_size, is_reconciled, model_id, currency_code, secondary_id, id, create_date].hash
    end
