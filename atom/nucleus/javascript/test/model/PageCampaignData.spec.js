...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageCampaignData();
  });
  ...
  describe('PageCampaignData', function() {
    it('should create an instance of PageCampaignData', function() {
      // uncomment below and update the code to test PageCampaignData
      //var instane = new HydrogenNucleusApi.PageCampaignData();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageCampaignData);
    });
