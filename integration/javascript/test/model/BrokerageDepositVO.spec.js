...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.BrokerageDepositVO();
  });
  ...
  describe('BrokerageDepositVO', function() {
    it('should create an instance of BrokerageDepositVO', function() {
      // uncomment below and update the code to test BrokerageDepositVO
      //var instane = new HydrogenIntegrationApi.BrokerageDepositVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.BrokerageDepositVO);
    });
