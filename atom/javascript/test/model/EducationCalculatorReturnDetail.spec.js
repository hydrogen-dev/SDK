...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.EducationCalculatorReturnDetail();
  });
  ...
  describe('EducationCalculatorReturnDetail', function() {
    it('should create an instance of EducationCalculatorReturnDetail', function() {
      // uncomment below and update the code to test EducationCalculatorReturnDetail
      //var instance = new atom_api.EducationCalculatorReturnDetail();
      //expect(instance).to.be.a(atom_api.EducationCalculatorReturnDetail);
    });
