...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WalletKeyGenerateParams', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.WalletKeyGenerateParams();
      });

      it('should create an instance of WalletKeyGenerateParams', function() {
        // TODO: update the code to test WalletKeyGenerateParams
        expect(instance).to.be.a(MoleculeApiDocumentation.WalletKeyGenerateParams);
      });
