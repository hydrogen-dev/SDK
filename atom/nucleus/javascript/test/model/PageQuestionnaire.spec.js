...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageQuestionnaire();
  });
  ...
  describe('PageQuestionnaire', function() {
    it('should create an instance of PageQuestionnaire', function() {
      ...
      //var instane = new HydrogenAtomApi.PageQuestionnaire();
      //expect(instance).to.be.a(HydrogenAtomApi.PageQuestionnaire);
    });
