...
module MoleculeApi
  class WalletSpecificResponse
    ...
    def self.swagger_types
      {
        ...
        :'name' => :'String',
        :'type' => :'String',
        :'clients' => :'Array<WalletCreateClient>',
        :'token_whitelists' => :'Array<WalletCreateWhitelist>',
        :'is_active' => :'BOOLEAN',
        :'metadata' => :'Object',
    ...
    def hash
      [id, create_date, name, type, clients, token_whitelists, is_active, metadata, secondary_id, update_date].hash
    end
