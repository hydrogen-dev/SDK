...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardLoadRequestCO :  IEquatable<CardLoadRequestCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardLoadRequestCO" /> class.
        /// </summary>
        /// <param name="nucleusFundingId">nucleusFundingId.</param>
        /// <param name="reason">reason.</param>
        public CardLoadRequestCO(Guid? nucleusFundingId = default(Guid?), string reason = default(string))
        {
        ...
        {
            return this.Equals(input as CardLoadRequestCO);
        }

        /// <summary>
        /// Returns true if CardLoadRequestCO instances are equal
        /// </summary>
        /// <param name="input">Instance of CardLoadRequestCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardLoadRequestCO input)
        {
            if (input == null)
                return false;
