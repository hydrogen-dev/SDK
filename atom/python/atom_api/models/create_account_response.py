...
class CreateAccountResponse(object):
    ...
    def __init__(self, name=None, account_type_id=None, managed=True, clients=None, goals=None, currency_code=None, metadata=None, secondary_id=None, last=None, total_pages=None, total_elements=None, sort=None, first=None, number_of_elements=None, size=None, number=None, id=None, create_date=None):  # noqa: E501
    ...
    def currency_code(self):
        """Gets the currency_code of this CreateAccountResponse.  # noqa: E501

        Alphabetic currency code for the base currency of the account, limited to 3 characters  # noqa: E501

        :return: The currency_code of this CreateAccountResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def currency_code(self, currency_code):
        """Sets the currency_code of this CreateAccountResponse.

        Alphabetic currency code for the base currency of the account, limited to 3 characters  # noqa: E501

        :param currency_code: The currency_code of this CreateAccountResponse.  # noqa: E501
        :type: str
        """
