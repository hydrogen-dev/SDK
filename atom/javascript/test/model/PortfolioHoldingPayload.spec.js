...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.PortfolioHoldingPayload();
  });
  ...
  describe('PortfolioHoldingPayload', function() {
    it('should create an instance of PortfolioHoldingPayload', function() {
      // uncomment below and update the code to test PortfolioHoldingPayload
      //var instance = new atom_api.PortfolioHoldingPayload();
      //expect(instance).to.be.a(atom_api.PortfolioHoldingPayload);
    });
