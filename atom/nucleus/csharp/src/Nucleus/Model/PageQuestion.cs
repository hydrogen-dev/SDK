...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageQuestion :  IEquatable<PageQuestion>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageQuestion" /> class.
        /// </summary>
        ...
        public PageQuestion(List<Question> content = default(List<Question>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        {
            return this.Equals(input as PageQuestion);
        }

        /// <summary>
        /// Returns true if PageQuestion instances are equal
        /// </summary>
        /// <param name="input">Instance of PageQuestion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageQuestion input)
        {
            if (input == null)
                return false;
