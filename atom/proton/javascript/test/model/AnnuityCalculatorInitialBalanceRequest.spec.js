...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AnnuityCalculatorInitialBalanceRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.AnnuityCalculatorInitialBalanceRequest();
      });

      it('should create an instance of AnnuityCalculatorInitialBalanceRequest', function() {
        // TODO: update the code to test AnnuityCalculatorInitialBalanceRequest
        expect(instance).to.be.a(HydrogenProtonApi.AnnuityCalculatorInitialBalanceRequest);
      });
