...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.AggregationAccountHolding();
  });
  ...
  describe('AggregationAccountHolding', function() {
    it('should create an instance of AggregationAccountHolding', function() {
      ...
      //var instane = new HydrogenAtomApi.AggregationAccountHolding();
      //expect(instance).to.be.a(HydrogenAtomApi.AggregationAccountHolding);
    });
