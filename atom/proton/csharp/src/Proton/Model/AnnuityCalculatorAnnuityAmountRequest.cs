...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnnuityCalculatorAnnuityAmountRequest :  IEquatable<AnnuityCalculatorAnnuityAmountRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnuityCalculatorAnnuityAmountRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AnnuityCalculatorAnnuityAmountRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnuityCalculatorAnnuityAmountRequest" /> class.
        /// </summary>
        ...
        /// <param name="annuityAmount">annuityAmount (default to 1.0F).</param>
        ...
        public AnnuityCalculatorAnnuityAmountRequest(float? inflationRate = 0.0F, int? decumulationHorizon = default(int?), List<Guid?> accountIds = default(List<Guid?>), float? taxRate = 0.0F, int? accumulationHorizon = default(int?), float? annuityAmount = 1.0F, float? portfolioReturn = default(float?), AnnuityDepositSchedule depositSchedule = default(AnnuityDepositSchedule), AnnuityFrequencyIntervalEnum? annuityFrequencyInterval = AnnuityFrequencyIntervalEnum.Year, float? initialBalance = 0.0F, List<Guid?> aggregationAccountIds = default(List<Guid?>), bool? createLog = false)
        {
            ...
            {
                throw new InvalidDataException("accumulationHorizon is a required property for AnnuityCalculatorAnnuityAmountRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioReturn is a required property for AnnuityCalculatorAnnuityAmountRequest and cannot be null");
            }
            else
            {
            ...
            // use default value if no "annuityAmount" provided
            if (annuityAmount == null)
            {
                this.AnnuityAmount = 1.0F;
            }
            else
            {
        ...
        {
            return this.Equals(input as AnnuityCalculatorAnnuityAmountRequest);
        }

        /// <summary>
        /// Returns true if AnnuityCalculatorAnnuityAmountRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AnnuityCalculatorAnnuityAmountRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnuityCalculatorAnnuityAmountRequest input)
        {
            if (input == null)
                return false;
