...
module ProtonApi
  class EducationCalculatorAnnualCostRequest
    ...
    def hash
      [decumulation_horizon, deposit_schedule, initial_balance, portfolio_return, education_inflation_rate, tax_rate, percent_of_costs_covered, aggregation_account_ids, account_ids, accumulation_horizon, general_inflation_rate].hash
    end
