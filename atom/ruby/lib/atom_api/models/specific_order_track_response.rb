...
module AtomApi
  class SpecificOrderTrackResponse
    ...
    attr_accessor :external_track_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'order_status_id')
        self.order_status_id = attributes[:'order_status_id']
      end
      ...
      if attributes.has_key?(:'external_track_id')
        self.external_track_id = attributes[:'external_track_id']
      end
    ...
    def list_invalid_properties
      ...
      if @order_status_id.nil?
        invalid_properties.push('invalid value for "order_status_id", order_status_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @order_status_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          external_track_id == o.external_track_id &&
          fee == o.fee &&
          price == o.price &&
          quantity == o.quantity &&
          metadata == o.metadata &&
    ...
    def hash
      [id, create_date, order_id, order_status_id, date, commission, external_track_id, fee, price, quantity, metadata, update_date].hash
    end
