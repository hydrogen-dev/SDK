...
module MoleculeApi
  class TokenCreatePayload
    ...
    def hash
      [symbol, name, type, is_mintable, is_burnable, nucleus_model_id, owner_wallet_id, total_supply, circulating_supply, whitelist_address, conract_address, crowdsale_address, restrictions, offering_settings, metadata, secondary_id].hash
    end
