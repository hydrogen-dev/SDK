...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.CampaignPlanPayloadPlanRates();
  });
  ...
  describe('CampaignPlanPayloadPlanRates', function() {
    it('should create an instance of CampaignPlanPayloadPlanRates', function() {
      // uncomment below and update the code to test CampaignPlanPayloadPlanRates
      //var instance = new atom_api.CampaignPlanPayloadPlanRates();
      //expect(instance).to.be.a(atom_api.CampaignPlanPayloadPlanRates);
    });
