...
module ProtonApi
  class EmergencyFundCalculatorRequest
    ...
    def hash
      [telecom_payments, frequency_unit, debt_payments, lookback_periods, emergency_fund_duration, housing_cost, insurance_payments, interest_rate, other_expenses, client_id, current_emergency_fund_balance, aggregation_account_ids, account_ids, utility_payments, savings_horizon, food_costs, transportation_costs].hash
    end
