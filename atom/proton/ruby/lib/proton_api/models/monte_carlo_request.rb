...
module ProtonApi
  class MonteCarloRequest
    ...
    def hash
      [max_sample, p, aggregation_account_id, allocation_id, mu, n, sigma, account_id, init_bal, remove_outliers, model_id, max_bal, min_bal, use_proxy_data, cf, result_type, ret_mod, market_data_source, portfolio_id, frequency_interval, create_log, min_sample].hash
    end
