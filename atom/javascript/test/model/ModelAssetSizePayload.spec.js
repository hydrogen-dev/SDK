...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.ModelAssetSizePayload();
  });
  ...
  describe('ModelAssetSizePayload', function() {
    it('should create an instance of ModelAssetSizePayload', function() {
      // uncomment below and update the code to test ModelAssetSizePayload
      //var instance = new atom_api.ModelAssetSizePayload();
      //expect(instance).to.be.a(atom_api.ModelAssetSizePayload);
    });
