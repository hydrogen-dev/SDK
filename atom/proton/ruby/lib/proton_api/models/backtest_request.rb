...
module ProtonApi
  class BacktestRequest
    ...
    def asset_size=(asset_size)
      if !asset_size.nil? && asset_size < 0
        fail ArgumentError, 'invalid value for "asset_size", must be greater than or equal to 0.'
      end
    ...
    def hash
      [asset_size, end_date, stats, asset_sizes, model_id, initial_weights, trades, start_date, settings, holdings].hash
    end
