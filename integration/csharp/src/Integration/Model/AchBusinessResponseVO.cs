...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchBusinessResponseVO :  IEquatable<AchBusinessResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchBusinessResponseVO" /> class.
        /// </summary>
        ...
        public AchBusinessResponseVO(string message = default(string), Guid? nucleusBusinessId = default(Guid?), string status = default(string), string vendorName = default(string), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as AchBusinessResponseVO);
        }

        /// <summary>
        /// Returns true if AchBusinessResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchBusinessResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchBusinessResponseVO input)
        {
            if (input == null)
                return false;
