...
public class SpecificBudgetResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createDate, name, clientId, currencyCode, budget, frequencyUnit, frequency, accountId, goalId, startDate, endDate, metadata, secondaryId, updateDate);
  }
