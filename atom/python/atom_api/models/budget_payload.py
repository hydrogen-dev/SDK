...
class BudgetPayload(object):
    ...
    def __init__(self, name=None, client_id=None, currency_code=None, budget=None, frequency_unit=None, frequency=None, account_id=None, goal_id=None, start_date=None, end_date=None, metadata=None, secondary_id=None):  # noqa: E501
