...
(function(root, factory) {
  ...
  describe('RetirementCalculatorExpensesResponse', function() {
    ...
    it('should have the property projectedRetirementExpensesAdjusted (base name: "projected_retirement_expenses_adjusted")', function() {
      // uncomment below and update the code to test the property projectedRetirementExpensesAdjusted
      //var instance = new atom_api.RetirementCalculatorExpensesResponse();
      //expect(instance).to.be();
    });
