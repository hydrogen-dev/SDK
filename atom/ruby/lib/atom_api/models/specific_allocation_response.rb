...
module AtomApi
  class SpecificAllocationResponse
    ...
    def hash
      [id, create_date, name, category, client_id, benchmark_id, inception_date, node_map, metadata, is_active, secondary_id, update_date].hash
    end
