...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PagePortfolioComment();
  });
  ...
  describe('PagePortfolioComment', function() {
    it('should create an instance of PagePortfolioComment', function() {
      // uncomment below and update the code to test PagePortfolioComment
      //var instane = new HydrogenNucleusApi.PagePortfolioComment();
      //expect(instance).to.be.a(HydrogenNucleusApi.PagePortfolioComment);
    });
