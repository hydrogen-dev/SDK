...
module NucleusApi
  ...
  class PortfolioTransaction
    ...
    def hash
      [account_id, amount, balance, category, check, create_date, currency_code, date, date_available, description, id, is_cleansed, is_read, is_recurring, location, memo, merchant, merchant_category_code, model_id, portfolio_id, price, quantity, secondary_id, security_id, status, subcategory, transaction_code_id, update_date].hash
    end
