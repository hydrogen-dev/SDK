...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageDailyWithdrawal();
  });
  ...
  describe('PageDailyWithdrawal', function() {
    it('should create an instance of PageDailyWithdrawal', function() {
      // uncomment below and update the code to test PageDailyWithdrawal
      //var instane = new HydrogenNucleusApi.PageDailyWithdrawal();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageDailyWithdrawal);
    });
