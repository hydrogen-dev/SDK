...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagePortfolio :  IEquatable<PagePortfolio>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePortfolio" /> class.
        /// </summary>
        ...
        public PagePortfolio(List<Portfolio> content = default(List<Portfolio>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Portfolio> Content { get; set; }
        ...
        {
            return this.Equals(input as PagePortfolio);
        }

        /// <summary>
        /// Returns true if PagePortfolio instances are equal
        /// </summary>
        /// <param name="input">Instance of PagePortfolio to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagePortfolio input)
        {
            if (input == null)
                return false;
