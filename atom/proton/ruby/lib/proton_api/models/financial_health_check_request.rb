...
module ProtonApi
  class FinancialHealthCheckRequest
    ...
    def hash
      [lookback_periods, gross_annual_income, ratio_targets, liquid_assets, client_id, net_monthly_income, total_liabilities, non_liquid_assets, short_term_liabilities, monthly_expenses].hash
    end
