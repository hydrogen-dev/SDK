...
public class AccountApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<PortfolioHoldingAgg> getPortfolioHoldingAggAllUsingGet(UUID accountId, Boolean ascending, String currencyConversion, LocalDate endDate, String filter, Boolean getLatest, String orderBy, Integer page, Integer size, LocalDate startDate) throws ApiException {
        ApiResponse<List<PortfolioHoldingAgg>> resp = getPortfolioHoldingAggAllUsingGetWithHttpInfo(accountId, ascending, currencyConversion, endDate, filter, getLatest, orderBy, page, size, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<PortfolioHoldingAgg>> getPortfolioHoldingAggAllUsingGetWithHttpInfo(UUID accountId, Boolean ascending, String currencyConversion, LocalDate endDate, String filter, Boolean getLatest, String orderBy, Integer page, Integer size, LocalDate startDate) throws ApiException {
