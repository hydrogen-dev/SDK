...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenParamsOfferingSettings', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.TokenParamsOfferingSettings();
      });

      it('should create an instance of TokenParamsOfferingSettings', function() {
        // TODO: update the code to test TokenParamsOfferingSettings
        expect(instance).to.be.a(MoleculeApiDocumentation.TokenParamsOfferingSettings);
      });
