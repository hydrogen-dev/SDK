...
module AtomApi
  class OptConfigPortfolio
    ...
    def list_invalid_properties
      ...
      if @w_asset_config.nil?
        invalid_properties.push('invalid value for "w_asset_config", w_asset_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @w_asset_config.nil?
