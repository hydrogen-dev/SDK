...
module AtomApi
  class CreateScoreResponse
    ...
    def hash
      [score_type, score_value, client_id, account_id, portfolio_id, goal_id, allocation_id, model_id, benchmark_id, security_id, score_time_stamp, metadata, secondary_id, id, create_date].hash
    end
