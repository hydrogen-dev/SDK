...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageSupportTicketComment();
  });
  ...
  describe('PageSupportTicketComment', function() {
    it('should create an instance of PageSupportTicketComment', function() {
      // uncomment below and update the code to test PageSupportTicketComment
      //var instane = new HydrogenNucleusApi.PageSupportTicketComment();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageSupportTicketComment);
    });
