...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PagePortfolioGoal();
  });
  ...
  describe('PagePortfolioGoal', function() {
    it('should create an instance of PagePortfolioGoal', function() {
      // uncomment below and update the code to test PagePortfolioGoal
      //var instane = new HydrogenNucleusApi.PagePortfolioGoal();
      //expect(instance).to.be.a(HydrogenNucleusApi.PagePortfolioGoal);
    });
