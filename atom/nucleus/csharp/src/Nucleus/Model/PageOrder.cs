...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageOrder :  IEquatable<PageOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageOrder" /> class.
        /// </summary>
        ...
        public PageOrder(List<Order> content = default(List<Order>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        {
            return this.Equals(input as PageOrder);
        }

        /// <summary>
        /// Returns true if PageOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of PageOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageOrder input)
        {
            if (input == null)
                return false;
