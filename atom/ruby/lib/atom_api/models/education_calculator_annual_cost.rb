...
module AtomApi
  class EducationCalculatorAnnualCost
    ...
    def hash
      [initial_balance, accumulation_horizon, decumulation_horizon, portfolio_return, percent_of_costs_covered, education_inflation_rate, general_inflation_rate, tax_rate, deposit_schedule].hash
    end
