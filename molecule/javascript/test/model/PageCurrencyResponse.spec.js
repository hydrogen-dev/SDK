...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageCurrencyResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageCurrencyResponse();
      });

      it('should create an instance of PageCurrencyResponse', function() {
        // TODO: update the code to test PageCurrencyResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageCurrencyResponse);
      });
