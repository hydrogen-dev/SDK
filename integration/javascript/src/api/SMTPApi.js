...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the sendMail1 operation.
     * @callback module:api/SMTPApi~sendMail1Callback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SMTPApi~sendMail1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SmtpResponseVO}
     */
    this.sendMail1 = function(smtpVO, callback) {
      var postBody = smtpVO;

      // verify the required parameter 'smtpVO' is set
      if (smtpVO === undefined || smtpVO === null) {
        throw new Error("Missing the required parameter 'smtpVO' when calling sendMail1");
      }
