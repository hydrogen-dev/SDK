...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AnnuityCalculatorDepositAmount();
  });
  ...
  describe('AnnuityCalculatorDepositAmount', function() {
    it('should create an instance of AnnuityCalculatorDepositAmount', function() {
      // uncomment below and update the code to test AnnuityCalculatorDepositAmount
      //var instance = new atom_api.AnnuityCalculatorDepositAmount();
      //expect(instance).to.be.a(atom_api.AnnuityCalculatorDepositAmount);
    });
