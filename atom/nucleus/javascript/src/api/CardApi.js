...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Card', 'model/CardProgram', 'model/PageCard', 'model/PageCardProgram', 'model/PagePortfolioTransaction'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Card'), require('../model/CardProgram'), require('../model/PageCard'), require('../model/PageCardProgram'), require('../model/PagePortfolioTransaction'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.CardApi = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Card, root.HydrogenNucleusApi.CardProgram, root.HydrogenNucleusApi.PageCard, root.HydrogenNucleusApi.PageCardProgram, root.HydrogenNucleusApi.PagePortfolioTransaction);
  }
}(this, function(ApiClient, Card, CardProgram, PageCard, PageCardProgram, PagePortfolioTransaction) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} cardProgram card_program
     * @param {String} cardProgramId UUID card_program_id
