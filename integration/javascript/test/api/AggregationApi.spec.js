    ...
    describe('AggregationApi', function() {
            ...
            expect(data.nucleusAggregationAccountId).to.be("""00000000-0000-0000-0000-000000000000");
            {
              ...
              for (let p in dataCtr) {
                ...
                expect(data.body).to.be.a(HydrogenIntegrationApi.AggregationAccount);
                  ...
                  expect(data.body.accountNumber).to.be.a('string');
                  expect(data.body.accountNumber).to.be("566788991");
      ...
      describe('createPropertyValueUsingPost', function() {
        it('should call createPropertyValueUsingPost successfully', function(done) {
          ...
          instance.createPropertyValueUsingPost(aggregationRequestObject, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
          ...
          instance.getAggregationAccountAllUsingGet(aggregationAccountIdList, function(error, data, response) {
            ...
            for (let p in dataCtr) {
              ...
              expect(data.nucleusAggregationAccount).to.be.a(HydrogenIntegrationApi.AggregationAccountResponseInternalObjectVO);
                  ...
                  expect(data.nucleusAggregationAccount.body.accountNumber).to.be.a('string');
                  expect(data.nucleusAggregationAccount.body.accountNumber).to.be("566788991");
          ...
          instance.getAggregationAccountBalanceAllUsingGet(aggregationAccountIdList, function(error, data, response) {
            ...
            for (let p in dataCtr) {
              ...
              expect(data.nucleusBalancePosted).to.be.a(HydrogenIntegrationApi.AggregationAccountBalance);
                ...
                expect(data.nucleusBalancePosted.availableBalance).to.be.a('string');
                expect(data.nucleusBalancePosted.availableBalance).to.be("10000");
                expect(data.nucleusBalancePosted.availableCredit).to.be.a('string');
                expect(data.nucleusBalancePosted.availableCredit).to.be("10000");
                expect(data.nucleusBalancePosted.balance).to.be.a('string');
                expect(data.nucleusBalancePosted.balance).to.be("9000");
