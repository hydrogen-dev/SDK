...
class PersonalFinancialManagementApi
{
     ...
     * Budget Calculator
     *
     * @param  \com\hydrogen\Model\BudgetCalculatorRequest $budget_calculator_request Request payload for Budget Calculator (required)
     *
     ...
     * Cash Flow Analysis
     *
     * @param  \com\hydrogen\Model\CashFlowAnalysisRequest $cash_flow_analysis_request Request payload for Cash Flow Analysis (required)
     *
     * @throws \com\hydrogen\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return map[string,object]
     ...
     * Financial Picture
     *
     * @param  \com\hydrogen\Model\FinancialPictureRequest $financial_picture_request Request payload for Financial Picture (required)
     *
     * @throws \com\hydrogen\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return map[string,object]
