...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageScore();
  });
  ...
  describe('PageScore', function() {
    it('should create an instance of PageScore', function() {
      // uncomment below and update the code to test PageScore
      //var instane = new HydrogenNucleusApi.PageScore();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageScore);
    });
