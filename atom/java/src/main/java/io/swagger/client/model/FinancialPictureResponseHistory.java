...
import io.swagger.client.model.FinancialPictureResponseHistoryByCategory;
 ...
 */
@ApiModel(description = "A historical record of the client’s financials for each date within the date range. This is an array of maps, with each map corresponding to a date.")
...
public class FinancialPictureResponseHistory {
  ...
  private List<FinancialPictureResponseHistoryByCategory> byCategory = null;
  ...
  **/
  ...
  public FinancialPictureResponseHistory byCategory(List<FinancialPictureResponseHistoryByCategory> byCategory) {
    this.byCategory = byCategory;
    return this;
  }

  public FinancialPictureResponseHistory addByCategoryItem(FinancialPictureResponseHistoryByCategory byCategoryItem) {
    if (this.byCategory == null) {
      this.byCategory = new ArrayList<FinancialPictureResponseHistoryByCategory>();
    }
  ...
  **/
  ...
  public List<FinancialPictureResponseHistoryByCategory> getByCategory() {
    return byCategory;
  }

  public void setByCategory(List<FinancialPictureResponseHistoryByCategory> byCategory) {
    this.byCategory = byCategory;
  }
