...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getHouseholdClientPerformanceUsingGet operation.
     * @callback module:api/PerformanceApi~getHouseholdClientPerformanceUsingGetCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} householdId Household Id -/household
     * @param {Object} opts Optional parameters
     * @param {String} opts.activePremiumPeriod Q (quarterly), Monthly (M) , Annually (Y), Daily (D) --caps matter, codes in () - (statId: 19, default: &#39;D&#39;)
     * @param {String} opts.annualizedReturnPeriod Q (quarterly), Monthly (M) , Annually (Y), Daily (D) --caps matter, codes in () - (statId: 19, default: &#39;D&#39;)
     * @param {String} opts.benchmarkId Client Benchmark or Tenant Benchmark id -/benchmark
     ...
     * @param {String} opts.stat A stat type -- /statistics
     * @param {Number} opts.varConfInterval VaR Confidence Interval ( alpha ) i.entity 99, 95, etc - (statId: 40, default: 95)
     * @param {module:api/PerformanceApi~getHouseholdClientPerformanceUsingGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.getHouseholdClientPerformanceUsingGet = function(householdId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'householdId' is set
      if (householdId === undefined || householdId === null) {
        throw new Error("Missing the required parameter 'householdId' when calling getHouseholdClientPerformanceUsingGet");
      }
     ...
     * data is of type: {@link Object}
     */
    this.getPortfolioPerformanceUsingGet = function(portfolioId, opts, callback) {
      opts = opts || {};
      var postBody = null;
