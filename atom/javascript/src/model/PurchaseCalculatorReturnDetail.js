...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.PurchaseCalculatorReturnDetail = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The PurchaseCalculatorReturnDetail model module.
   * @module model/PurchaseCalculatorReturnDetail
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>PurchaseCalculatorReturnDetail</code>.
   * @alias module:model/PurchaseCalculatorReturnDetail
   * @class
   ...
   */
  var exports = function(periodEarnings, periodContribution, cumulativeEarnings, cumulativeContributions, endingBalance) {
    var _this = this;
  ...
  /**
   * Constructs a <code>PurchaseCalculatorReturnDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseCalculatorReturnDetail} obj Optional instance to populate.
   * @return {module:model/PurchaseCalculatorReturnDetail} The populated <code>PurchaseCalculatorReturnDetail</code> instance.
   */
