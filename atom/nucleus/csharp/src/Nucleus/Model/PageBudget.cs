...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageBudget :  IEquatable<PageBudget>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageBudget" /> class.
        /// </summary>
        ...
        public PageBudget(List<Budget> content = default(List<Budget>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Budget> Content { get; set; }
        ...
        {
            return this.Equals(input as PageBudget);
        }

        /// <summary>
        /// Returns true if PageBudget instances are equal
        /// </summary>
        /// <param name="input">Instance of PageBudget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageBudget input)
        {
            if (input == null)
                return false;
