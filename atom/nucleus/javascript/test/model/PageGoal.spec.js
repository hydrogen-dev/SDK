...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageGoal();
  });
  ...
  describe('PageGoal', function() {
    it('should create an instance of PageGoal', function() {
      // uncomment below and update the code to test PageGoal
      //var instane = new HydrogenNucleusApi.PageGoal();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageGoal);
    });
