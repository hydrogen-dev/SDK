...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EducationCalculatorDepositAmountRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.EducationCalculatorDepositAmountRequest();
      });

      it('should create an instance of EducationCalculatorDepositAmountRequest', function() {
        // TODO: update the code to test EducationCalculatorDepositAmountRequest
        expect(instance).to.be.a(HydrogenProtonApi.EducationCalculatorDepositAmountRequest);
      });
      ...
      it('should have the property percentOfCostsCovered (base name: "percent_of_costs_covered")', function() {
        // TODO: update the code to test the property percentOfCostsCovered
        expect(instance).to.have.property('percentOfCostsCovered');
        // expect(instance.percentOfCostsCovered).to.be(expectedValueLiteral);
      });
