...
module AtomApi
  class CashFlowAnalysisResponseSpendingDetailsByCategory
    ...
    def self.swagger_types
      {
        ...
        :'subcategories' => :'Array<CashFlowAnalysisResponseSpendingDetailsSubcategories>'
      }
    end
    ...
    def hash
      [category, value, benchmark_value, change, weight, benchmark_weight, subcategories].hash
    end
