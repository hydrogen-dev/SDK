...
module NucleusApi
  class AggregateDataByCategoryForClientFromDbVO
    ...
    attr_accessor :aggregation_account_balance_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'aggregation_account_balance_id')
        self.aggregation_account_balance_id = attributes[:'aggregation_account_balance_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          aggregation_account_balance_id == o.aggregation_account_balance_id &&
    ...
    def hash
      [account_holder, account_name, account_number, aggregation_account_balance_id, aggregation_account_id, available_balance, available_credit, balance, balance_time_stamp, category, client_id, currency_code, financial_offer_id, institution_name, is_active, is_asset, mask, metadata, subcategory].hash
    end
