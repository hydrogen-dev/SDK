...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AggregationAccountHoldingPayload', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AggregationAccountHoldingPayload'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.CreateAggregationAccountHoldingResponse = factory(root.atom_api.ApiClient, root.atom_api.AggregationAccountHoldingPayload, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, AggregationAccountHoldingPayload, SecondaryId) {
  'use strict';
  ...
  /**
   * The CreateAggregationAccountHoldingResponse model module.
   * @module model/CreateAggregationAccountHoldingResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateAggregationAccountHoldingResponse</code>.
   * @alias module:model/CreateAggregationAccountHoldingResponse
   * @class
   * @implements module:model/AggregationAccountHoldingPayload
  ...
  var exports = function(aggregationAccountId, ticker, tickerName, shares) {
    ...
    AggregationAccountHoldingPayload.call(_this, aggregationAccountId, ticker, tickerName, shares);


  };

  /**
   * Constructs a <code>CreateAggregationAccountHoldingResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateAggregationAccountHoldingResponse} obj Optional instance to populate.
   * @return {module:model/CreateAggregationAccountHoldingResponse} The populated <code>CreateAggregationAccountHoldingResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      AggregationAccountHoldingPayload.constructFromObject(data, obj);
  ...
  // Implement AggregationAccountHoldingPayload interface:
  /**
