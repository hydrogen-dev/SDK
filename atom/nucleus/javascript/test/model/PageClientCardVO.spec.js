...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageClientCardVO();
  });
  ...
  describe('PageClientCardVO', function() {
    it('should create an instance of PageClientCardVO', function() {
      // uncomment below and update the code to test PageClientCardVO
      //var instane = new HydrogenNucleusApi.PageClientCardVO();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageClientCardVO);
    });
