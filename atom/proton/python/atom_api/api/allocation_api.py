...
class AllocationApi(object):
    ...
    def get_all_holdings_using_get(self, allocation_id, **kwargs):  # noqa: E501
        """List all allocation holdings  # noqa: E501

        Get the information for all securities assigned to a specific allocation.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_holdings_using_get(allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_holdings_using_get_with_http_info(allocation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_holdings_using_get_with_http_info(allocation_id, **kwargs)  # noqa: E501
            return data

    def get_all_holdings_using_get_with_http_info(self, allocation_id, **kwargs):  # noqa: E501
        """List all allocation holdings  # noqa: E501

        Get the information for all securities assigned to a specific allocation.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_holdings_using_get_with_http_info(allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_holdings_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'allocation_id' is set
        if ('allocation_id' not in params or
                params['allocation_id'] is None):
            raise ValueError("Missing the required parameter `allocation_id` when calling `get_all_holdings_using_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ModelHoldingAgg]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_all_transactions_using_get(self, allocation_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_transactions_using_get(allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_transactions_using_get_with_http_info(allocation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_transactions_using_get_with_http_info(allocation_id, **kwargs)  # noqa: E501
            return data

    def get_all_transactions_using_get_with_http_info(self, allocation_id, **kwargs):  # noqa: E501
        """List all allocation transactions  # noqa: E501

        Get the information for all transactions made under an allocation to achieve the composition of the allocation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_transactions_using_get_with_http_info(allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_transactions_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'allocation_id' is set
        if ('allocation_id' not in params or
                params['allocation_id'] is None):
            raise ValueError("Missing the required parameter `allocation_id` when calling `get_all_transactions_using_get`")  # noqa: E501
    ...
    def get_allocation_aggregated_data_using_get(self, allocation_id, **kwargs):  # noqa: E501
        """List all Allocation aggregated data overview  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_allocation_aggregated_data_using_get(allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_allocation_aggregated_data_using_get_with_http_info(allocation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_allocation_aggregated_data_using_get_with_http_info(allocation_id, **kwargs)  # noqa: E501
            return data

    def get_allocation_aggregated_data_using_get_with_http_info(self, allocation_id, **kwargs):  # noqa: E501
        """List all Allocation aggregated data overview  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_allocation_aggregated_data_using_get_with_http_info(allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_allocation_aggregated_data_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'allocation_id' is set
        if ('allocation_id' not in params or
                params['allocation_id'] is None):
            raise ValueError("Missing the required parameter `allocation_id` when calling `get_allocation_aggregated_data_using_get`")  # noqa: E501
    ...
    def get_assetsize_using_get(self, allocation_id, **kwargs):  # noqa: E501
        """List all allocation asset sizes  # noqa: E501

        Get a list of asset sizes by date for a specific allocation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_assetsize_using_get(allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_assetsize_using_get_with_http_info(allocation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_assetsize_using_get_with_http_info(allocation_id, **kwargs)  # noqa: E501
            return data

    def get_assetsize_using_get_with_http_info(self, allocation_id, **kwargs):  # noqa: E501
        """List all allocation asset sizes  # noqa: E501

        Get a list of asset sizes by date for a specific allocation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_assetsize_using_get_with_http_info(allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_assetsize_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'allocation_id' is set
        if ('allocation_id' not in params or
                params['allocation_id'] is None):
            raise ValueError("Missing the required parameter `allocation_id` when calling `get_assetsize_using_get`")  # noqa: E501
    ...
    def update_allocation_composition_using_put(self, allocation_composition, allocation_composition_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param AllocationComposition allocation_composition: aggregation_composition (required)
        :param str allocation_composition_id: UUID allocation_composition_id (required)
        :return: AllocationComposition
                 If the method is called asynchronously,
                 returns the request thread.
