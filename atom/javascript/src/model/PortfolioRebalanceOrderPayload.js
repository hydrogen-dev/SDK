...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.PortfolioRebalanceOrderPayload = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The PortfolioRebalanceOrderPayload model module.
   * @module model/PortfolioRebalanceOrderPayload
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PortfolioRebalanceOrderPayload</code>.
   * @alias module:model/PortfolioRebalanceOrderPayload
   * @class
   ...
   */
  var exports = function(sellTransactionCodeId, buyTransactionCodeId) {
    var _this = this;
  ...
  /**
   * Constructs a <code>PortfolioRebalanceOrderPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioRebalanceOrderPayload} obj Optional instance to populate.
   * @return {module:model/PortfolioRebalanceOrderPayload} The populated <code>PortfolioRebalanceOrderPayload</code> instance.
   */
   ...
   * @default false
   */
  exports.prototype['use_cash_available'] = false;
  /**
