...
module NucleusApi
  ...
  class PortfolioHoldingLog
    ...
    def hash
      [account_id, amount, cost_basis, create_date, currency_code, date, id, model_id, portfolio_id, secondary_id, security_id, shares, update_date, weight].hash
    end
