...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageCard();
  });
  ...
  describe('PageCard', function() {
    it('should create an instance of PageCard', function() {
      // uncomment below and update the code to test PageCard
      //var instane = new HydrogenNucleusApi.PageCard();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageCard);
    });
