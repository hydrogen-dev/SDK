...
class InvoiceApi
{
    ...
    protected function deleteInvoicePaymentUsingDeleteRequest($invoice_payment_id)
    {
        ...
        $resourcePath = '/invoice_payment/{invoice_payment_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteInvoiceUsingDeleteRequest($invoice_id)
    {
        ...
        $resourcePath = '/invoice/{invoice_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getInvoiceAllUsingGetWithHttpInfo($ascending, $filter, $order_by, $page, $size);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoiceAllUsingGetAsync($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
        return $this->getInvoiceAllUsingGetAsyncWithHttpInfo($ascending, $filter, $order_by, $page, $size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInvoiceAllUsingGetRequest($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
    ...
    {
        list($response) = $this->getInvoicePaymentAllUsingGetWithHttpInfo($ascending, $filter, $order_by, $page, $size);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoicePaymentAllUsingGetAsync($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
        return $this->getInvoicePaymentAllUsingGetAsyncWithHttpInfo($ascending, $filter, $order_by, $page, $size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInvoicePaymentAllUsingGetRequest($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
    ...
    {
        list($response) = $this->getInvoicePaymentUsingGetWithHttpInfo($invoice_payment_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoicePaymentUsingGetAsync($invoice_payment_id)
    {
        return $this->getInvoicePaymentUsingGetAsyncWithHttpInfo($invoice_payment_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInvoicePaymentUsingGetRequest($invoice_payment_id)
    {
        // verify the required parameter 'invoice_payment_id' is set
        if ($invoice_payment_id === null || (is_array($invoice_payment_id) && count($invoice_payment_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->getInvoiceUsingGetWithHttpInfo($invoice_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoiceUsingGetAsync($invoice_id)
    {
        return $this->getInvoiceUsingGetAsyncWithHttpInfo($invoice_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInvoiceUsingGetRequest($invoice_id)
    {
        // verify the required parameter 'invoice_id' is set
        if ($invoice_id === null || (is_array($invoice_id) && count($invoice_id) === 0)) {
            throw new \InvalidArgumentException(
