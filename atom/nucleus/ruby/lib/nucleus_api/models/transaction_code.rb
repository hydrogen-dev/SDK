...
module NucleusApi
  class TransactionCode
    ...
    def valid?
      ...
      is_deposit_validator = EnumAttributeValidator.new('String', ['true', 'false', 'null'])
      return false unless is_deposit_validator.valid?(@is_deposit)
    ...
    # @param [Object] is_buy Object to be assigned
    def is_buy=(is_buy)
      validator = EnumAttributeValidator.new('String', ['true', 'false', 'null'])
      unless validator.valid?(is_buy)
        fail ArgumentError, 'invalid value for "is_buy", must be one of #{validator.allowable_values}.'
      end
      @is_buy = is_buy
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] is_deposit Object to be assigned
    def is_deposit=(is_deposit)
      validator = EnumAttributeValidator.new('String', ['true', 'false', 'null'])
      unless validator.valid?(is_deposit)
        fail ArgumentError, 'invalid value for "is_deposit", must be one of #{validator.allowable_values}.'
      end
      @is_deposit = is_deposit
    end
    ...
    def hash
      [category, create_date, id, is_buy, is_deposit, is_fee, is_transfer, metadata, secondary_id, subcategory, transaction_code, transaction_code_description, transaction_type, update_date].hash
    end
