...
class UtilsApi
{
     ...
     */
    public function getWidgetLinkUsingGet($nucleus_id, $is_business = 'false', $is_mobile_webview = 'false', $message_version = null, $mode = 'aggregation', $vendor_name = null, $wait_for_full_aggregation = 'true', $webview_url_scheme = null)
    {
        list($response) = $this->getWidgetLinkUsingGetWithHttpInfo($nucleus_id, $is_business, $is_mobile_webview, $message_version, $mode, $vendor_name, $wait_for_full_aggregation, $webview_url_scheme);
        return $response;
    }
     ...
     */
    public function getWidgetLinkUsingGetWithHttpInfo($nucleus_id, $is_business = 'false', $is_mobile_webview = 'false', $message_version = null, $mode = 'aggregation', $vendor_name = null, $wait_for_full_aggregation = 'true', $webview_url_scheme = null)
    {
        $returnType = '\com\hydrogen\integration\Model\WidgetUrlVO';
        $request = $this->getWidgetLinkUsingGetRequest($nucleus_id, $is_business, $is_mobile_webview, $message_version, $mode, $vendor_name, $wait_for_full_aggregation, $webview_url_scheme);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWidgetLinkUsingGetAsync($nucleus_id, $is_business = 'false', $is_mobile_webview = 'false', $message_version = null, $mode = 'aggregation', $vendor_name = null, $wait_for_full_aggregation = 'true', $webview_url_scheme = null)
    {
        return $this->getWidgetLinkUsingGetAsyncWithHttpInfo($nucleus_id, $is_business, $is_mobile_webview, $message_version, $mode, $vendor_name, $wait_for_full_aggregation, $webview_url_scheme)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWidgetLinkUsingGetAsyncWithHttpInfo($nucleus_id, $is_business = 'false', $is_mobile_webview = 'false', $message_version = null, $mode = 'aggregation', $vendor_name = null, $wait_for_full_aggregation = 'true', $webview_url_scheme = null)
    {
        $returnType = '\com\hydrogen\integration\Model\WidgetUrlVO';
        $request = $this->getWidgetLinkUsingGetRequest($nucleus_id, $is_business, $is_mobile_webview, $message_version, $mode, $vendor_name, $wait_for_full_aggregation, $webview_url_scheme);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWidgetLinkUsingGetRequest($nucleus_id, $is_business = 'false', $is_mobile_webview = 'false', $message_version = null, $mode = 'aggregation', $vendor_name = null, $wait_for_full_aggregation = 'true', $webview_url_scheme = null)
    {
