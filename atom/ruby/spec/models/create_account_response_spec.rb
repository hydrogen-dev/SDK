...
# Unit tests for AtomApi::CreateAccountResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateAccountResponse' do
  before do
    # run before each test
    @instance = AtomApi::CreateAccountResponse.new
  end
  ...
  describe 'test an instance of CreateAccountResponse' do
    it 'should create an instance of CreateAccountResponse' do
      expect(@instance).to be_instance_of(AtomApi::CreateAccountResponse)
    end
  end
