...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getAsyncData = function(id, integrationType, service, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getAsyncData");
      }
    ...
    /**
     * Callback function to receive the result of the getAsyncData1 operation.
     * @callback module:api/AsyncApi~getAsyncData1Callback
     * @param {String} error Error message, if any.
     * @param {module:model/AsyncTransaction} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} integrationType String integration_type
     * @param {String} service String service
     * @param {module:api/AsyncApi~getAsyncData1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AsyncTransaction}
     */
    this.getAsyncData1 = function(id, integrationType, service, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getAsyncData1");
      }

      // verify the required parameter 'integrationType' is set
      if (integrationType === undefined || integrationType === null) {
        throw new Error("Missing the required parameter 'integrationType' when calling getAsyncData1");
      }

      // verify the required parameter 'service' is set
      if (service === undefined || service === null) {
        throw new Error("Missing the required parameter 'service' when calling getAsyncData1");
      }
    ...
    /**
     * Callback function to receive the result of the getAsyncData2 operation.
     * @callback module:api/AsyncApi~getAsyncData2Callback
     * @param {String} error Error message, if any.
     * @param {module:model/AsyncTransaction} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} integrationType String integration_type
     * @param {String} service String service
     * @param {module:api/AsyncApi~getAsyncData2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AsyncTransaction}
     */
    this.getAsyncData2 = function(data, integrationType, service, callback) {
      var postBody = data;

      // verify the required parameter 'data' is set
      if (data === undefined || data === null) {
        throw new Error("Missing the required parameter 'data' when calling getAsyncData2");
      }

      // verify the required parameter 'integrationType' is set
      if (integrationType === undefined || integrationType === null) {
        throw new Error("Missing the required parameter 'integrationType' when calling getAsyncData2");
      }

      // verify the required parameter 'service' is set
      if (service === undefined || service === null) {
        throw new Error("Missing the required parameter 'service' when calling getAsyncData2");
      }
