...
/**
 * GoalDecumulationAllocationRequest Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\proton
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GoalDecumulationAllocationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'goalDecumulationAllocationRequest';
    ...
    public function setCompoundingRate($compounding_rate)
    {
        ...
        if (!is_null($compounding_rate) && ($compounding_rate < -1)) {
            throw new \InvalidArgumentException('invalid value for $compounding_rate when calling GoalDecumulationAllocationRequest., must be bigger than or equal to -1.');
        }
    ...
    public function setRiskScore($risk_score)
    {
        ...
        if (!is_null($risk_score) && ($risk_score > 100)) {
            throw new \InvalidArgumentException('invalid value for $risk_score when calling GoalDecumulationAllocationRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($risk_score) && ($risk_score < 0)) {
            throw new \InvalidArgumentException('invalid value for $risk_score when calling GoalDecumulationAllocationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setN($n)
    {
        ...
        if (!is_null($n) && ($n > 10000)) {
            throw new \InvalidArgumentException('invalid value for $n when calling GoalDecumulationAllocationRequest., must be smaller than or equal to 10000.');
        }
        if (!is_null($n) && ($n < 1)) {
            throw new \InvalidArgumentException('invalid value for $n when calling GoalDecumulationAllocationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAHorizon($a_horizon)
    {
        ...
        if (!is_null($a_horizon) && ($a_horizon > 350)) {
            throw new \InvalidArgumentException('invalid value for $a_horizon when calling GoalDecumulationAllocationRequest., must be smaller than or equal to 350.');
        }
        if (!is_null($a_horizon) && ($a_horizon < 0)) {
            throw new \InvalidArgumentException('invalid value for $a_horizon when calling GoalDecumulationAllocationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setConfTgt($conf_tgt)
    {
        ...
        if (!is_null($conf_tgt) && ($conf_tgt > 1)) {
            throw new \InvalidArgumentException('invalid value for $conf_tgt when calling GoalDecumulationAllocationRequest., must be smaller than or equal to 1.');
        }
        if (!is_null($conf_tgt) && ($conf_tgt < 0)) {
            throw new \InvalidArgumentException('invalid value for $conf_tgt when calling GoalDecumulationAllocationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTradingDaysPerYear($trading_days_per_year)
    {
        ...
        if (!is_null($trading_days_per_year) && ($trading_days_per_year > 365)) {
            throw new \InvalidArgumentException('invalid value for $trading_days_per_year when calling GoalDecumulationAllocationRequest., must be smaller than or equal to 365.');
        }
        if (!is_null($trading_days_per_year) && ($trading_days_per_year < 1)) {
            throw new \InvalidArgumentException('invalid value for $trading_days_per_year when calling GoalDecumulationAllocationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setThresh($thresh)
    {
        ...
        if (!is_null($thresh) && ($thresh < 0)) {
            throw new \InvalidArgumentException('invalid value for $thresh when calling GoalDecumulationAllocationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setWithdrawalTax($withdrawal_tax)
    {
        ...
        if (!is_null($withdrawal_tax) && ($withdrawal_tax > 1)) {
            throw new \InvalidArgumentException('invalid value for $withdrawal_tax when calling GoalDecumulationAllocationRequest., must be smaller than or equal to 1.');
        }
        if (!is_null($withdrawal_tax) && ($withdrawal_tax < 0)) {
            throw new \InvalidArgumentException('invalid value for $withdrawal_tax when calling GoalDecumulationAllocationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDHorizon($d_horizon)
    {
        ...
        if (!is_null($d_horizon) && ($d_horizon > 350)) {
            throw new \InvalidArgumentException('invalid value for $d_horizon when calling GoalDecumulationAllocationRequest., must be smaller than or equal to 350.');
        }
        if (!is_null($d_horizon) && ($d_horizon < 0)) {
            throw new \InvalidArgumentException('invalid value for $d_horizon when calling GoalDecumulationAllocationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrInv($curr_inv)
    {
        ...
        if (!is_null($curr_inv) && ($curr_inv < 0)) {
            throw new \InvalidArgumentException('invalid value for $curr_inv when calling GoalDecumulationAllocationRequest., must be bigger than or equal to 0.');
        }
