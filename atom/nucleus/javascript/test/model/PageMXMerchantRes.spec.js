...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageMXMerchantRes();
  });
  ...
  describe('PageMXMerchantRes', function() {
    it('should create an instance of PageMXMerchantRes', function() {
      // uncomment below and update the code to test PageMXMerchantRes
      //var instane = new HydrogenNucleusApi.PageMXMerchantRes();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageMXMerchantRes);
    });
