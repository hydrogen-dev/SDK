...
module AtomApi
  class DimRiskScoreResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dim_scores')
        if (value = attributes[:'dim_scores']).is_a?(Hash)
          self.dim_scores = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dim_scores.nil?
        invalid_properties.push('invalid value for "dim_scores", dim_scores cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @risk_score > 100
      return false if @risk_score < 0
      return false if @dim_scores.nil?
      true
    end
