...
class SavingsCalculatorRequest(object):
    ...
    def __init__(self, deposit_schedule=None, horizon_frequency_interval='year', initial_balance=None, return_schedule=None, tax_rate=0.0, inflation_rate=0.0, aggregation_account_ids=None, account_ids=None, horizon=None):  # noqa: E501
