...
module AtomApi
  class RetirementCalculatorDepositamountResponse
    ...
    def hash
      [deposit_amount, deposit_frequency_interval, projected_savings_at_retirement, total_earnings, total_contributions, total_withdrawals, total_taxes, return_details].hash
    end
