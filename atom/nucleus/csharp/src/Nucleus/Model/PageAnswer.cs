...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageAnswer :  IEquatable<PageAnswer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAnswer" /> class.
        /// </summary>
        ...
        public PageAnswer(List<Answer> content = default(List<Answer>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Answer> Content { get; set; }
        ...
        {
            return this.Equals(input as PageAnswer);
        }

        /// <summary>
        /// Returns true if PageAnswer instances are equal
        /// </summary>
        /// <param name="input">Instance of PageAnswer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageAnswer input)
        {
            if (input == null)
                return false;
