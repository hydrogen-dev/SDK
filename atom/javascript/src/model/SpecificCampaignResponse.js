...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateCampaignResponse', 'model/SecondaryId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CreateCampaignResponse'), require('./SecondaryId'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.SpecificCampaignResponse = factory(root.atom_api.ApiClient, root.atom_api.CreateCampaignResponse, root.atom_api.SecondaryId);
  }
}(this, function(ApiClient, CreateCampaignResponse, SecondaryId) {
  'use strict';
  ...
  /**
   * The SpecificCampaignResponse model module.
   * @module model/SpecificCampaignResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SpecificCampaignResponse</code>.
   * @alias module:model/SpecificCampaignResponse
   * @class
   * @implements module:model/CreateCampaignResponse
  ...
  var exports = function(title, description, startDate, endDate) {
    ...
    CreateCampaignResponse.call(_this, title, description, startDate, endDate);

  };

  /**
   * Constructs a <code>SpecificCampaignResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpecificCampaignResponse} obj Optional instance to populate.
   * @return {module:model/SpecificCampaignResponse} The populated <code>SpecificCampaignResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      CreateCampaignResponse.constructFromObject(data, obj);
  ...
  // Implement CreateCampaignResponse interface:
  /**
