...
# create an instance of the API class
api_instance = atom_api.DocumentApi(atom_api.ApiClient(configuration))
document_request = atom_api.Document() # Document | documentRequest
...
# create an instance of the API class
api_instance = atom_api.DocumentApi(atom_api.ApiClient(configuration))
document = atom_api.Document() # Document | document
document_id = 'document_id_example' # str | UUID document_id
