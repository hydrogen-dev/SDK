...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageNotificationClient();
  });
  ...
  describe('PageNotificationClient', function() {
    it('should create an instance of PageNotificationClient', function() {
      // uncomment below and update the code to test PageNotificationClient
      //var instane = new HydrogenNucleusApi.PageNotificationClient();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageNotificationClient);
    });
