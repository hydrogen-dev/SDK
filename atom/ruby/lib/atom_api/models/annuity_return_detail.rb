...
module AtomApi
  class AnnuityReturnDetail
    ...
    attr_accessor :period_tax

    # The cumulative taxes up to and including this period.
    attr_accessor :cumulative_tax
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'period_tax')
        self.period_tax = attributes[:'period_tax']
      end

      if attributes.has_key?(:'cumulative_tax')
        self.cumulative_tax = attributes[:'cumulative_tax']
      end
    ...
    def list_invalid_properties
      ...
      if @period_tax.nil?
        invalid_properties.push('invalid value for "period_tax", period_tax cannot be nil.')
      end

      if @period_tax < 0
        invalid_properties.push('invalid value for "period_tax", must be greater than or equal to 0.')
      end

      if @cumulative_tax.nil?
        invalid_properties.push('invalid value for "cumulative_tax", cumulative_tax cannot be nil.')
      end

      if @cumulative_tax < 0
        invalid_properties.push('invalid value for "cumulative_tax", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @period_tax.nil?
      return false if @period_tax < 0
      return false if @cumulative_tax.nil?
      return false if @cumulative_tax < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] period_tax Value to be assigned
    def period_tax=(period_tax)
      if period_tax.nil?
        fail ArgumentError, 'period_tax cannot be nil'
      end

      if period_tax < 0
        fail ArgumentError, 'invalid value for "period_tax", must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] cumulative_tax Value to be assigned
    def cumulative_tax=(cumulative_tax)
      if cumulative_tax.nil?
        fail ArgumentError, 'cumulative_tax cannot be nil'
      end

      if cumulative_tax < 0
        fail ArgumentError, 'invalid value for "cumulative_tax", must be greater than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          period_tax == o.period_tax &&
          cumulative_tax == o.cumulative_tax &&
    ...
    def hash
      [period_contribution, cumulative_contributions, period_withdrawal, cumulative_withdrawals, period_tax, cumulative_tax, period_earnings, cumulative_earnings, ending_balance].hash
    end
