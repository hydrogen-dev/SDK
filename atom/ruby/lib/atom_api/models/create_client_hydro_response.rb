...
module AtomApi
  class CreateClientHydroResponse
    ...
    def hash
      [client_id, hydro_id, is_hydro_id_verified, is_client_raindrop_linked, is_client_raindrop_enabled, metadata, secondary_id, id, create_date].hash
    end
