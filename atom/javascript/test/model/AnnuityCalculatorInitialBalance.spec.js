...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AnnuityCalculatorInitialBalance();
  });
  ...
  describe('AnnuityCalculatorInitialBalance', function() {
    it('should create an instance of AnnuityCalculatorInitialBalance', function() {
      // uncomment below and update the code to test AnnuityCalculatorInitialBalance
      //var instance = new atom_api.AnnuityCalculatorInitialBalance();
      //expect(instance).to.be.a(atom_api.AnnuityCalculatorInitialBalance);
    });
