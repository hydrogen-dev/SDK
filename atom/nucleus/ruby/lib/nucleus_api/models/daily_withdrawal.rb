...
module NucleusApi
  ...
  class DailyWithdrawal
    ...
    def hash
      [account_id, account_number, amount, comments, create_date, currency_code, direction, fees, funding_id, id, last_request_date, metadata, notes, portfolio_id, received_date, secondary_id, status, status_time_stamp, type, update_date, withdrawal_date].hash
    end
