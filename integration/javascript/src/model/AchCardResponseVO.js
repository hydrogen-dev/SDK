...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.AchCardResponseVO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
  ...
  /**
   * The AchCardResponseVO model module.
   * @module model/AchCardResponseVO
   * @version 1.3.1
   */

  /**
   * Constructs a new <code>AchCardResponseVO</code>.
   * @alias module:model/AchCardResponseVO
   * @class
   */
  ...
  /**
   * Constructs a <code>AchCardResponseVO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AchCardResponseVO} obj Optional instance to populate.
   * @return {module:model/AchCardResponseVO} The populated <code>AchCardResponseVO</code> instance.
   */
