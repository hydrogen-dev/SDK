...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AllocationTransactionResponseContent();
  });
  ...
  describe('AllocationTransactionResponseContent', function() {
    it('should create an instance of AllocationTransactionResponseContent', function() {
      // uncomment below and update the code to test AllocationTransactionResponseContent
      //var instance = new atom_api.AllocationTransactionResponseContent();
      //expect(instance).to.be.a(atom_api.AllocationTransactionResponseContent);
    });
