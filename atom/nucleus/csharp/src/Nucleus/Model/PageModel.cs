...
namespace Nucleus.ModelEntity
{
    ...
    public partial class PageModel :  IEquatable<PageModel>, IValidatableObject
    {
        ...
        public PageModel(List<Model> content = default(List<Model>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
