...
import com.hydrogen.model.PagePortfolioAssetSizeLog;
import com.hydrogen.model.PagePortfolioGoal;
import com.hydrogen.model.Portfolio;
import com.hydrogen.model.PortfolioAssetSize;
import com.hydrogen.model.PortfolioComment;
import com.hydrogen.model.PortfolioHolding;
import com.hydrogen.model.PortfolioTransaction;
...
import com.hydrogen.model.PagePortfolio;
import com.hydrogen.model.PagePortfolioComment;
import com.hydrogen.model.PagePortfolioTransaction;
import com.hydrogen.model.PortfolioAggregatedVO;
import com.hydrogen.model.PortfolioAssetSizeLog;
import com.hydrogen.model.PortfolioGoal;
import com.hydrogen.model.PortfolioHoldingLog;
...
public class PortfolioApi {
    ...
    public com.squareup.okhttp.Call createPortfolioAssetSizeUsingPostCall(PortfolioAssetSizeLog portfolioAssetSizeLogRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/portfolio_asset_size";
    ...
    public com.squareup.okhttp.Call createPortfolioCommentUsingPostCall(PortfolioComment portfolioComment, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio_comment";
    ...
    public com.squareup.okhttp.Call createPortfolioGoalUsingPostCall(PortfolioGoal portfolioGoal, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio_goal";
    ...
    public com.squareup.okhttp.Call createPortfolioHoldingUsingPostCall(PortfolioHoldingLog portfolioHoldinLogRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio_holding";
    ...
    public com.squareup.okhttp.Call createPortfolioTransactionUsingPostCall(PortfolioTransaction portfolioTransactionRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio_transaction";
    ...
    public com.squareup.okhttp.Call deletePortfolioAssetSizeUsingDeleteCall(UUID portfolioAssetSizeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio_asset_size/{portfolio_asset_size_id}"
    ...
    public com.squareup.okhttp.Call deletePortfolioCommentUsingDeleteCall(UUID portfolioCommentId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio_comment/{portfolio_comment_id}"
    ...
    public com.squareup.okhttp.Call deletePortfolioGoalUsingDeleteCall(UUID portfolioGoalId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio_goal/{portfolio_goal_id}"
    ...
    public com.squareup.okhttp.Call deletePortfolioHoldingUsingDeleteCall(UUID portfolioHoldingId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio_holding/{portfolio_holding_id}"
    ...
    public com.squareup.okhttp.Call deletePortfolioTransactionUsingDeleteCall(UUID portfolioTransactionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio_transaction/{portfolio_transaction_id}"
    ...
    public com.squareup.okhttp.Call deletePortfolioUsingDeleteCall(UUID portfolioId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio/{portfolio_id}"
    ...
    public com.squareup.okhttp.Call getPortfolioAggregatedDataUsingGetCall(UUID portfolioId, Boolean showAssetClass, Boolean showCategory, Boolean showIndustry, Boolean showSector, Boolean showSecurityClass, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/portfolio/{portfolio_id}/aggregate_data"
            .replaceAll("\\{" + "portfolio_id" + "\\}", apiClient.escapeString(portfolioId.toString()));
     ...
     * @param showSector true or false (optional, default to true)
     * @param showSecurityClass true or false (optional, default to true)
     * @return PortfolioAggregatedVO
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PortfolioAggregatedVO getPortfolioAggregatedDataUsingGet(UUID portfolioId, Boolean showAssetClass, Boolean showCategory, Boolean showIndustry, Boolean showSector, Boolean showSecurityClass) throws ApiException {
        ApiResponse<PortfolioAggregatedVO> resp = getPortfolioAggregatedDataUsingGetWithHttpInfo(portfolioId, showAssetClass, showCategory, showIndustry, showSector, showSecurityClass);
        return resp.getData();
    }
     ...
     * @param showSector true or false (optional, default to true)
     * @param showSecurityClass true or false (optional, default to true)
     * @return ApiResponse&lt;PortfolioAggregatedVO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PortfolioAggregatedVO> getPortfolioAggregatedDataUsingGetWithHttpInfo(UUID portfolioId, Boolean showAssetClass, Boolean showCategory, Boolean showIndustry, Boolean showSector, Boolean showSecurityClass) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<PortfolioAggregatedVO>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioAggregatedDataUsingGetAsync(UUID portfolioId, Boolean showAssetClass, Boolean showCategory, Boolean showIndustry, Boolean showSector, Boolean showSecurityClass, final ApiCallback<PortfolioAggregatedVO> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPortfolioAssetSizeAllUsingGetCall(Boolean ascending, String filter, String orderBy, Integer page, Integer size, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPortfolioAssetSizeAllUsingGetValidateBeforeCall(Boolean ascending, String filter, String orderBy, Integer page, Integer size, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getPortfolioAssetSizeAllUsingGetCall(ascending, filter, orderBy, page, size, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PagePortfolioAssetSizeLog getPortfolioAssetSizeAllUsingGet(Boolean ascending, String filter, String orderBy, Integer page, Integer size) throws ApiException {
        ApiResponse<PagePortfolioAssetSizeLog> resp = getPortfolioAssetSizeAllUsingGetWithHttpInfo(ascending, filter, orderBy, page, size);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PagePortfolioAssetSizeLog> getPortfolioAssetSizeAllUsingGetWithHttpInfo(Boolean ascending, String filter, String orderBy, Integer page, Integer size) throws ApiException {
        com.squareup.okhttp.Call call = getPortfolioAssetSizeAllUsingGetValidateBeforeCall(ascending, filter, orderBy, page, size, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioAssetSizeAllUsingGetAsync(Boolean ascending, String filter, String orderBy, Integer page, Integer size, final ApiCallback<PagePortfolioAssetSizeLog> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioAssetSizeAllUsingGetValidateBeforeCall(ascending, filter, orderBy, page, size, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PagePortfolioAssetSizeLog>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPortfolioAssetSizeUsingGetCall(UUID portfolioAssetSizeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPortfolioAssetSizeUsingGetValidateBeforeCall(UUID portfolioAssetSizeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioAssetSizeUsingGetCall(portfolioAssetSizeId, progressListener, progressRequestListener);
        return call;
     ...
     * Retrieve the information for a portfolio asset size record for a portfolio.
     * @param portfolioAssetSizeId portfolio_asset_size_id (required)
     * @return PortfolioAssetSize
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PortfolioAssetSize getPortfolioAssetSizeUsingGet(UUID portfolioAssetSizeId) throws ApiException {
        ApiResponse<PortfolioAssetSize> resp = getPortfolioAssetSizeUsingGetWithHttpInfo(portfolioAssetSizeId);
        return resp.getData();
    }
     ...
     * Retrieve the information for a portfolio asset size record for a portfolio.
     * @param portfolioAssetSizeId portfolio_asset_size_id (required)
     * @return ApiResponse&lt;PortfolioAssetSize&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PortfolioAssetSize> getPortfolioAssetSizeUsingGetWithHttpInfo(UUID portfolioAssetSizeId) throws ApiException {
        com.squareup.okhttp.Call call = getPortfolioAssetSizeUsingGetValidateBeforeCall(portfolioAssetSizeId, null, null);
        Type localVarReturnType = new TypeToken<PortfolioAssetSize>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioAssetSizeUsingGetAsync(UUID portfolioAssetSizeId, final ApiCallback<PortfolioAssetSize> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioAssetSizeUsingGetValidateBeforeCall(portfolioAssetSizeId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PortfolioAssetSize>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPortfolioHoldingAllUsingGetCall(Boolean ascending, String filter, String orderBy, Integer page, Integer size, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call getPortfolioHoldingAllUsingGetValidateBeforeCall(Boolean ascending, String filter, String orderBy, Integer page, Integer size, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioHoldingAllUsingGetCall(ascending, filter, orderBy, page, size, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PortfolioHolding getPortfolioHoldingAllUsingGet(Boolean ascending, String filter, String orderBy, Integer page, Integer size) throws ApiException {
        ApiResponse<PortfolioHolding> resp = getPortfolioHoldingAllUsingGetWithHttpInfo(ascending, filter, orderBy, page, size);
        return resp.getData();
    }
     ...
     * @param page page (optional, default to 0)
     * @param size size (optional, default to 25)
     * @return ApiResponse&lt;PortfolioHolding&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PortfolioHolding> getPortfolioHoldingAllUsingGetWithHttpInfo(Boolean ascending, String filter, String orderBy, Integer page, Integer size) throws ApiException {
        com.squareup.okhttp.Call call = getPortfolioHoldingAllUsingGetValidateBeforeCall(ascending, filter, orderBy, page, size, null, null);
        Type localVarReturnType = new TypeToken<PortfolioHolding>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioHoldingAllUsingGetAsync(Boolean ascending, String filter, String orderBy, Integer page, Integer size, final ApiCallback<PortfolioHolding> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioHoldingAllUsingGetValidateBeforeCall(ascending, filter, orderBy, page, size, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PortfolioHolding>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPortfolioHoldingUsingGetCall(UUID portfolioHoldingId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPortfolioHoldingUsingGetValidateBeforeCall(UUID portfolioHoldingId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioHoldingUsingGetCall(portfolioHoldingId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PortfolioHolding getPortfolioHoldingUsingGet(UUID portfolioHoldingId) throws ApiException {
        ApiResponse<PortfolioHolding> resp = getPortfolioHoldingUsingGetWithHttpInfo(portfolioHoldingId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PortfolioHolding> getPortfolioHoldingUsingGetWithHttpInfo(UUID portfolioHoldingId) throws ApiException {
        com.squareup.okhttp.Call call = getPortfolioHoldingUsingGetValidateBeforeCall(portfolioHoldingId, null, null);
        Type localVarReturnType = new TypeToken<PortfolioHolding>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioHoldingUsingGetAsync(UUID portfolioHoldingId, final ApiCallback<PortfolioHolding> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioHoldingUsingGetValidateBeforeCall(portfolioHoldingId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PortfolioHolding>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPortfolioTransactionAllUsingGetCall(Boolean ascending, String filter, String orderBy, Integer page, Integer size, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPortfolioTransactionAllUsingGetValidateBeforeCall(Boolean ascending, String filter, String orderBy, Integer page, Integer size, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getPortfolioTransactionAllUsingGetCall(ascending, filter, orderBy, page, size, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PagePortfolioTransaction getPortfolioTransactionAllUsingGet(Boolean ascending, String filter, String orderBy, Integer page, Integer size) throws ApiException {
        ApiResponse<PagePortfolioTransaction> resp = getPortfolioTransactionAllUsingGetWithHttpInfo(ascending, filter, orderBy, page, size);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PagePortfolioTransaction> getPortfolioTransactionAllUsingGetWithHttpInfo(Boolean ascending, String filter, String orderBy, Integer page, Integer size) throws ApiException {
        com.squareup.okhttp.Call call = getPortfolioTransactionAllUsingGetValidateBeforeCall(ascending, filter, orderBy, page, size, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioTransactionAllUsingGetAsync(Boolean ascending, String filter, String orderBy, Integer page, Integer size, final ApiCallback<PagePortfolioTransaction> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioTransactionAllUsingGetValidateBeforeCall(ascending, filter, orderBy, page, size, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PagePortfolioTransaction>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPortfolioTransactionUsingGetCall(UUID portfolioTransactionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPortfolioTransactionUsingGetValidateBeforeCall(UUID portfolioTransactionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioTransactionUsingGetCall(portfolioTransactionId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PortfolioTransaction getPortfolioTransactionUsingGet(UUID portfolioTransactionId) throws ApiException {
        ApiResponse<PortfolioTransaction> resp = getPortfolioTransactionUsingGetWithHttpInfo(portfolioTransactionId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PortfolioTransaction> getPortfolioTransactionUsingGetWithHttpInfo(UUID portfolioTransactionId) throws ApiException {
        com.squareup.okhttp.Call call = getPortfolioTransactionUsingGetValidateBeforeCall(portfolioTransactionId, null, null);
        Type localVarReturnType = new TypeToken<PortfolioTransaction>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPortfolioTransactionUsingGetAsync(UUID portfolioTransactionId, final ApiCallback<PortfolioTransaction> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioTransactionUsingGetValidateBeforeCall(portfolioTransactionId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PortfolioTransaction>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PortfolioAssetSize updatePortfolioAssetSizeUsingPut(PortfolioAssetSizeLog portfolioAssetSize, UUID portfolioAssetSizeId) throws ApiException {
        ApiResponse<PortfolioAssetSize> resp = updatePortfolioAssetSizeUsingPutWithHttpInfo(portfolioAssetSize, portfolioAssetSizeId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PortfolioAssetSize> updatePortfolioAssetSizeUsingPutWithHttpInfo(PortfolioAssetSizeLog portfolioAssetSize, UUID portfolioAssetSizeId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePortfolioAssetSizeUsingPutAsync(PortfolioAssetSizeLog portfolioAssetSize, UUID portfolioAssetSizeId, final ApiCallback<PortfolioAssetSize> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PortfolioHolding updatePortfolioHoldingUsingPut(PortfolioHoldingLog portfolioHolding, UUID portfolioHoldingId) throws ApiException {
        ApiResponse<PortfolioHolding> resp = updatePortfolioHoldingUsingPutWithHttpInfo(portfolioHolding, portfolioHoldingId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PortfolioHolding> updatePortfolioHoldingUsingPutWithHttpInfo(PortfolioHoldingLog portfolioHolding, UUID portfolioHoldingId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePortfolioHoldingUsingPutAsync(PortfolioHoldingLog portfolioHolding, UUID portfolioHoldingId, final ApiCallback<PortfolioHolding> callback) throws ApiException {
