...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageContact();
  });
  ...
  describe('PageContact', function() {
    it('should create an instance of PageContact', function() {
      // uncomment below and update the code to test PageContact
      //var instane = new HydrogenNucleusApi.PageContact();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageContact);
    });
