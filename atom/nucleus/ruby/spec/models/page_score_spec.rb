...
# Unit tests for NucleusApi::PageScore
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PageScore' do
  before do
    # run before each test
    @instance = NucleusApi::PageScore.new
  end
  ...
  describe 'test an instance of PageScore' do
    it 'should create an instance of PageScore' do
      expect(@instance).to be_instance_of(NucleusApi::PageScore)
    end
  end
