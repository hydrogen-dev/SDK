...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class FxRate :  IEquatable<FxRate>, IValidatableObject
    {
        /// <summary>
        ...
        public FxRate(string currencyCodeFrom = default(string), string currencyCodeTo = default(string), DateTime? date = default(DateTime?), double? exchangeRate = default(double?))
        {
            // to ensure "currencyCodeFrom" is required (not null)
            if (currencyCodeFrom == null)
            {
                throw new InvalidDataException("currencyCodeFrom is a required property for FxRate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("currencyCodeTo is a required property for FxRate and cannot be null");
            }
            else
            {
            ...
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for FxRate and cannot be null");
            }
            else
            {
                this.Date = date;
            ...
            {
                throw new InvalidDataException("exchangeRate is a required property for FxRate and cannot be null");
            }
            else
            {
