...
class PortfolioApi
{
    ...
    protected function createPortfolioAssetSizeUsingPostRequest($portfolio_asset_size_log_request)
    {
        ...
        $resourcePath = '/portfolio_asset_size';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createPortfolioCommentUsingPostRequest($portfolio_comment)
    {
        ...
        $resourcePath = '/portfolio_comment';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createPortfolioHoldingUsingPostRequest($portfolio_holdin_log_request)
    {
        ...
        $resourcePath = '/portfolio_holding';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createPortfolioTransactionUsingPostRequest($portfolio_transaction_request)
    {
        ...
        $resourcePath = '/portfolio_transaction';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePortfolioAssetSizeUsingDeleteRequest($portfolio_asset_size_id)
    {
        ...
        $resourcePath = '/portfolio_asset_size/{portfolio_asset_size_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePortfolioCommentUsingDeleteRequest($portfolio_comment_id)
    {
        ...
        $resourcePath = '/portfolio_comment/{portfolio_comment_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePortfolioGoalUsingDeleteRequest($portfolio_goal_id)
    {
        ...
        $resourcePath = '/portfolio_goal/{portfolio_goal_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePortfolioHoldingUsingDeleteRequest($portfolio_holding_id)
    {
        ...
        $resourcePath = '/portfolio_holding/{portfolio_holding_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePortfolioTransactionUsingDeleteRequest($portfolio_transaction_id)
    {
        ...
        $resourcePath = '/portfolio_transaction/{portfolio_transaction_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePortfolioUsingDeleteRequest($portfolio_id)
    {
        ...
        $resourcePath = '/portfolio/{portfolio_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getPortfolioAggregatedDataUsingGetRequest($portfolio_id, $show_asset_class = 'true', $show_category = 'true', $show_industry = 'true', $show_sector = 'true', $show_security_class = 'true')
    {
        ...
        $resourcePath = '/portfolio/{portfolio_id}/aggregate_data';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getPortfolioAssetSizeAllUsingGetWithHttpInfo($ascending, $filter, $order_by, $page, $size);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioAssetSizeAllUsingGetAsync($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
        return $this->getPortfolioAssetSizeAllUsingGetAsyncWithHttpInfo($ascending, $filter, $order_by, $page, $size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioAssetSizeAllUsingGetRequest($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
    ...
    {
        list($response) = $this->getPortfolioAssetSizeUsingGetWithHttpInfo($portfolio_asset_size_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioAssetSizeUsingGetAsync($portfolio_asset_size_id)
    {
        return $this->getPortfolioAssetSizeUsingGetAsyncWithHttpInfo($portfolio_asset_size_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioAssetSizeUsingGetRequest($portfolio_asset_size_id)
    {
        // verify the required parameter 'portfolio_asset_size_id' is set
        if ($portfolio_asset_size_id === null || (is_array($portfolio_asset_size_id) && count($portfolio_asset_size_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->getPortfolioHoldingAllUsingGetWithHttpInfo($ascending, $filter, $order_by, $page, $size);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioHoldingAllUsingGetAsync($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
        return $this->getPortfolioHoldingAllUsingGetAsyncWithHttpInfo($ascending, $filter, $order_by, $page, $size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioHoldingAllUsingGetRequest($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
    ...
    {
        list($response) = $this->getPortfolioHoldingUsingGetWithHttpInfo($portfolio_holding_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioHoldingUsingGetAsync($portfolio_holding_id)
    {
        return $this->getPortfolioHoldingUsingGetAsyncWithHttpInfo($portfolio_holding_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioHoldingUsingGetRequest($portfolio_holding_id)
    {
        // verify the required parameter 'portfolio_holding_id' is set
        if ($portfolio_holding_id === null || (is_array($portfolio_holding_id) && count($portfolio_holding_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->getPortfolioTransactionAllUsingGetWithHttpInfo($ascending, $filter, $order_by, $page, $size);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioTransactionAllUsingGetAsync($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
        return $this->getPortfolioTransactionAllUsingGetAsyncWithHttpInfo($ascending, $filter, $order_by, $page, $size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioTransactionAllUsingGetRequest($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
    ...
    {
        list($response) = $this->getPortfolioTransactionUsingGetWithHttpInfo($portfolio_transaction_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioTransactionUsingGetAsync($portfolio_transaction_id)
    {
        return $this->getPortfolioTransactionUsingGetAsyncWithHttpInfo($portfolio_transaction_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioTransactionUsingGetRequest($portfolio_transaction_id)
    {
        // verify the required parameter 'portfolio_transaction_id' is set
        if ($portfolio_transaction_id === null || (is_array($portfolio_transaction_id) && count($portfolio_transaction_id) === 0)) {
            throw new \InvalidArgumentException(
