...
module NucleusApi
  ...
  class SpendingControl
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'client_group')
        self.client_group = attributes[:'client_group']
      end
    ...
    def hash
      [client_group, client_id, control_scope, control_type, control_values, create_date, currency_code, description, frequency, frequency_unit, id, is_active, limit_value, metadata, secondary_id, update_date].hash
    end
