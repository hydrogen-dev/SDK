...
module ProtonApi
  class FinancialHealthCheckRequest
    ...
    def hash
      [client_id, total_liabilities, liquid_assets, monthly_expenses, ratio_targets, non_liquid_assets, gross_annual_income, lookback_periods, net_monthly_income, short_term_liabilities].hash
    end
