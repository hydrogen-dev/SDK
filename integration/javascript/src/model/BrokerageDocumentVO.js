...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.BrokerageDocumentVO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
  ...
  /**
   * The BrokerageDocumentVO model module.
   * @module model/BrokerageDocumentVO
   * @version 1.3.0
   */

  /**
   * Constructs a new <code>BrokerageDocumentVO</code>.
   * @alias module:model/BrokerageDocumentVO
   * @class
   */
  ...
  /**
   * Constructs a <code>BrokerageDocumentVO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BrokerageDocumentVO} obj Optional instance to populate.
   * @return {module:model/BrokerageDocumentVO} The populated <code>BrokerageDocumentVO</code> instance.
   */
