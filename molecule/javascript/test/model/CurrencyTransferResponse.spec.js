...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CurrencyTransferResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.CurrencyTransferResponse();
      });

      it('should create an instance of CurrencyTransferResponse', function() {
        // TODO: update the code to test CurrencyTransferResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.CurrencyTransferResponse);
      });
