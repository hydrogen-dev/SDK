...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GoalReturnDetailsPeriodResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GoalReturnDetailsPeriodResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.GoalStatusSectionResponse = factory(root.atom_api.ApiClient, root.atom_api.GoalReturnDetailsPeriodResponse);
  }
}(this, function(ApiClient, GoalReturnDetailsPeriodResponse) {
  'use strict';
  ...
  /**
   * The GoalStatusSectionResponse model module.
   * @module model/GoalStatusSectionResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GoalStatusSectionResponse</code>.
   * @alias module:model/GoalStatusSectionResponse
   * @class
   ...
   */
  var exports = function(onTrack, progress, goalProbability, goalAchievementScore, returnDetails, adjustedGoalAmount) {
    var _this = this;
  ...
  /**
   * Constructs a <code>GoalStatusSectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GoalStatusSectionResponse} obj Optional instance to populate.
   * @return {module:model/GoalStatusSectionResponse} The populated <code>GoalStatusSectionResponse</code> instance.
   */
