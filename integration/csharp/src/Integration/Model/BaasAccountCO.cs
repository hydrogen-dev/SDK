...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaasAccountCO :  IEquatable<BaasAccountCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaasAccountCO" /> class.
        /// </summary>
        /// <param name="nucleusAccountId">nucleusAccountId.</param>
        /// <param name="nucleusClientId">nucleusClientId.</param>
        public BaasAccountCO(Guid? nucleusAccountId = default(Guid?), Guid? nucleusClientId = default(Guid?))
        {
        ...
        {
            return this.Equals(input as BaasAccountCO);
        }

        /// <summary>
        /// Returns true if BaasAccountCO instances are equal
        /// </summary>
        /// <param name="input">Instance of BaasAccountCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaasAccountCO input)
        {
            if (input == null)
                return false;
