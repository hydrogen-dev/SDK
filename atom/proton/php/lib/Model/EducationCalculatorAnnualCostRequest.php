...
/**
 * EducationCalculatorAnnualCostRequest Class Doc Comment
 *
 * @category Class
 * @package  com\hydrogen\proton
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EducationCalculatorAnnualCostRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'educationCalculatorAnnualCostRequest';
    ...
    public function setEducationInflationRate($education_inflation_rate)
    {
        ...
        if (!is_null($education_inflation_rate) && ($education_inflation_rate < -1)) {
            throw new \InvalidArgumentException('invalid value for $education_inflation_rate when calling EducationCalculatorAnnualCostRequest., must be bigger than or equal to -1.');
        }
    ...
    public function setDecumulationHorizon($decumulation_horizon)
    {
        ...
        if (($decumulation_horizon < 0)) {
            throw new \InvalidArgumentException('invalid value for $decumulation_horizon when calling EducationCalculatorAnnualCostRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setAccumulationHorizon($accumulation_horizon)
    {
        ...
        if (($accumulation_horizon < 0)) {
            throw new \InvalidArgumentException('invalid value for $accumulation_horizon when calling EducationCalculatorAnnualCostRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxRate($tax_rate)
    {
        ...
        if (!is_null($tax_rate) && ($tax_rate > 1)) {
            throw new \InvalidArgumentException('invalid value for $tax_rate when calling EducationCalculatorAnnualCostRequest., must be smaller than or equal to 1.');
        }
        if (!is_null($tax_rate) && ($tax_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_rate when calling EducationCalculatorAnnualCostRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setGeneralInflationRate($general_inflation_rate)
    {
        ...
        if (!is_null($general_inflation_rate) && ($general_inflation_rate < -1)) {
            throw new \InvalidArgumentException('invalid value for $general_inflation_rate when calling EducationCalculatorAnnualCostRequest., must be bigger than or equal to -1.');
        }
    ...
    public function setPortfolioReturn($portfolio_return)
    {
        ...
        if (($portfolio_return < -1)) {
            throw new \InvalidArgumentException('invalid value for $portfolio_return when calling EducationCalculatorAnnualCostRequest., must be bigger than or equal to -1.');
        }
    ...
    public function setInitialBalance($initial_balance)
    {
        ...
        if (!is_null($initial_balance) && ($initial_balance < 0)) {
            throw new \InvalidArgumentException('invalid value for $initial_balance when calling EducationCalculatorAnnualCostRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setPercentOfCostsCovered($percent_of_costs_covered)
    {
        ...
        if (!is_null($percent_of_costs_covered) && ($percent_of_costs_covered > 1)) {
            throw new \InvalidArgumentException('invalid value for $percent_of_costs_covered when calling EducationCalculatorAnnualCostRequest., must be smaller than or equal to 1.');
        }
        if (!is_null($percent_of_costs_covered) && ($percent_of_costs_covered < 0)) {
            throw new \InvalidArgumentException('invalid value for $percent_of_costs_covered when calling EducationCalculatorAnnualCostRequest., must be bigger than or equal to 0.');
        }
