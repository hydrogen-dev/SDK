...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.AllocationTransactionResponseContent = factory(root.atom_api.ApiClient);
  }
  ...
  /**
   * The AllocationTransactionResponseContent model module.
   * @module model/AllocationTransactionResponseContent
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AllocationTransactionResponseContent</code>.
   * @alias module:model/AllocationTransactionResponseContent
   * @class
   */
  ...
  /**
   * Constructs a <code>AllocationTransactionResponseContent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllocationTransactionResponseContent} obj Optional instance to populate.
   * @return {module:model/AllocationTransactionResponseContent} The populated <code>AllocationTransactionResponseContent</code> instance.
   */
