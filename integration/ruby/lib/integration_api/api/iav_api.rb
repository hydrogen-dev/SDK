...
module IntegrationApi
  class IAVApi
    ...
    def delete_bank_link_using_delete2(nucleus_bank_link_id, opts = {})
      delete_bank_link_using_delete2_with_http_info(nucleus_bank_link_id, opts)
      nil
    end
    ...
    def delete_bank_link_using_delete2_with_http_info(nucleus_bank_link_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IAVApi.delete_bank_link_using_delete2 ...'
      end
      ...
      if @api_client.config.client_side_validation && nucleus_bank_link_id.nil?
        fail ArgumentError, "Missing the required parameter 'nucleus_bank_link_id' when calling IAVApi.delete_bank_link_using_delete2"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IAVApi#delete_bank_link_using_delete2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
