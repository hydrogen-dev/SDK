...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.UpdateBusinessResponseVO();
  });
  ...
  describe('UpdateBusinessResponseVO', function() {
    it('should create an instance of UpdateBusinessResponseVO', function() {
      // uncomment below and update the code to test UpdateBusinessResponseVO
      //var instane = new HydrogenIntegrationApi.UpdateBusinessResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.UpdateBusinessResponseVO);
    });
