...
from integration_api.models.get_order_response import GetOrderResponse  # noqa: E501
...
class TestGetOrderResponse(unittest.TestCase):
    ...
    def testGetOrderResponse(self):
        ...
        # model = integration_api.models.get_order_response.GetOrderResponse()  # noqa: E501
        pass
