...
class GetCardTokenResponseVO(object):
    ...
    def __init__(self, message=None, nucleus_card_id=None, pan_reference=None, status=None, token_reference=None, vendor_name=None, vendor_response=None, wallet=None, _configuration=None):  # noqa: E501
