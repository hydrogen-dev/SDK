...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RetirementCalculatorExpensesRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.RetirementCalculatorExpensesRequest();
      });

      it('should create an instance of RetirementCalculatorExpensesRequest', function() {
        // TODO: update the code to test RetirementCalculatorExpensesRequest
        expect(instance).to.be.a(HydrogenProtonApi.RetirementCalculatorExpensesRequest);
      });
