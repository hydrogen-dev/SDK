...
module NucleusApi
  class OverflowBankLinkMap
    ...
    def list_invalid_properties
      ...
      if @bank_link_id.nil?
        invalid_properties.push('invalid value for "bank_link_id", bank_link_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bank_link_id.nil?
      true
    end
