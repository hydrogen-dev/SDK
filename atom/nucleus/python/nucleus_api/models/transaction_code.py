...
class TransactionCode(object):
    ...
    def __init__(self, category=None, create_date=None, id=None, is_buy=None, is_deposit=None, is_fee=None, is_transfer=None, metadata=None, secondary_id=None, subcategory=None, transaction_code=None, transaction_code_description=None, transaction_type=None, update_date=None, _configuration=None):  # noqa: E501
    ...
    @property
    def is_deposit(self):
        """Gets the is_deposit of this TransactionCode.  # noqa: E501


        :return: The is_deposit of this TransactionCode.  # noqa: E501
        :rtype: str
        """
    ...
    def is_deposit(self, is_deposit):
        """Sets the is_deposit of this TransactionCode.


        :param is_deposit: The is_deposit of this TransactionCode.  # noqa: E501
        :type: str
        """
        allowed_values = ["true", "false", "null"]  # noqa: E501
        if (self._configuration.client_side_validation and
                is_deposit not in allowed_values):
            raise ValueError(
                "Invalid value for `is_deposit` ({0}), must be one of {1}"  # noqa: E501
                .format(is_deposit, allowed_values)
            )
    ...
    def transaction_code(self, transaction_code):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and transaction_code is None:
