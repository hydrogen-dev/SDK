...
module AtomApi
  class AnnuityCalculatorDecumulationHorizon
    ...
    def hash
      [portfolio_return, initial_balance, accumulation_horizon, annuity_amount, annuity_frequency_interval, inflation_rate, tax_rate, deposit_schedule].hash
    end
