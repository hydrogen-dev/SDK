...
module ProtonApi
  class CashAnalysisRequest
    ...
    def hash
      [end_date, client_id, show_inflow_details, currency_conversion, history_frequency_interval, start_date, show_history, currency_code, show_outflow_details, scope].hash
    end
