...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.CreateBusinessResponseVO();
  });
  ...
  describe('CreateBusinessResponseVO', function() {
    it('should create an instance of CreateBusinessResponseVO', function() {
      // uncomment below and update the code to test CreateBusinessResponseVO
      //var instane = new HydrogenIntegrationApi.CreateBusinessResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.CreateBusinessResponseVO);
    });
