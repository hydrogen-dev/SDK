...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PagePortfolio();
  });
  ...
  describe('PagePortfolio', function() {
    it('should create an instance of PagePortfolio', function() {
      // uncomment below and update the code to test PagePortfolio
      //var instane = new HydrogenNucleusApi.PagePortfolio();
      //expect(instance).to.be.a(HydrogenNucleusApi.PagePortfolio);
    });
