  ...
  class BrokerageHoldingVO
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nucleus_holdings_posted')
        self.nucleus_holdings_posted = attributes[:'nucleus_holdings_posted']
      end
    ...
    def hash
      [message, nucleus_holdings_posted, nucleus_portfolio_id, status, vendor_name, vendor_response].hash
    end
