...
*ProtonApi::FinancialPlanningApi* | [**mortgage_calculator_periodic_payment**](docs/FinancialPlanningApi.md#mortgage_calculator_periodic_payment) | **POST** /mortgage_calculator/period_payment | Mortgage Calculator - Periodic Payment
