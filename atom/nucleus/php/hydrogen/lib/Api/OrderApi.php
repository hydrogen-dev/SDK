...
class OrderApi
{
    ...
    protected function createAccountOrderBulkUsingPostRequest($account_id, $req)
    {
        ...
        $resourcePath = '/account/{account_id}/order_bulk';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createAccountOrderBuyOnlyUsingPostRequest($account_id, $req)
    {
        ...
        $resourcePath = '/account/{account_id}/order_buy_only';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createAccountOrderRebalanceUsingPostRequest($account_id, $req)
    {
        ...
        $resourcePath = '/account/{account_id}/order_rebalance';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createAccountOrderReconciliationRequest($account_id, $req)
    {
        ...
        $resourcePath = '/account/{account_id}/order_reconciliation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createAccountOrderSellAllUsingPostRequest($account_id, $req)
    {
        ...
        $resourcePath = '/account/{account_id}/order_sell_all';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createAccountOrderSellOnlyUsingPostRequest($account_id, $req)
    {
        ...
        $resourcePath = '/account/{account_id}/order_sell_only';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createClientOrderBulkUsingPostRequest($client_id, $req)
    {
        ...
        $resourcePath = '/client/{client_id}/order_bulk';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createPortfolioOrderBuyOnlyUsingPostRequest($portfolio_id, $req)
    {
        ...
        $resourcePath = '/portfolio/{portfolio_id}/order_buy_only';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createPortfolioOrderRebalanceUsingPostRequest($portfolio_id, $req)
    {
        ...
        $resourcePath = '/portfolio/{portfolio_id}/order_rebalance';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createPortfolioOrderReconciliationRequest($portfolio_id, $req)
    {
        ...
        $resourcePath = '/portfolio/{portfolio_id}/order_reconciliation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createPortfolioOrderSellAllUsingPostRequest($portfolio_id, $req)
    {
        ...
        $resourcePath = '/portfolio/{portfolio_id}/order_sell_all';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createPortfolioOrderSellOnlyUsingPostRequest($portfolio_id, $req)
    {
        ...
        $resourcePath = '/portfolio/{portfolio_id}/order_sell_only';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOrderStatusUsingDeleteRequest($order_status_id)
    {
        ...
        $resourcePath = '/order_status/{order_status_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOrderTrackUsingDeleteRequest($order_track_id)
    {
        ...
        $resourcePath = '/order_track/{order_track_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getOrderAllUsingGetWithHttpInfo($order_info_request);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderAllUsingGetAsync($order_info_request)
    {
        return $this->getOrderAllUsingGetAsyncWithHttpInfo($order_info_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrderAllUsingGetRequest($order_info_request)
    {
        ...
        if ($order_info_request === null || (is_array($order_info_request) && count($order_info_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_info_request when calling getOrderAllUsingGet'
            );
        }
    ...
    /**
     * Operation getOrderAllUsingGet1
     *
    ...
    {
        list($response) = $this->getOrderAllUsingGet1WithHttpInfo($ascending, $filter, $order_by, $page, $size);
        return $response;
    }

    /**
     * Operation getOrderAllUsingGet1WithHttpInfo
     *
     * List all order records
     *
     * @param  bool $ascending ascending (optional, default to false)
    ...
    /**
     * Operation getOrderAllUsingGet1Async
     *
     * List all order records
     *
     * @param  bool $ascending ascending (optional, default to false)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderAllUsingGet1Async($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
        return $this->getOrderAllUsingGet1AsyncWithHttpInfo($ascending, $filter, $order_by, $page, $size)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrderAllUsingGet1AsyncWithHttpInfo
     *
     * List all order records
     *
     * @param  bool $ascending ascending (optional, default to false)
    ...
    /**
     * Create request for operation 'getOrderAllUsingGet1'
     *
     * @param  bool $ascending ascending (optional, default to false)
     * @param  string $filter filter (optional)
     * @param  string $order_by order_by (optional, default to update_date)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrderAllUsingGet1Request($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderBulkAllUsingGetAsync($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrderBulkAllUsingGetRequest($ascending = 'false', $filter = null, $order_by = 'update_date', $page = '0', $size = '25')
    {
