...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAccounting();
  });
  ...
  describe('PageAccounting', function() {
    it('should create an instance of PageAccounting', function() {
      // uncomment below and update the code to test PageAccounting
      //var instane = new HydrogenNucleusApi.PageAccounting();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAccounting);
    });
