...
class AggregationAccountHolding(object):
    ...
    def __init__(self, aggregation_account_id=None, amount=None, asset_class=None, cost_basis=None, create_date=None, currency_code=None, cusip=None, exchange=None, holding_date=None, holding_type=None, id=None, isin=None, metadata=None, price=None, secondary_id=None, shares=None, ticker=None, ticker_name=None, update_date=None, _configuration=None):  # noqa: E501
