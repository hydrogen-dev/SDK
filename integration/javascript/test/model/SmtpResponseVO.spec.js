...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.SmtpResponseVO();
  });
  ...
  describe('SmtpResponseVO', function() {
    it('should create an instance of SmtpResponseVO', function() {
      // uncomment below and update the code to test SmtpResponseVO
      //var instane = new HydrogenIntegrationApi.SmtpResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.SmtpResponseVO);
    });
