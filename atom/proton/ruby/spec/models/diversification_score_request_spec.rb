...
# Unit tests for ProtonApi::DiversificationScoreRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DiversificationScoreRequest' do
  before do
    # run before each test
    @instance = ProtonApi::DiversificationScoreRequest.new
  end
  ...
  describe 'test an instance of DiversificationScoreRequest' do
    it 'should create an instance of DiversificationScoreRequest' do
      expect(@instance).to be_instance_of(ProtonApi::DiversificationScoreRequest)
    end
  end
