...
module AtomApi
  ...
  class Budget
    ...
    def hash
      [account_id, aggregation_accounts, budget, client_id, create_date, currency_code, end_date, frequency, frequency_unit, goal_id, id, is_active, metadata, name, secondary_id, start_date, update_date].hash
    end
