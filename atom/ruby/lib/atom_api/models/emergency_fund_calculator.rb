...
module AtomApi
  class EmergencyFundCalculator
    ...
    def list_invalid_properties
      ...
      if !@interest_rate.nil? && @interest_rate >= 0.1
        invalid_properties.push('invalid value for "interest_rate", must be smaller than 0.1.')
      end
    ...
    def valid?
      ...
      return false if !@interest_rate.nil? && @interest_rate >= 0.1
    ...
    def interest_rate=(interest_rate)
      if !interest_rate.nil? && interest_rate >= 0.1
        fail ArgumentError, 'invalid value for "interest_rate", must be smaller than 0.1.'
      end
