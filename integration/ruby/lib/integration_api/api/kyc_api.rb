...
module IntegrationApi
  class KYCApi
    ...
    def get_kyc_status_using_get(nucleus_client_id, opts = {})
      data, _status_code, _headers = get_kyc_status_using_get_with_http_info(nucleus_client_id, opts)
      data
    end
    ...
    def get_kyc_status_using_get_with_http_info(nucleus_client_id, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && nucleus_client_id.nil?
        fail ArgumentError, "Missing the required parameter 'nucleus_client_id' when calling KYCApi.get_kyc_status_using_get"
      end
      # resource path
      local_var_path = '/kyc_status/{nucleus_client_id}'.sub('{' + 'nucleus_client_id' + '}', nucleus_client_id.to_s)
