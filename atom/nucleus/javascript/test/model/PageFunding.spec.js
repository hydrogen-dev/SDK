...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageFunding();
  });
  ...
  describe('PageFunding', function() {
    it('should create an instance of PageFunding', function() {
      // uncomment below and update the code to test PageFunding
      //var instane = new HydrogenNucleusApi.PageFunding();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageFunding);
    });
