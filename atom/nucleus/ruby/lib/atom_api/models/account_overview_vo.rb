...
module AtomApi
  class AccountOverviewVO
    ...
    def self.swagger_types
      {
        ...
        :'account_holdings' => :'Array<AccountHoldingVO>',
        :'account_id' => :'String',
        :'account_name' => :'String',
        :'account_type_id' => :'String',
        :'account_type_name' => :'String',
        :'allocations' => :'Array<AllocationVO>',
        :'clients' => :'Array<AccountClientsOverviewVO>',
        :'deposits' => :'Array<DepositVO>',
        :'withdrawals' => :'Array<WithdrawalVO>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'account_holdings')
        if (value = attributes[:'account_holdings']).is_a?(Array)
          self.account_holdings = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account_holdings == o.account_holdings &&
    ...
    def hash
      [account_asset_size, account_asset_size_date, account_holdings, account_id, account_name, account_type_id, account_type_name, allocations, clients, deposits, withdrawals].hash
    end
