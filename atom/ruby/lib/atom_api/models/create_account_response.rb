...
module AtomApi
  class CreateAccountResponse
    ...
    def hash
      [name, account_type_id, managed, clients, goals, currency_code, metadata, secondary_id, last, total_pages, total_elements, sort, first, number_of_elements, size, number, id, create_date].hash
    end
