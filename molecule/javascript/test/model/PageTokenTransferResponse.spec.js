...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageTokenTransferResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageTokenTransferResponse();
      });

      it('should create an instance of PageTokenTransferResponse', function() {
        // TODO: update the code to test PageTokenTransferResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageTokenTransferResponse);
      });
