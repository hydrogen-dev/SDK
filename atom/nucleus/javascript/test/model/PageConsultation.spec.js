...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageConsultation();
  });
  ...
  describe('PageConsultation', function() {
    it('should create an instance of PageConsultation', function() {
      // uncomment below and update the code to test PageConsultation
      //var instane = new HydrogenNucleusApi.PageConsultation();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageConsultation);
    });
