...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageCustomerRevenue();
  });
  ...
  describe('PageCustomerRevenue', function() {
    it('should create an instance of PageCustomerRevenue', function() {
      // uncomment below and update the code to test PageCustomerRevenue
      //var instane = new HydrogenNucleusApi.PageCustomerRevenue();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageCustomerRevenue);
    });
