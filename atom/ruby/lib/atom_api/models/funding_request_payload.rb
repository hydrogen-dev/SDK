...
module AtomApi
  class FundingRequestPayload
    ...
    def hash
      [account_id, funding_type, funding_status, frequency_unit, is_deposit, start_date, end_date, last_request_date, next_request_date, frequency, description, amount, bank_link_id, transfer_id, support_ticket_id, is_active, metadata, secondary_id].hash
    end
