...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageKmsConfig :  IEquatable<PageKmsConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageKmsConfig" /> class.
        /// </summary>
        ...
        public PageKmsConfig(List<KmsConfig> content = default(List<KmsConfig>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<KmsConfig> Content { get; set; }
        ...
        {
            return this.Equals(input as PageKmsConfig);
        }

        /// <summary>
        /// Returns true if PageKmsConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of PageKmsConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageKmsConfig input)
        {
            if (input == null)
                return false;
