...
module ProtonApi
  class GoalAccumulationAllocationRequest
    ...
    def hash
      [goal_id, allocation_method, curr_inv, risk_score, n, allocation_priority, horizon_frequency, allocations, client_id, remove_outliers, use_proxy_data, goal_config, conf_tgt, horizon, thresh_type, thresh, deposit_config, market_data_source, recommendation_config, opt_config, withdrawal_tax, trading_days_per_year, compounding_rate, adjust_for_compounding, create_log, recommend_type].hash
    end
