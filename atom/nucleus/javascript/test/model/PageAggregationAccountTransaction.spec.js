...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageAggregationAccountTransaction();
  });
  ...
  describe('PageAggregationAccountTransaction', function() {
    it('should create an instance of PageAggregationAccountTransaction', function() {
      // uncomment below and update the code to test PageAggregationAccountTransaction
      //var instane = new HydrogenNucleusApi.PageAggregationAccountTransaction();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageAggregationAccountTransaction);
    });
