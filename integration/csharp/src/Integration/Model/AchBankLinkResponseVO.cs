...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AchBankLinkResponseVO :  IEquatable<AchBankLinkResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AchBankLinkResponseVO" /> class.
        /// </summary>
        ...
        public AchBankLinkResponseVO(string message = default(string), Guid? nucleusBankLinkId = default(Guid?), Guid? nucleusClientId = default(Guid?), string status = default(string), string vendorName = default(string), BankLinkVendorDataVO vendorRequestData = default(BankLinkVendorDataVO), Object vendorResponse = default(Object))
        {
        ...
        {
            return this.Equals(input as AchBankLinkResponseVO);
        }

        /// <summary>
        /// Returns true if AchBankLinkResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of AchBankLinkResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AchBankLinkResponseVO input)
        {
            if (input == null)
                return false;
