...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DecisionTree', 'model/Sort'], factory);
  ...
  /**
   * The PageDecisionTree model module.
   * @module model/PageDecisionTree
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageDecisionTree</code>.
   * Page Object
   * @alias module:model/PageDecisionTree
   * @class
   */
  ...
  /**
   * Constructs a <code>PageDecisionTree</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageDecisionTree} obj Optional instance to populate.
   * @return {module:model/PageDecisionTree} The populated <code>PageDecisionTree</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [DecisionTree]);
      }
  ...
  /**
   * @member {Array.<module:model/DecisionTree>} content
   */
