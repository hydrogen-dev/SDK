...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenTransferParams', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.TokenTransferParams();
      });

      it('should create an instance of TokenTransferParams', function() {
        // TODO: update the code to test TokenTransferParams
        expect(instance).to.be.a(MoleculeApiDocumentation.TokenTransferParams);
      });
