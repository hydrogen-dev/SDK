...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageAuditLog :  IEquatable<PageAuditLog>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAuditLog" /> class.
        /// </summary>
        ...
        public PageAuditLog(List<AuditLog> content = default(List<AuditLog>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<AuditLog> Content { get; set; }
        ...
        {
            return this.Equals(input as PageAuditLog);
        }

        /// <summary>
        /// Returns true if PageAuditLog instances are equal
        /// </summary>
        /// <param name="input">Instance of PageAuditLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageAuditLog input)
        {
            if (input == null)
                return false;
