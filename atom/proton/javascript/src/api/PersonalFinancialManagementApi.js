...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BudgetCalculatorRequest', 'model/CashFlowAnalysisRequest', 'model/FeeAnalysisRequest', 'model/FinancialPictureRequest', 'model/RecurringTransactionAnalysisRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BudgetCalculatorRequest'), require('../model/CashFlowAnalysisRequest'), require('../model/FeeAnalysisRequest'), require('../model/FinancialPictureRequest'), require('../model/RecurringTransactionAnalysisRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenProtonApi) {
      root.HydrogenProtonApi = {};
    }
    root.HydrogenProtonApi.PersonalFinancialManagementApi = factory(root.HydrogenProtonApi.ApiClient, root.HydrogenProtonApi.BudgetCalculatorRequest, root.HydrogenProtonApi.CashFlowAnalysisRequest, root.HydrogenProtonApi.FeeAnalysisRequest, root.HydrogenProtonApi.FinancialPictureRequest, root.HydrogenProtonApi.RecurringTransactionAnalysisRequest);
  }
}(this, function(ApiClient, BudgetCalculatorRequest, CashFlowAnalysisRequest, FeeAnalysisRequest, FinancialPictureRequest, RecurringTransactionAnalysisRequest) {
  'use strict';
