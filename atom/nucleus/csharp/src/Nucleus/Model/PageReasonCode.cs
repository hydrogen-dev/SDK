...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageReasonCode :  IEquatable<PageReasonCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageReasonCode" /> class.
        /// </summary>
        ...
        public PageReasonCode(List<ReasonCode> content = default(List<ReasonCode>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<ReasonCode> Content { get; set; }
        ...
        {
            return this.Equals(input as PageReasonCode);
        }

        /// <summary>
        /// Returns true if PageReasonCode instances are equal
        /// </summary>
        /// <param name="input">Instance of PageReasonCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageReasonCode input)
        {
            if (input == null)
                return false;
