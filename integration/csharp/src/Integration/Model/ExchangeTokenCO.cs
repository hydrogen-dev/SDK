...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExchangeTokenCO :  IEquatable<ExchangeTokenCO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeTokenCO" /> class.
        /// </summary>
        ...
        public ExchangeTokenCO(string integrationType = default(string), Guid? nucleusBusinessId = default(Guid?), Guid? nucleusClientId = default(Guid?), string product = default(string), Guid? tenantId = default(Guid?), string vendorName = default(string), Object vendorRequest = default(Object))
        {
        ...
        {
            return this.Equals(input as ExchangeTokenCO);
        }

        /// <summary>
        /// Returns true if ExchangeTokenCO instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangeTokenCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangeTokenCO input)
        {
            if (input == null)
                return false;
