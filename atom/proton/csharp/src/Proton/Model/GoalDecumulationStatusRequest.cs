...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalDecumulationStatusRequest :  IEquatable<GoalDecumulationStatusRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoalDecumulationStatusRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GoalDecumulationStatusRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GoalDecumulationStatusRequest" /> class.
        /// </summary>
        ...
        public GoalDecumulationStatusRequest(RecommendationConfig recommendationConfig = default(RecommendationConfig), float? compoundingRate = 0.0F, RecommendTypeEnum? recommendType = RecommendTypeEnum.Horizon, bool? createLog = false, int? n = 1000, int? aHorizon = default(int?), List<float?> pRisk = default(List<float?>), bool? removeOutliers = true, bool? adjustForCompounding = false, Guid? goalId = default(Guid?), float? confTgt = 0.9F, int? tradingDaysPerYear = 252, decimal? thresh = default(decimal?), float? withdrawalTax = 0.0F, int? dHorizon = default(int?), Guid? clientId = default(Guid?), ThreshTypeEnum? threshType = ThreshTypeEnum.Perc, HorizonFrequencyEnum? horizonFrequency = HorizonFrequencyEnum.Year, List<GoalWithdrawalConfig> withdrawalConfig = default(List<GoalWithdrawalConfig>), decimal? currInv = default(decimal?), List<DecumulationGoalDepositConfig> depositConfig = default(List<DecumulationGoalDepositConfig>), List<float?> pRet = default(List<float?>))
        {
            ...
            if (pRet == null)
            {
                throw new InvalidDataException("pRet is a required property for GoalDecumulationStatusRequest and cannot be null");
            }
            else
            {
                this.PRet = pRet;
        ...
        {
            return this.Equals(input as GoalDecumulationStatusRequest);
        }

        /// <summary>
        /// Returns true if GoalDecumulationStatusRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalDecumulationStatusRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalDecumulationStatusRequest input)
        {
            if (input == null)
                return false;
