...
module IntegrationApi
  class GetCardTokenResponseVO
    attr_accessor :message

    attr_accessor :nucleus_card_id

    attr_accessor :pan_reference
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pan_reference')
        self.pan_reference = attributes[:'pan_reference']
      end
      ...
      if attributes.has_key?(:'token_reference')
    ...
    def hash
      [message, nucleus_card_id, pan_reference, status, token_reference, vendor_name, vendor_response, wallet].hash
    end
