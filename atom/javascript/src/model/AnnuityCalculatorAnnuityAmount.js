...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.AnnuityCalculatorAnnuityAmount = factory(root.atom_api.ApiClient, root.atom_api.AnnuityDepositSchedule);
  }
  ...
  /**
   * The AnnuityCalculatorAnnuityAmount model module.
   * @module model/AnnuityCalculatorAnnuityAmount
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>AnnuityCalculatorAnnuityAmount</code>.
   * @alias module:model/AnnuityCalculatorAnnuityAmount
   * @class
   ...
   */
  var exports = function(portfolioReturn, initialBalance, accumulationHorizon, decumulationHorizon) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AnnuityCalculatorAnnuityAmount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AnnuityCalculatorAnnuityAmount} obj Optional instance to populate.
   * @return {module:model/AnnuityCalculatorAnnuityAmount} The populated <code>AnnuityCalculatorAnnuityAmount</code> instance.
   */
   ...
   * @member {module:model/AnnuityCalculatorAnnuityAmount.AnnuityFrequencyIntervalEnum} annuity_frequency_interval
   * @default 'year'
   */
