...
module ProtonApi
  class DiversificationScoreRequest
    ...
    def hash
      [use_proxy_data, start_date, portfolio_tickers, end_date, model_id, allocation_id, account_id, portfolio_id, portfolio_weights, aggregation_account_id, market_data_source].hash
    end
