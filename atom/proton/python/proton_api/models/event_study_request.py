...
class EventStudyRequest(object):
    ...
    def __init__(self, portfolio_tickers=None, market_data_source='nucleus', portfolio_id=None, model_id=None, create_log=False, allocation_id=None, events=None, use_proxy_data=False, account_id=None, aggregation_account_id=None, portfolio_weights=None):  # noqa: E501
