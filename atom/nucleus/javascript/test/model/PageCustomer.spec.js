...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageCustomer();
  });
  ...
  describe('PageCustomer', function() {
    it('should create an instance of PageCustomer', function() {
      // uncomment below and update the code to test PageCustomer
      //var instane = new HydrogenNucleusApi.PageCustomer();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageCustomer);
    });
