...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.SalesPayload = factory(root.atom_api.ApiClient, root.atom_api.SecondaryId);
  }
  ...
  /**
   * The SalesPayload model module.
   * @module model/SalesPayload
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SalesPayload</code>.
   * @alias module:model/SalesPayload
   * @class
  ...
  /**
   * Constructs a <code>SalesPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesPayload} obj Optional instance to populate.
   * @return {module:model/SalesPayload} The populated <code>SalesPayload</code> instance.
   */
