...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_disputed')) {
        obj['is_disputed'] = ApiClient.convertToType(data['is_disputed'], 'Boolean');
      }
  ...
  /**
   * is_disputed
   * @member {Boolean} is_disputed
   */
  exports.prototype['is_disputed'] = undefined;
  /**
   * isRead
