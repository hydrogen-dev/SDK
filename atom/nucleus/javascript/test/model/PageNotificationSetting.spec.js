...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PageNotificationSetting();
  });
  ...
  describe('PageNotificationSetting', function() {
    it('should create an instance of PageNotificationSetting', function() {
      ...
      //var instane = new HydrogenAtomApi.PageNotificationSetting();
      //expect(instance).to.be.a(HydrogenAtomApi.PageNotificationSetting);
    });
