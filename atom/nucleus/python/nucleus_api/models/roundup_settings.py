...
class RoundupSettings(object):
    ...
    def __init__(self, account_id=None, accounts=None, aggregation_accounts=None, bank_links=None, categories=None, client_id=None, create_date=None, id=None, is_active=None, merchants=None, metadata=None, portfolio_id=None, secondary_id=None, update_date=None, _configuration=None):  # noqa: E501
    ...
    def bank_links(self, bank_links):
        ...
        """
        if self._configuration.client_side_validation and bank_links is None:
