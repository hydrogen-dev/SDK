...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WalletPermissionUpdateParams', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.WalletPermissionUpdateParams();
      });

      it('should create an instance of WalletPermissionUpdateParams', function() {
        // TODO: update the code to test WalletPermissionUpdateParams
        expect(instance).to.be.a(MoleculeApiDocumentation.WalletPermissionUpdateParams);
      });
