...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Faq', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Faq'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageFaq = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Faq, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, Faq, Sort) {
  'use strict';
  ...
  /**
   * The PageFaq model module.
   * @module model/PageFaq
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageFaq</code>.
   * Page Object
   * @alias module:model/PageFaq
   * @class
   */
  ...
  /**
   * Constructs a <code>PageFaq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageFaq} obj Optional instance to populate.
   * @return {module:model/PageFaq} The populated <code>PageFaq</code> instance.
   */
