...
module NucleusApi
  ...
  class Card
    ...
    # spendingLimitAtm
    attr_accessor :spending_limit_atm

    # spendingLimitPurchase
    attr_accessor :spending_limit_purchase
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'spending_limit_atm')
        self.spending_limit_atm = attributes[:'spending_limit_atm']
      end

      if attributes.has_key?(:'spending_limit_purchase')
        self.spending_limit_purchase = attributes[:'spending_limit_purchase']
      end
      ...
      if attributes.has_key?(:'transaction_limit')
        self.transaction_limit = attributes[:'transaction_limit']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          spending_limit_atm == o.spending_limit_atm &&
          spending_limit_purchase == o.spending_limit_purchase &&
          status == o.status &&
          transaction_limit == o.transaction_limit &&
    ...
    def hash
      [account_id, address, card_holder_name, card_image, card_issuance, card_name, card_network, card_program_id, card_type, client_id, create_date, credit_limit, currency_code, expiry_date, fulfillment, id, institution_name, is_active, is_primary, is_reloadable, mask, metadata, phone_number, portfolio_id, prepaid_amount, secondary_id, spending_limit_atm, spending_limit_purchase, status, transaction_limit, update_date].hash
    end
