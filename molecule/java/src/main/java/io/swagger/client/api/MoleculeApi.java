...
public class MoleculeApi {
    ...
    /**
     * Build call for getTokenRestriction
     * @param tokenRestrictionId UUID of a token restriction (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * 
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Retrieve-a-restriction">Retrieve a token restriction Documentation</a>
     */
    public com.squareup.okhttp.Call getTokenRestrictionCall(UUID tokenRestrictionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/molecule/v1/token_restriction/{token_restriction_id}/"
            .replaceAll("\\{" + "token_restriction_id" + "\\}", apiClient.escapeString(tokenRestrictionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getTokenRestrictionValidateBeforeCall(UUID tokenRestrictionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'tokenRestrictionId' is set
        if (tokenRestrictionId == null) {
            throw new ApiException("Missing the required parameter 'tokenRestrictionId' when calling getTokenRestriction(Async)");
        }
        

        com.squareup.okhttp.Call call = getTokenRestrictionCall(tokenRestrictionId, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Retrieve-a-restriction">Retrieve a token restriction Documentation</a>
     */
    public TokenRestrictionSpecificResponse getTokenRestriction(UUID tokenRestrictionId) throws ApiException {
        ApiResponse<TokenRestrictionSpecificResponse> resp = getTokenRestrictionWithHttpInfo(tokenRestrictionId);
        return resp.getData();
    }
     ...
     * 
     * @param tokenRestrictionId UUID of a token restriction (required)
     * @return ApiResponse&lt;TokenRestrictionSpecificResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * 
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Retrieve-a-restriction">Retrieve a token restriction Documentation</a>
     */
    public ApiResponse<TokenRestrictionSpecificResponse> getTokenRestrictionWithHttpInfo(UUID tokenRestrictionId) throws ApiException {
        com.squareup.okhttp.Call call = getTokenRestrictionValidateBeforeCall(tokenRestrictionId, null, null);
        Type localVarReturnType = new TypeToken<TokenRestrictionSpecificResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Retrieve a token restriction (asynchronously)
     * 
     * @param tokenRestrictionId UUID of a token restriction (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Retrieve-a-restriction">Retrieve a token restriction Documentation</a>
     */
    public com.squareup.okhttp.Call getTokenRestrictionAsync(UUID tokenRestrictionId, final ApiCallback<TokenRestrictionSpecificResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getTokenRestrictionValidateBeforeCall(tokenRestrictionId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TokenRestrictionSpecificResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for getTokenRestrictions
     * @param page Page number for the page that should be returned as the starting page. For example, if this is specified as 0, then the first page of the results will be the shown, if it is set as 3 then the third page of the results will be shown, and so on. The default is 0 (optional, default to 0)
     * @param size The number or records to be included per page. The default is 25. There is no max value. (optional, default to 25)
     * @param orderBy The field in the response body to order the list by. Default is update_date. (optional, default to update_date)
     * @param ascending If true, order the results in ascending order. For an alphabetical result this would be A-Z. If false, order the results in descending order. For an alphabetical result this would be Z-A. Default is false which would order by descending. (optional, default to false)
     ...
     * @throws ApiException If fail to serialize the request body object
     * 
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#List-all-restrictions">Get information for all token restrictions defined for your firm Documentation</a>
     */
    public com.squareup.okhttp.Call getTokenRestrictionsCall(Integer page, Integer size, String orderBy, Boolean ascending, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/molecule/v1/token_restriction";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getTokenRestrictionsValidateBeforeCall(Integer page, Integer size, String orderBy, Boolean ascending, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getTokenRestrictionsCall(page, size, orderBy, ascending, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#List-all-restrictions">Get information for all token restrictions defined for your firm Documentation</a>
     */
    public TokenRestrictionGetResponse getTokenRestrictions(Integer page, Integer size, String orderBy, Boolean ascending) throws ApiException {
        ApiResponse<TokenRestrictionGetResponse> resp = getTokenRestrictionsWithHttpInfo(page, size, orderBy, ascending);
        return resp.getData();
    }
     ...
     * @param orderBy The field in the response body to order the list by. Default is update_date. (optional, default to update_date)
     * @param ascending If true, order the results in ascending order. For an alphabetical result this would be A-Z. If false, order the results in descending order. For an alphabetical result this would be Z-A. Default is false which would order by descending. (optional, default to false)
     * @return ApiResponse&lt;TokenRestrictionGetResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * 
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#List-all-restrictions">Get information for all token restrictions defined for your firm Documentation</a>
     */
    public ApiResponse<TokenRestrictionGetResponse> getTokenRestrictionsWithHttpInfo(Integer page, Integer size, String orderBy, Boolean ascending) throws ApiException {
        com.squareup.okhttp.Call call = getTokenRestrictionsValidateBeforeCall(page, size, orderBy, ascending, null, null);
        Type localVarReturnType = new TypeToken<TokenRestrictionGetResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get information for all token restrictions defined for your firm (asynchronously)
     * 
     * @param page Page number for the page that should be returned as the starting page. For example, if this is specified as 0, then the first page of the results will be the shown, if it is set as 3 then the third page of the results will be shown, and so on. The default is 0 (optional, default to 0)
     * @param size The number or records to be included per page. The default is 25. There is no max value. (optional, default to 25)
     * @param orderBy The field in the response body to order the list by. Default is update_date. (optional, default to update_date)
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#List-all-restrictions">Get information for all token restrictions defined for your firm Documentation</a>
     */
    public com.squareup.okhttp.Call getTokenRestrictionsAsync(Integer page, Integer size, String orderBy, Boolean ascending, final ApiCallback<TokenRestrictionGetResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getTokenRestrictionsValidateBeforeCall(page, size, orderBy, ascending, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TokenRestrictionGetResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for postTokenRestriction
     * @param payload  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * 
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Create-a-restriction">Create a token restriction under your firm. Documentation</a>
     */
    public com.squareup.okhttp.Call postTokenRestrictionCall(TokenRestrictionCreatePayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = payload;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postTokenRestrictionValidateBeforeCall(TokenRestrictionCreatePayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'payload' is set
        if (payload == null) {
            throw new ApiException("Missing the required parameter 'payload' when calling postTokenRestriction(Async)");
        }
        

        com.squareup.okhttp.Call call = postTokenRestrictionCall(payload, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Create-a-restriction">Create a token restriction under your firm. Documentation</a>
     */
    public TokenRestrictionCreateResponse postTokenRestriction(TokenRestrictionCreatePayload payload) throws ApiException {
        ApiResponse<TokenRestrictionCreateResponse> resp = postTokenRestrictionWithHttpInfo(payload);
        return resp.getData();
    }
     ...
     * 
     * @param payload  (required)
     * @return ApiResponse&lt;TokenRestrictionCreateResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * 
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Create-a-restriction">Create a token restriction under your firm. Documentation</a>
     */
    public ApiResponse<TokenRestrictionCreateResponse> postTokenRestrictionWithHttpInfo(TokenRestrictionCreatePayload payload) throws ApiException {
        com.squareup.okhttp.Call call = postTokenRestrictionValidateBeforeCall(payload, null, null);
        Type localVarReturnType = new TypeToken<TokenRestrictionCreateResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create a token restriction under your firm. (asynchronously)
     * 
     * @param payload  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Create-a-restriction">Create a token restriction under your firm. Documentation</a>
     */
    public com.squareup.okhttp.Call postTokenRestrictionAsync(TokenRestrictionCreatePayload payload, final ApiCallback<TokenRestrictionCreateResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postTokenRestrictionValidateBeforeCall(payload, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TokenRestrictionCreateResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for updateTokenRestriction
     * @param tokenRestrictionId UUID of a token restriction (required)
     * @param payload  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     * 
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Update-a-restriction">Update a token restriction Documentation</a>
     */
    public com.squareup.okhttp.Call updateTokenRestrictionCall(UUID tokenRestrictionId, TokenRestrictionCreatePayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = payload;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateTokenRestrictionValidateBeforeCall(UUID tokenRestrictionId, TokenRestrictionCreatePayload payload, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'tokenRestrictionId' is set
        if (tokenRestrictionId == null) {
            throw new ApiException("Missing the required parameter 'tokenRestrictionId' when calling updateTokenRestriction(Async)");
        }
        
        // verify the required parameter 'payload' is set
        if (payload == null) {
            throw new ApiException("Missing the required parameter 'payload' when calling updateTokenRestriction(Async)");
        }
        

        com.squareup.okhttp.Call call = updateTokenRestrictionCall(tokenRestrictionId, payload, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Update-a-restriction">Update a token restriction Documentation</a>
     */
    public TokenRestrictionSpecificResponse updateTokenRestriction(UUID tokenRestrictionId, TokenRestrictionCreatePayload payload) throws ApiException {
        ApiResponse<TokenRestrictionSpecificResponse> resp = updateTokenRestrictionWithHttpInfo(tokenRestrictionId, payload);
        return resp.getData();
    }
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Update-a-restriction">Update a token restriction Documentation</a>
     */
    public ApiResponse<TokenRestrictionSpecificResponse> updateTokenRestrictionWithHttpInfo(UUID tokenRestrictionId, TokenRestrictionCreatePayload payload) throws ApiException {
        com.squareup.okhttp.Call call = updateTokenRestrictionValidateBeforeCall(tokenRestrictionId, payload, null, null);
        Type localVarReturnType = new TypeToken<TokenRestrictionSpecificResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Update a token restriction (asynchronously)
     * 
     * @param tokenRestrictionId UUID of a token restriction (required)
     * @param payload  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://www.hydrogenplatform.com/docs/molecule/v1/#Update-a-restriction">Update a token restriction Documentation</a>
     */
    public com.squareup.okhttp.Call updateTokenRestrictionAsync(UUID tokenRestrictionId, TokenRestrictionCreatePayload payload, final ApiCallback<TokenRestrictionSpecificResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateTokenRestrictionValidateBeforeCall(tokenRestrictionId, payload, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TokenRestrictionSpecificResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
