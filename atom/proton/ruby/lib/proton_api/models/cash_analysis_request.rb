...
module ProtonApi
  class CashAnalysisRequest
    ...
    def hash
      [scope, show_outflow_details, show_history, client_id, show_inflow_details, currency_conversion, end_date, currency_code, start_date, history_frequency_interval].hash
    end
