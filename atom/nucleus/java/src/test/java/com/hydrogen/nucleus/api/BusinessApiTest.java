...
public class BusinessApiTest {
    ...
    public void getBusinessHoldingUsingGetTest() throws ApiException {
        ...
        Integer size = null;
        String startDate = null;
        List<PortfolioHoldingAgg> response = api.getBusinessHoldingUsingGet(businessId, ascending, currencyConversion, endDate, filter, getLatest, orderBy, page, size, startDate);
