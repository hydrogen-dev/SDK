...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageFundingTransaction();
  });
  ...
  describe('PageFundingTransaction', function() {
    it('should create an instance of PageFundingTransaction', function() {
      // uncomment below and update the code to test PageFundingTransaction
      //var instane = new HydrogenNucleusApi.PageFundingTransaction();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageFundingTransaction);
    });
