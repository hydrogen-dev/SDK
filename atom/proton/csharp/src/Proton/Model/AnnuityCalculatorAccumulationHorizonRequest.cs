...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnnuityCalculatorAccumulationHorizonRequest :  IEquatable<AnnuityCalculatorAccumulationHorizonRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnuityCalculatorAccumulationHorizonRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AnnuityCalculatorAccumulationHorizonRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnuityCalculatorAccumulationHorizonRequest" /> class.
        /// </summary>
        ...
        public AnnuityCalculatorAccumulationHorizonRequest(float? inflationRate = 0.0F, int? decumulationHorizon = default(int?), List<Guid?> accountIds = default(List<Guid?>), float? taxRate = 0.0F, int? accumulationHorizon = default(int?), float? annuityAmount = default(float?), float? portfolioReturn = default(float?), AnnuityDepositSchedule depositSchedule = default(AnnuityDepositSchedule), AnnuityFrequencyIntervalEnum? annuityFrequencyInterval = AnnuityFrequencyIntervalEnum.Year, float? initialBalance = 0.0F, List<Guid?> aggregationAccountIds = default(List<Guid?>), bool? createLog = false)
        {
            ...
            {
                throw new InvalidDataException("annuityAmount is a required property for AnnuityCalculatorAccumulationHorizonRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioReturn is a required property for AnnuityCalculatorAccumulationHorizonRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AnnuityCalculatorAccumulationHorizonRequest);
        }

        /// <summary>
        /// Returns true if AnnuityCalculatorAccumulationHorizonRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AnnuityCalculatorAccumulationHorizonRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnuityCalculatorAccumulationHorizonRequest input)
        {
            if (input == null)
                return false;
