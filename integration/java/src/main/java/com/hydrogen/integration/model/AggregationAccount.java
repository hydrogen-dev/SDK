...
public class AggregationAccount {
  ...
  **/
  @ApiModelProperty(value = "account_holder")
  ...
  **/
   ...
   * @return bankLinkId
  **/
  @ApiModelProperty(example = "2035f52d-2c5b-4e07-8904-cb037bad7aff", value = "bankLinkId")
  ...
  **/
  @ApiModelProperty(example = "2035f52d-2c5b-4e07-8904-cb037bad7aff", value = "financial_offer_id")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountCategoryId, accountHolder, accountName, apr, apy, bankLinkId, businessId, category, clientId, createDate, creditLimit, currencyCode, deathBenefit, financialOfferId, id, institutionId, institutionName, interestRate, isActive, isLinkVerified, isManual, lastPayment, lastPaymentDate, mask, maturityDate, metadata, minimumPayment, nextPaymentDate, secondaryId, subcategory, updateDate);
  }
