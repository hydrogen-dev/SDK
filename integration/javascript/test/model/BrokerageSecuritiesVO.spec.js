...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.BrokerageSecuritiesVO();
  });
  ...
  describe('BrokerageSecuritiesVO', function() {
    it('should create an instance of BrokerageSecuritiesVO', function() {
      // uncomment below and update the code to test BrokerageSecuritiesVO
      //var instane = new HydrogenIntegrationApi.BrokerageSecuritiesVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.BrokerageSecuritiesVO);
    });
