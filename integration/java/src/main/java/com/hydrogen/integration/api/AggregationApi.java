...
public class AggregationApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteAggregationAccountUsingDeleteCall(UUID nucleusAggregationAccountId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteAggregationAccountUsingDeleteValidateBeforeCall(UUID nucleusAggregationAccountId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteAggregationAccountUsingDeleteCall(nucleusAggregationAccountId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void deleteAggregationAccountUsingDelete(UUID nucleusAggregationAccountId) throws ApiException {
        deleteAggregationAccountUsingDeleteWithHttpInfo(nucleusAggregationAccountId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> deleteAggregationAccountUsingDeleteWithHttpInfo(UUID nucleusAggregationAccountId) throws ApiException {
        com.squareup.okhttp.Call call = deleteAggregationAccountUsingDeleteValidateBeforeCall(nucleusAggregationAccountId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteAggregationAccountUsingDeleteAsync(UUID nucleusAggregationAccountId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteAggregationAccountUsingDeleteValidateBeforeCall(nucleusAggregationAccountId, progressListener, progressRequestListener);
