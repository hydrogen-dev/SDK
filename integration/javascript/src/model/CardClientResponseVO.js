...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.CardClientResponseVO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CardClientResponseVO model module.
   * @module model/CardClientResponseVO
   * @version 1.2.1
   */

  /**
   * Constructs a new <code>CardClientResponseVO</code>.
   * @alias module:model/CardClientResponseVO
   * @class
   */
  ...
  /**
   * Constructs a <code>CardClientResponseVO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CardClientResponseVO} obj Optional instance to populate.
   * @return {module:model/CardClientResponseVO} The populated <code>CardClientResponseVO</code> instance.
   */
