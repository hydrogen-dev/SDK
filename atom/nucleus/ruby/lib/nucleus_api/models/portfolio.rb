...
module NucleusApi
  ...
  class Portfolio
    ...
    def hash
      [account_id, account_number, create_date, currency_code, description, id, is_active, is_subledger, metadata, model_id, name, percentage, secondary_id, update_date].hash
    end
