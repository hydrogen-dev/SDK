...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenAtomApi.PortfolioAssetSize();
  });
  ...
  describe('PortfolioAssetSize', function() {
    it('should create an instance of PortfolioAssetSize', function() {
      ...
      //var instane = new HydrogenAtomApi.PortfolioAssetSize();
      //expect(instance).to.be.a(HydrogenAtomApi.PortfolioAssetSize);
    });
