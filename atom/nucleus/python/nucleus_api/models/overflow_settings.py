...
class OverflowSettings(object):
    ...
    def __init__(self, account_id=None, bank_links=None, client_id=None, create_date=None, id=None, is_active=None, metadata=None, portfolio_id=None, secondary_id=None, update_date=None, _configuration=None):  # noqa: E501
