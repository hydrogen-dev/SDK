...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.BrokerageWithdrawalVO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
  ...
  /**
   * The BrokerageWithdrawalVO model module.
   * @module model/BrokerageWithdrawalVO
   * @version 1.3.1
   */

  /**
   * Constructs a new <code>BrokerageWithdrawalVO</code>.
   * @alias module:model/BrokerageWithdrawalVO
   * @class
   */
  ...
  /**
   * Constructs a <code>BrokerageWithdrawalVO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BrokerageWithdrawalVO} obj Optional instance to populate.
   * @return {module:model/BrokerageWithdrawalVO} The populated <code>BrokerageWithdrawalVO</code> instance.
   */
