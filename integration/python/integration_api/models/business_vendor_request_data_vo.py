...
class BusinessVendorRequestDataVO(object):
    ...
    def __init__(self, business_addresses=None, dba_name=None, email=None, identification_number=None, identification_number_type=None, incorporation_date=None, incorporation_state=None, is_public=None, legal_name=None, legal_structure=None, metadata=None, owners=None, phone_number=None, ticker=None, website=None, _configuration=None):  # noqa: E501
