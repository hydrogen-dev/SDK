...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageWalletPermissionResponse', function() {
      beforeEach(function() {
        instance = new MoleculeApiDocumentation.PageWalletPermissionResponse();
      });

      it('should create an instance of PageWalletPermissionResponse', function() {
        // TODO: update the code to test PageWalletPermissionResponse
        expect(instance).to.be.a(MoleculeApiDocumentation.PageWalletPermissionResponse);
      });
