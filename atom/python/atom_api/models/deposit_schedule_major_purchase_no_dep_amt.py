...
class DepositScheduleMajorPurchaseNoDepAmt(object):
    ...
    def __init__(self, deposit_frequency_interval='year', adjust_deposit_for_inflation=True):  # noqa: E501
        """DepositScheduleMajorPurchaseNoDepAmt - a model defined in Swagger"""  # noqa: E501
    ...
    def deposit_frequency_interval(self):
        """Gets the deposit_frequency_interval of this DepositScheduleMajorPurchaseNoDepAmt.  # noqa: E501

        The deposit frequency interval  # noqa: E501

        :return: The deposit_frequency_interval of this DepositScheduleMajorPurchaseNoDepAmt.  # noqa: E501
        :rtype: str
        """
    ...
    def deposit_frequency_interval(self, deposit_frequency_interval):
        """Sets the deposit_frequency_interval of this DepositScheduleMajorPurchaseNoDepAmt.

        The deposit frequency interval  # noqa: E501

        :param deposit_frequency_interval: The deposit_frequency_interval of this DepositScheduleMajorPurchaseNoDepAmt.  # noqa: E501
        :type: str
        """
    ...
    def adjust_deposit_for_inflation(self):
        """Gets the adjust_deposit_for_inflation of this DepositScheduleMajorPurchaseNoDepAmt.  # noqa: E501

        T/F adjust deposit for inflation rate  # noqa: E501

        :return: The adjust_deposit_for_inflation of this DepositScheduleMajorPurchaseNoDepAmt.  # noqa: E501
        :rtype: bool
        """
    ...
    def adjust_deposit_for_inflation(self, adjust_deposit_for_inflation):
        """Sets the adjust_deposit_for_inflation of this DepositScheduleMajorPurchaseNoDepAmt.

        T/F adjust deposit for inflation rate  # noqa: E501

        :param adjust_deposit_for_inflation: The adjust_deposit_for_inflation of this DepositScheduleMajorPurchaseNoDepAmt.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DepositScheduleMajorPurchaseNoDepAmt, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DepositScheduleMajorPurchaseNoDepAmt):
            return False
