...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.SellAllPortfolioPayload();
  });
  ...
  describe('SellAllPortfolioPayload', function() {
    it('should create an instance of SellAllPortfolioPayload', function() {
      // uncomment below and update the code to test SellAllPortfolioPayload
      //var instance = new atom_api.SellAllPortfolioPayload();
      //expect(instance).to.be.a(atom_api.SellAllPortfolioPayload);
    });
