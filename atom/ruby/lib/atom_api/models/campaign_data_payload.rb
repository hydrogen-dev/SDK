...
module AtomApi
  class CampaignDataPayload
    ...
    def hash
      [campaign_id, start_date, end_date, click_through_rate, line_item, publisher_campaign_name, total_clicks, total_impressions, secondary_id, metadata].hash
    end
