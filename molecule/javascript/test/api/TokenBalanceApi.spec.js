...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoleculeApiDocumentation.TokenBalanceApi();
  });

  describe('(package)', function() {
    describe('TokenBalanceApi', function() {
      describe('getTokenBalanceAllUsingGet', function() {
        it('should call getTokenBalanceAllUsingGet successfully', function(done) {
          // TODO: uncomment, update parameter values for getTokenBalanceAllUsingGet call and complete the assertions
          /*
          var opts = {};
          ...
          instance.getTokenBalanceAllUsingGet(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MoleculeApiDocumentation.PageTokenBalanceResponse);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MoleculeApiDocumentation.TokenBalanceResponse);
      ...
      describe('getTokenBalanceUsingGet', function() {
        it('should call getTokenBalanceUsingGet successfully', function(done) {
          // TODO: uncomment, update parameter values for getTokenBalanceUsingGet call and complete the assertions
          /*
          var tokenBalanceId = "tokenBalanceId_example";

          instance.getTokenBalanceUsingGet(tokenBalanceId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
