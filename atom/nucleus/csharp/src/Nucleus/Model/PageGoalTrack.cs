...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageGoalTrack :  IEquatable<PageGoalTrack>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageGoalTrack" /> class.
        /// </summary>
        ...
        public PageGoalTrack(List<GoalTrack> content = default(List<GoalTrack>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<GoalTrack> Content { get; set; }
        ...
        {
            return this.Equals(input as PageGoalTrack);
        }

        /// <summary>
        /// Returns true if PageGoalTrack instances are equal
        /// </summary>
        /// <param name="input">Instance of PageGoalTrack to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageGoalTrack input)
        {
            if (input == null)
                return false;
