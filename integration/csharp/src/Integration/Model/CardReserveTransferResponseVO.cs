...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardReserveTransferResponseVO :  IEquatable<CardReserveTransferResponseVO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardReserveTransferResponseVO" /> class.
        /// </summary>
        ...
        public CardReserveTransferResponseVO(double? amount = default(double?), string message = default(string), Guid? nucleusFundingId = default(Guid?), string vendorName = default(string), Object vendorResponse = default(Object))
        {
            this.Amount = amount;
        ...
        {
            return this.Equals(input as CardReserveTransferResponseVO);
        }

        /// <summary>
        /// Returns true if CardReserveTransferResponseVO instances are equal
        /// </summary>
        /// <param name="input">Instance of CardReserveTransferResponseVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardReserveTransferResponseVO input)
        {
            if (input == null)
                return false;
