...
(function(root, factory) {
  ...
  describe('AggregationAccountTransactionResponseInternalObjectVO', function() {
    it('should create an instance of AggregationAccountTransactionResponseInternalObjectVO', function() {
      // uncomment below and update the code to test AggregationAccountTransactionResponseInternalObjectVO
      //var instane = new HydrogenIntegrationApi.AggregationAccountTransactionResponseInternalObjectVO();
