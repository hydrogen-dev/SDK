...
${nuget_cmd} install src/Integration/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Integration.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Integration.dll \
-recurse:'src/Integration/*.cs' \
-doc:bin/Integration.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Integration.dll was created successfully"
fi
