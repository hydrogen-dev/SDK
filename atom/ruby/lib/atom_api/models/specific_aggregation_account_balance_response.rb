...
module AtomApi
  class SpecificAggregationAccountBalanceResponse
    ...
    def hash
      [id, aggregation_account_id, currency_code, balance, available_balance, balance_time_stamp, is_active, secondary_id, create_date, update_date].hash
    end
