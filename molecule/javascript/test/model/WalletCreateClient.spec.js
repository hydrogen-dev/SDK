...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new molecule_api.WalletCreateClient();
  });
  ...
  describe('WalletCreateClient', function() {
    it('should create an instance of WalletCreateClient', function() {
      // uncomment below and update the code to test WalletCreateClient
      //var instance = new molecule_api.WalletCreateClient();
      //expect(instance).to.be.a(molecule_api.WalletCreateClient);
    });
