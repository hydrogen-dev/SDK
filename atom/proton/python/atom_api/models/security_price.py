...
class SecurityPrice(object):
    ...
    def __init__(self, adjusted_price=None, create_date=None, currency_code=None, _date=None, id=None, price=None, secondary_id=None, security_id=None, update_date=None):  # noqa: E501
    ...
    def adjusted_price(self, adjusted_price):
        ...
        if adjusted_price is None:
            raise ValueError("Invalid value for `adjusted_price`, must not be `None`")  # noqa: E501
