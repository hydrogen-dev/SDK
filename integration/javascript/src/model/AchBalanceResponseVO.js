...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydrogenIntegrationApi.AchBalanceResponseVO = factory(root.HydrogenIntegrationApi.ApiClient);
  }
  ...
  /**
   * The AchBalanceResponseVO model module.
   * @module model/AchBalanceResponseVO
   * @version 1.3.0
   */

  /**
   * Constructs a new <code>AchBalanceResponseVO</code>.
   * @alias module:model/AchBalanceResponseVO
   * @class
   */
  ...
  /**
   * Constructs a <code>AchBalanceResponseVO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AchBalanceResponseVO} obj Optional instance to populate.
   * @return {module:model/AchBalanceResponseVO} The populated <code>AchBalanceResponseVO</code> instance.
   */
