...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class OptConfig :  IEquatable<OptConfig>, IValidatableObject
    {
        /// <summary>
        /// Defines SecTypes
        /// </summary>
        ...
        {
            return this.Equals(input as OptConfig);
        }

        /// <summary>
        /// Returns true if OptConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of OptConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptConfig input)
        {
            if (input == null)
                return false;
