...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PermissionVO :  IEquatable<PermissionVO>, IValidatableObject
    {
        /// <summary>
        /// permissionType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PermissionVO" /> class.
        /// </summary>
        /// <param name="clientId">clientId.</param>
        /// <param name="permissionType">permissionType.</param>
        public PermissionVO(Guid? clientId = default(Guid?), PermissionTypeEnum? permissionType = default(PermissionTypeEnum?))
        {
        ...
        {
            return this.Equals(input as PermissionVO);
        }

        /// <summary>
        /// Returns true if PermissionVO instances are equal
        /// </summary>
        /// <param name="input">Instance of PermissionVO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PermissionVO input)
        {
            if (input == null)
                return false;
