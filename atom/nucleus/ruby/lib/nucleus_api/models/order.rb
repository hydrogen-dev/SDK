...
module NucleusApi
  ...
  class Order
    ...
    def hash
      [account_id, create_date, date, id, is_read, metadata, model_id, order_bulk_id, order_ticket_id, order_type, portfolio_id, price, quantity, secondary_id, security_id, tmp_tracker_id, transaction_code_id, update_date].hash
    end
