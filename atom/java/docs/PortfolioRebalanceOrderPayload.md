...
# PortfolioRebalanceOrderPayload
...
**useCashAvailable** | **Boolean** | Indicates if only the cash in the cash portfolio should be used. Defaults to false which indicates it should not |  [optional]
