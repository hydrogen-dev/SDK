...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoleculeApiDocumentation.CurrencyBalanceApi();
  });

  describe('(package)', function() {
    describe('CurrencyBalanceApi', function() {
      describe('getCurrencyBalanceAllUsingGet', function() {
        it('should call getCurrencyBalanceAllUsingGet successfully', function(done) {
          // TODO: uncomment, update parameter values for getCurrencyBalanceAllUsingGet call and complete the assertions
          /*
          var opts = {};
          ...
          instance.getCurrencyBalanceAllUsingGet(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MoleculeApiDocumentation.PageCurrencyBalanceResponse);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MoleculeApiDocumentation.CurrencyBalanceResponse);
      ...
      describe('getCurrencyBalanceUsingGet', function() {
        it('should call getCurrencyBalanceUsingGet successfully', function(done) {
          // TODO: uncomment, update parameter values for getCurrencyBalanceUsingGet call and complete the assertions
          /*
          var currencyBalanceId = "currencyBalanceId_example";

          instance.getCurrencyBalanceUsingGet(currencyBalanceId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateCurrencyBalanceUsingPost', function() {
        it('should call updateCurrencyBalanceUsingPost successfully', function(done) {
          // TODO: uncomment, update parameter values for updateCurrencyBalanceUsingPost call and complete the assertions
          /*
          var currencyBalanceUpdateParams = new MoleculeApiDocumentation.CurrencyBalanceUpdateParams();
          currencyBalanceUpdateParams.walletId = """00000000-0000-0000-0000-000000000000";
          currencyBalanceUpdateParams.currencyId = """00000000-0000-0000-0000-000000000000";

          instance.updateCurrencyBalanceUsingPost(currencyBalanceUpdateParams, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
