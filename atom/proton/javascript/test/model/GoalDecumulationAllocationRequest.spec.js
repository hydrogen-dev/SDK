...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GoalDecumulationAllocationRequest', function() {
      beforeEach(function() {
        instance = new HydrogenProtonApi.GoalDecumulationAllocationRequest();
      });

      it('should create an instance of GoalDecumulationAllocationRequest', function() {
        // TODO: update the code to test GoalDecumulationAllocationRequest
        expect(instance).to.be.a(HydrogenProtonApi.GoalDecumulationAllocationRequest);
      });
