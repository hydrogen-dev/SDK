...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageScore :  IEquatable<PageScore>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageScore" /> class.
        /// </summary>
        ...
        public PageScore(List<Score> content = default(List<Score>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        public List<Score> Content { get; set; }
        ...
        {
            return this.Equals(input as PageScore);
        }

        /// <summary>
        /// Returns true if PageScore instances are equal
        /// </summary>
        /// <param name="input">Instance of PageScore to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageScore input)
        {
            if (input == null)
                return false;
