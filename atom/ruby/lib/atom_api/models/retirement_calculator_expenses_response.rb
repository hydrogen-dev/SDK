...
module AtomApi
  class RetirementCalculatorExpensesResponse
    # The after-tax retirement expenses available expressed in today’s dollars.
    attr_accessor :projected_retirement_expenses

    # The after-tax retirement expenses available, expressed in today's dollars.
    attr_accessor :projected_retirement_expenses_adjusted
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'projected_retirement_expenses')
        self.projected_retirement_expenses = attributes[:'projected_retirement_expenses']
      end

      if attributes.has_key?(:'projected_retirement_expenses_adjusted')
        self.projected_retirement_expenses_adjusted = attributes[:'projected_retirement_expenses_adjusted']
      end
    ...
    def list_invalid_properties
      ...
      if @projected_retirement_expenses.nil?
        invalid_properties.push('invalid value for "projected_retirement_expenses", projected_retirement_expenses cannot be nil.')
      end

      if @projected_retirement_expenses_adjusted.nil?
        invalid_properties.push('invalid value for "projected_retirement_expenses_adjusted", projected_retirement_expenses_adjusted cannot be nil.')
      end
    ...
    def valid?
      return false if @projected_retirement_expenses.nil?
      return false if @projected_retirement_expenses_adjusted.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          projected_retirement_expenses == o.projected_retirement_expenses &&
          projected_retirement_expenses_adjusted == o.projected_retirement_expenses_adjusted &&
    ...
    def hash
      [projected_retirement_expenses, projected_retirement_expenses_adjusted, projected_savings_at_retirement, total_earnings, total_contributions, total_withdrawals, total_taxes, return_details].hash
    end
