...
module AtomApi
  class SpecificQuestionnaireResponse
    ...
    def self.swagger_types
      {
        ...
        :'type' => :'String',
        :'questions' => :'Array<QuestionnairePayloadQuestions>',
    ...
    def hash
      [id, create_date, name, description, decision_tree_id, type, questions, secondary_id, update_date].hash
    end
