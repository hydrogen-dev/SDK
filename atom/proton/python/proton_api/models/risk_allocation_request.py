...
class RiskAllocationRequest(object):
    ...
    def __init__(self, allocations=None, use_proxy_data=False, client_id=None, risk_score=None, opt_config=None, market_data_source='nucleus', allocation_method=None):  # noqa: E501
    ...
    def allocation_method(self, allocation_method):
        ...
        if allocation_method is not None and allocation_method.lower() not in allowed_values:
            raise ValueError(
