...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new molecule_api.WalletPermissionUpdatePayload();
  });
  ...
  describe('WalletPermissionUpdatePayload', function() {
    it('should create an instance of WalletPermissionUpdatePayload', function() {
      // uncomment below and update the code to test WalletPermissionUpdatePayload
      //var instance = new molecule_api.WalletPermissionUpdatePayload();
      //expect(instance).to.be.a(molecule_api.WalletPermissionUpdatePayload);
    });
