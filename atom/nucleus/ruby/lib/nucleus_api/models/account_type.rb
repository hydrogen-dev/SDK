...
module NucleusApi
  ...
  class AccountType
    ...
    def hash
      [category, code, create_date, id, is_active, is_asset, is_business, is_cash, is_investment, is_taxable, metadata, name, secondary_id, short_name, subcategory, update_date].hash
    end
