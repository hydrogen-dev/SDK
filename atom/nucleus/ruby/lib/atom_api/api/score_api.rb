...
module AtomApi
  class ScoreApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Score]
    def create_score_using_post1(score_id, opts = {})
      data, _status_code, _headers = create_score_using_post1_with_http_info(score_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Score, Fixnum, Hash)>] Score data, response status code and response headers
    def create_score_using_post1_with_http_info(score_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScoreApi.create_score_using_post1 ...'
      end
      # verify the required parameter 'score_id' is set
      if @api_client.config.client_side_validation && score_id.nil?
        fail ArgumentError, "Missing the required parameter 'score_id' when calling ScoreApi.create_score_using_post1"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Score')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ScoreApi#create_score_using_post1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Delete a score
