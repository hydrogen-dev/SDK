...
module AtomApi
  class AnnuityCalculatorInitialBalance
    ...
    def hash
      [portfolio_return, accumulation_horizon, decumulation_horizon, annuity_amount, annuity_frequency_interval, inflation_rate, tax_rate, deposit_schedule].hash
    end
