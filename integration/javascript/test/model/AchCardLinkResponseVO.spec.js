...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.AchCardLinkResponseVO();
  });
  ...
  describe('AchCardLinkResponseVO', function() {
    it('should create an instance of AchCardLinkResponseVO', function() {
      // uncomment below and update the code to test AchCardLinkResponseVO
      //var instane = new HydrogenIntegrationApi.AchCardLinkResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.AchCardLinkResponseVO);
    });
