...
module AtomApi
  class SpecificClientResponse
    ...
    def hash
      [username, client_type, email, title, first_name, middle_name, last_name, phone_number, date_of_birth, identification_number, country_of_residence, income, is_verified, hydro_id, is_active, address, metadata, secondary_id, id, create_date, update_date].hash
    end
