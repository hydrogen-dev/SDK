...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OfferingSettingsCreatePayload', 'model/SecondaryId', 'model/TokenCreatePayload', 'model/TokenRestrictionsPayload'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OfferingSettingsCreatePayload'), require('./SecondaryId'), require('./TokenCreatePayload'), require('./TokenRestrictionsPayload'));
  } else {
    // Browser globals (root is window)
    if (!root.molecule_api) {
      root.molecule_api = {};
    }
    root.molecule_api.TokenCreateResponse = factory(root.molecule_api.ApiClient, root.molecule_api.OfferingSettingsCreatePayload, root.molecule_api.SecondaryId, root.molecule_api.TokenCreatePayload, root.molecule_api.TokenRestrictionsPayload);
  }
}(this, function(ApiClient, OfferingSettingsCreatePayload, SecondaryId, TokenCreatePayload, TokenRestrictionsPayload) {
  'use strict';
