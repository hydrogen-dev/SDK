...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GoalDepositConfig'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GoalDepositConfig'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.GoalAccumulationRecommendation = factory(root.atom_api.ApiClient, root.atom_api.GoalDepositConfig);
  }
}(this, function(ApiClient, GoalDepositConfig) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('goal_config')) {
        obj['goal_config'] = ApiClient.convertToType(data['goal_config'], Object);
      }
