...
module ProtonApi
  class FinancialStatementAnalysisRequest
    ...
    def hash
      [period_quarter, show_history, client_id, currency_conversion, accounting_method, period_length, period_type, period_year, end_date, currency_code, stat_names, start_date, statement_type, history_frequency_interval, period_month].hash
    end
