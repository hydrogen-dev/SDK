...
class KmsConfig(object):
    ...
    def __init__(self, aws_key_id=None, create_date=None, id=None, key_name=None, key_value=None, nucleus_client_id=None, product=None, secondary_id=None, update_date=None, vendor_id=None, vendor_name=None, wallet_id=None, _configuration=None):  # noqa: E501
    ...
    def nucleus_client_id(self, nucleus_client_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and nucleus_client_id is None:
