...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.atom_api.RetirementCalculatorPercentCovered = factory(root.atom_api.ApiClient, root.atom_api.DepositSchedule);
  }
  ...
  /**
   * The RetirementCalculatorPercentCovered model module.
   * @module model/RetirementCalculatorPercentCovered
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>RetirementCalculatorPercentCovered</code>.
   * @alias module:model/RetirementCalculatorPercentCovered
   * @class
  ...
  /**
   * Constructs a <code>RetirementCalculatorPercentCovered</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RetirementCalculatorPercentCovered} obj Optional instance to populate.
   * @return {module:model/RetirementCalculatorPercentCovered} The populated <code>RetirementCalculatorPercentCovered</code> instance.
   */
