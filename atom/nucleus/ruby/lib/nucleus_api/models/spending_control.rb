...
module NucleusApi
  ...
  class SpendingControl
    ...
    def hash
      [client_id, control_scope, control_type, control_values, create_date, currency_code, description, frequency, frequency_unit, id, is_active, limit_value, secondary_id, update_date].hash
    end
