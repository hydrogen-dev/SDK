...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.PageWebhook();
  });
  ...
  describe('PageWebhook', function() {
    it('should create an instance of PageWebhook', function() {
      ...
      //var instane = new HydrogenIntegrationApi.PageWebhook();
      //expect(instance).to.be.a(HydrogenIntegrationApi.PageWebhook);
    });
