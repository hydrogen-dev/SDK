...
class CardProgram(object):
    ...
    def __init__(self, card_issuer=None, card_network=None, card_processor=None, card_type=None, client_id=None, code=None, create_date=None, description=None, id=None, issuing_bank=None, metadata=None, name=None, secondary_id=None, update_date=None):  # noqa: E501
