...
module AtomApi
  class AccountApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_account_type_using_delete(account_type_id, account_type_id2, opts = {})
      delete_account_type_using_delete_with_http_info(account_type_id, account_type_id2, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def delete_account_type_using_delete_with_http_info(account_type_id, account_type_id2, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && account_type_id2.nil?
        fail ArgumentError, "Missing the required parameter 'account_type_id2' when calling AccountApi.delete_account_type_using_delete"
      end
      # resource path
      local_var_path = '/account_type/{account_type_id}'.sub('{' + 'accountTypeId' + '}', account_type_id.to_s).sub('{' + 'account_type_id' + '}', account_type_id2.to_s)
    ...
    # @option opts [BOOLEAN] :ascending ascending
    # @option opts [String] :order_by order_by
    # @return [Array<(AccountOverviewVO, Fixnum, Hash)>] AccountOverviewVO data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @return [AccountType]
    def get_account_type_using_get(account_type_id, account_type_id2, opts = {})
      data, _status_code, _headers = get_account_type_using_get_with_http_info(account_type_id, account_type_id2, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountType, Fixnum, Hash)>] AccountType data, response status code and response headers
    def get_account_type_using_get_with_http_info(account_type_id, account_type_id2, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'account_type_id2' is set
      if @api_client.config.client_side_validation && account_type_id2.nil?
        fail ArgumentError, "Missing the required parameter 'account_type_id2' when calling AccountApi.get_account_type_using_get"
      end
      # resource path
      local_var_path = '/account_type/{account_type_id}'.sub('{' + 'accountTypeId' + '}', account_type_id.to_s).sub('{' + 'account_type_id' + '}', account_type_id2.to_s)
