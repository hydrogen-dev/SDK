...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Node', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Node'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.HydrogenNucleusApi) {
      root.HydrogenNucleusApi = {};
    }
    root.HydrogenNucleusApi.PageNode = factory(root.HydrogenNucleusApi.ApiClient, root.HydrogenNucleusApi.Node, root.HydrogenNucleusApi.Sort);
  }
}(this, function(ApiClient, Node, Sort) {
  'use strict';
  ...
  /**
   * The PageNode model module.
   * @module model/PageNode
   * @version 1.7.0
   */

  /**
   * Constructs a new <code>PageNode</code>.
   * Page Object
   * @alias module:model/PageNode
   * @class
   */
  ...
  /**
   * Constructs a <code>PageNode</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageNode} obj Optional instance to populate.
   * @return {module:model/PageNode} The populated <code>PageNode</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Node]);
      }
  ...
  /**
   * @member {Array.<module:model/Node>} content
   */
