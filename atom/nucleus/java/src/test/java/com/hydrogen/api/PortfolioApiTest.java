...
public class PortfolioApiTest {
    ...
    public void getPortfolioAggregatedDataUsingGetTest() throws ApiException {
        ...
        PortfolioAggregatedVO response = api.getPortfolioAggregatedDataUsingGet(portfolioId, showAssetClass, showCategory, showIndustry, showSector, showSecurityClass);
    ...
    public void getPortfolioAssetSizeAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PagePortfolioAssetSizeLog response = api.getPortfolioAssetSizeAllUsingGet(ascending, filter, orderBy, page, size);
    ...
    public void getPortfolioAssetSizeUsingGetTest() throws ApiException {
        UUID portfolioAssetSizeId = null;
        PortfolioAssetSize response = api.getPortfolioAssetSizeUsingGet(portfolioAssetSizeId);
    ...
    public void getPortfolioHoldingAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PortfolioHolding response = api.getPortfolioHoldingAllUsingGet(ascending, filter, orderBy, page, size);
    ...
    public void getPortfolioHoldingUsingGetTest() throws ApiException {
        UUID portfolioHoldingId = null;
        PortfolioHolding response = api.getPortfolioHoldingUsingGet(portfolioHoldingId);
    ...
    public void getPortfolioTransactionAllUsingGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        PagePortfolioTransaction response = api.getPortfolioTransactionAllUsingGet(ascending, filter, orderBy, page, size);
    ...
    public void getPortfolioTransactionUsingGetTest() throws ApiException {
        UUID portfolioTransactionId = null;
        PortfolioTransaction response = api.getPortfolioTransactionUsingGet(portfolioTransactionId);
    ...
    public void updatePortfolioAssetSizeUsingPutTest() throws ApiException {
        ...
        UUID portfolioAssetSizeId = null;
        PortfolioAssetSize response = api.updatePortfolioAssetSizeUsingPut(portfolioAssetSize, portfolioAssetSizeId);
    ...
    public void updatePortfolioHoldingUsingPutTest() throws ApiException {
        ...
        UUID portfolioHoldingId = null;
        PortfolioHolding response = api.updatePortfolioHoldingUsingPut(portfolioHolding, portfolioHoldingId);
