...
class LifeInsuranceNeedsCalculatorRequest(object):
    ...
    def __init__(self, margin_of_error=0.0, end_of_life_expenses=None, interest_rate=None, existing_life_insurance=None, tax_rate=0.0, education_inflation_rate=0.0, liquid_assets=None, other_debt=None, client_id=None, mortgage_balance=None, benefit_amount_rounding=0, income_config=None, beneficiary_bequest_config=None, general_inflation_rate=0.0, children_education_config=None):  # noqa: E501
