...
# Unit tests for IntegrationApi::CreateOrderResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateOrderResponse' do
  before do
    # run before each test
    @instance = IntegrationApi::CreateOrderResponse.new
  end
  ...
  describe 'test an instance of CreateOrderResponse' do
    it 'should create an instance of CreateOrderResponse' do
      expect(@instance).to be_instance_of(IntegrationApi::CreateOrderResponse)
    end
  end
