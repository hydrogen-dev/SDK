...
public class SpecificOrderResponse {
  ...
  public SpecificOrderResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public SpecificOrderResponse createDate(String createDate) {
  ...
  **/
  ...
  public SpecificOrderResponse transactionCodeId(UUID transactionCodeId) {
  ...
  **/
  ...
  public SpecificOrderResponse quantity(Double quantity) {
  ...
  **/
  ...
  public SpecificOrderResponse securityId(UUID securityId) {
  ...
  **/
  ...
  public SpecificOrderResponse date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  **/
  ...
  public SpecificOrderResponse price(Double price) {
    this.price = price;
    return this;
  }
  ...
  **/
  ...
  public SpecificOrderResponse orderBulkId(UUID orderBulkId) {
  ...
  **/
  ...
  public SpecificOrderResponse isRead(Boolean isRead) {
    this.isRead = isRead;
    return this;
  }
  ...
  **/
  ...
  public SpecificOrderResponse orderType(String orderType) {
  ...
  **/
  ...
  public SpecificOrderResponse orderTicketId(UUID orderTicketId) {
  ...
  **/
  ...
  public SpecificOrderResponse portfolioId(UUID portfolioId) {
  ...
  **/
  ...
  public SpecificOrderResponse accountId(UUID accountId) {
  ...
  **/
  ...
  public SpecificOrderResponse modelId(UUID modelId) {
  ...
  **/
  ...
  public SpecificOrderResponse metadata(Object metadata) {
  ...
  **/
  ...
  public SpecificOrderResponse updateDate(String updateDate) {
   ...
   * @return updateDate
  **/
  @ApiModelProperty(value = "Datetime the order record was last updated")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SpecificOrderResponse specificOrderResponse = (SpecificOrderResponse) o;
    return Objects.equals(this.id, specificOrderResponse.id) &&
        Objects.equals(this.createDate, specificOrderResponse.createDate) &&
        Objects.equals(this.transactionCodeId, specificOrderResponse.transactionCodeId) &&
        Objects.equals(this.quantity, specificOrderResponse.quantity) &&
        Objects.equals(this.securityId, specificOrderResponse.securityId) &&
        Objects.equals(this.date, specificOrderResponse.date) &&
        Objects.equals(this.price, specificOrderResponse.price) &&
        Objects.equals(this.orderBulkId, specificOrderResponse.orderBulkId) &&
        Objects.equals(this.isRead, specificOrderResponse.isRead) &&
        Objects.equals(this.orderType, specificOrderResponse.orderType) &&
        Objects.equals(this.orderTicketId, specificOrderResponse.orderTicketId) &&
        Objects.equals(this.portfolioId, specificOrderResponse.portfolioId) &&
        Objects.equals(this.accountId, specificOrderResponse.accountId) &&
        Objects.equals(this.modelId, specificOrderResponse.modelId) &&
        Objects.equals(this.metadata, specificOrderResponse.metadata) &&
        Objects.equals(this.updateDate, specificOrderResponse.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createDate, transactionCodeId, quantity, securityId, date, price, orderBulkId, isRead, orderType, orderTicketId, portfolioId, accountId, modelId, metadata, updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class SpecificOrderResponse {\n");
