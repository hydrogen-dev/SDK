...
public class SpecificBankLinkResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createDate, accountId, bankAccountHolder, bankAccountNumber, name, routing, routingWire, bankAccountName, currencyCode, balance, availableBalance, type, isActive, isLinkVerified, linkVerifiedDate, metadata, secondaryId, updateDate);
  }
