...
module NucleusApi
  ...
  class Stage
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_client')
      ...
      if attributes.has_key?(:'is_converted')
        self.is_converted = attributes[:'is_converted']
      end
    ...
    def hash
      [application_id, category, create_date, description, id, is_account, is_active, is_business, is_client, is_closed, is_converted, is_verified, metadata, name, order_index, secondary_id, update_date].hash
    end
