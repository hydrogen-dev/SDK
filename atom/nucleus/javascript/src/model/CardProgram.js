...
(function(root, factory) {
   ...
   */
  var exports = function(cardNetwork, cardType, issuingBank, name) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_delegated_authority')) {
        obj['is_delegated_authority'] = ApiClient.convertToType(data['is_delegated_authority'], 'Boolean');
      }
      ...
      if (data.hasOwnProperty('program_manager')) {
        obj['program_manager'] = ApiClient.convertToType(data['program_manager'], 'String');
      }
   ...
   * @member {Boolean} is_delegated_authority
   */
  exports.prototype['is_delegated_authority'] = undefined;
  /**
   * issuingBank
  ...
  /**
   * programManager
   * @member {String} program_manager
   */
  exports.prototype['program_manager'] = undefined;
  /**
