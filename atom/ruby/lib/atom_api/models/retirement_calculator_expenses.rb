...
module AtomApi
  class RetirementCalculatorExpenses
    ...
    def hash
      [current_age, death_age, portfolio_return, retirement_age, percent_of_expenses_covered, retirement_savings, retirement_income, deposit_schedule, inflation_rate, retirement_tax].hash
    end
