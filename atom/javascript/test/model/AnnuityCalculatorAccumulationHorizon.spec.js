...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.AnnuityCalculatorAccumulationHorizon();
  });
  ...
  describe('AnnuityCalculatorAccumulationHorizon', function() {
    it('should create an instance of AnnuityCalculatorAccumulationHorizon', function() {
      // uncomment below and update the code to test AnnuityCalculatorAccumulationHorizon
      //var instance = new atom_api.AnnuityCalculatorAccumulationHorizon();
      //expect(instance).to.be.a(atom_api.AnnuityCalculatorAccumulationHorizon);
    });
