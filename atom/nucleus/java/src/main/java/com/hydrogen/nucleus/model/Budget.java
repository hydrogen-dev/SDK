...
public class Budget {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, aggregationAccounts, budget, clientId, createDate, currencyCode, endDate, frequency, frequencyUnit, goalId, id, isActive, metadata, name, secondaryId, startDate, updateDate);
  }
