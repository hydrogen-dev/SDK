...
namespace Nucleus.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageMXMerchantRes :  IEquatable<PageMXMerchantRes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageMXMerchantRes" /> class.
        /// </summary>
        ...
        public List<MXMerchantRes> Content { get; set; }
        ...
        {
            return this.Equals(input as PageMXMerchantRes);
        }

        /// <summary>
        /// Returns true if PageMXMerchantRes instances are equal
        /// </summary>
        /// <param name="input">Instance of PageMXMerchantRes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageMXMerchantRes input)
        {
            if (input == null)
                return false;
