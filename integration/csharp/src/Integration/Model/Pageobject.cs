...
namespace Integration.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class Pageobject :  IEquatable<Pageobject>, IValidatableObject
    {
        /// <summary>
        ...
        public Pageobject(List<Object> content = default(List<Object>), bool? first = default(bool?), bool? last = default(bool?), int? number = default(int?), int? numberOfElements = default(int?), int? size = default(int?), List<Sort> sort = default(List<Sort>), long? totalElements = default(long?), int? totalPages = default(int?))
        {
        ...
        {
            return this.Equals(input as Pageobject);
        }

        /// <summary>
        /// Returns true if Pageobject instances are equal
        /// </summary>
        /// <param name="input">Instance of Pageobject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Pageobject input)
        {
            if (input == null)
                return false;
