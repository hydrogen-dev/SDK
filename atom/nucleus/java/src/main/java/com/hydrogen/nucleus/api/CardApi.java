...
public class CardApi {
    ...
    public com.squareup.okhttp.Call getCardAssetSizeAggAllUsingGetCall(UUID cardId, String currencyConversion, LocalDate endDate, Boolean getLatest, String sortType, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/card/{card_id}/asset_size"
            .replaceAll("\\{" + "card_id" + "\\}", apiClient.escapeString(cardId.toString()));
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getCardTransactionAggAllUsingGetCall(UUID cardId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/card/{card_id}/transaction"
            .replaceAll("\\{" + "card_id" + "\\}", apiClient.escapeString(cardId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getCardTransactionAggAllUsingGetValidateBeforeCall(UUID cardId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCardTransactionAggAllUsingGetCall(cardId, ascending, currencyConversion, endDate, orderBy, page, size, startDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PagePortfolioTransaction getCardTransactionAggAllUsingGet(UUID cardId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate) throws ApiException {
        ApiResponse<PagePortfolioTransaction> resp = getCardTransactionAggAllUsingGetWithHttpInfo(cardId, ascending, currencyConversion, endDate, orderBy, page, size, startDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PagePortfolioTransaction> getCardTransactionAggAllUsingGetWithHttpInfo(UUID cardId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate) throws ApiException {
        com.squareup.okhttp.Call call = getCardTransactionAggAllUsingGetValidateBeforeCall(cardId, ascending, currencyConversion, endDate, orderBy, page, size, startDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCardTransactionAggAllUsingGetAsync(UUID cardId, Boolean ascending, String currencyConversion, LocalDate endDate, String orderBy, Integer page, Integer size, LocalDate startDate, final ApiCallback<PagePortfolioTransaction> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCardTransactionAggAllUsingGetValidateBeforeCall(cardId, ascending, currencyConversion, endDate, orderBy, page, size, startDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PagePortfolioTransaction>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
