...
class KYCApi
{
     ...
     * @return \com\hydrogen\integration\Model\KycResponseVo[]
     */
    public function getKYCStatusUsingGet($get_latest = 'false', $kyc_type = 'all', $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {
        list($response) = $this->getKYCStatusUsingGetWithHttpInfo($get_latest, $kyc_type, $nucleus_business_id, $nucleus_client_id, $product);
        return $response;
    }
     ...
     * @return array of \com\hydrogen\integration\Model\KycResponseVo[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getKYCStatusUsingGetWithHttpInfo($get_latest = 'false', $kyc_type = 'all', $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {
        $returnType = '\com\hydrogen\integration\Model\KycResponseVo[]';
        $request = $this->getKYCStatusUsingGetRequest($get_latest, $kyc_type, $nucleus_business_id, $nucleus_client_id, $product);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getKYCStatusUsingGetAsync($get_latest = 'false', $kyc_type = 'all', $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {
        return $this->getKYCStatusUsingGetAsyncWithHttpInfo($get_latest, $kyc_type, $nucleus_business_id, $nucleus_client_id, $product)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getKYCStatusUsingGetAsyncWithHttpInfo($get_latest = 'false', $kyc_type = 'all', $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {
        $returnType = '\com\hydrogen\integration\Model\KycResponseVo[]';
        $request = $this->getKYCStatusUsingGetRequest($get_latest, $kyc_type, $nucleus_business_id, $nucleus_client_id, $product);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getKYCStatusUsingGetRequest($get_latest = 'false', $kyc_type = 'all', $nucleus_business_id = null, $nucleus_client_id = null, $product = 'atom')
    {

        $resourcePath = '/kyc_status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
