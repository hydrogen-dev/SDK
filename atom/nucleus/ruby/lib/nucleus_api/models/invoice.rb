...
module NucleusApi
  ...
  class Invoice
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'payment_details')
    ...
    def list_invalid_properties
      ...
      if @invoice_name.nil?
        invalid_properties.push('invalid value for "invoice_name", invoice_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @invoice_name.nil?
    ...
    def hash
      [client_id, create_date, currency_code, customer_id, description, division, document_id, due_date, id, invoice_amount, invoice_date, invoice_name, invoice_number, is_active, metadata, payment_details, secondary_id, status, update_date].hash
    end
