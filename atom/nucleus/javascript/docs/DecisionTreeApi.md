...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **decisionTreeId** | [**String**](.md)| UUID decision_tree_id | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **nodeRelationshipId** | [**String**](.md)| UUID node_relationship_id | 
...
var decisionTree = null; // Object | decision_tree
...
var jsonNode = null; // Object | jsonNode
