...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageOrderStatus();
  });
  ...
  describe('PageOrderStatus', function() {
    it('should create an instance of PageOrderStatus', function() {
      // uncomment below and update the code to test PageOrderStatus
      //var instane = new HydrogenNucleusApi.PageOrderStatus();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageOrderStatus);
    });
