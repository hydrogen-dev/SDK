...
(function(root, factory) {
   ...
   * @class
   * @implements module:model/EducationCalculatorDepositScheduleNoDepAmt
   */
  var exports = function() {
    var _this = this;

    EducationCalculatorDepositScheduleNoDepAmt.call(_this);
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      EducationCalculatorDepositScheduleNoDepAmt.constructFromObject(data, obj);
  ...
  // Implement EducationCalculatorDepositScheduleNoDepAmt interface:
  /**
