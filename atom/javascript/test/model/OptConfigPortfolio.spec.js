...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.OptConfigPortfolio();
  });
  ...
  describe('OptConfigPortfolio', function() {
    it('should create an instance of OptConfigPortfolio', function() {
      // uncomment below and update the code to test OptConfigPortfolio
      //var instance = new atom_api.OptConfigPortfolio();
      //expect(instance).to.be.a(atom_api.OptConfigPortfolio);
    });
    ...
    it('should have the property tgtType (base name: "tgt_type")', function() {
      // uncomment below and update the code to test the property tgtType
      //var instance = new atom_api.OptConfigPortfolio();
      //expect(instance).to.be();
    });

    it('should have the property tgtVal (base name: "tgt_val")', function() {
      // uncomment below and update the code to test the property tgtVal
      //var instance = new atom_api.OptConfigPortfolio();
      //expect(instance).to.be();
    });
