...
module MoleculeApi
  class TokenUpdatePayload
    ...
    def hash
      [symbol, name, nucleus_model_id, owner_wallet_id, total_supply, circulating_supply, conract_address, crowdsale_address, restrictions, offering_settings, metadata, secondary_id].hash
    end
