...
class FeatureTrack(object):
    ...
    def __init__(self, client_id=None, create_date=None, feature_id=None, id=None, metadata=None, secondary_id=None, update_date=None, _configuration=None):  # noqa: E501
    ...
    def feature_id(self, feature_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and feature_id is None:
