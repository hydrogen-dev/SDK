...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenIntegrationApi.WireTransferResponseVO();
  });
  ...
  describe('WireTransferResponseVO', function() {
    it('should create an instance of WireTransferResponseVO', function() {
      // uncomment below and update the code to test WireTransferResponseVO
      //var instane = new HydrogenIntegrationApi.WireTransferResponseVO();
      //expect(instance).to.be.a(HydrogenIntegrationApi.WireTransferResponseVO);
    });
