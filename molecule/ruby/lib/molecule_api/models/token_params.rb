...
module MoleculeApi
  class TokenParams
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contract_address')
    ...
    def list_invalid_properties
      ...
      if @offering_settings.nil?
        invalid_properties.push('invalid value for "offering_settings", offering_settings cannot be nil.')
      end
