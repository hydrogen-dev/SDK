...
# Unit tests for ProtonApi::EventStudyRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventStudyRequest' do
  before do
    # run before each test
    @instance = ProtonApi::EventStudyRequest.new
  end
  ...
  describe 'test an instance of EventStudyRequest' do
    it 'should create an instance of EventStudyRequest' do
      expect(@instance).to be_instance_of(ProtonApi::EventStudyRequest)
    end
  end
