...
module AtomApi
  class RetirementCalculatorPercentCovered
    ...
    def hash
      [current_age, death_age, retirement_expenses, portfolio_return, retirement_age, retirement_savings, retirement_income, deposit_schedule, inflation_rate, retirement_tax].hash
    end
