...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.BulkOrderClientPayload();
  });
  ...
  describe('BulkOrderClientPayload', function() {
    it('should create an instance of BulkOrderClientPayload', function() {
      // uncomment below and update the code to test BulkOrderClientPayload
      //var instance = new atom_api.BulkOrderClientPayload();
      //expect(instance).to.be.a(atom_api.BulkOrderClientPayload);
    });
