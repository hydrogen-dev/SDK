...
module AtomApi
  class SpecificConsultationResponse
    ...
    def hash
      [id, create_date, account_type_id, additional_questions, assets, assigned, calendar, category, comments, client_id, time, close_time, closed_by, completed, name, email, firmname, phone, investment_allocation, investment_location, investment_objectives, is_active, reminded, source, secondary_id, update_date].hash
    end
