...
class AccountApi
{
    ...
    protected function deleteAccountStatusUsingDeleteRequest($account_status_id)
    {
        ...
        $resourcePath = '/account_status/{account_status_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getPortfolioHoldingAggAllUsingGet($account_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        list($response) = $this->getPortfolioHoldingAggAllUsingGetWithHttpInfo($account_id, $currency_conversion, $end_date, $get_latest, $start_date);
        return $response;
    }
     ...
     */
    public function getPortfolioHoldingAggAllUsingGetWithHttpInfo($account_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PortfolioHoldingAgg[]';
        $request = $this->getPortfolioHoldingAggAllUsingGetRequest($account_id, $currency_conversion, $end_date, $get_latest, $start_date);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioHoldingAggAllUsingGetAsync($account_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        return $this->getPortfolioHoldingAggAllUsingGetAsyncWithHttpInfo($account_id, $currency_conversion, $end_date, $get_latest, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioHoldingAggAllUsingGetAsyncWithHttpInfo($account_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PortfolioHoldingAgg[]';
        $request = $this->getPortfolioHoldingAggAllUsingGetRequest($account_id, $currency_conversion, $end_date, $get_latest, $start_date);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioHoldingAggAllUsingGetRequest($account_id, $currency_conversion = null, $end_date = null, $get_latest = null, $start_date = null)
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getPortfolioTransactionAggAllUsingGet($account_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        list($response) = $this->getPortfolioTransactionAggAllUsingGetWithHttpInfo($account_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date);
        return $response;
    }
     ...
     */
    public function getPortfolioTransactionAggAllUsingGetWithHttpInfo($account_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PagePortfolioTransaction_';
        $request = $this->getPortfolioTransactionAggAllUsingGetRequest($account_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioTransactionAggAllUsingGetAsync($account_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        return $this->getPortfolioTransactionAggAllUsingGetAsyncWithHttpInfo($account_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPortfolioTransactionAggAllUsingGetAsyncWithHttpInfo($account_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        $returnType = '\com\hydrogen\nucleus\Model\PagePortfolioTransaction_';
        $request = $this->getPortfolioTransactionAggAllUsingGetRequest($account_id, $ascending, $currency_conversion, $end_date, $order_by, $page, $size, $start_date);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPortfolioTransactionAggAllUsingGetRequest($account_id, $ascending = 'false', $currency_conversion = null, $end_date = null, $order_by = 'update_date', $page = '0', $size = '25', $start_date = null)
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
