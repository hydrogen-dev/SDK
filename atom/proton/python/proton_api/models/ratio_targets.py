...
class RatioTargets(object):
    ...
    def __init__(self, liquidity_ratio_expenses=2.5, asset_allocation_ratio=1.5, liquidity_ratio_liabilities=0.1, current_ratio=0.5, savings_ratio_net=0.1, savings_ratio_gross=0.1):  # noqa: E501
