...
module NucleusApi
  ...
  class CardBalanceVO
    ...
    # balanceTimestamp
    attr_accessor :balance_timestamp
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'balance_timestamp')
        self.balance_timestamp = attributes[:'balance_timestamp']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          balance_timestamp == o.balance_timestamp &&
    ...
    def hash
      [balance, balance_available, balance_timestamp, currency_code].hash
    end
