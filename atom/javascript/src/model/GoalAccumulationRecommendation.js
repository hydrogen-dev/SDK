...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GoalConfig', 'model/GoalDepositConfig', 'model/GoalRecommendationConfigRec'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GoalConfig'), require('./GoalDepositConfig'), require('./GoalRecommendationConfigRec'));
  } else {
    // Browser globals (root is window)
    if (!root.atom_api) {
      root.atom_api = {};
    }
    root.atom_api.GoalAccumulationRecommendation = factory(root.atom_api.ApiClient, root.atom_api.GoalConfig, root.atom_api.GoalDepositConfig, root.atom_api.GoalRecommendationConfigRec);
  }
}(this, function(ApiClient, GoalConfig, GoalDepositConfig, GoalRecommendationConfigRec) {
  'use strict';
  ...
  /**
   * The GoalAccumulationRecommendation model module.
   * @module model/GoalAccumulationRecommendation
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GoalAccumulationRecommendation</code>.
   * @alias module:model/GoalAccumulationRecommendation
   * @class
   ...
   * @param horizonFrequency {module:model/GoalAccumulationRecommendation.HorizonFrequencyEnum} Frequency in relation to the horizon
  ...
  /**
   * Constructs a <code>GoalAccumulationRecommendation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GoalAccumulationRecommendation} obj Optional instance to populate.
   * @return {module:model/GoalAccumulationRecommendation} The populated <code>GoalAccumulationRecommendation</code> instance.
   */
   ...
   * @member {module:model/GoalAccumulationRecommendation.HorizonFrequencyEnum} horizon_frequency
   */
   ...
   * @member {module:model/GoalAccumulationRecommendation.RecommendTypeEnum} recommend_type
   * @default 'horizon'
   */
   ...
   * @member {module:model/GoalAccumulationRecommendation.ThreshTypeEnum} thresh_type
   * @default 'perc'
   */
