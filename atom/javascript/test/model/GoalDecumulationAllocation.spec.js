...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new atom_api.GoalDecumulationAllocation();
  });
  ...
  describe('GoalDecumulationAllocation', function() {
    it('should create an instance of GoalDecumulationAllocation', function() {
      // uncomment below and update the code to test GoalDecumulationAllocation
      //var instance = new atom_api.GoalDecumulationAllocation();
      //expect(instance).to.be.a(atom_api.GoalDecumulationAllocation);
    });
    ...
    it('should have the property allocationPriority (base name: "allocation_priority")', function() {
      // uncomment below and update the code to test the property allocationPriority
      //var instance = new atom_api.GoalDecumulationAllocation();
      //expect(instance).to.be();
    });
