...
class RetirementCalculatorExpensesRequest(object):
    ...
    def __init__(self, inflation_rate=0.0, current_age=None, deposit_schedule=None, portfolio_return=None, retirement_income=0.0, aggregation_account_ids=None, percent_of_expenses_covered=1.0, retirement_tax=0.0, account_ids=None, retirement_age=65, death_age=None, retirement_savings=0.0):  # noqa: E501
