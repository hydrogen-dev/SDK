...
namespace Proton.ModelEntity
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalDecumulationRecommendationRequest :  IEquatable<GoalDecumulationRecommendationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoalDecumulationRecommendationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GoalDecumulationRecommendationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GoalDecumulationRecommendationRequest" /> class.
        /// </summary>
        ...
        public GoalDecumulationRecommendationRequest(RecommendationConfig1 recommendationConfig = default(RecommendationConfig1), float? compoundingRate = 0.0F, RecommendTypeEnum? recommendType = RecommendTypeEnum.Horizon, bool? createLog = false, int? n = 1000, int? aHorizon = default(int?), List<float?> pRisk = default(List<float?>), bool? removeOutliers = true, bool? adjustForCompounding = false, Guid? goalId = default(Guid?), float? confTgt = 0.9F, int? tradingDaysPerYear = 252, decimal? thresh = default(decimal?), float? withdrawalTax = 0.0F, int? dHorizon = default(int?), Guid? clientId = default(Guid?), ThreshTypeEnum? threshType = ThreshTypeEnum.Perc, HorizonFrequencyEnum? horizonFrequency = HorizonFrequencyEnum.Year, List<GoalWithdrawalConfig> withdrawalConfig = default(List<GoalWithdrawalConfig>), decimal? currInv = default(decimal?), List<DecumulationGoalDepositConfig> depositConfig = default(List<DecumulationGoalDepositConfig>), List<float?> pRet = default(List<float?>))
        {
            // to ensure "pRisk" is required (not null)
            if (pRisk == null)
            {
                throw new InvalidDataException("pRisk is a required property for GoalDecumulationRecommendationRequest and cannot be null");
            }
            else
            {
                this.PRisk = pRisk;
            ...
            if (pRet == null)
            {
                throw new InvalidDataException("pRet is a required property for GoalDecumulationRecommendationRequest and cannot be null");
            }
            else
            {
                this.PRet = pRet;
        ...
        public RecommendationConfig1 RecommendationConfig { get; set; }
        ...
        {
            return this.Equals(input as GoalDecumulationRecommendationRequest);
        }

        /// <summary>
        /// Returns true if GoalDecumulationRecommendationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalDecumulationRecommendationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalDecumulationRecommendationRequest input)
        {
            if (input == null)
                return false;
