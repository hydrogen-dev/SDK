...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrogenNucleusApi.PageFeature();
  });
  ...
  describe('PageFeature', function() {
    it('should create an instance of PageFeature', function() {
      // uncomment below and update the code to test PageFeature
      //var instane = new HydrogenNucleusApi.PageFeature();
      //expect(instance).to.be.a(HydrogenNucleusApi.PageFeature);
    });
