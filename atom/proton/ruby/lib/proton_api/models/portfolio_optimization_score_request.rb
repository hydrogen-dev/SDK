...
module ProtonApi
  class PortfolioOptimizationScoreRequest
    ...
    def hash
      [opt_config, tgt_type, portfolio_tickers, create_log, aggregation_account_id, allocation_id, model_id, portfolio_weights, end_date, start_date, use_proxy_data, account_id, market_data_source, portfolio_id].hash
    end
