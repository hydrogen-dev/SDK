...
public class SpecificBudgetResponse {
  @SerializedName("id")
  ...
  public SpecificBudgetResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public SpecificBudgetResponse createDate(String createDate) {
  ...
  **/
  ...
  public SpecificBudgetResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public SpecificBudgetResponse clientId(UUID clientId) {
  ...
  **/
  ...
  public SpecificBudgetResponse currencyCode(String currencyCode) {
  ...
  **/
  ...
  public SpecificBudgetResponse budget(List<BudgetPayloadBudget> budget) {
    this.budget = budget;
    return this;
  }

  public SpecificBudgetResponse addBudgetItem(BudgetPayloadBudget budgetItem) {
  ...
  **/
  ...
  public SpecificBudgetResponse frequencyUnit(FrequencyUnitEnum frequencyUnit) {
  ...
  **/
  ...
  public SpecificBudgetResponse frequency(BigDecimal frequency) {
  ...
  **/
  ...
  public SpecificBudgetResponse accountId(UUID accountId) {
  ...
  **/
  ...
  public SpecificBudgetResponse goalId(UUID goalId) {
    this.goalId = goalId;
    return this;
  }
  ...
  **/
  ...
  public SpecificBudgetResponse aggregationAccounts(List<BudgetPayloadAggregationAccounts> aggregationAccounts) {
    this.aggregationAccounts = aggregationAccounts;
    return this;
  }

  public SpecificBudgetResponse addAggregationAccountsItem(BudgetPayloadAggregationAccounts aggregationAccountsItem) {
  ...
  **/
  ...
  public SpecificBudgetResponse startDate(LocalDate startDate) {
  ...
  **/
  ...
  public SpecificBudgetResponse endDate(LocalDate endDate) {
  ...
  **/
  ...
  public SpecificBudgetResponse metadata(Object metadata) {
  ...
  **/
  ...
  public SpecificBudgetResponse secondaryId(String secondaryId) {
  ...
  **/
  ...
  public SpecificBudgetResponse updateDate(String updateDate) {
   ...
   * @return updateDate
  **/
  @ApiModelProperty(value = "Datetime the budget was last updated")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SpecificBudgetResponse specificBudgetResponse = (SpecificBudgetResponse) o;
    return Objects.equals(this.id, specificBudgetResponse.id) &&
        Objects.equals(this.createDate, specificBudgetResponse.createDate) &&
        Objects.equals(this.name, specificBudgetResponse.name) &&
        Objects.equals(this.clientId, specificBudgetResponse.clientId) &&
        Objects.equals(this.currencyCode, specificBudgetResponse.currencyCode) &&
        Objects.equals(this.budget, specificBudgetResponse.budget) &&
        Objects.equals(this.frequencyUnit, specificBudgetResponse.frequencyUnit) &&
        Objects.equals(this.frequency, specificBudgetResponse.frequency) &&
        Objects.equals(this.accountId, specificBudgetResponse.accountId) &&
        Objects.equals(this.goalId, specificBudgetResponse.goalId) &&
        Objects.equals(this.aggregationAccounts, specificBudgetResponse.aggregationAccounts) &&
        Objects.equals(this.startDate, specificBudgetResponse.startDate) &&
        Objects.equals(this.endDate, specificBudgetResponse.endDate) &&
        Objects.equals(this.metadata, specificBudgetResponse.metadata) &&
        Objects.equals(this.secondaryId, specificBudgetResponse.secondaryId) &&
        Objects.equals(this.updateDate, specificBudgetResponse.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createDate, name, clientId, currencyCode, budget, frequencyUnit, frequency, accountId, goalId, aggregationAccounts, startDate, endDate, metadata, secondaryId, updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class SpecificBudgetResponse {\n");
